...
<td style="border:1px solid black;"><strong>Aggiornamento cumulativo per la protezione di Internet Explorer (2416400)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Alcune vulnerabilità in Microsoft Publisher possono consentire l'esecuzione di codice in modalità remota (2292970)</strong><br />
<br />
...
| [MS10-099](http://go.microsoft.com/fwlink/?linkid=206365) | Vulnerabilità legata al sovraccarico del buffer NDProxy del kernel                                                                  | [CVE-2010-3963](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963) | [**1**](http://technet.microsoft.com/it-it/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | (Nessuna)                                                                    |  
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=f58a765f-cea9-456d-b0ab-bfc70b109cbf)\*  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Publisher 2010 (edizioni a 32 bit)](http://www.microsoft.com/downloads/details.aspx?familyid=99e18990-75e9-497e-9b4f-5d7ef8656ab2)  
(KB2409055)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Publisher 2010 (edizioni a 64 bit)](http://www.microsoft.com/downloads/details.aspx?familyid=9b27ee11-e563-4152-9691-25eec1ee9966)  
(KB2409055)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<sup>[1]</sup>I clienti che utilizzano il software indicato devono installare l'aggiornamento di Microsoft Office fornito nell'articolo MS10-087 per essere protetti dalle vulnerabilità descritte nel bollettino MS10-105.
...
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (edizioni a 32 bit)](http://www.microsoft.com/downloads/details.aspx?familyid=3c8fb9f9-7920-43ea-b618-e26dc3360c60)  
(KB2433089)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (edizioni a 64 bit)](http://www.microsoft.com/downloads/details.aspx?familyid=3db09280-24bd-42e0-9ae3-02c9bf3e8ee3)  
(KB2433089)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Exchange Server 2007 Service Pack 2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=7b983156-9e9f-4d29-9e9b-2369747e3b62)  
(KB2407132)  
(Moderato)
</td>
</tr>
...
-   Aniway di [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato un problema descritto nel bollettino MS10-090
-   Nicolas Joly del [VUPEN Vulnerability Research Team](http://www.vupen.com/) per aver segnalato un problema descritto nel bollettino MS10-090
-   Stephen Fewer che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/) per aver segnalato un problema descritto nel bollettino MS10-090
-   [Peter Vreugdenhil](http://vreugdenhilresearch.nl/) che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/) per aver segnalato un problema descritto nel bollettino MS10-090
-   Masatoshi Sato di [AZIA CO., LTD.](http://www.azia.jp) per aver segnalato un problema descritto nel bollettino MS10-090
-   [Yosuke Hasegawa](http://utf-8.jp/) per avere collaborato con noi allo studio di un problema descritto nel bollettino MS10-090
-   Jose Antonio Vazquez Gonzalez di [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato un problema descritto nel bollettino MS10-090
-   Marc Schoenefeld di [Red Hat Security Response Team](https://www.redhat.com/security/team/), che collabora con [Opera Security Team](http://www.opera.com/security/), per aver segnalato un problema descritto nel bollettino MS10-091
-   Marc Schoenefeld del [Red Hat Security Response Team](https://www.redhat.com/security/team/) per aver segnalato un problema descritto nel bollettino MS10-091
-   Paul-Kenji Cahier Furuya per aver segnalato un problema descritto nel bollettino MS10-091
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin e Alexey Monastyrsky di [Kaspersky Lab](http://usa.kaspersky.com/) e Vitaly Kiktenko e Alexander Saprykin di [Design and Test Lab](http://www.dnt-lab.com/) per aver segnalato un problema descritto nel bollettino MS10-092
-   Liam O Morchu di [Symantec](http://www.symantec.com/index.jsp) per aver segnalato un problema descritto nel bollettino MS10-092
-   Alexandr Matrosov, Eugene Rodionov, Juraj Malcho e David Harley di [ESET](http://www.eset.com/) per aver segnalato un problema descritto nel bollettino MS10-092
-   Haifei Li di [FortiGuard Labs di Fortinet](http://www.fortiguard.com/) per aver segnalato un problema descritto nel bollettino MS10-095
-   Simon Raner di [ACROS Security](http://www.acrossecurity.com/) per aver segnalato un problema descritto nel bollettino MS10-096
-   HD Moore di [Rapid7](http://www.rapid7.com/) per aver segnalato un problema descritto nel bollettino MS10-096
-   Muhaimin Dzulfakar di [NGS Software](http://www.ngssoftware.com/) per aver segnalato un problema descritto nel bollettino MS10-096
-   Muhaimin Dzulfakar di [NGS Software](http://www.ngssoftware.com/) per aver segnalato un problema descritto nel bollettino MS10-097
-   Tarjei Mandt di [Norman](http://www.norman.com/) per aver segnalato quattro problemi descritti nel bollettino MS10-098
-   Stéfan Le Berre di [Sysdream](http://www.sysdream.com/) per aver segnalato un problema descritto nel bollettino MS10-098
-   Bing Liu di [FortiGuard Labs di Fortinet](http://www.fortiguard.com/) per aver segnalato un problema descritto nel bollettino MS10-099
-   Cesar Cerrudo di [Argeniss](http://www.argeniss.com/) per aver segnalato un problema descritto nel bollettino MS10-100
-   Matthias Dieter Wallnöfer e Andrew Bartlett di The Samba Team per aver segnalato un problema descritto nel bollettino MS10-101
-   [HP](http://www.hp.com/) e [techit](http://www.techit.de/) per aver segnalato un problema descritto nel bollettino MS10-102
-   Chaouki Bekrar del [VUPEN Vulnerability Research Team](http://www.vupen.com/) per aver segnalato cinque problemi descritti nel bollettino MS10-103
-   Oleksandr Mirosh, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato un problema descritto nel bollettino MS10-104
-   Yamata Li di [Palo Alto Networks](http://www.paloaltonetworks.com/) per aver segnalato due problemi descritti nel bollettino MS10-105
-   Alin Rad Pop di [Secunia Research](http://secunia.com/) per aver segnalato un problema descritto nel bollettino MS10-105
-   Carsten Eiram di [Secunia Research](http://secunia.com/) per aver segnalato tre problemi descritti nel bollettino MS10-105
-   Dyon Balding di [Secunia Research](http://secunia.com/) per aver segnalato due problemi descritti nel bollettino MS10-105
-   Oleksandr Mirosh, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato un problema descritto nel bollettino MS10-106
...
-   V1.0 (14 dicembre 2010): Pubblicazione del riepilogo dei bollettini.
-   V1.1 (15 dicembre 2010): È stato chiarito che i clienti di Microsoft Office XP e Microsoft Office 2003 devono applicare l'aggiornamento fornito nell'articolo MS10-087 per essere protetti dalle vulnerabilità descritte nel bollettino MS10-105.
