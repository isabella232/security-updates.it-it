---
TOCTitle: 'MS11-JAN'
Title: 'Riepilogo dei bollettini Microsoft sulla sicurezza - gennaio 2011'
ms:assetid: 'ms11-jan'
ms:contentKeyID: 61240058
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-jan(v=Security.10)'
author: SharonSears
...
Riepilogo dei bollettini Microsoft sulla sicurezza - gennaio 2011
=================================================================
...
Questo riepilogo elenca i bollettini sulla sicurezza rilasciati a gennaio 2011.

Con il rilascio dei bollettini sulla sicurezza di gennaio 2011, questo riepilogo dei bollettini sostituisce la notifica anticipata relativa al rilascio di bollettini pubblicata originariamente in data 06 gennaio 2011. Per ulteriori informazioni su questo servizio, vedere la [Notifica anticipata relativa al rilascio di bollettini Microsoft sulla sicurezza](http://technet.microsoft.com/security/bulletin/advance).

Per informazioni su come ricevere automaticamente una notifica ogni volta che viene rilasciato un bollettino Microsoft sulla sicurezza, vedere il [servizio di notifica sulla sicurezza Microsoft](http://technet.microsoft.com/it-it/security/dd252948.aspx).

Microsoft mette a disposizione un webcast per rispondere alle domande dei clienti su questi bollettini il 12 gennaio 2011 alle 11:00 ora del Pacifico (USA e Canada). [Registrazione immediata per i Webcast dei bollettini sulla sicurezza di gennaio](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032454958&eventcategory=4&culture=en-us&countrycode=us). Dopo questa data, il webcast sarà disponibile su richiesta. Per ulteriori informazioni, vedere i [riepiloghi e i webcast dei bollettini Microsoft sulla sicurezza](http://technet.microsoft.com/security/bulletin/summary).
...
<td style="border:1px solid black;"><strong>Alcune vulnerabilità in Microsoft Data Access Components possono consentire l'esecuzione di codice in modalità remota (2451910)</strong><br />
<br />
Questo aggiornamento per la protezione risolve due vulnerabilità segnalate privatamente in Microsoft Data Access Components. Queste vulnerabilità possono consentire l'esecuzione di codice in modalità remota durante la visualizzazione di una pagina Web appositamente predisposta. Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.</td>
...
|-----------------------------------------------------------|-------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|  
| [MS11-001](http://go.microsoft.com/fwlink/?linkid=207795) | Vulnerabilità legata al caricamento delle librerie non sicure nel Manager di backup | [CVE-2010- 3145](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3145) | [1](http://technet.microsoft.com/it-it/security/cc998259.aspx) - In caso di sfruttamento sistematico della vulnerabilità | **Le informazioni sulla vulnerabilità sono state divulgate pubblicamente** |  
| [MS11-002](http://go.microsoft.com/fwlink/?linkid=204803) | Vulnerabilità legata al sovraccarico del DSN                                        | [CVE-2011-0026](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0026)  | [1](http://technet.microsoft.com/it-it/security/cc998259.aspx) - In caso di sfruttamento sistematico della vulnerabilità | (Nessuna)                                                                  |  
| [MS11-002](http://go.microsoft.com/fwlink/?linkid=204803) | Vulnerabilità legata alla memoria dei record ADO                                    | [CVE-2011-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0027)  | [1](http://technet.microsoft.com/it-it/security/cc998259.aspx) - In caso di sfruttamento sistematico della vulnerabilità | (Nessuna)                                                                  |
...
-   Abdul Aziz Hariri, che collabora con [Zero Day Initiative](http://www.tippingpoint.com/)* di* [TippingPoint](http://www.zerodayinitiative.com/), per aver segnalato un problema descritto nel bollettino MS11-002
-   Peter Vreugdenhil, che collabora con [Zero Day Initiative](http://www.tippingpoint.com/)* di* [TippingPoint](http://www.zerodayinitiative.com/), per aver segnalato un problema descritto nel bollettino MS11-002
...
-   V1.0 (11 gennaio 2011): Pubblicazione del riepilogo dei bollettini.
