---
TOCTitle: 'MS06-SEP'
Title: 'Riepilogo dei bollettini Microsoft sulla sicurezza - settembre 2006'
ms:assetid: 'ms06-sep'
ms:contentKeyID: 61240005
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-sep(v=Security.10)'
---

Security Bulletin Summary

Riepilogo dei bollettini Microsoft sulla sicurezza - settembre 2006
===================================================================

Data di pubblicazione: martedì 12 settembre 2006 | Aggiornamento: martedì 26 settembre 2006

**Versione:** 2.0

Una versione per gli utenti finali di questo documento è disponibile presso il seguente [sito Web](http://www.microsoft.com/security/default.mspx).
...
-   Informazioni per i professionisti IT: visitare il sito Web [Security Guidance Center](http://www.microsoft.com/italy/technet/security/guidance/default.mspx).
...
<span></span>
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS06-054                                                                                                                             |
|---------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | [**Una vulnerabilità in Microsoft Publisher può consentire l'esecuzione di codice in modalità remota (910729)**](http://technet.microsoft.com/security/bulletin/ms06-054) |
| **Riepilogo**                   | L'aggiornamento risolve una vulnerabilità in Publisher associata all'esecuzione di codice in modalità remota.                                                             |
...
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS06-055                                                                                                                               |
|---------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | [**La vulnerabilità in Vector Markup Language può consentire l'esecuzione di codice in modalità remota (925486)**](http://technet.microsoft.com/security/bulletin/ms06-055) |
| **Riepilogo**                   | L'aggiornamento risolve una vulnerabilità in Vector Markup Language associata all'esecuzione di codice in modalità remota.                                                  |
| **Livello di gravità**          | [Critico](http://technet.microsoft.com/security/bulletin/rating)                                                                                                            |
| **Effetti della vulnerabilità** | Esecuzione di codice in modalità remota                                                                                                                                     |
...
<span></span>
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS06-052                                                                                                                                           |
|---------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | [**Una vulnerabilità in Pragmatic General Multicast (PGM) può consentire l'esecuzione di codice in modalità remota (919007)**](http://technet.microsoft.com/security/bulletin/ms06-052) |
| **Riepilogo**                   | Questo aggiornamento risolve una vulnerabilità nel programma Reliable Multicast (PGM) che potrebbe consentire l'esecuzione di codice in modalità remota.                                |
...
<span></span>
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS06-053                                                                                                                   |
|---------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | [**Una vulnerabilità nel servizio di indicizzazione può consentire il cross-site scripting (920685)**](http://technet.microsoft.com/security/bulletin/ms06-053) |
| **Riepilogo**                   | Questo aggiornamento risolve una vulnerabilità nel servizio di indicizzazione che potrebbe consentire l'intercettazione di informazioni personali.              |
...
#### Software interessato e posizioni per il download dei bollettini da MS06-052 a MS06-055
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0182e8e7-9755-46cc-a393-c1e95fd508b2">Basso</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=af8f3a58-ba7a-41bf-bb1b-3a9ddfdc3e27">Moderato</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0182e8e7-9755-46cc-a393-c1e95fd508b2">Basso</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=af8f3a58-ba7a-41bf-bb1b-3a9ddfdc3e27">Critico</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 con SP1 per sistemi basati su Itanium</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e3e4a66c-ca9d-453b-8875-fb57528117ac">Basso</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=271e9c78-1c6a-443e-924d-43fd6d51e643">Moderato</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e3e4a66c-ca9d-453b-8875-fb57528117ac">Basso</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=271e9c78-1c6a-443e-924d-43fd6d51e643">Critico</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=acf35f34-0d26-4b79-b81f-1111a784a66d">Basso</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e2cb474f-fc1b-4b7d-a607-02a1528c6743">Critico</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2731c0bf-6034-4c16-bb57-66e70a31a3d6">Moderato</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b5f19858-4e86-4fd4-a264-e4823ff6d0a9">Critico</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2731c0bf-6034-4c16-bb57-66e70a31a3d6">Moderato</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=383c13dc-51a9-4b12-89e3-871a1a3de98f">Critico</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3f604b2a-1383-4a45-b25b-c468deefbfc1">Moderato</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=afd3279c-6171-4f20-a36e-b9b56ee4c7f1">Critico</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=778294ae-c5e3-4f17-b0e4-308e46e00105">Moderato</a></td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=461a126b-596f-4e84-99fd-03554ac55213">Critico</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ea7de30f-d765-4e5b-bfd4-64f3fed578ff">Critico</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Internet Explorer 6 Service Pack 1 in Windows XP Service Pack 1</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4c48ff93-6559-4616-9c2d-406e808b7e97">Critico</a></td>
</tr>
</tbody>
</table>
...
-   David Warden di NuPaper Inc. per aver segnalato un problema descritto nel bollettino [MS06-052](http://technet.microsoft.com/security/bulletin/ms06-052).  
-   Eiji James Yoshid per aver segnalato un problema descritto nel bollettino [MS06-053](http://technet.microsoft.com/security/bulletin/ms06-053).  
-   Stuart Pearson di [Computer Terrorism](http://www.computerterrorism.com/) per aver segnalato un problema descritto nel bollettino [MS06-054](http://technet.microsoft.com/security/bulletin/ms06-054).  
-   [ISS X-Force](http://www.iss.net/) per aver collaborato con noi su un problema descritto nel bollettino [MS06-055](http://technet.microsoft.com/security/bulletin/ms06-055).  
-   [iDEFENSE](http://www.idefense.com/) per aver collaborato con noi su un problema descritto nel bollettino [MS06-055](http://technet.microsoft.com/security/bulletin/ms06-055).  
-   Dan Hubbard di [Websense Security Labs](http://www.websense.com/securitylabs/) per aver segnalato un problema descritto nel bollettino [MS06-055](http://technet.microsoft.com/security/bulletin/ms06-055).
...
-   V2.0 (26 settembre 2006): Bollettino aggiornato con MS06-055.
