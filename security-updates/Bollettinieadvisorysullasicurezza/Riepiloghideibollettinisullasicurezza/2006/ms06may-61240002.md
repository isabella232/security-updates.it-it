---
TOCTitle: 'MS06-MAY'
Title: 'Riepilogo dei bollettini Microsoft sulla sicurezza - maggio 2006'
ms:assetid: 'ms06-may'
ms:contentKeyID: 61240002
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-may(v=Security.10)'
---

Security Bulletin Summary

Riepilogo dei bollettini Microsoft sulla sicurezza - maggio 2006
================================================================

Data di pubblicazione: martedì 9 maggio 2006
...
<span></span>
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS06-019                                                                                                                            |
|---------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | [**Una vulnerabilità in Microsoft Exchange può consentire l'esecuzione di codice in modalità remota (916803)**](http://technet.microsoft.com/security/bulletin/ms06-019) |
| **Riepilogo**                   | In Microsoft Exchange esistono alcune vulnerabilità che possono consentire l'esecuzione di codice in modalità remota.                                                    |
...
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS06-020                                                                                                                                          |
|---------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | [**Vulnerabilità in Macromedia Flash Player di Adobe possono consentire l'esecuzione di codice in modalità remota (913433)**](http://technet.microsoft.com/security/bulletin/ms06-020) |
| **Riepilogo**                   | Vulnerabilità in Macromedia Flash Player di Adobe possono consentire l'esecuzione di codice in modalità remota.                                                                        |
| **Livello di gravità**          | [Critico](http://technet.microsoft.com/security/bulletin/rating)                                                                                                                       |
| **Effetti della vulnerabilità** | Esecuzione di codice in modalità remota                                                                                                                                                |
...
<span></span>
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS06-018                                                                                                                                                                                                                                                  |
|---------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | [**Una vulnerabilità in Microsoft Distributed Transaction Coordinator può consentire un attacco di tipo Denial of Service (913580)**](http://technet.microsoft.com/security/bulletin/ms06-018)                                                                                                 |
| **Riepilogo**                   | Esiste una vulnerabilità ad attacchi di tipo Denial of Service che potrebbe consentire l'invio di un messaggio di rete appositamente predisposto a un sistema interessato.  Un utente malintenzionato potrebbe impedire a Microsoft Distributed Transaction Coordinator (MSDTC) di rispondere. |
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e70515c7-8924-46da-8573-457957eea0d7">Basso</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 per sistemi basati su Itanium</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7bd81335-79ea-46ce-8d3c-0aa91eefff02">Basso</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Service Pack 1</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d80b43b2-727b-46b6-82d1-f2cbd916fe32">Basso</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b2b8f9a8-4874-405a-9f0c-768b2631673a">Critico</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8b98f380-0e5c-4b80-9710-95e1b35afd83">Moderato</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Software di Exchange interessato:</strong></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f32574e0-f35c-4537-9ad0-524cb49afe53">Critico</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Exchange Server 2000 con il rollup di aggiornamento di Exchange 2000 Post-Service Pack 3 dell'agosto 2004</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e72c8f94-782f-4670-9221-e2e37eadb8ec">Critico</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   [eEye Digital Security](http://www.eeye.com/html/) per aver segnalato un problema descritto nel bollettino [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018).  
-   Xiao Chen di [McAfee](http://www.mcafee.com) per aver segnalato un problema descritto nel bollettino [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018).  
-   Kai Zhang di [VenusTech](http://www.venustech.com.cn) per aver segnalato un problema descritto nel bollettino [MS06-018](http://technet.microsoft.com/security/bulletin/ms06-018).
