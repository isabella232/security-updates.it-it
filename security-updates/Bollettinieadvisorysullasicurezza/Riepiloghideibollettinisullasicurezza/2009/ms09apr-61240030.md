---
TOCTitle: 'MS09-APR'
Title: 'Riepilogo dei bollettini Microsoft sulla sicurezza - aprile 2009'
ms:assetid: 'ms09-apr'
ms:contentKeyID: 61240030
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-apr(v=Security.10)'
---

Security Bulletin Summary

Riepilogo dei bollettini Microsoft sulla sicurezza - aprile 2009
================================================================

Data di pubblicazione: martedì 14 aprile 2009 | Aggiornamento: giovedì 16 aprile 2009
...
Microsoft mette a disposizione un webcast per rispondere alle domande dei clienti su questi bollettini in data 15 aprile 2009 alle 11:00 ora del Pacifico (USA e Canada). [Registrazione immediata per i Webcast dei bollettini sulla sicurezza di aprile](http://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032395126). Dopo questa data, il webcast sarà disponibile su richiesta. Per ulteriori informazioni, vedere i [riepiloghi e i webcast dei bollettini Microsoft sulla sicurezza](http://technet.microsoft.com/security/bulletin/default).
...
<td style="border:1px solid black;"><strong>Alcune vulnerabilità nei convertitori di testo di WordPad e Office possono consentire l'esecuzione di codice in modalità remota (960477)</strong><br />
<br />
Questo aggiornamento per la protezione risolve due vulnerabilità divulgate pubblicamente e due vulnerabilità segnalate privatamente, che sono state riscontrate in Microsoft WordPad e nei convertitori di testo di Microsoft Office. Tali vulnerabilità possono consentire l'esecuzione di codice in modalità remota durante l'apertura di un file appositamente predisposto in WordPad o in Microsoft Office Word. Si raccomanda di non aprire file di Microsoft Office, RTF, Write o WordPerfect provenienti da fonti non attendibili utilizzando versioni interessate di WordPad o di Microsoft Office Word.</td>
...
<td style="border:1px solid black;"><strong>Alcune vulnerabilità in Windows HTTP Services possono consentire l'esecuzione di codice in modalità remota (960803)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Una vulnerabilità in Microsoft DirectShow può consentire l'esecuzione di codice in modalità remota (961373)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Aggiornamento cumulativo per la protezione di Internet Explorer (963027)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Alcune vulnerabilità di Microsoft Office Excel possono consentire l'esecuzione di codice in modalità remota (968557)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Una vulnerabilità di varia natura in SearchPath può consentire l'acquisizione di privilegi più elevati (959426)</strong><br />
<br />
...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|  
| [MS09-009](http://technet.microsoft.com/security/bulletin/ms09-009) | Alcune vulnerabilità di Microsoft Office Excel possono consentire l'esecuzione di codice in modalità remota (968557)                                                     | [CVE-2009-0100](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0100)     | [**2**](http://technet.microsoft.com/security/cc998259.aspx) - Media probabilità di sfruttamento della vulnerabilità  | (Nessuna)                                                                                                                                                                                                                                                                                                                    |  
| [MS09-009](http://technet.microsoft.com/security/bulletin/ms09-009) | Alcune vulnerabilità di Microsoft Office Excel possono consentire l'esecuzione di codice in modalità remota (968557)                                                     | [CVE-2009-0238](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | **Questa vulnerabilità è attualmente sfruttata nell'ecosistema di Internet.**                                                                                                                                                                                                                                                |  
| [MS09-010](http://technet.microsoft.com/security/bulletin/ms09-010) | Alcune vulnerabilità nei convertitori di testo di WordPad e Office possono consentire l'esecuzione di codice in modalità remota (960477)                                 | [CVE-2008-4841](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4841)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | **Questa vulnerabilità è attualmente sfruttata nell'ecosistema di Internet.**                                                                                                                                                                                                                                                |  
| [MS09-010](http://technet.microsoft.com/security/bulletin/ms09-010) | Alcune vulnerabilità nei convertitori di testo di WordPad e Office possono consentire l'esecuzione di codice in modalità remota (960477)                                 | [CVE-2009-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0087)     | [**2**](http://technet.microsoft.com/security/cc998259.aspx) - Media probabilità di sfruttamento della vulnerabilità  | Questo è una vulnerabilità complessa a causa di più percorsi di codice. La probabilità di sfruttamento della vulnerabilità risulta essere media nella maggior parte dei casi. I fattori attenuanti predefiniti proteggono da questo vettore.                                                                                 |  
| [MS09-010](http://technet.microsoft.com/security/bulletin/ms09-010) | Alcune vulnerabilità nei convertitori di testo di WordPad e Office possono consentire l'esecuzione di codice in modalità remota (960477)                                 | [CVE-2009-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0088)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | Questa vulnerabilità è sfruttabile ma interessa soltanto le versioni precedenti e un formato file precedente e non comune. Le versioni più recenti, come Microsoft Office System 2007 e Microsoft Office 2003 Service Pack 3, non sono interessate.                                                                          |  
| [MS09-010](http://technet.microsoft.com/security/bulletin/ms09-010) | Alcune vulnerabilità nei convertitori di testo di WordPad e Office possono consentire l'esecuzione di codice in modalità remota (960477)                                 | [CVE-2009-0235](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0235)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | Questa vulnerabilità legata al danneggiamento della memoria è facilmente sfruttabile.                                                                                                                                                                                                                                        |  
| [MS09-011](http://technet.microsoft.com/security/bulletin/ms09-011) | Una vulnerabilità in Microsoft DirectShow può consentire l'esecuzione di codice in modalità remota (961373)                                                              | [CVE-2009-0084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0084)     | [**2**](http://technet.microsoft.com/security/cc998259.aspx) - Media probabilità di sfruttamento della vulnerabilità  | (Nessuna)                                                                                                                                                                                                                                                                                                                    |  
| [MS09-012](http://technet.microsoft.com/security/bulletin/ms09-012) | Alcune vulnerabilità di Windows possono consentire l'acquisizione di privilegi più elevati (959454)                                                                      | [CVE-2008-1436](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1436)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | **Questa vulnerabilità è attualmente sfruttata nell'ecosistema di Internet.**                                                                                                                                                                                                                                                |  
| [MS09-012](http://technet.microsoft.com/security/bulletin/ms09-012) | Alcune vulnerabilità di Windows possono consentire l'acquisizione di privilegi più elevati (959454)                                                                      | [CVE-2009-0078](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0078)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | **Questa vulnerabilità è attualmente sfruttata nell'ecosistema di Internet.**                                                                                                                                                                                                                                                |  
| [MS09-012](http://technet.microsoft.com/security/bulletin/ms09-012) | Alcune vulnerabilità di Windows possono consentire l'acquisizione di privilegi più elevati (959454)                                                                      | [CVE-2009-0079](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0079)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | **Questa vulnerabilità è attualmente sfruttata nell'ecosistema di Internet.**                                                                                                                                                                                                                                                |  
| [MS09-012](http://technet.microsoft.com/security/bulletin/ms09-012) | Alcune vulnerabilità di Windows possono consentire l'acquisizione di privilegi più elevati (959454)                                                                      | [CVE-2009-0080](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0080)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | **Questa vulnerabilità è attualmente sfruttata nell'ecosistema di Internet.**                                                                                                                                                                                                                                                |  
| [MS09-013](http://technet.microsoft.com/security/bulletin/ms09-013) | Alcune vulnerabilità in Windows HTTP Services possono consentire l'esecuzione di codice in modalità remota (960803)                                                      | [CVE-2009-0086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0086)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | Questo è una vulnerabilità della memoria facilmente controllabile con più vettori di attacco e opportunità per lo sfruttamento dovute all'uso esteso di questa tecnologia.                                                                                                                                                   |  
| [MS09-013](http://technet.microsoft.com/security/bulletin/ms09-013) | Alcune vulnerabilità in Windows HTTP Services possono consentire l'esecuzione di codice in modalità remota (960803)                                                      | [CVE-2009-0089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0089)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | (Nessuna)                                                                                                                                                                                                                                                                                                                    |  
| [MS09-013](http://technet.microsoft.com/security/bulletin/ms09-013) | Alcune vulnerabilità in Windows HTTP Services possono consentire l'esecuzione di codice in modalità remota (960803)                                                      | [CVE-2009-0550](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550)\*\* | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | La vulnerabilità è stata resa pubblica.                                                                                                                                                                                                                                                                                      |  
| [MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014) | Aggiornamento cumulativo per la protezione di Internet Explorer (963027)                                                                                                 | [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)\*   | [**3**](http://technet.microsoft.com/security/cc998259.aspx) - Scarsa probabilità di sfruttamento della vulnerabilità | I dettagli di attacco sono stati resi pubblici, tuttavia al momento non esistono vettori di attacco noti per questo problema. Per sfruttare questa vulnerabilità, è necessario che un utente malintenzionato e l'utente stesso seguano una serie operazioni complesse, tra cui il salvataggio di file specifici sul desktop. |  
| [MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014) | Aggiornamento cumulativo per la protezione di Internet Explorer (963027)                                                                                                 | [CVE-2009-0550](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550)\*\* | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | La vulnerabilità è stata resa pubblica.                                                                                                                                                                                                                                                                                      |  
| [MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014) | Aggiornamento cumulativo per la protezione di Internet Explorer (963027)                                                                                                 | [CVE-2009-0551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0551)     | [**2**](http://technet.microsoft.com/security/cc998259.aspx) - Media probabilità di sfruttamento della vulnerabilità  | (Nessuna)                                                                                                                                                                                                                                                                                                                    |  
| [MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014) | Aggiornamento cumulativo per la protezione di Internet Explorer (963027)                                                                                                 | [CVE-2009-0552](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0552)     | [**3**](http://technet.microsoft.com/security/cc998259.aspx) - Scarsa probabilità di sfruttamento della vulnerabilità | I fattori attenuanti per Internet Explorer 7 impediscono l'esecuzione di codice. Internet Explorer 6 e le versioni precedenti sono più facilmente sfruttabili se non sono aggiornati con tutti gli aggiornamenti per la protezione.                                                                                          |  
| [MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014) | Aggiornamento cumulativo per la protezione di Internet Explorer (963027)                                                                                                 | [CVE-2009-0553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0553)     | [**3**](http://technet.microsoft.com/security/cc998259.aspx) - Scarsa probabilità di sfruttamento della vulnerabilità | (Nessuna)                                                                                                                                                                                                                                                                                                                    |  
| [MS09-014](http://technet.microsoft.com/security/bulletin/ms09-014) | Aggiornamento cumulativo per la protezione di Internet Explorer (963027)                                                                                                 | [CVE-2009-0554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0554)     | [**1**](http://technet.microsoft.com/security/cc998259.aspx) - Alta probabilità di sfruttamento della vulnerabilità   | (Nessuna)                                                                                                                                                                                                                                                                                                                    |  
| [MS09-015](http://technet.microsoft.com/security/bulletin/ms09-015) | Una vulnerabilità di varia natura in SearchPath può consentire l'acquisizione di privilegi più elevati (959426)                                                          | [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)\*   | [**2**](http://technet.microsoft.com/security/cc998259.aspx) - Media probabilità di sfruttamento della vulnerabilità  | I dettagli di attacco sono stati resi pubblici, tuttavia al momento non esistono vettori di attacco noti per questo problema. Per sfruttare questa vulnerabilità, è necessario che un utente malintenzionato e l'utente stesso seguano una serie operazioni complesse, tra cui il salvataggio di file specifici sul desktop. |  
| [MS09-016](http://technet.microsoft.com/security/bulletin/ms09-016) | Alcune vulnerabilità in Microsoft ISA Server e Forefront Threat Management Gateway (Medium Business Edition) possono causare attacchi di tipo Denial of Service (961759) | [CVE-2009-0077](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0077)     | [**3**](http://technet.microsoft.com/security/cc998259.aspx) - Scarsa probabilità di sfruttamento della vulnerabilità | Gli attacchi di tipo Denial of Service basati su servizi sono estremamente probabili. Tuttavia, l'esecuzione di codice non è possibile.                                                                                                                                                                                      |  
| [MS09-016](http://technet.microsoft.com/security/bulletin/ms09-016) | Alcune vulnerabilità in Microsoft ISA Server e Forefront Threat Management Gateway (Medium Business Edition) possono causare attacchi di tipo Denial of Service (961759) | [CVE-2009-0237](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-0237)          | [**3**](http://technet.microsoft.com/security/cc998259.aspx) - Scarsa probabilità di sfruttamento della vulnerabilità | L'intercettazione di informazioni personali è possibile. L'esecuzione di codice è estremamente improbabile.                                                                                                                                                                                                                  |
  
\*Questa coppia di vulnerabilità, con lo stesso codice CVE, viene risolta in due aggiornamenti per la protezione. Per ulteriori informazioni fare riferimento ai rispettivi bollettini.
...
<td style="border:1px solid black;">
Aggiornamento della soluzione per transazioni MSDTC:  
...
(KB952004)  
(Importante)  
Aggiornamento dell'isolamento del servizio Windows:  
...
<td style="border:1px solid black;">
[Windows Server 2003 con SP1 per sistemi basati su Itanium e Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=e840b9cb-f1f4-482a-aa07-eb6b42b477c4)  
(KB923561)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 con SP1 per sistemi basati su Itanium e Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=05e33cc5-cff6-4c71-be71-285f66a95e01)  
(Critico)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Aggiornamento della soluzione per transazioni MSDTC:  
[Windows Server 2003 con SP1 per sistemi basati su Itanium e Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=6ada372b-ba17-433e-b022-d2c57b35af8a)  
(KB952004)  
(Importante)  
Aggiornamento dell'isolamento del servizio Windows:  
[Windows Server 2003 con SP1 per sistemi basati su Itanium e Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=fda8837c-e5d2-4489-9b44-4c24a1102e77)  
(KB956572)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 con SP1 per sistemi basati su Itanium e Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=00c6479d-f81f-445d-b8e4-7b71d77d540a)  
(Moderato)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=4c36548f-c8c9-4318-91e2-9e0501339548)\*  
(Critico)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<td style="border:1px solid black;">
Aggiornamento della soluzione per transazioni MSDTC:  
[Windows Server 2008 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=9e3c7b52-65a7-42fb-beb5-1b374934737f)\*  
(KB952004)  
(Importante)  
Aggiornamento dell'isolamento del servizio Windows:  
[Windows Server 2008 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=d58702af-bbf8-4f1b-ae72-ced9ef23d581)\*  
(KB956572)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=6b73cf5e-66fe-4b7d-95fc-91a1c262c1e5)\*  
(Moderato)
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=1c3f0997-a8a9-4340-ae0c-2c4d6792c65c)\*  
(Critico)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<td style="border:1px solid black;">
Aggiornamento della soluzione per transazioni MSDTC:  
[Windows Server 2008 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=eebb4d4d-29d2-4247-8cbb-63a3b17585ec)\*  
(KB952004)  
(Importante)  
Aggiornamento dell'isolamento del servizio Windows:  
[Windows Server 2008 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=20bf4e9b-909b-4bc3-ae43-322d74a4f1c3)\*  
(KB956572)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=7e60847c-b341-4c38-bc25-2e3cf2d4ae14)\*  
(Moderato)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0885b3b0-b78e-4980-902d-dff3886bcaac)  
(Critico)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<td style="border:1px solid black;">
Aggiornamento della soluzione per transazioni MSDTC:  
[Windows Server 2008 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cc383c24-b0f6-47c1-9e89-6a378b09e82f)  
(KB952004)  
(Importante)  
Aggiornamento dell'isolamento del servizio Windows:  
[Windows Server 2008 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=bcc2b18f-67db-4109-a9f4-764f985423ee)  
(KB956572)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=de1c2b4b-af47-4b9a-8363-720e5527573c)  
(Moderato)
</td>
</tr>
</table>
...
Per ulteriori file di aggiornamento, vedere anche la sezione seguente, **Suite e software Microsoft Office**. Questo bollettino comprende sia la sezione Sistema operativo Windows e suoi componenti sia la sezione Suite e software Microsoft Office.
...
\*Per Microsoft Office Excel 2007 Service Pack 1, i clienti devono installare anche l'aggiornamento per la protezione del Pacchetto di compatibilità di Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 Service Pack 1 per essere protetti dalle vulnerabilità descritte in questo bollettino.
...
\*Microsoft Forefront Threat Management Gateway, Medium Business Edition, viene fornito sia come prodotto autonomo sia come componente di Windows Essential Business Server 2008.

\*\*Microsoft ISA Server 2004 Standard Edition viene fornito come prodotto autonomo. Microsoft ISA Server 2004 Standard Edition viene anche fornito come componente di Windows Small Business Server 2003 Enterprise Edition Service Pack 1 e Windows Small Business Server 2003 R2 Enterprise Edition.
...
-   Haifei Li del [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) di Fortinet per aver segnalato un problema descritto nel bollettino MS09-009
-   Sean Larsson e Jun Mao di [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato un problema descritto nel bollettino MS09-010
-   Un ricercatore che collabora col [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) di Fortinet per aver segnalato un problema descritto nel bollettino MS09-010
-   Un ricercatore che collabora con [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato un problema descritto nel bollettino MS09-010
-   Piotr Bania di [Kryptos Logic](http://www.kryptoslogic.com/) per aver segnalato un problema descritto nel bollettino MS09-011
-   Cesar Cerrudo di [Argeniss](http://www.argeniss.com/) per aver segnalato diversi problemi descritti nel bollettino MS09-012
-   Greg MacManus di [iSIGHT Partners Labs](http://www.isightpartners.com/) per aver segnalato un problema descritto nel bollettino MS09-013
-   Wan-Teh Chang e Cem Paya di [Google Inc.](http://www.google.com/) per aver segnalato un problema descritto nel bollettino MS09-013
-   [Aviv Raff](http://aviv.raffon.net/) per aver segnalato un problema descritto nel bollettino MS09-014
-   Michal Zalewski di [Google Inc.](http://www.google.com/) per aver segnalato un problema descritto nel bollettino MS09-014
-   Ivan Fratric di [iSIGHT Partners Labs](http://www.isightpartners.com/) per aver segnalato un problema descritto nel bollettino MS09-014
-   Skylined di [Google Inc.](http://www.google.com/) per aver segnalato un problema descritto nel bollettino MS09-014
-   ADLab di [VenusTech](http://www.venustech.com.cn/) per aver segnalato un problema descritto nel bollettino MS09-014
-   [Aviv Raff](http://aviv.raffon.net/) per aver segnalato un problema descritto nel bollettino MS09-015
-   Il New York State Chief Information Officer/Office for Technology per aver segnalato un problema descritto nel bollettino MS09-016
...
-   V1.0 (14 aprile 2009): Pubblicazione del riepilogo dei bollettini.
-   V1.1 (16 aprile 2009): l'Exploitability Index è stato aggiornato: le note fondamentali per CVE-2009-0089 sono state rimosse e le note fondamentali per CVE-2008-2540 sono state modificate nei bollettini MS09-014 e MS09-015.
