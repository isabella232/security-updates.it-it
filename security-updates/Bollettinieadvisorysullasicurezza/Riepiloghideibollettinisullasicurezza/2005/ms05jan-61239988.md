...
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS05-002                                                                                                                                                           |
|---------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Windows Affected Operating System Components:</strong></p></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
