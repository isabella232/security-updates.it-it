---
TOCTitle: 'MS05-NOV'
Title: 'Riepilogo dei bollettini Microsoft sulla sicurezza - novembre 2005'
ms:assetid: 'ms05-nov'
ms:contentKeyID: 61239992
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms05-nov(v=Security.10)'
---

Security Bulletin Summary

Riepilogo dei bollettini Microsoft sulla sicurezza - novembre 2005
==================================================================
...
<span></span>
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS05-053                                                                                                          |
|---------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | Alcune vulnerabilità del motore di rendering della grafica possono consentire l'esecuzione di codice non autorizzato                                   |
| **Riepilogo**                   | In Windows esistono alcune vulnerabilità che possono consentire a un utente malintenzionato di assumere il controllo completo del sistema interessato. |
| **Livello di gravità massimo**  | [Critico](http://technet.microsoft.com/security/bulletin/rating)                                                                                       |
| **Effetti della vulnerabilità** | Esecuzione di codice remoto                                                                                                                            |
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cee3dd3b-3c20-47a9-8bbd-1ea2fbb4af96">Critico</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f1adb6e4-0a08-496c-b94c-a1b37178914a">Critico</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows Server 2003 per sistemi basati su Itanium</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ccff22bb-adc4-4974-813c-7721bdb842c0">Critico</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Server 2003 Service Pack 1 per sistemi basati su Itanium</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ccff22bb-adc4-4974-813c-7721bdb842c0">Critico</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Service Pack 1</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e38372b2-3bf6-4393-b9a4-f34248c8073e">Critico</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=086c6878-916c-4a4f-8ca8-a4c0e304fda4">Critico</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f361fccb-b273-47e7-bb15-bc9c27073446">Critico</a></td>
</tr>
</tbody>
</table>
...
-   [Venustech AdDLab](http://www.venustech.com.cn/), [eEye Digital Security](http://www.eeye.com/html/) e Peter Ferrie di [Symantec Security Response](http://securityresponse.symantec.com/) per aver segnalato un problema descritto nel bollettino [MS05-053](http://technet.microsoft.com/security/bulletin/ms05-053).
