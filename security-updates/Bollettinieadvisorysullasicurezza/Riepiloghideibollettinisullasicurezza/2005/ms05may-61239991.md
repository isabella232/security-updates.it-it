---
TOCTitle: 'MS05-MAY'
Title: 'Riepilogo dei bollettini Microsoft sulla sicurezza - maggio 2005'
ms:assetid: 'ms05-may'
ms:contentKeyID: 61239991
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms05-may(v=Security.10)'
---

Security Bulletin Summary

Riepilogo dei bollettini Microsoft sulla sicurezza - maggio 2005
================================================================
...
Questo bollettino include gli aggiornamenti per una vulnerabilità scoperta di recente:

Importante (1)
--------------

<span></span>
| Identificatore del bollettino   | Bollettino Microsoft sulla sicurezza MS05-024                                                                                                                                |
|---------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Titolo del bollettino**       | [**Una vulnerabilità nella visualizzazione Web può consentire l'esecuzione di codice in modalità remota (894320)**](http://technet.microsoft.com/security/bulletin/ms05-024) |
| **Riepilogo**                   | Nella visualizzazione Web è presente una vulnerabilità legata all'introduzione di uno script durante la gestione di attributi dei file.                                      |
| **Livello di gravità massimo**  | [Importante](http://technet.microsoft.com/security/bulletin/rating)                                                                                                          |
| **Effetti della vulnerabilità** | Esecuzione di codice in modalità remota                                                                                                                                      |
| **Software interessato**        | **Windows**                                                                                                                                                                  |
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=67581d32-743f-44ff-9b53-30277c196923">Importante</a></td>
</tr>
<tr class="odd">
