---
TOCTitle: 'MS04-AUG'
Title: 'Riepilogo dei bollettini Microsoft sulla sicurezza - agosto 2004'
ms:assetid: 'ms04-aug'
ms:contentKeyID: 61239977
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms04-aug(v=Security.10)'
---

Security Bulletin Summary

Riepilogo dei bollettini Microsoft sulla sicurezza - agosto 2004
================================================================
...
<thead>
<tr class="header">
<th>Identificatore del bollettino</th>
<th>Bollettino Microsoft sulla sicurezza MS04-026</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Titolo</strong> <strong>del</strong> <strong>bollettino</strong></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms04-026">Una vulnerabilità in Exchange Server 5.5 Outlook Web Access può consentire attacchi di Cross-Site Scripting e di spoofing (842463)</a>
<p></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Riepilogo</strong></td>
<td style="border:1px solid black;">In OWA per Exchange Server 5.5 esiste una vulnerabilità di Cross-Site Scripting e spoofing che potrebbe causare l'esecuzione di script da parte di un utente per conto di un pirata informatico.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Livello di gravità</strong></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/rating">Moderato</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Microsoft Exchange, Outlook Web Access</strong>. Per ulteriori informazioni, vedere la sezione &quot;Software interessato e posizioni per il download&quot;.</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Software Exchange interessato:</strong></p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Componenti di Exchange interessati:</strong></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Outlook Web Access (OWA)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=66e4e033-5a4c-4eec-84f1-31f0ca878092&amp;displaylang=en">Moderato</a></td>
</tr>
</tbody>
</table>
...
**<sup>[1]</sup>** È disponibile un aggiornamento della protezione per questa versione del software. Per ulteriori dettagli, vedere il componente interessato dalla vulnerabilità, Outlook Web Access, nella tabella e il relativo bollettino sulla sicurezza.
...
-   Amit Klein di [Sanctum Inc.](http://www.sanctuminc.com/), per aver segnalato il problema descritto nel bollettino [MS04-026](http://technet.microsoft.com/security/bulletin/msxx-xxx).
