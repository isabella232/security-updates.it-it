...
<p>Gli amministratori di sistema possono rimuovere l'aggiornamento per la protezione anche mediante l'utilità Spuninst.exe, disponibile nella cartella %Windir%\$NTUninstallKB936021$\Spuninst.</p></td>
</tr>
<tr class="odd">
...
<p><strong>Nota</strong> La rimozione dell'aggiornamento per la protezione per Microsoft XML Core Services 6 rimuove completamente MSXML6 dal sistema.</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'argomento <strong>Informazioni sui file</strong>, riportato di seguito, per visualizzare il manifest completo</td>
