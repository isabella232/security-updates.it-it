---
TOCTitle: 'MS09-074'
Title: 'Bollettino Microsoft sulla sicurezza MS09-074 - Critico'
ms:assetid: 'ms09-074'
ms:contentKeyID: 61240439
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-074(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS09-074 - Critico
=======================================================

Una vulnerabilità di Microsoft Office Project può consentire l'esecuzione di codice in modalità remota (967183)
---------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello critico per Microsoft Project 2000 Service Release 1 e di livello importante per Microsoft Project 2002 Service Pack 1 e Microsoft Office Project 2003 Service Pack 3. Per ulteriori informazioni, vedere la sottosezione Software interessato e Software non interessato in questa sezione.

L'aggiornamento elimina la vulnerabilità modificando il modo in cui Microsoft Office Project convalida le allocazioni della memoria durante l'apertura di file Project dal disco alla memoria. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<th>  
Vulnerabilità legata alla convalida della memoria in Project - CVE-2009-0102  
</th>  
<th>  
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Office Project gestisce file Project appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0102](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0102).

#### Fattori attenuanti della vulnerabilità legata alla convalida della memoria in Project - CVE-2009-0102
...
#### Soluzioni alternative per la vulnerabilità legata alla convalida della memoria in Project - CVE-2009-0102

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   Non aprire i file Project (ad esempio i file con un'estensione .mpp) provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata alla convalida della memoria in Project - CVE-2009-0102
...
Microsoft Office Project non convalida correttamente le allocazioni delle risorse di memoria durante l'apertura di file Project.
...
Questa vulnerabilità può essere sfruttata solo se un utente apre un file Project non valido di una versione interessata di Microsoft Office Project.
...
In uno scenario di attacco dal Web l'utente malintenzionato deve pubblicare un sito Web contenente un file Project utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare un sito Web appositamente predisposto, l'utente malintenzionato dovrebbe convincere le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento che le indirizzi al sito.

**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**  
I sistemi più esposti sono quelli che utilizzano una versione interessata di Microsoft Office Project, come le workstation e i server terminal. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.

**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve la vulnerabilità modificando il modo in cui Microsoft Office Project convalida le allocazioni della memoria quando si aprono i file Project appositamente predisposti.
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/961083">articolo della Microsoft Knowledge Base 961083</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/961079">articolo della Microsoft Knowledge Base 961079</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo della chiave del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/961082">articolo della Microsoft Knowledge Base 961082</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo della chiave del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Bing Liu di [Fortinet's FortiGuard Labs](http://www.fortiguard.com) per aver segnalato la vulnerabilità legata alla convalida della memoria in Project (CVE-2009-0102)
