...
<p>Esempio di installazione standard:<br />
SQLWMSDE-KB960082-x86-ENU.exe SAPWD=&quot;(password dell'amministratore)&quot; INSTANCENAME=UDDI</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installazione senza riavvio</td>
<td style="border:1px solid black;">Tutte le edizioni a 32 bit supportate di Microsoft SQL Server 2000 Desktop Engine:<br />
...
<p><strong>Nota</strong> Non è disponibile alcuna Installazione guidata né una finestra di dialogo</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Necessità di riavvio</strong></td>
<td style="border:1px solid black;"></td>
...
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo.
<p><strong>Nota</strong> La rimozione di questo aggiornamento per la protezione per WYukon causerà la completa rimozione dal sistema dell'istanza di WYukon. WYukon mostra in <strong>Installazione applicazioni</strong> come &quot;Database interno di Windows&quot;</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/959420">articolo della Microsoft Knowledge Base 959420</a></td>
