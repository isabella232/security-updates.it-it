---
TOCTitle: 'MS12-077'
Title: 'Bollettino Microsoft sulla sicurezza MS12-077 - Critico'
ms:assetid: 'ms12-077'
ms:contentKeyID: 61240718
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-077(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS12-077 - Critico
=======================================================

Aggiornamento cumulativo per la protezione di Internet Explorer (2761465)
-------------------------------------------------------------------------

Data di pubblicazione: martedì 11 dicembre 2012
...
Questo aggiornamento per la protezione risolve tre vulnerabilità di Internet Explorer segnalate privatamente. Le vulnerabilità con gli effetti più gravi sulla protezione possono consentire l'esecuzione di codice in modalità remota se un utente visualizza una pagina Web appositamente predisposta in Internet Explorer. Sfruttando queste vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente corrente. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Questo aggiornamento per la protezione è considerato di livello critico per Internet Explorer 9 e Internet Explorer 10 nei client Windows e di livello moderato per Internet Explorer 9 e Internet Explorer 10 nei server Windows. Questo aggiornamento per la protezione non presenta alcun livello di gravità per Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno della presente sezione.
...
<td style="border:1px solid black;">
KB2744842 in [MS12-063](http://go.microsoft.com/fwlink/?linkid=255505) è stato sostituito da KB2761465
</td>
</tr>
...
<td style="border:1px solid black;">
KB2761451 in [MS12-071](http://go.microsoft.com/fwlink/?linkid=268299) è stato sostituito da KB2761465
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Sì. L'aggiornamento KB2761465 è disponibile per Internet Explorer 10 in Windows 8 Release Preview e Internet Explorer 10 in Windows Server 2012 Release Candidate. I clienti che hanno Windows 8 Release Preview e Windows Server 2012 Release Candidate installati sono incoraggiati ad applicare gli aggiornamenti ai propri sistemi. Gli aggiornamenti sono disponibili in [Windows Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it).

**Internet Explorer 10** **Release Preview** **per Windows 7 e Windows Server 2008 R2** **sonointeressati dalle vulnerabilità risolte in questo bollettino?**
Sì. L'aggiornamento KB2761465 è disponibile per Internet Explorer 10 Release Preview per Windows 7 per sistemi a 32 bit Service Pack 1, Windows 7 per sistemi x64 Service Pack 1 e Windows Server 2008 R2 per sistemi x64 Service Pack 1. Ai clienti che utilizzano Internet Explorer 10 Release Preview per Windows 7 per sistemi a 32 bit Service Pack 1, Windows 7 per sistemi x64 Service Pack 1 e Windows Server 2008 R2 per sistemi x64 Service Pack 1 si consiglia di applicare gli aggiornamenti nei sistemi in uso. Gli aggiornamenti sono disponibili in [Windows Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it).
...
<th>
Vulnerabilità legata a un errore di tipo use-after-free in InjectHTMLStream - CVE-2012-4781
</th>
<th>
Vulnerabilità legata a un errore di tipo use-after-free in CMarkup - CVE-2012-4782
</th>
<th>
Vulnerabilità legata a un errore di tipo use-after-free nel conteggio errato dei riferimenti - CVE-2012-4787
</th>
<th>
Livello di gravità aggregato
</th>
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-4781](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4781).

#### Fattori attenuanti della vulnerabilità legata a un errore di tipo use-after-free in InjectHTMLStream - CVE-2012-4781
...
#### Soluzioni alternative per la vulnerabilità legata a un errore di tipo use-after-free in InjectHTMLStream - CVE-2012-4781
...
#### Domande frequenti sulla vulnerabilità legata a un errore di tipo use-after-free in InjectHTMLStream - CVE-2012-4781
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-4782](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4782).

#### Fattori attenuanti della vulnerabilità legata a un errore di tipo use-after-free in CMarkup - CVE-2012-4782
...
#### Soluzioni alternative per la vulnerabilità legata a un errore di tipo use-after-free in CMarkup - CVE-2012-4782
...
#### Domande frequenti sulla vulnerabilità legata a un errore di tipo use-after-free in CMarkup - CVE-2012-4782
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-4787](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4787).

#### Fattori attenuanti della vulnerabilità legata a un errore di tipo use-after-free nel conteggio errato dei riferimenti - CVE-2012-4787
...
#### Soluzioni alternative per la vulnerabilità legata a un errore di tipo use-after-free nel conteggio errato dei riferimenti - CVE-2012-4787
...
#### Domande frequenti sulla vulnerabilità legata a un errore di tipo use-after-free nel conteggio errato dei riferimenti - CVE-2012-4787
...
<p>Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2761465$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB2761465-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB2761465-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2761465">articolo della Microsoft Knowledge Base 2761465</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2761465$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 10 in tutte le edizioni x64 supportate di Windows 8:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Per rimuovere un aggiornamento installato tramite WUSA, utilizzare l'opzione del programma di installazione /Uninstall o fare clic su <strong>Pannello di controllo</strong>, selezionare <strong>Sistema e sicurezza</strong>, quindi in Windows Update fare clic su <strong>Aggiornamenti installati</strong> e selezionarne uno dall'elenco.</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2761465">articolo della Microsoft Knowledge Base 2761465</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Installazione senza riavvio</td>
<td style="border:1px solid black;">Internet Explorer 10 in tutte le edizioni supportate di Windows Server 2008 R2:<br />
Windows8-RT-KB2761465-x64.msu /quiet /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Ulteriori informazioni</td>
...
| **Informazioni sui file**                 | Consultare l'[articolo della Microsoft Knowledge Base 2761465](http://support.microsoft.com/kb/2761465)                                                                                                                                                                                                  |
...
-   [Rosario Valotta](https://sites.google.com/site/tentacoloviola) per aver segnalato la vulnerabilità legata a un errore di tipo use-after-free in InjectHTMLStream (CVE-2012-4781)  
-   [Rosario Valotta](https://sites.google.com/site/tentacoloviola) per aver segnalato la vulnerabilità legata a un errore di tipo use-after-free in CMarkup (CVE-2012-4782)  
-   Fermin J. Serna di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata a un errore di tipo use-after-free nel conteggio errato dei riferimenti (CVE-2012-4787)
