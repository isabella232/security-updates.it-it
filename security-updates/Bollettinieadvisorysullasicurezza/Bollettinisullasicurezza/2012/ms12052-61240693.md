---
TOCTitle: 'MS12-052'
Title: 'Bollettino Microsoft sulla sicurezza MS12-052 - Critico'
ms:assetid: 'ms12-052'
ms:contentKeyID: 61240693
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-052(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS12-052 - Critico
=======================================================

Aggiornamento cumulativo per la protezione di Internet Explorer (2722913)
-------------------------------------------------------------------------

Data di pubblicazione: martedì 14 agosto 2012 | Aggiornamento: mercoledì 17 luglio 2013
...
L'aggiornamento per la protezione risolve le vulnerabilità modificando il modo in cui Internet Explorer gestisce degli oggetti nella memoria. Per ulteriori informazioni sulle vulnerabilità, consultare la sottosezione delle Domande frequenti relativa alla vulnerabilità specifica sotto la sezione successiva, **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
La soluzione KB2699988 in [MS12-037](http://go.microsoft.com/fwlink/?linkid=249045) è stata sostituita dalla soluzione KB2722913
</td>
</tr>
...
<td style="border:1px solid black;">
KB2719177 in [MS12-044](http://go.microsoft.com/fwlink/?linkid=254377) è stata sostituita dalla soluzione KB2722913
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**Qual è la relazione tra il presente aggiornamento per la protezione e il bollettino** **MS12**-056**?**
La vulnerabilità legata all'esecuzione di codice in modalità remota dovuta al sovraccarico di valori integer di JavaScript (CVE-2012-2523) descritta in questo bollettino è anche risolta da [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487).

Per i clienti che utilizzano Internet Explorer 8, installare l'aggiornamento KB2706045, che è descritto in [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487), per attivare la protezione dalla vulnerabilità descritta in CVE-2012-2523.

I clienti che hanno Internet Explorer 9 installato sui loro sistemi non devono installare l'aggiornamento KB2706045, perché questo aggiornamento (KB2722913), descritto in questo bollettino, si riferisce a CVE-2012-2523 per sistemi su cui è in esecuzione Internet Explorer 9.
...
<th>
Vulnerabilità legata al danneggiamento della memoria del layout - CVE-2012-1526
</th>
<th>
Vulnerabilità legata all'esecuzione di codice in modalità remota di accesso asincrono agli oggetti NULL - CVE-2012-2521
</th>
<th>
Vulnerabilità legata all'esecuzione di codice in modalità remota in una tabella delle funzioni virtuali corrotta - CVE-2012-2522
</th>
<th>
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta al modo in cui Internet Explorer accede a un oggetto non inizializzato correttamente o eliminato. La vulnerabilità potrebbe danneggiare la memoria in modo tale da consentire a un utente malintenzionato di eseguire codice arbitrario nel contesto dell'utente attuale.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1526](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1526).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria del layout - CVE-2012-1526
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria del layout - CVE-2012-1526
...
#### Domande frequenti relative alla vulnerabilità legata al danneggiamento della memoria del layout - CVE-2012-1526
...
Quando Internet Explorer tenta di accedere a un oggetto che è stato eliminato, la memoria può venire danneggiata in modo da consentire a un utente malintenzionato di eseguire codice arbitrario nel contesto dell'utente corrente.
...
Questa vulnerabilità può essere sfruttata per l'esecuzione di azioni dannose solo se un utente è connesso al sistema e visita un sito Web. Pertanto, i sistemi maggiormente a rischio sono quelli in cui Internet Explorer 6 o Internet Explorer 7 vengono utilizzati frequentemente, come workstation o server terminal.
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-2521](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2521).

#### Fattori attenuanti della vulnerabilità legata all'esecuzione di codice in modalità remota di accesso asincrono agli oggetti NULL - CVE-2012-2521
...
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di codice in modalità remota di accesso asincrono agli oggetti NULL - CVE-2012-2521
...
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di codice in modalità remota di accesso asincrono agli oggetti NULL - CVE-2012-2521
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta al modo in cui Internet Explorer accede a una tabella di funzioni virtuali corrotta che è stata eliminata. La vulnerabilità potrebbe danneggiare la memoria in modo tale da consentire a un utente malintenzionato di eseguire codice arbitrario nel contesto dell'utente attuale.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-2522](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2522).

#### Fattori attenuanti della vulnerabilità legata all'esecuzione di codice in modalità remota in una tabella delle funzioni virtuali corrotta - CVE-2012-2522
...
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di codice in modalità remota in una tabella delle funzioni virtuali corrotta - CVE-2012-2522
...
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di codice in modalità remota in una tabella delle funzioni virtuali corrotta - CVE-2012-2522

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota nel contesto dell'utente corrente.

**Quali sono le cause di questa vulnerabilità?**
Quando Internet Explorer tenta di accedere a una tabella delle funzioni virtuali corrotta, potrebbe danneggiare la memoria in modo tale da consentire a un utente malintenzionato di eseguire codice arbitrario nel contesto dell'utente corrente.
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota causata dal modo in cui Internet Explorer calcola la dimensione di un oggetto nella memoria durante un'operazione di copia. La vulnerabilità potrebbe danneggiare la memoria in modo tale da consentire a un utente malintenzionato di eseguire codice arbitrario nel contesto dell'utente attuale.
...
**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità si presenta quando Internet Explorer calcola erroneamente la dimensione di un oggetto nella memoria durante un'operazione di copia.
...
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**
I sistemi maggiormente a rischio sono quelli in cui Internet Explorer 8 o Internet Explorer 9 vengono utilizzati frequentemente, come workstation o server terminal.

**Se si esegue Internet Explorer per Windows Server 2003, Windows Server 2008 o Windows Server 2008 R2, il problema ha una portata più limitata?**
Sì. Per impostazione predefinita, Internet Explorer in Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2 viene eseguito in una modalità limitata denominata [Protezione avanzata](http://technet.microsoft.com/library/dd883248.aspx). La configurazione Protezione avanzata è costituita da un gruppo di impostazioni di Internet Explorer preconfigurate che riduce la probabilità che un utente o un amministratore scarichi ed esegua contenuto Web appositamente predisposto in un server. Questo è un fattore attenuante per i siti Web che non sono stati aggiunti all'area Siti attendibili di Internet Explorer.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità per Internet Explorer 9 modificando il modo in cui Internet Explorer gestisce gli oggetti nella memoria.

**Nota** Questo aggiornamento non risolve questa vulnerabilità per Internet Explorer 8. Per Internet Explorer 8, l'aggiornamento è disponibile nell'aggiornamento KB2706045 descritto in [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487).

**Internet Explorer 8 è installato sul sistema in uso. Dove posso trovare l'aggiornamento che risolve CVE-2012-2523?**
I clienti che hanno Internet Explorer 8 installato possono risolvere la vulnerabilità descritta in CVE-2012-2523 installando l'aggiornamento KB2706045, descritto in [MS12-056](http://go.microsoft.com/fwlink/?linkid=256487).

I clienti che hanno Internet Explorer 9 installato sui loro sistemi non devono installare l'aggiornamento KB2706045, perché questo aggiornamento (KB2722913) si riferisce a CVE-2012-2523 per sistemi su cui è in esecuzione Internet Explorer 9.
...
<p>Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2722913$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB2722913-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB2722913-IE8\spuninst</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2722913$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
...
-   GWSlabs, in collaborazione con [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata al danneggiamento della memoria del layout (CVE-2012-1526)  
-   Soeder di Derek, che collabora con il programma [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html), per aver segnalato la vulnerabilità legata all'esecuzione di codice in modalità remota di accesso asincrono agli oggetti NULL (CVE-2012-2521)  
-   Sung-ting Tsai e Ming-Chieh Pan di [Trend Micro](http://www.trendmicro.com) per aver segnalato la vulnerabilità legata all'esecuzione di codice in modalità remota in una tabella delle funzioni virtuali corrotta (CVE-2012-2522)  
...
-   V1.1 (15 agosto 2012): Sono state rimosse le domande frequenti erronee per le versioni Windows 8 Release Preview e Windows Server 2012 Release Candidate. Le versioni Windows 8 Release Preview e Windows Server 2012 Release Candidate non sono interessati dalle vulnerabilità descritte in questo bollettino.  
-   V1.2 (17 luglio 2013): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2722913 nella sottosezione Problemi noti del Riepilogo.
