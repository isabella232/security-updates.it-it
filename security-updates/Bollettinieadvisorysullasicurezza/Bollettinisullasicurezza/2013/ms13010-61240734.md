---
TOCTitle: 'MS13-010'
Title: 'Bollettino Microsoft sulla sicurezza MS13-010 - Critico'
ms:assetid: 'ms13-010'
ms:contentKeyID: 61240734
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms13-010(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS13-010 - Critico
=======================================================

Una vulnerabilità in Vector Markup Language può consentire l'esecuzione di codice in modalità remota (2797052)
--------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello critico per Internet Explorer 6, Internet Explorer 7, Internet Explorer 8, Internet Explorer 9 e Internet Explorer 10 in tutte le versioni supportate di Microsoft Windows. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.
...
<td style="border:1px solid black;">
KB2544521 in [MS11-052](http://go.microsoft.com/fwlink/?linkid=218115)
</td>
</tr>
...
Sì. L'aggiornamento KB2797052 è disponibile per Internet Explorer 10 Release Preview per Windows 7 per sistemi a 32 bit Service Pack 1, Windows 7 per sistemi x64 Service Pack 1 e Windows Server 2008 R2 per sistemi x64 Service Pack 1. Ai clienti che utilizzano Internet Explorer 10 Release Preview per Windows 7 per sistemi a 32 bit Service Pack 1, Windows 7 per sistemi x64 Service Pack 1 e Windows Server 2008 R2 per sistemi x64 Service Pack 1 si consiglia di applicare gli aggiornamenti nei sistemi in uso. L'aggiornamento KB2797052 per Internet Explorer 10 Release Preview per Windows 7 per sistemi a 32 bit Service Pack 1 e Windows 7 per sistemi x64 Service Pack 1 è disponibile in [Windows Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it) e nell'[Area download Microsoft](http://www.microsoft.com/downloads/results.aspx?displaylang=it&freetext=security%20update). L'aggiornamento KB2797052 per Internet Explorer 10 Release Preview per Windows Server 2008 R2 per sistemi x64 Service Pack 1 è disponibile nell'[Area download Microsoft](http://www.microsoft.com/downloads/results.aspx?displaylang=it&freetext=security%20update).

**Se si installa questo aggiornamento per la protezione prima di aggiornare il sistema a Internet Explorer 7, Internet Explorer 8 o Internet Explorer 9, sarà necessario applicarlo anche dopo tale aggiornamento?**
Sì. I clienti che aggiornano Internet Explorer dopo aver applicato questo aggiornamento dovranno applicarlo di nuovo per la versione in uso di Internet Explorer, come specificato nella tabella Software interessato.
...
<th>
Vulnerabilità legata al danneggiamento della memoria VML - CVE-2013-0030
</th>
<th colspan="3">
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Internet Explorer gestisce gli oggetti nella memoria. Un utente malintenzionato può sfruttare la vulnerabilità creando una pagina Web appositamente predisposta. Se un utente visualizza la pagina Web, la vulnerabilità può consentire l'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente corrente.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2013-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0030).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria VML - CVE-2013-0030
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria VML - CVE-2013-0030
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria VML - CVE-2013-0030
...
Quando i buffer di VML vengono allocati, alcuni dati appositamente predisposti possono corrompere la memoria in modo tale che un utente malintenzionato potrebbe eseguire codice arbitrario nel contesto dell'utente corrente.
...
No. Al momento della pubblicazione del presente bollettino, Microsoft non aveva ricevuto alcuna segnalazione in merito allo sfruttamento di questa vulnerabilità a scopo di attacco come esecuzione di codice in modalità remota. Microsoft è a conoscenza di questa vulnerabilità come vulnerabilità legata all'intercettazione di informazioni in attacchi mirati e limitati. Questo aggiornamento risolve la vulnerabilità sia quando viene utilizzata come esecuzione di codice in modalità remota sia quando è legata all'intercettazione di informazioni.
...
<p>Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2797052$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB2797052-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB2797052-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2797052">articolo della Microsoft Knowledge Base 2797052</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2797052$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
...
| **Informazioni sui file**                 | Consultare l'[articolo della Microsoft Knowledge Base 2797052](http://support.microsoft.com/kb/2797052)                                                                                                                                                                                                                                                                                                                           |
...
-   V1.1 (12 febbraio 2013): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2797052 nella sottosezione Problemi noti del Riepilogo. Inoltre, la voce Domande frequenti è stata corretta per Internet Explorer 10 Release Preview per Windows 7 e Windows Server 2008 R2.
