---
TOCTitle: 'MS11-021'
Title: 'Bollettino Microsoft sulla sicurezza MS11-021 - Importante'
ms:assetid: 'ms11-021'
ms:contentKeyID: 61240564
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-021(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS11-021 - Importante
==========================================================

Alcune vulnerabilità di Microsoft Excel possono consentire l'esecuzione di codice in modalità remota (2489279)
--------------------------------------------------------------------------------------------------------------
...
L'aggiornamento risolve le vulnerabilità correggendo il modo in cui Microsoft Excel gestisce le strutture di dati, convalida le informazioni sui record, inizializza le variabili utilizzate nelle operazioni di memoria e distribuisce lo spazio del buffer durante l'analisi di un file appositamente predisposto. Per ulteriori informazioni sulla vulnerabilità, vedere la voce specifica nella sottosezione Domande frequenti all'interno della sezione **Informazioni sulle vulnerabilità.**
...
<sup>[1]</sup>Per Microsoft Office Excel 2007 Service Pack 2, oltre al pacchetto di aggiornamento per la protezione KB2464583, i clienti devono installare anche l'aggiornamento per la protezione del Pacchetto di compatibilità di Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 Service Pack 2 (KB2466156) per essere protetti dalle vulnerabilità descritte in questo bollettino.
...
Sì. Gli aggiornamenti per Microsoft Excel 2003 Service Pack 3 (KB2502786) e Microsoft Excel 2007 Service Pack 2 (KB2464583), insieme all'aggiornamento offerto in [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206), forniscono il supporto per la funzionalità di Convalida file di Office. Per ulteriori informazioni sulla funzionalità di Convalida file di Office, consultare l'[Advisory Microsoft sulla sicurezza 2501584](http://technet.microsoft.com/security/advisory/2501584).

**Qual è la relazione tra il presente aggiornamento per la protezione e i bollettini MS10-087 e MS10-088?**  
L'aggiornamento Microsoft Office 2004 per Mac (KB2505924) offerto in questo bollettino risolve anche le vulnerabilità descritte nei bollettini sulla sicurezza [MS10-087](http://go.microsoft.com/fwlink/?linkid=203241) e [MS10-088](http://go.microsoft.com/fwlink/?linkid=198186).

**I bollettini MS11-022 e MS11-023 descrivono anche alcune vulnerabilità in Microsoft Office 2004 per Mac, Microsoft Office 2008 per Mac e del convertitore file in formato XML aperto per Mac. MS11-022 descrive** **anche alcune vulnerabilità in Microsoft Office per Mac 2011. Qual è la relazione tra MS11-022 e MS11-023 e il presente bollettino, MS11-021?**  
I pacchetti di aggiornamento per la protezione di Microsoft Office 2004 per Mac (KB2505924), Microsoft Office 2008 per Mac (KB2505927), e del convertitore file in formato XML aperto per Mac (KB2505935) offerti in questo bollettino risolvono anche le vulnerabilità descritte nei bollettini sulla sicurezza [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) e [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206). Il pacchetto di aggiornamento per la protezione di Microsoft Office per Mac 2011 (KB2525412) offerto in questo bollettino risolve anche le vulnerabilità descritte in [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727). Gli utenti che utilizzano Microsoft Office 2004 per Mac, Microsoft Office 2008 per Mac, il convertitore file in formato XML aperto per Mac o Microsoft Office per Mac 2011 dovranno installare questi pacchetti di aggiornamento per la protezione una sola volta.
...
<th style="border:1px solid black;" >Vulnerabilità legata al sovraccarico dei valori integer in Excel - CVE-2011-0097</th>
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow degli heap in Excel - CVE-2011-0098</th>
<th style="border:1px solid black;" >Vulnerabilità WriteAV dell'analisi dei record in Excel - CVE-2011-0101</th>
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria in Excel - CVE-2011-0103</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla sovrascrittura del buffer in Excel - CVE-2011-0104</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Excel 2010 (edizioni a 32 bit)</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Esecuzione di codice in modalità remota</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Excel (edizioni a 64 bit)</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Esecuzione di codice in modalità remota</td>
...
**Tabella Parte 2 (continuodi** **Parte 2)**
 
<table style="border:1px solid black;">
<thead>
<tr class="header">
<th style="border:1px solid black;" >Vulnerabilità legata all'inizializzazione dei dati in Excel - CVE-2011-0105</th>
<th style="border:1px solid black;" >Vulnerabilità legata all'indicizzazione della matrice in Excel - CVE-2011-0978</th>
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento dell'elenco collegato in Excel - CVE-2011-0979</th>
<th style="border:1px solid black;" >Vulnerabilità legata al puntatore pendente in Excel - CVE-2011-0980</th>
...
Vulnerabilità legata al sovraccarico dei valori integer in Excel - CVE-2011-0097  
--------------------------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0097](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097).
  
#### Fattori attenuanti della vulnerabilità legata al sovraccarico dei valori integer in Excel - CVE-2011-0097
...
#### Soluzioni alternative per la vulnerabilità legata al sovraccarico dei valori integer in Excel - CVE-2011-0097
...
-   **Utilizzare il criterio del blocco dei file di Microsoft Office per bloccare l'apertura di documenti di Office 2003 e fonti precedenti non attendibili**
    ...
    **Per Office 2007** 
    ```
    Editor del Registro di sistema di Windows versione 5.00   [HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.  0\Excel\Security\FileOpenBlock]   
    "BinaryFiles"=dword:00000001
    ```
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    Per Office 2003  
    ```
    Editor del Registro di sistema di Windows versione 5.00     [HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Excel\Security\FileOpenBlock``] 
...
#### Domande frequenti sulla vulnerabilità legata al sovraccarico dei valori integer in Excel - CVE-2011-0097
...
La vulnerabilità esiste quando Microsoft Excel non assegna in modo corretto lo spazio del buffer durante l'analisi delle informazioni sui record in un file di Excel appositamente predisposto.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui Microsoft Excel assegna lo spazio del buffer quando analizza un file appositamente predisposto.
...
Vulnerabilità legata all'overflow degli heap in Excel - CVE-2011-0098
---------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Excel gestisce file Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0098](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098).

#### Fattori attenuanti della vulnerabilità legata all'overflow degli heap in Excel - CVE-2011-0098
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow degli heap in Excel - CVE-2011-0098
...
#### Domande frequenti sulla vulnerabilità legata all'overflow degli heap in Excel - CVE-2011-0098

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo in remoto del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando Microsoft Excel riscontra un errore di gestione di memoria durante la convalida delle informazioni sui record quando analizza un file di Excel appositamente predisposto, corrompendo la memoria del sistema in modo tale da permettere ad un utente malintenzionato di eseguire codice arbitrario.
...
Vulnerabilità WriteAV dell'analisi dei record in Excel - CVE-2011-0101
----------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Excel gestisce file Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0101](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101).

#### Fattori attenuanti della vulnerabilità WriteAV dell'analisi dei record in Excel - CVE-2011-0101
...
#### Soluzioni alternative per la vulnerabilità WriteAV dell'analisi dei record in Excel - CVE-2011-0101
...
#### Domande frequenti sulla vulnerabilità WriteAV dell'analisi dei record in Excel - CVE-2011-0101
...
Vulnerabilità legata al danneggiamento della memoria in Excel - CVE-2011-0103
-----------------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Excel gestisce file Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0103](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria in Excel - CVE-2011-0103
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria in Excel - CVE-2011-0103
...
-   **Utilizzare il criterio del blocco dei file di Microsoft Office per bloccare l'apertura di documenti di Office 2003 e fonti precedenti non attendibili**
    ...
    **Per Office 2003** 
    ```
    Editor del Registro di sistema di Window``s versione 5.00    `[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Excel\Security\FileOpenBlock]
    "BinaryFiles"=dword:00000001
    ```
    **Nota** Per utilizzare "FileOpenBlock" con Microsoft Office 2003, è necessario applicare tutti gli ultimi aggiornamenti per la protezione di Microsoft Office 2003.
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria in Excel - CVE-2011-0103
...
Vulnerabilità legata alla sovrascrittura del buffer in Excel - CVE-2011-0104
----------------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Excel gestisce file Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0104](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104).

#### Fattori attenuanti della vulnerabilità legata alla sovrascrittura del buffer in Excel - CVE-2011-0104
...
#### Soluzioni alternative per la vulnerabilità legata alla sovrascrittura del buffer in Excel - CVE-2011-0104
...
-   **Utilizzare il criterio del blocco dei file di Microsoft Office per bloccare l'apertura di documenti di Office 2003 e fonti precedenti non attendibili**
    ...
    **Per Office 2003** 
    ```
    Editor del Registro di sistema di Windows versione 5.00    `[HKEY_CURRENT_USER\Software\Microsoft\Offi``ce\11.0\Excel\Security\FileOpenBlock]
    "BinaryFiles"=dword:00000001
    ```
    **Nota** Per utilizzare "FileOpenBlock" con Microsoft Office 2003, è necessario applicare tutti gli ultimi aggiornamenti per la protezione di Microsoft Office 2003.
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    Per Office 2003
    ```
    Editor del Regis``tro di sistema di Windows versione 5.00    `[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Excel\Security\FileOpenBlock]
    "BinaryFiles"=dword:00000000
    ```
...
#### Domande frequenti sulla vulnerabilità legata alla sovrascrittura del buffer in Excel - CVE-2011-0104
...
Vulnerabilità legata all'inizializzazione dei dati in Excel - CVE-2011-0105
---------------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Excel gestisce file Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0105](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105).

#### Fattori attenuanti della vulnerabilità legata all'inizializzazione dei dati in Excel - CVE-2011- 0105
...
#### Soluzioni alternative per la vulnerabilità legata all'inizializzazione dei dati in Excel - CVE-2011- 0105
...
#### Domande frequenti sulla vulnerabilità legata all'inizializzazione dei dati in Excel - CVE-2011- 0105

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando Microsoft Excel, durante l'analisi di un file Excel appositamente predisposto, non inizializza in modo corretto una variabile che è utilizzata come lunghezza in un'operazione di memoria. Questa condizione può essere sfruttata per causare un sovraccarico del buffer che conduce all'esecuzione di codice nel contesto di protezione dell'utente connesso.
...
**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui Microsoft Excel inizializza le variabili utilizzate nelle operazioni di memoria.
...
Vulnerabilità legata all'indicizzazione della matrice in Excel - CVE-2011-0978
------------------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Excel gestisce file Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0978](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978).

#### Fattori attenuanti della vulnerabilità legata all'indicizzazione della matrice in Excel - CVE-2011-0978
...
#### Soluzioni alternative per la vulnerabilità legata all'indicizzazione della matrice in Excel - CVE-2011-0978
...
-   **Utilizzare il criterio del blocco dei file di Microsoft Office per bloccare l'apertura di documenti di Office 2003 e fonti precedenti non attendibili**
    ...
    **Per Office 2003** 
    ```
    Editor del Registro di sistema di Windows versione 5.00  [HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Excel\Sec``urity\FileOpenBlock]
    "BinaryFiles"=dword:00000001
    ```
    **Nota** Per utilizzare "FileOpenBlock" con Microsoft Office 2003, è necessario applicare tutti gli ultimi aggiornamenti per la protezione di Microsoft Office 2003.
    ...
    **Per Office 2007** 
    ```
    Editor del Registro di si``stema di Windows versione 5.00 [HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.0\Excel\Security\FileOpenBlock]
    "BinaryFiles"=dword:00000001
    ```
    **Nota** Per utilizzare "FileOpenBlock" con Microsoft Office 2007, è necessario applicare tutti gli ultimi aggiornamenti per la protezione di Microsoft Office 2007.
...
#### Domande frequenti sulla vulnerabilità legata all'indicizzazione della matrice in Excel - CVE-2011-0978
...
Vulnerabilità legata al danneggiamento dell'elenco collegato in Excel - CVE-2011-0979
-------------------------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Excel gestisce file Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento dell'elenco collegato in Excel - CVE-2011-0979
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento dell'elenco collegato in Excel - CVE-2011-0979
...
-   **Utilizzare il criterio del blocco dei file** **di Microsoft Office per bloccare l'apertura di documenti di Office 2003 e fonti precedenti non attendibili**
    ...
    **Per Office 2007** 
    `Editor del Registro di sistema di Windows versione 5.00`
    `[HKEY_CURRENT_USER\Software\Policies\Microsoft\Offic``e\12.0\Excel\Security\FileOpenBlock]`
    `"BinaryFiles"=dword:00000001`
    **Nota** Per utilizzare "FileOpenBlock" con Microsoft Office 2007, è necessario applicare tutti gli ultimi aggiornamenti per la protezione di Microsoft Office 2007.
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    Per Office 2003
    `Editor del Registro di sistema di Windows v``ersione 5.00`
    `[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Excel\Security\FileOpenBlock]`
    `"BinaryFiles"=dword:00000000`
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento dell'elenco collegato in Excel - CVE-2011-0979

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando Microsoft Excel non gestisce correttamente i membri di una struttura di dati mentre analizza un file di Excel appositamente predisposto.
...
**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui Microsoft Excel gestisce le strutture di dati.
...
Vulnerabilità legata al puntatore pendente in Excel - CVE-2011-0980
-------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Excel gestisce file Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0980](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980).

#### Fattori attenuanti della vulnerabilità legata al puntatore pendente in Excel - CVE-2011-0980
...
#### Soluzioni alternative per la vulnerabilità legata al puntatore pendente in Excel - CVE-2011-0980
...
#### Domande frequenti sulla vulnerabilità legata al puntatore pendente in Excel - CVE-2011-0980

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando Microsoft Excel non gestisce correttamente le strutture di dati durante l'analisi di un file di Excel appositamente predisposto.
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it">articolo della Microsoft Knowledge Base 2466169</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it">articolo della Microsoft Knowledge Base 2502786</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Microsoft Excel 2007, vedere <a href="http://support.microsoft.com/?ln=it">l'articolo della Microsoft Knowledge Base 2464583</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft Excel Viewer, vedere <a href="http://support.microsoft.com/?ln=it">l'articolo della Microsoft Knowledge Base 2466158</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per il pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007, vedere <a href="http://support.microsoft.com/?ln=it">l'articolo della Microsoft Knowledge Base 2466156</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it">articolo della Microsoft Knowledge Base 2466146</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Alin Rad Pop di [Secunia Research](http://secunia.com/) per aver segnalato la vulnerabilità legata al sovraccarico dei valori integer in Excel (CVE-2011-0097)  
-   Alin Rad Pop di [Secunia Research](http://secunia.com/) per aver segnalato la vulnerabilità legata all'overflow degli heap in Excel (CVE-2011-0098)  
-   Muhammad Junaid Bohio di [Telus Security Labs](http://www.telussecuritylabs.com) per aver segnalato la vulnerabilità WriteAV dell'analisi dei record in Excel (CVE-2011-0101)  
-   Aniway, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità WriteAV dell'analisi dei record in Excel (CVE-2011-0101)  
-   Un ricercatore anonimo per aver segnalato la vulnerabilità legata al danneggiamento della memoria in Excel (CVE-2011-0103)  
-   Rodrigo Rubira Branco di [Check Point Vulnerability Discovery Team](http://www.checkpoint.com/) (VDT) per aver segnalato la vulnerabilità legata alla sovrascrittura del buffer in Excel (CVE-2011-0104)  
-   Aniway, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata all'inizializzazione dei dati in Excel (CVE-2011-0105)  
-   Aniway, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità all'indicizzazione della matrice in Excel (CVE-2011-0978)  
-   Un ricercatore anonimo, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata al danneggiamento dell'elenco collegato in Excel (CVE-2011-0979)  
-   Un ricercatore anonimo, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata al puntatore pendente in Excel (CVE-2011-0980)
