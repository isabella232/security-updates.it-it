---
TOCTitle: 'MS11-018'
Title: 'Bollettino Microsoft sulla sicurezza MS11-018 - Critico'
ms:assetid: 'ms11-018'
ms:contentKeyID: 61240561
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-018(v=Security.10)'
---
...
Aggiornamento cumulativo per la protezione di Internet Explorer (2497640)
-------------------------------------------------------------------------

Data di pubblicazione: martedì 12 aprile 2011 | Aggiornamento: lunedì 16 maggio 2011
...
Questo aggiornamento per la protezione risolve quattro vulnerabilità segnalate privatamente a Microsoft e una vulnerabilità divulgata pubblicamente relative a Internet Explorer. Questo aggiornamento per la protezione è considerato di livello critico per Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 sui client Windows e di livello moderato per Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 sui server Windows. Internet Explorer 9 non è interessato da queste vulnerabilità. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno di questa sezione.
...
L'aggiornamento risolve le vulnerabilità modificando il modo in cui Internet Explorer gestisce gli oggetti nella memoria, il contenuto e gli script durante determinati processi. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<span></span>
**Perché Microsoft ha rilasciato un nuovo bollettino in data 16 maggio 2011?**  
Microsoft ha rilasciato nuovamente questo bollettino per risolvere un problema legato alla logica di rilevamento per Internet Explorer 7 nelle edizioni supportate di Windows XP e Windows Server 2003 che potrebbe interessare i clienti con configurazioni specifiche. Il problema potrebbe generare una logica di rilevamento che non offre l'aggiornamento o che, a torto, stabilisce che l'aggiornamento è stato applicato. La nuova pubblicazione consiste in una modifica solo al rilevamento per correggere la logica dell'offerta e non comporta modifiche agli aggiornamenti per la protezione di file binari.

Gli utenti finali che eseguono Internet Explorer 7 nelle edizioni supportate di Windows XP e Windows Server 2003 i quali hanno installato precedentemente l'aggiornamento manualmente o tramite aggiornamento automatico non sono interessati dal problema e non devono eseguire ulteriori operazioni. Agli utenti finali che eseguono le configurazioni interessate, ai quali non è stato messo correttamente a disposizione l'aggiornamento a seguito del problema legato alla logica di rilevamento, non verrà reso disponibile l'aggiornamento tramite aggiornamento automatico ed è opportuno che applichino immediatamente l'aggiornamento.

Per gli amministratori IT, il problema legato alla logica di rilevamento potrebbe aver comportato che le soluzioni Enterprise Scanning (come WSUS,System Center Configuration Manager 2007 e SMS 2003 con ITMU), abbiano erroneamente stabilito che sui sistemi interessati l'aggiornamento era stato applicato. I sistemi erroneamente identificati in precedenza come aggiornati saranno ora identificati come in attesa di aggiornamento.

L'aggiornamento viene offerto solo ai clienti interessati. I clienti che hanno installato l'aggiornamento manualmente e quelli che eseguono configurazioni non interessate dalla modifica alla logica di rilevamento non devono eseguire ulteriori operazioni.
...
**Internet Explorer 6 ed Internet Explorer 7 sono elencati come prodotti interessati per CVE-2011-1244. Perché Microsoft non rilascia un aggiornamento per CVE-2011-1244 per questi prodotti interessati?**  
Non esiste in Internet Explorer 6 ed Internet Explorer 7 un'architettura in grado di supportare adeguatamente le correzioni per evitare il clickjacking. Pertanto è impossibile creare correzioni per questi prodotti capaci di eliminare la vulnerabilità descritta in CVE-2011-1244.
...
<th>
Vulnerabilità legata al danneggiamento della memoria nella gestione dei layout - CVE-2011-0094
</th>
<th>
Vulnerabilità legata al danneggiamento della memoria MSHTML - CVE-2011-0346
</th>
<th>
Vulnerabilità legata all'intercettazione di informazioni personali con i tag frame - CVE-2011-1244
</th>
<th>
Vulnerabilità legata all'intercettazione di informazioni personali in Javascript - CVE-2011-1245
</th>
<th>
Vulnerabilità legata al danneggiamento della memoria nella gestione degli oggetti - CVE-2011-1345
</th>
<th>
Livello di gravità aggregato
</th>
...
<td style="border:1px solid black;">
**Moderato**   
Intercettazione di informazioni personali<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Importante**   
...
<p> </p>
<sup>[1]</sup>Nessuno aggiornamento disponibile. Per ulteriori informazioni, vedere **Domande frequenti sull'aggiornamento per la protezione**.
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0094](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0094).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria nella gestione dei layout - CVE-2011-0094
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria nella gestione dei layout - CVE-2011-0094
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria nella gestione dei layout - CVE-2011-0094
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0346).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria MSHTML - CVE-2011-0346
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria MSHTML - CVE-2011-0346
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria MSHTML - CVE-2011-0346
...
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**  
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2011-0346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0346).
...
<span></span>
In Internet Explorer esiste una vulnerabilità legata all'intercettazione di informazioni personali. Un utente malintenzionato potrebbe sfruttare la vulnerabilità creando una pagina Web appositamente predisposta camuffata da contenuto legittimo. Le azioni dell'utente sulla pagina potrebbero consentire l'intercettazione di informazioni personali o il clickjacking, per cui i clic dell'utente eseguono delle azioni non desiderate.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1244).

#### Fattori attenuanti della vulnerabilità legata all'intercettazione di informazioni personali con i tag frame - CVE-2011-1244
...
#### Soluzioni alternative per la vulnerabilità legata all'intercettazione di informazioni personali con i tag frame - CVE-2011-1244

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata all'intercettazione di informazioni personali con i tag frame - CVE-2011-1244
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1245](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1245).

#### Fattori attenuanti della vulnerabilità legata all'intercettazione di informazioni personali di Javascript - CVE-2011-1245
...
#### Soluzioni alternative per la vulnerabilità legata all'intercettazione di informazioni personali di Javascript - CVE-2011-1245
...
#### Domande frequenti sulla vulnerabilità legata all'intercettazione di informazioni personali di Javascript - CVE-2011-1245
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1345](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1345).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria nella gestione degli oggetti - CVE-2011-1345
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria nella gestione degli oggetti - CVE-2011-1345
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria nella gestione degli oggetti - CVE-2011-1345
...
<p>Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2497640$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB2497640-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB2497640-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it">articolo della Microsoft Knowledge Base 2497640</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2497640$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
...
-   Un ricercatore anonimo, di [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata al danneggiamento della memoria nella gestione dei layout (CVE-2011-0094)  
-   [MITRE](http://mitre.org/) per aver collaborato con noi alla vulnerabilità legata al danneggiamento della memoria nella gestione dei layout (CVE-2011-0094)  
-   Michal Zalewski di [Google Inc.](http://www.google.com/) per aver collaborato con noi sulla vulnerabilità legata al danneggiamento della memoria MSHTML (CVE-2011-0346)  
-   David Bloom di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata all'intercettazione di informazioni personali con i tag frame (CVE-2011-1244)  
-   David Bloom di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata all'intercettazione di informazioni personali in Javascript (CVE-2011-1245)  
-   Stephen Fewer di [Harmony Security](http://www.harmonysecurity.com), che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata al danneggiamento della memoria nella gestione degli oggetti (CVE-2011-1345)
