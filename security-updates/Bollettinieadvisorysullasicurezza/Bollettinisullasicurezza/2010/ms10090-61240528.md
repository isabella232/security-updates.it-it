---
TOCTitle: 'MS10-090'
Title: 'Bollettino Microsoft sulla sicurezza MS10-090 - Critico'
ms:assetid: 'ms10-090'
ms:contentKeyID: 61240528
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-090(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS10-090 - Critico
=======================================================

Aggiornamento cumulativo per la protezione di Internet Explorer (2416400)
-------------------------------------------------------------------------

Data di pubblicazione: martedì 14 dicembre 2010 | Aggiornamento: venerdì 1 aprile 2011
...
L'aggiornamento per la protezione risolve le vulnerabilità modificando il modo in cui Internet Explorer gestisce gli oggetti nella memoria e gli script durante determinati processi. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.

Questo aggiornamento per la protezione risolve anche la vulnerabilità descritta per la prima volta nell'[Advisory Microsoft sulla sicurezza 2458511](http://technet.microsoft.com/security/advisory/2458511).
...
<span></span>
**Perché questo bollettino sulla sicurezza è stato rivisto in data 4 gennaio 2011?**  
Microsoft ha rivisto questo bollettino per comunicare un modifica di rilevamento che consente di verificare che gli aggiornamenti cumulativi di Internet Explorer precedentemente rilasciati siano forniti correttamente in base alle date di rilascio. Si tratta di una modifica solo al rilevamento. Non sono previsti aggiornamenti ai file sull'aggiornamento per la protezione. I clienti che hanno già installato l'aggiornamento non devono eseguire una nuova installazione.
...
Le versioni Windows 7 Service Pack 1 Beta e Windows Server 2008 R2 Service Pack 1 Beta sono interessate dalle vulnerabilità descritte in questo bollettino. Ai clienti che utilizzano queste versioni Beta si consiglia di scaricare l'aggiornamento e di installarlo nei sistemi in uso. Gli aggiornamenti per la protezione sono disponibili dai siti Web [Microsoft Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it) e [Windows Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it). L'aggiornamento per la protezione è anche disponibile per il download nell'[Area download Microsoft](http://www.microsoft.com/downloads/results.aspx?pocid=&freetext=security%20update&displaylang=it).

**Internet Explorer 9 Beta è interessato da queste vulnerabilità?**  
No. Internet Explorer 9 Beta non è interessato dalle vulnerabilità descritte in questo bollettino.

**L'aggiornamento include modifiche di funzionalità relative alla sicurezza?**  
Questo aggiornamento contiene un aggiornamento di difesa in profondità per migliorare la protezione tra domini in Internet Explorer.
...
<th>
Vulnerabilità legata al danneggiamento della memoria di oggetti HTML - CVE-2010-3340
</th>
<th>
Vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali - CVE-2010-3342
</th>
<th>
Vulnerabilità legata al danneggiamento della memoria di oggetti HTML - CVE-2010-3343
</th>
<th>
Vulnerabilità legata al danneggiamento della memoria di elementi HTML - CVE-2010-3345
</th>
<th>
Vulnerabilità legata al danneggiamento della memoria di elementi HTML - CVE-2010-3346
</th>
<th>
Vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali - CVE-2010-3348
</th>
<th>
Vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2010-3962
</th>
<th>
Livello di gravità aggregato
</th>
...
<sup>[1]</sup>Livelli di gravità non sono applicabili a questo aggiornamento perché la vulnerabilità trattata in questo bollettino non interessa questo software. Tuttavia, agli utenti di questo software Microsoft viene consigliato di applicare l'aggiornamento per la protezione come misura preventiva per difendersi da eventuali nuovi vettori identificabili in futuro.
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3340](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3340).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria degli oggetti HTML - CVE-2010-3340
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria degli oggetti HTML - CVE-2010-3340
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria degli oggetti HTML - CVE-2010-3340
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3342](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342).

#### Fattori attenuanti della vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali - CVE-2010-3342
...
#### Soluzioni alternative per la vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali - CVE-2010-3342
...
#### Domande frequenti sulla vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali - CVE-2010-3342
...
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**  
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-3342](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342).
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3343](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3343).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria degli oggetti HTML - CVE-2010-3343
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria degli oggetti HTML - CVE-2010-3343

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Disattivare LMClassFactory**

    Rimuovere la chiave Liquid Motion Class dal Registro di sistema.

    **Avvertenza** L'utilizzo non corretto dell'Editor del Registro di sistema potrebbe causare problemi tali da rendere necessaria la reinstallazione del sistema operativo. Microsoft non garantisce la risoluzione di problemi dovuti a un utilizzo non corretto dell'Editor del Registro di sistema. È quindi necessario utilizzare questo strumento con grande attenzione.

    1.  Creare una copia di backup delle chiavi del Registro di sistema utilizzando il comando riportato di seguito da un prompt dei comandi di livello elevato:
        `Regedit.exe /e Disable_LM_Factory_backup.reg HKEY_CLASSES_ROOT\CLSID\{B1549E58-3894-11D2-BB7F-00A0C999C4C1}`
    2.  incollare il seguente testo in un editor di testo come Blocco note. Successivamente, salvare il file utilizzando l'estensione di nome file reg, ad esempio Disable\_LM\_Factory.reg:
        `Editor del Registro di sistema di Windows versione 5.00`
        `[-HKEY_CLASSES_ROOT\CLSID\{B1549E58-3894-11D2-BB7F-00A0C999C4C1}]`
    3.  Eseguire Disable\_LM\_Factory.reg con il comando seguente da un prompt dei comandi di livello elevato:
        `Regedit.exe /s Disable_LM_Factory.reg `

    **Impatto della soluzione alternativa**. Le funzionalità che utilizzano Liquid Motion sono disattivate. Per ulteriori informazioni su Liquid Motion, vedere l'[articolo della Microsoft Knowledge Base 257557](http://support.microsoft.com/kb/257557).
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria degli oggetti HTML - CVE-2010-3343
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3345](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3345).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria di elementi HTML - CVE-2010-3345
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di elementi HTML - CVE-2010-3345
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di elementi HTML - CVE-2010-3345
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3346).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria di elementi HTML - CVE-2010-3346
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di elementi HTML - CVE-2010-3346
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di elementi HTML - CVE-2010-3346
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3348](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348).

#### Fattori attenuanti della vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali - CVE-2010-3348
...
#### Soluzioni alternative per la vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali - CVE-2010-3348
...
#### Domande frequenti sulla vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali - CVE-2010-3348
...
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**  
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-3348](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348).
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta al modo in cui Internet Explorer accede a un oggetto non inizializzato correttamente o eliminato. Un utente malintenzionato può sfruttare la vulnerabilità convincendo l'utente ad aprire un documento Word dannoso. Se un utente chiude il documento, la vulnerabilità può consentire l'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente connesso. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2010-3962

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   La Protezione esecuzione programmi aumenta la protezione contro gli attacchi mirati all'esecuzione di codice ed è attivata per impostazione predefinita in Internet Explorer 8 nelle seguenti versioni del sistema operativo Windows: Windows XP Service Pack 3, Windows Vista Service Pack 1, Windows Vista Service Pack 2 e Windows 7.
-   In uno scenario di attacco basato sul Web, l'utente malintenzionato potrebbe pubblicare un sito Web contenente una pagina utilizzata per sfruttare la vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti o annunci pubblicitari forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. In tutti questi casi, comunque, non è in alcun modo possibile obbligare gli utenti a visitare questi siti Web. L'utente malintenzionato dovrebbe invece convincere le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento in un messaggio di posta elettronica o di Instant Messenger che le indirizzi al sito.
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2010-3962

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Sovrascrittura del CSS del sito Web con un foglio di stile definito dall'utente**

    Per applicare un foglio di stile CSS personalizzato per la formattazione di documenti caricati in Internet Explorer, salvare il testo seguente in un file con l'estensione .CSS, tipo KB2458511.CSS:
    TABLE
    {
        POSI\\TION: relative !important;
    }

    **Nota** La barra retroversa "\\" tra "POSI" e "TION" è intenzionale.

    **Impatto della soluzione alternativa.** L'applicazione di un CSS definito dall'utente può compromettere il funzionamento dei fogli di stile del sito Web. Se in precedenza questa soluzione alternativa è già stata applicata, è necessario disattivarla prima di applicare il presente aggiornamento per la protezione. Utilizzare la soluzione di **fix automatico di Microsoft** descritta nell'[articolo della Microsoft Knowledge Base 2458511](http://support.microsoft.com/kb/2458511) per disattivare la soluzione alternativa.

    **Per applicare la modifica in modo interattivo**

    1.  In Internet Explorer, scegliere **Opzioni Internet** dal menu **Strumenti**.
    2.  Nella scheda **Generale**, fare clic su **Accesso facilitato**.
    3.  Selezionare **Formatta i documenti utilizzando il foglio di stile dell'utente**, fare clic su **Sfoglia**, quindi accedere alla posizione del file precedente e selezionare il file.
    4.  Fare clic su **Apri**, quindi su **OK** due volte e riavviare Internet Explorer.

    **Per annullare il risultato della soluzione alternativa.** Ripetere i passaggi precedenti, ad eccezione del passaggio 3 e deselezionare la casella **Formatta i documenti utilizzando il foglio di stile dell'utente**.

    **Per applicare la modifica utilizzando l'Editor del Registro di sistema**

    **Avvertenza** L'utilizzo non corretto dell'Editor del Registro di sistema potrebbe causare problemi tali da rendere necessaria la reinstallazione del sistema operativo. Microsoft non garantisce la risoluzione di problemi dovuti a un utilizzo non corretto dell'Editor del Registro di sistema. È quindi necessario utilizzare questo strumento con grande attenzione.

    1.  Creare una copia di backup delle chiavi del Registro di sistema utilizzando il comando riportato di seguito da un prompt dei comandi di livello elevato:
        regedit /e CSS-backup.reg "HKEY\_CURRENT\_USER\\Software\\Microsoft\\Internet Explorer\\Styles"
        Se il file CSS-backup.reg non è stato creato, significa che non esiste alcun file CSS definito dall'utente.
    2.  Quindi, salvare quanto segue in un file con estensione REG, ad esempio Apply\_user\_CSS.reg:
        Editor del Registro di sistema di Windows versione 5.00
        \[HKEY\_CURRENT\_USER\\Software\\Microsoft\\Internet Explorer\\Styles\]
        "User Stylesheet"="C:\\\\\[posizione directory\]\\\\KB2458511.css"
        "Use My Stylesheet"=dword:00000001
        **Nota** \[posizione directory\] deve corrispondere alla posizione del file KB2458511.css nel sistema locale.
    3.  Quindi, eseguire Apply\_user\_CSS.reg per applicare l'impostazione.

    **Per annullare il risultato della soluzione alternativa.** Se esiste un precedente file CSS definito dall'utente, utilizzare il file CSS-backup.reg per ripristinare l'impostazione precedente. Se non esiste, salvare quanto segue in un file con estensione REG, ad esempio Remove\_user\_CSS.reg:
    Editor del Registro di sistema di Windows versione 5.00
    \[-HKEY\_CURRENT\_USER\\Software\\Microsoft\\Internet Explorer\\Styles\]

    Quindi, eseguire Remove\_user\_CSS.reg con il comando seguente da un prompt dei comandi di livello elevato:
    Regedit.exe /s Remove\_user\_CSS.reg

    **Per applicare la modifica utilizzando la soluzione di fix automatico di Microsoft**

    Consultare l'[articolo della Microsoft Knowledge Base 2458511](http://support.microsoft.com/kb/2458511) per utilizzare la soluzione di **fix automatico di Microsoft** per attivare o disattivare questa soluzione alternativa.

-   **Attivazione della Protezione esecuzione programmi (DEP) per Internet Explorer 7**

    Gli **amministratori** locali possono controllare l'utilizzo di DEP/NX eseguendo Internet Explorer in qualità di amministratori. Per attivare DEP, utilizzare un dei metodi seguenti:

    **Attivazione di DEP per Internet Explorer 7 in modo interattivo**
    ...
    **Impatto della soluzione alternativa.** Alcune estensioni browser potrebbero non essere compatibili con DEP causando una chiusura inaspettata.

    **Per annullare il risultato della soluzione alternativa.** In questo caso è possibile disattivare il componente aggiuntivo o ripristinare l'impostazione di DEP tramite il Pannello di controllo Internet. Il Pannello di controllo Internet è accessibile anche dal pannello di controllo del sistema.

    **Attivazione di DEP per Internet Explorer 7 utilizzando il fix automatico di Microsoft**

    Consultare l'[articolo della Microsoft Knowledge Base 2458511](http://support.microsoft.com/kb/2458511) al fine di utilizzare la soluzione di fix automatico di Microsoft per attivare o disattivare questa soluzione alternativa.

    **Impatto della soluzione alternativa.** Alcune estensioni browser potrebbero non essere compatibili con DEP causando una chiusura inaspettata.

    **Per annullare il risultato della soluzione alternativa.** In questo caso è possibile disattivare il componente aggiuntivo o ripristinare l'impostazione DEP tramite il fix automatico di Microsoft per disattivare la soluzione alternativa.
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2010-3962
...
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**  
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. La vulnerabilità è stata identificata con il codice [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962) e descritta precedentemente nell'[advisory Microsoft sulla sicurezza 2458511](http://technet.microsoft.com/security/advisory/2458511).

**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**  
Sì. Microsoft è a conoscenza di attacchi attivi che tentano di sfruttare questa vulnerabilità.
...
Sì. L'aggiornamento per la protezione affronta la vulnerabilità attualmente sfruttata. Questa vulnerabilità è stata identificata con il codice [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962).

**Se sono state applicate le soluzioni alternative fornite nell'**[**Advisory Microsoft sulla sicurezza 2458511**](http://technet.microsoft.com/security/advisory/2458511)**, è necessario disattivarle prima di applicare questo aggiornamento?**  
Microsoft consiglia di annullare la soluzione alternativa "Sovrascrittura del CSS del sito Web" nei sistemi in cui è stata applicata in precedenza, prima di installare il presente aggiornamento per la protezione. Tuttavia, potrebbe essere necessario conservare le soluzioni alternative "Implementazione di Enhanced Mitigation Experience Toolkit" (EMET) e "Attivazione della Protezione esecuzione programmi (DEP) per Internet Explorer 7" come una misura di difesa in profondità.
...
<p>Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2416400$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB2416400-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB2416400-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2416400">articolo della Microsoft Knowledge Base 2416400</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2416400$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate a 32 bit, basate su x64 e basate su Itanium di Windows Server 2003:<br />
...
-   Aniway di [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria con HTML (CVE-2010-3340)  
-   Nicolas Joly del [VUPEN Vulnerability Research Team](http://www.vupen.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria di oggetti HTML (CVE-2010-3343)  
-   Stephen Fewer, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata al danneggiamento della memoria in elementi HTM (CVE-2010-3345)  
-   [Peter Vreugdenhil](http://vreugdenhilresearch.nl/) che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata al danneggiamento della memoria in elementi HTM (CVE-2010-3346)  
-   Masatoshi Sato di [AZIA CO., LTD.](http://www.azia.jp) per aver segnalato la vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali (CVE-2010-3348)  
-   [Yosuke Hasegawa](http://utf-8.jp) per aver collaborato con noi allo studio della vulnerabilità del modello di protezione tra domini legata all'intercettazione di informazioni personali (CVE-2010-3348)  
-   Jose Antonio Vazquez Gonzalez di [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria non inizializzata (CVE-2010-3962)
...
-   V1.1 (4 gennaio 2011): È stata aggiunta una Domanda frequente per comunicare un modifica di rilevamento che consente di verificare che gli aggiornamenti cumulativi di Internet Explorer precedentemente rilasciati siano forniti correttamente in base alle date di rilascio. Si tratta di una modifica solo al rilevamento. Non sono previsti aggiornamenti ai file sull'aggiornamento per la protezione.
