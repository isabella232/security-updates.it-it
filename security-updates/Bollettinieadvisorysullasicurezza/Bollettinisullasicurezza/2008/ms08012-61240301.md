---
TOCTitle: 'MS08-012'
Title: 'Bollettino Microsoft sulla sicurezza MS08-012 - Critico'
ms:assetid: 'ms08-012'
ms:contentKeyID: 61240301
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-012(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS08-012 - Critico
=======================================================
...
Questo è un aggiornamento critico per la protezione per le versioni supportate di Microsoft Office Publisher 2000 Microsoft Office Publisher 2002 e Microsoft Office Publisher 2003 Service Pack 2. Microsoft Publisher 2003 Service Pack 3, Microsoft Office Publisher 2007 e Microsoft Office Publisher 2007 Service Pack 1 non sono interessati da questa vulnerabilità. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione corregge le vulnerabilità modificando il modo in cui Microsoft Office Publisher gestisce file di Publisher appositamente predisposti. Per ulteriori informazioni sulle vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione seguente **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=d8b085fb-858f-4c7e-96de-edff8f49d62a">Microsoft Office Publisher 2000</a><br />
(KB946255)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=1135c63a-6ce7-4051-81ba-bfbba8d857fb">Microsoft Office Publisher 2002</a><br />
(KB946216)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
...
<th>Vulnerabilità legata al riferimento a una memoria non valida in Publisher - CVE-2008-0102</th>
<th>Vulnerabilità legata al danneggiamento della memoria in Publisher - CVE-2008-0104</th>
<th>Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
Vulnerabilità legata al riferimento a una memoria non valida in Publisher - CVE-2008-0102  
-----------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta al modo in cui Microsoft Office Publisher convalida i dati dell'applicazione durante il caricamento dei file di Publisher in memoria. Un utente malintenzionato potrebbe sfruttare la vulnerabilità creando un file Publisher (.pub) dannoso. Se un utente visualizza il file pub, la vulnerabilità potrebbe consentire l'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-0102](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0102).
  
#### Fattori attenuanti della vulnerabilità legata al riferimento a una memoria non valida in Publisher - CVE-2008-0102
...
#### Soluzioni alternative per la vulnerabilità legata al riferimento a una memoria non valida in Publisher - CVE-2008-0102
...
#### Domande frequenti sulla vulnerabilità legata al riferimento a una memoria non valida in Publisher - CVE-2008-0102
  
**Qual è la portata o l'impatto di questa vulnerabilità? **  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità? **  
Publisher non convalida correttamente i dati dell'applicazione durante il caricamento dei file di Publisher in memoria.
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità? **  
Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità? **  
Questa vulnerabilità può essere sfruttata solo se un utente apre un file Publisher appositamente predisposto di un'edizione interessata di Microsoft Office Publisher.
...
L'aggiornamento rimuove la vulnerabilità convalidando correttamente i valori di memoria durante il caricamento dei dati delle applicazioni dal disco alla memoria.
...
Vulnerabilità legata al danneggiamento della memoria in Publisher - CVE-2008-0104  
---------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta al modo in cui Microsoft Office Publisher convalida i valori di indice della memoria. Un utente malintenzionato potrebbe sfruttare la vulnerabilità creando un file Publisher (.pub) dannoso. Se un utente visualizza il file pub, la vulnerabilità potrebbe consentire l'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-0102](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0102).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria in Publisher - CVE-2008-0104
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria in Publisher - CVE-2008-0104
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   Non aprire o salvare file Microsoft Office provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.
  
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria in Publisher - CVE-2008-0104
  
**Qual è la portata o l'impatto di questa vulnerabilità? **  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità? **  
Publisher non convalida correttamente i valori di indice della memoria quando apre un file Publisher appositamente predisposto.
...
| Microsoft Publisher 2002 Service Pack 3 | No         |  
| Microsoft Publisher 2003 Service Pack 2 | No         |
...
|-----------------------------------------|---------|--------------------|-------------------|-----------|  
| Microsoft Publisher 2000 Service Pack 3 | No      | No                 | No                | No        |  
| Microsoft Publisher 2002 Service Pack 3 | No      | No                 | No                | No        |  
| Microsoft Publisher 2003 Service Pack 2 | No      | No                 | No                | No        |
...
#### Publisher 2000 (tutte le edizioni)
...
Per tutte le edizioni supportate di Publisher 2000:
  
| Nome file | Versione   | Data        | Ora   | Dimensione |  
|-----------|------------|-------------|-------|------------|  
| Mspub.exe | 9.0.8931.0 | 03-gen-2008 | 17:29 | 3.567.616  |  
...
<tr class="odd">
<td style="border:1px solid black;">Aggiornamento del file di registro</td>
<td style="border:1px solid black;">Gli utenti possono attivare la registrazione dettagliata utilizzando lo switch /log. Per ulteriori informazioni, vedere l'<a href="http://support.microsoft.com/kb/912203">articolo della Microsoft Knowledge Base 912203</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Ulteriori informazioni</td>
<td style="border:1px solid black;">Vedere la sottosezione <strong>Strumenti e informazioni sul rilevamento e sulla distribuzione.</strong>
...
Per tutte le edizioni supportate di Publisher 2002:
  
| Nome file   | Versione    | Data        | Ora   | Dimensione |  
|-------------|-------------|-------------|-------|------------|  
| Mspub.exe   | 10.0.6840.0 | 19-dic-2007 | 21:46 | 4.105.216  |  
| Prtf9.dll   | 10.0.6784.0 | 19-dic-2007 | 21:42 | 137.920    |  
| Ptxt9.dll   | 10.0.6840.0 | 19-dic-2007 | 21:44 | 599.040    |  
| Pubconv.dll | 10.0.6840.0 | 19-dic-2007 | 21:46 | 603.144    |
...
Per tutte le edizioni supportate di Publisher 2003:
  
| Nome file   | Versione    | Data        | Ora   | Dimensione |  
|-------------|-------------|-------------|-------|------------|  
| Mspub.exe   | 11.0.8200.0 | 15-dic-2007 | 02:39 | 6.747.136  |  
| Prtf9.dll   | 11.0.8200.0 | 15-dic-2007 | 02:39 | 133.632    |  
| Ptxt9.dll   | 11.0.8200.0 | 15-dic-2007 | 02:39 | 612.352    |  
| Pubconv.dll | 11.0.8200.0 | 15-dic-2007 | 02:39 | 562.184    |
...
-   Piotr Bania per aver segnalato la vulnerabilità legata al riferimento a una memoria non valida in Publisher - CVE-2008-0102.  
-   Bing Liu di [Fortinet Security Research](http://www.fortinet.com/) per aver segnalato la vulnerabilità legata al riferimento a una memoria non valida in Publisher - CVE-2008-0102.  
-   Bing Liu di [Fortinet Security Research](http://www.fortinet.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria in Publisher - CVE-2008-0104.
...
-   V1.1 (13 febbraio 2008): bollettino aggiornato per indicare l'assenza di problemi noti legati all'installazione di questo aggiornamento per la protezione e per elencare Microsoft Publisher 2003 Service Pack 2 (invece di Service Pack 3) nelle tabelle MBSA e SMS nella sezione relativa al rilevamento e alla distribuzione.  
-   V1.2 (10 settembre 2008): il bollettino è stato aggiornato per aggiungere una voce per le domande frequenti in modo da chiarire perché in questo aggiornamento vengono offerte versioni non esposte a vulnerabilità di Office.
