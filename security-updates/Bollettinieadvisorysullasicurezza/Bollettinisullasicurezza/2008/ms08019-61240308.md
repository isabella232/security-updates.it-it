---
TOCTitle: 'MS08-019'
Title: 'Bollettino Microsoft sulla sicurezza MS08-019 - Importante'
ms:assetid: 'ms08-019'
ms:contentKeyID: 61240308
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-019(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS08-019 - Importante
==========================================================

Alcune vulnerabilità in Microsoft Visio possono consentire l'esecuzione di codice in modalità remota (949032)
-------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve alcune vulnerabilità segnalate privatamente in Microsoft Visio che potrebbero consentire l'esecuzione di codice in modalità remota se un utente apre un file Visio appositamente predisposto. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Questo aggiornamento per la protezione è considerato di livello importante per Microsoft Visio 2002 Service Pack 2, Microsoft Visio 2003 Service Pack 2, Microsoft Visio 2003 Service Pack 3, Microsoft Visio 2007 e Microsoft Visio 2007 Service Pack 1. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato**, in questa sezione.

L'aggiornamento per la protezione corregge le vulnerabilità modificando il modo in cui Microsoft Visio esegue la convalida quando apre i file Visio. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.

**Raccomandazione.** Microsoft consiglia di installare l'aggiornamento quanto prima.

**Problemi noti.** L'[articolo della Microsoft Knowledge Base 949032](http://support.microsoft.com/kb/949032) descrive i problemi attualmente noti che gli utenti possono riscontrare installando questo aggiornamento per la protezione e le soluzioni consigliate. Quando i problemi noti e le soluzioni consigliate si riferiscono solo a determinate versioni di questo software, nell'articolo vengono forniti collegamenti ad altri articoli.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=0056a936-def5-40fa-bcfc-0ab0dd5c3964">Microsoft Visio 2002 Service Pack 2</a><br />
(KB947896)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=18af0ce6-99a0-4471-8d26-9700a8a8e631">Microsoft Visio 2003 Service Pack 2</a><br />
(KB947650)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-030">MS07-030</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=18af0ce6-99a0-4471-8d26-9700a8a8e631">Microsoft Visio 2003 Service Pack 3</a><br />
(KB947650)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-030">MS07-030</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=0510a1bb-b464-452c-900f-7f4e58ed9c7e">Microsoft Visio 2007</a><br />
(KB947590)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=0510a1bb-b464-452c-900f-7f4e58ed9c7e">Microsoft Visio 2007 Service Pack 1</a><br />
(KB947590)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nessuno</td>
...
<span></span>
**Perché Microsoft ha rivisto questo bollettino il 18 aprile 2008?**    
Questo bollettino è stato rivisto per correggere i problemi di rilevamento e installazione che avevano avuto conseguenze per gli utenti dei componenti di Microsoft Office 2007. L'aggiornamento prevedeva l'offerta e l'installazione dell'aggiornamento di Visio 2007 agli utenti che non avevano Visio 2007 installato nei loro sistemi. Microsoft ha corretto il problema e ha aggiornato questo bollettino per fare riferimento alla modifica. Si tratta di una modifica relativa al rilevamento che non interessa i file contenuti nell'aggiornamento iniziale. L'aggiornamento non sarà offerto nuovamente ai sistemi che eseguono Visio 2007 che hanno già applicato l'aggiornamento e gli utenti che hanno già installato l'aggiornamento non devono riapplicarlo nei propri sistemi.
  
**Qual è l'impatto sulla protezione dell'installazione di questo aggiornamento se Visio 2007 non è installato nel sistema? Che cosa è necessario fare?**    
Nessuno. L'installazione non necessaria di questo aggiornamento in sistemi sui quali non è presente Visio 2007 non aumenta i rischi di protezione. Gli utenti possono disinstallare l'aggiornamento se è stato già applicato. Tuttavia, la disinstallazione dell'aggiornamento non è richiesta in quanto l'aggiornamento non avrà un impatto negativo sulla protezione o sulle prestazioni del sistema.
...
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 949032](http://support.microsoft.com/kb/949032).
...
<th>Vulnerabilità legata all'intestazione dell'oggetto in Visio CVE-2008-1089</th>
<th>Vulnerabilità legata alla convalida della memoria in Visio CVE-2008-1090</th>
<th>Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
Vulnerabilità legata all'intestazione dell'oggetto in Visio CVE-2008-1089  
-------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Visio convalida i dati dell'intestazione dell'oggetto in file appositamente predisposti. Un utente malintenzionato può sfruttare la vulnerabilità inviando un file non valido che potrebbe essere contenuto in un allegato di posta elettronica o ospitato su un sito Web appositamente predisposto o manomesso.
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-1089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1089).
  
#### Fattori attenuanti della vulnerabilità legata all'intestazione dell'oggetto in Visio - CVE-2008-1089
...
#### Soluzioni alternative per la vulnerabilità legata all'intestazione dell'oggetto in Visio - CVE-2008-1089
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   Utilizzare Microsoft Visio 2003 Viewer o Microsoft Visio 2007 Viewer per aprire e visualizzare i file Visio. Microsoft Visio 2003 Viewer e Microsoft Visio 2007 Viewer non sono interessati da questa vulnerabilità.  
-   Non aprire o salvare file Visio provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.
  
#### Domande frequenti sulla vulnerabilità legata all'intestazione dell'oggetto in Visio - CVE-2008-1089
...
Microsoft Visio non convalida correttamente i dati dell'intestazione dell'oggetto durante l'apertura di file Visio.
...
Questa vulnerabilità può essere sfruttata solo se un utente apre un file Visio non valido di una versione interessata di Microsoft Visio.
  
In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato potrebbe sfruttare la vulnerabilità inviando un file Visio non valido e inducendo l'utente ad aprirlo.
...
I sistemi più esposti sono quelli in cui viene utilizzato Microsoft Visio. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento rimuove la vulnerabilità eseguendo la convalida durante l'allocazione di spazio per i dati dell'intestazione dell'oggetto durante l'apertura di file Visio.
...
Vulnerabilità legata alla convalida della memoria in Visio CVE-2008-1090  
------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Visio convalida le allocazioni della memoria durante il caricamento di file DXF appositamente predisposti dal disco alla memoria. Un utente malintenzionato può sfruttare la vulnerabilità inviando un file non valido che potrebbe essere contenuto in un allegato di posta elettronica o ospitato su un sito Web appositamente predisposto o manomesso.
  
Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-1090](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1090).
  
#### Fattori attenuanti della vulnerabilità legata alla convalida della memoria in Visio - CVE-2008-1090
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per impostazione predefinita, i file di disegno AutoCAD (estensione di file DXF) non vengono registrati da Visio e un file DXF appositamente predisposto non verrebbe aperto semplicemente facendo doppio clic su di esso. Un utente malintenzionato dovrebbe indurre l'utente ad aprire un file DXF aprendo Visio, selezionando Apri e modificando il tipo di file predefinito da "Tutti i file di Visio" in "Disegno di AutoCAD".  
-   In uno scenario di attacco basato sul Web, l'utente malintenzionato potrebbe pubblicare un sito Web contenente una pagina utilizzata per sfruttare la vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti o annunci pubblicitari forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. In tutti questi casi, comunque, non è in alcun modo possibile obbligare gli utenti a visitare questi siti Web. L'utente malintenzionato dovrebbe invece convincere le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento in un messaggio di posta elettronica o di Instant Messenger che le indirizzi al sito.  
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.  
-   Non è possibile sfruttare la vulnerabilità automaticamente per posta elettronica. L'attacco è possibile solo se l'utente apre un allegato a un messaggio di posta elettronica.
  
#### Soluzioni alternative per la vulnerabilità legata alla convalida della memoria in Visio - CVE-2008-1090
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Disattivare l'apertura in Visio di file DXF limitando l'accesso a DWGDP.DLL.**  
    Per limitare l'accesso a DWGDP.DLL, digitare quanto segue al prompt dei comandi:  
    **Nota** Per Vista, è necessario un account con privilegi di amministratore per implementare questa soluzione alternativa.  
    **Per Windows XP**  
    ...
    **Effetto della soluzione alternativa:** applicando questa soluzione alternativa, i file di disegno di AutoCAD (DXF) non verranno più aperti in Visio. Se non è necessario aprire tali file, la soluzione alternativa non ha alcun effetto sulla funzionalità del sistema.  
...
#### Domande frequenti sulla vulnerabilità legata alla convalida della memoria in Visio - CVE-2008-1090
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo in remoto del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
Microsoft Visio non convalida correttamente le allocazioni della memoria durante il caricamento di file DXF appositamente predisposti dal disco alla memoria.
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**    
Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe eseguire codice non autorizzato nel contesto dell'utente collegato. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
Questa vulnerabilità può essere sfruttata solo se un utente apre un file DXF non valido di una versione interessata di Microsoft Visio.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento rimuove la vulnerabilità eseguendo la convalida delle allocazioni della memoria durante il caricamento di file Visio dal disco alla memoria.
...
| Microsoft Visio 2003 Service Pack 2 | No         |  
| Microsoft Visio 2003 Service Pack 3 | No         |  
| Microsoft Visio 2007                | No         |  
| Microsoft Visio 2007 Service Pack 1 | No         |
...
**Nota** Per i clienti che utilizzano software legacy non supportato da MBSA 2.0.1, Microsoft Update e Windows Server Update Services: visitare Microsoft Baseline Security Analyzer e leggere la sezione relativa al supporto per i prodotti legacy che spiega come creare funzionalità complete per il rilevamento degli aggiornamenti per la protezione con gli strumenti legacy.
...
| Microsoft Visio 2003 Service Pack 2 | No      | No                 | No                | No        |  
| Microsoft Visio 2003 Service Pack 3 | No      | No                 | No                | No        |  
| Microsoft Visio 2007                | No      | No                 | No                | No        |  
| Microsoft Visio 2007 Service Pack 1 | No      | No                 | No                | No        |
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/949032">articolo della Microsoft Knowledge Base 949032</a></td>
</tr>
<tr class="even">
...
-   Un utente anonimo per aver segnalato la vulnerabilità legata all'intestazione dell'oggetto in Visio - CVE-2008-1089.  
-   Un utente anonimo per aver segnalato la vulnerabilità legata alla convalida della memoria in Visio - CVE-2008-1090.
...
-   V1.1 (9 aprile 2008): Aggiornamento della sezione dei problemi noti.  
-   V1.1 (9 aprile 2008): Bollettino aggiornato. Aggiunta una voce delle Domande frequenti su un problema noto relativo al rilevamento in Visio 2007.  
-   V1.3 (16 aprile 2008): Bollettino aggiornato: È stata aggiunta una voce per aggiornare le Domande frequenti in modo da descrivere le funzionalità di protezione aggiuntive incluse in Microsoft Office 2003 Service Pack 2. La tabella del software interessato è stata chiarita.  
-   V1.4 (18 aprile 2008): Voce aggiornata della sezione Domande frequenti su un problema noto relativo al rilevamento in Visio 2007.  
-   V1.5 (23 aprile 2008): è stata chiarita la voce delle Domande frequenti sull'ultima revisione, con data 18 aprile. Si tratta di una modifica relativa al rilevamento che non interessa i file contenuti nell'aggiornamento iniziale.
