---
TOCTitle: 'MS08-018'
Title: 'Bollettino Microsoft sulla sicurezza MS08-018 - Critico'
ms:assetid: 'ms08-018'
ms:contentKeyID: 61240307
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-018(v=Security.10)'
---

Security Bulletin

Bollettino Microsoft sulla sicurezza MS08-018 - Critico
=======================================================

Una vulnerabilità in Microsoft Project può consentire l'esecuzione di codice in modalità remota (950183)
--------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 8 aprile 2008 | Aggiornamento: mercoledì 10 settembre 2008
...
Questo aggiornamento per la protezione risolve una vulnerabilità segnalata privatamente in Microsoft Project che potrebbe consentire l'esecuzione di codice in modalità remota se un utente apre un file Project appositamente predisposto. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Questo aggiornamento per la protezione è considerato di livello critico per Microsoft Project 2000 Service Release 1 e di livello importante per Microsoft Project 2002 Service Pack 1 e Microsoft Project 2003 Service Pack 2. Per ulteriori informazioni, vedere la sottosezione Software interessato e Software non interessato in questa sezione.

Questo aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Microsoft Project calcola l'allocazione in memoria richiesta durante l'apertura di file Project. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.

**Raccomandazione.** Microsoft consiglia di applicare l'aggiornamento immediatamente

**Problemi noti.** L'[articolo della Microsoft Knowledge Base 950183](http://support.microsoft.com/kb/950183) descrive i problemi attualmente noti che gli utenti possono riscontrare disinstallando questo aggiornamento per la protezione e le soluzioni consigliate. Quando i problemi noti e le soluzioni consigliate si riferiscono solo a determinate versioni di questo software, nell'articolo vengono forniti collegamenti ad altri articoli.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=fbe46241-b9da-40c6-803d-42eb6234be77">Microsoft Project 2000 Service Release 1</a><br />
(KB949043)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=07a90718-6597-426d-9dca-a336d60c01b8">Microsoft Project 2002 Service Pack 1</a><br />
(KB949005)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;amp;familyid=aaba07d6-e972-4e85-bccd-406aa2c4a4f4">Microsoft Project 2003 Service Pack 2</a><br />
(KB948962)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nessuno</td>
...
<span></span>  
**Perché questo aggiornamento è critico per Project 2000 ma solo importante per tutte le altre versioni interessate di Project?**    
Microsoft Project 2002 e versioni successive dispongono di una funzionalità che chiede all'utente di aprire, salvare o annullare un documento prima di aprirlo. Questo fattore attenuante riduce la vulnerabilità a un livello importante perché richiede più azioni dell'utente per sfruttarla.
...
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 950183](http://support.microsoft.com/kb/950183).
...
**Se si utilizza Microsoft Project 2003 Service Pack 3, perché viene comunque offerto questo aggiornamento?**    
Microsoft Project 2003 Service Pack 3 non è interessato dalle vulnerabilità di protezione documentate nel bollettino. Tuttavia, agli utenti verrà comunque offerto questo aggiornamento poiché i file di aggiornamento per Microsoft Project 2003 Service Pack 3 sono più recenti (con numeri di versione superiori) rispetto ai file attualmente presenti nel sistema. Questo aggiornamento è stato verificato in modo completo, ma come per tutti gli aggiornamenti si consiglia di eseguire i test appropriati per il proprio ambiente e la configurazione per il proprio sistema.
  
**L'offerta di aggiornamento a una versione non esposta a vulnerabilità di Microsoft Project implica un bug nel meccanismo di aggiornamento Microsoft?**    
...
**Quale elemento contenuto nell'aggiornamento di Microsoft Project porta a un numero di versione più alto dei file dell'aggiornamento?**    
I file dell'aggiornamento sono stati modificati per consentire il supporto di modifiche alla stabilità in Microsoft Project, nonché di modifiche all'ambiente aziendale. Questo aggiornamento è stato verificato in modo completo, ma come per tutti gli aggiornamenti si consiglia di eseguire i test appropriati per il proprio ambiente e la configurazione per il proprio sistema.
...
<th>Vulnerabilità legata alla convalida della memoria in Project CVE-2008-1088</th>  
<th>Livello di gravità aggregato</th>  
</tr>  
</thead>  
<tbody>  
...
Vulnerabilità legata alla convalida della memoria in Project - CVE-2008-1088  
----------------------------------------------------------------------------
  
<span></span>  
In Microsoft Project esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta alla gestione di file Project appositamente predisposto. Un utente malintenzionato può sfruttare la vulnerabilità inviando un file non valido che potrebbe essere contenuto in un allegato di posta elettronica o ospitato su un sito Web appositamente predisposto o manomesso.
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-1088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1088).
  
#### Fattori attenuanti della vulnerabilità legata alla convalida della memoria in Project - CVE-2008-1088
...
#### Soluzioni alternative per la vulnerabilità legata alla convalida della memoria in Project - CVE-2008-1088
...
#### Domande frequenti sulla vulnerabilità legata alla convalida della memoria in Project - CVE-2008-1088
...
Microsoft Project non convalida correttamente le allocazioni delle risorse di memoria durante l'apertura di file Project.
...
Questa vulnerabilità può essere sfruttata solo se un utente apre un file Project non valido di una versione interessata di Microsoft Project.
  
In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato potrebbe sfruttare la vulnerabilità inviando un file Project non valido e inducendo l'utente ad aprirlo.
...
I sistemi più esposti sono quelli in cui viene utilizzato Microsoft Project. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento elimina la vulnerabilità modificando il modo in cui Microsoft Project convalida le allocazioni della memoria durante l'apertura di file Project dal disco alla memoria.
...
| Microsoft Project 2002 Service Pack 1    | No         |  
| Microsoft Project 2003 Service Pack 2    | No         |
...
| Microsoft Project 2002 Service Pack 1    | No      | No                 | No                | No        |  
| Microsoft Project 2003 Service Pack 2    | No      | No                 | No                | No        |
...
#### Project 2000 (tutte le edizioni)
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/950183">articolo della Microsoft Knowledge Base 950183</a></td>
</tr>  
<tr class="even">
...
#### Project 2002 (tutte le edizioni)
...
#### Project 2003 (tutte le edizioni)
...
-   [National Cyber Security Center](http://www.ncsc.go.kr/eng/), Repubblica di Corea, per aver segnalato la vulnerabilità legata alla convalida della memoria in Project - CVE-2008-1088.
...
-   V1.1 (9 aprile 2008): Bollettino aggiornamento per aggiungere Microsoft Project 2003 Service Pack 3 alla tabella Software non interessato, per aggiungere un collegamento all'articolo della Microsoft Knowledge Base 950183 nella sezione dei problemi noti e per aggiungere una sezione per Microsoft Project 2003 Service Pack 3 alle Domande frequenti.  
-   V1.2 (16 aprile 2008): Bollettino aggiornato: aggiunta una voce per aggiornare le Domande frequenti e descrivere ulteriori funzionalità di protezione incluse per Microsoft Office 2003 Service Pack 2. Le tabelle relative a Microsoft Baseline Security Analyzer e Systems Management Server sono state aggiornate affinché corrispondano alla tabella Software interessato.  
-   V1.3 (10 settembre 2008): Bollettino aggiornato: è stata aggiunta una voce per aggiornare le domande frequenti in modo da chiarire perché questo aggiornamento è di livello critico per Project 2000 ma solo di livello importante per tutte le altre versioni interessate di Project.
