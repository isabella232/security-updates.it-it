...
<td style="border:1px solid black;"><p>Vulnerabilità legata all'intercettazione di informazioni sulle risorse in Internet Explorer</p></td>
<td style="border:1px solid black;"><p>Client Windows:<br />
<strong>Importante/intercettazione di informazioni personali<br />
</strong><br />
Server Windows:<br />
<strong>Basso/intercettazione di informazioni personali</strong></p></td>
<td style="border:1px solid black;"><p>Client Windows:<br />
<strong>Importante/intercettazione di informazioni personali<br />
</strong><br />
Server Windows:<br />
...
Server Windows:<br />
<strong>Moderato / DOS</strong></p></td>
<td style="border:1px solid black;"><p>Client Windows:<br />
<strong>Moderato / DOS<br />
</strong><br />
Server Windows:<br />
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-7331">CVE-2013-7331</a></p></td>
<td style="border:1px solid black;"><p>Sì. Microsoft è a conoscenza di attacchi attivi limitati che tentano di sfruttare questa vulnerabilità.</p></td>
</tr>
</tbody>
</table>
...
<td style="border:1px solid black;"><p>Per Internet Explorer 6 in tutte le edizioni supportate a 32 bit, x64 e Itanium di Windows Server 2003:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2977629$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 7 in tutte le edizioni supportate a 32 bit, x64 e Itanium di Windows Server 2003:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB2977629-IE7\spuninst</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 8 in tutte le edizioni supportate a 32 bit e x64 di Windows Server 2003:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB2977629-IE8\spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Informazioni sui file</strong></p></td>
<td style="border:1px solid black;"><p>Consultare l'<a href="https://support.microsoft.com/kb/2976627">articolo della Microsoft Knowledge Base 2977629</a></p></td>
</tr>
<tr class="even">
