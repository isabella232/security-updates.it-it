...
<td style="border:1px solid black;"><p><strong>MSXML 3.0 e MSXML 6.0</strong></p></td>
<td style="border:1px solid black;"><p><strong>MSXML 4.0 e MSXML 5.0</strong></p></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><p>Windows XP</p></td>
<td style="border:1px solid black;"><p>Fornito con il sistema operativo</p></td>
<td style="border:1px solid black;"><p>Installato con software aggiuntivo</p></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><p>Windows Server 2003</p></td>
<td style="border:1px solid black;"><p>MSXML 3.0 fornito con il sistema operativo. MSXML 6.0 installato con il software aggiuntivo.</p></td>
<td style="border:1px solid black;"><p>Installato con software aggiuntivo</p></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><p>Fornito con il sistema operativo</p></td>
<td style="border:1px solid black;"><p>MSXML 4.0 installato con software aggiuntivo. MSXML 5.0 non applicabile.</p></td>
</tr>  
<tr class="odd">
...
<p> </p>
    ...
    <thead>
    <tr class="header">
    <th><img src="images/Dn613825.note(it-IT,Security.10).gif" class="note" />Nota:</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
...
<td style="border:1px solid black;"><p>Per tutte le edizioni basate su x64 supportate di Windows XP Professional:<br />
...
<td style="border:1px solid black;"><p>Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2916036$\Spuninst</p></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Informazioni sui file</strong></p></td>
<td style="border:1px solid black;"><p>Consultare l'<a href="https://support.microsoft.com/kb/2916036">articolo della Microsoft Knowledge Base 2916036</a></p></td>
</tr>  
<tr class="even">
