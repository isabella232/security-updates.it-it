...
<th><p>Aggiornamento cumulativo più recente che deve essere applicato prima di installare l'aggiornamento MS14-021</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<td style="border:1px solid black;"><p><a href="http://go.microsoft.com/fwlink/?linkid=393743">MS14-018</a> (tenere presente che questo non era un aggiornamento correlato alla protezione per Internet Explorer 10)</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p>Internet Explorer 11 su Windows 7 o Windows Server 2008 R2</p></td>
<td style="border:1px solid black;"><p>Per l'aggiornamento 2964444: <a href="http://go.microsoft.com/fwlink/?linkid=392064">MS14-012</a> (tenere presente che MS14-018 non era un aggiornamento cumulativo per Internet Explorer 11)<br />
<br />
Per l'aggiornamento 2964358: <a href="https://support.microsoft.com/kb/2929437">2929437</a></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p>Internet Explorer 11 su Windows 8.1, Windows Server 2012 R2 o Windows RT 8.1</p></td>
<td style="border:1px solid black;"><p>Per l'aggiornamento 2964444: <a href="http://go.microsoft.com/fwlink/?linkid=392064">MS14-012</a> (tenere presente che MS14-018 non era un aggiornamento cumulativo per Internet Explorer 11)<br />
<br />
Per l'aggiornamento 2964358: <a href="https://support.microsoft.com/kb/2919355">2919355</a></p></td>
</tr>
</tbody>
</table>
<p> </p>
...
<th><p>Internet Explorer 6 per le edizioni supportate di Windows XP e Windows XP Professional x64</p></th>
...
<th><p>Codice CVE</p></th>
<th><p>Titolo della vulnerabilità</p></th>
<th><p>Internet Explorer 7 per le edizioni supportate di Windows XP e Windows XP Professional x64</p></th>
...
<th><p>Codice CVE</p></th>
<th><p>Titolo della vulnerabilità</p></th>
<th><p>Internet Explorer 8 per Windows XP per le edizioni supportate di Windows XP e Windows XP Professional x64</p></th>
<th><p>Internet Explorer 8 per le edizioni supportate di Windows Server 2003</p></th>
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1776">CVE-2014-1776</a></p></td>
<td style="border:1px solid black;"><p>Sì. Questa vulnerabilità è stata descritta per la prima volta nell'<a href="https://technet.microsoft.com/library/security/2963983">advisory Microsoft sulla sicurezza 2963983</a>.</p></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1776">CVE-2014-1776</a></p></td>
<td style="border:1px solid black;"><p>Sì. Microsoft è a conoscenza di attacchi mirati che tentano di sfruttare questa vulnerabilità in Internet Explorer.</p></td>
</tr>
</tbody>
</table>
...
<td style="border:1px solid black;"><p>Per Internet Explorer 6 in tutte le edizioni a 32 bit supportate di Windows XP:<br />
<strong>WindowsXP-KB2964358-x86-ENU.exe</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 6 in tutte le edizioni supportate basate su x64 di Windows XP:<br />
<strong>WindowsServer2003-KB2964358-x64-ENU.exe</strong></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 7 in tutte le edizioni a 32 bit supportate di Windows XP:<br />
<strong>IE7-WindowsXP-KB2964358-x86-ENU.exe</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 7 in tutte le edizioni supportate basate su x64 di Windows XP:<br />
<strong>IE7-WindowsServer2003-KB2964358-x64-ENU.exe</strong></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 8 in tutte le edizioni a 32 bit supportate di Windows XP:<br />
<strong>IE8-WindowsXP-KB2964358-x86-ENU.exe</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Internet Explorer 8 per tutte le edizioni supportate basate su x64 di Windows XP:<br />
...
<td style="border:1px solid black;"><p>Per Internet Explorer 6 per tutte le edizioni supportate di Windows XP:<br />
KB2964358.log</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
KB2964358-IE7.log</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
...
<td style="border:1px solid black;"><p>Per Internet Explorer 6 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2964358$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB2964358-IE7\spuninst</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB2964358-IE8\spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Informazioni sui file</strong></p></td>
<td style="border:1px solid black;"><p>Consultare l'<a href="https://support.microsoft.com/kb/2964358">articolo della Microsoft Knowledge Base 2964358</a></p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Per Internet Explorer 11 in tutte le edizioni x64 supportate di Windows 8:<br />
...
<tr class="even">
<td style="border:1px solid black;"><p><strong>Informazioni sui file</strong></p></td>
<td style="border:1px solid black;"><p>Vedere l'<a href="https://support.microsoft.com/kb/2964358">articolo della Microsoft Knowledge Base 2964358</a> o l'<a href="https://support.microsoft.com/kb/2964444">articolo della Microsoft Knowledge Base 2964444</a></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Controllo delle chiavi del Registro di sistema</strong></p></td>
<td style="border:1px solid black;"><p><strong>Nota</strong> Non esiste alcuna chiave del Registro di sistema per verificare la presenza di questo aggiornamento.</p></td>
