...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Versione</strong></p></td>
...
(Internet Explorer 6, eccetto in Windows XP Service Pack 3)</p></td>
<td style="border:1px solid black;"><p>VBScript 5.6 <br />
(2909213)</p></td>
...
(Internet Explorer 6 in Windows XP Service Pack 3 e Internet Explorer 7)</p></td>
<td style="border:1px solid black;"><p>VBScript 5.7 <br />
(2909212)</p></td>
<td style="border:1px solid black;"><p>Non applicabile</p></td>
</tr>
...
</strong>Acquisizione di privilegi più elevati</p></td>
<td style="border:1px solid black;"><p><strong>Importante<br />
</strong>Acquisizione di privilegi più elevati</p></td>
<td style="border:1px solid black;"><p><strong>Importante<br />
</strong>Acquisizione di privilegi più elevati</p></td>
...
<td style="border:1px solid black;"><p>Vulnerabilità legata all'intercettazione di informazioni personali tra domini in Internet Explorer</p></td>
<td style="border:1px solid black;"><p><strong>Importante<br />
</strong>Intercettazione di informazioni personali</p></td>
<td style="border:1px solid black;"><p><strong>Basso<br />
</strong>Intercettazione di informazioni personali</p></td>
<td style="border:1px solid black;"><p><strong>Importante<br />
</strong>Intercettazione di informazioni personali</p></td>
<td style="border:1px solid black;"><p><strong>Basso<br />
...
<td style="border:1px solid black;"><p>Per Internet Explorer 6 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2909921$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Per Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB2909921-IE7\spuninst</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Per Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB2909921-IE8\spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Informazioni sui file</strong></p></td>
<td style="border:1px solid black;"><p>Consultare l'<a href="https://support.microsoft.com/kb/2909921">articolo della Microsoft Knowledge Base 2909921</a></p></td>
</tr>
<tr class="even">
