...
ms:contentKeyID: 18132344
ms:mtpsurl: 'https://technet.microsoft.com/it-it/library/Cc708429(v=WS.10)'
---
...
This component is built into the Windows Server 2008, Microsoft Windows Vista, Windows Server 2003, Windows XP, and Windows 2000 SP4 operating systems. Automatic Updates enables both server and client computers to receive updates from Microsoft Update or from a WSUS server.
