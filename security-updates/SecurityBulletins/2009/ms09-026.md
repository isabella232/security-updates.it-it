---
TOCTitle: 'MS09-026'
Title: 'Bollettino Microsoft sulla sicurezza MS09-026 - Importante'
ms:assetid: 'ms09-026'
ms:contentKeyID: 61240393
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-026(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-026 - Importante
==========================================================
...
L'aggiornamento risolve la vulnerabilità correggendo la modalità con cui il motore di marshalling RPC aggiorna il proprio stato interno. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=155a79c1-e5e4-4f62-b4b0-53aca59f20ac)                                                                                | Acquisizione di privilegi più elevati       | Importante                   | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40)                                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40)                                                                                            | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=20734b70-37f1-47dd-bc09-d56f93577a55)                                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62bb9e22-4f4b-4ffc-ba76-f626e94c79d5)                                                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=888b8dd8-d76c-42f5-a377-1f1750d3cf56)                                                                       | Acquisizione di privilegi più elevati       | Importante                   | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3084f46e-02b9-4d99-a7a1-033817f9bd9f)                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214)                                                                                                        | Acquisizione di privilegi più elevati       | Importante                   | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214)                                                          | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd)                                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd)                                  | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eaa26c6c-5bf7-4099-bb21-1e03de3a25ca)\*                 | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=447aaa4f-946b-4f23-b151-dcf46ea9f80e)\*                           | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi basati su Itanium e Windows Server 2008 per sistemi basati su Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f33012b9-5d5b-4f72-8d49-a8e1c8bc1337) | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
...
<th style="border:1px solid black;" >Vulnerabilità legata al motore di marshalling RPC - CVE-2009-0568</th>
...
Vulnerabilità legata al motore di marshalling RPC - CVE-2009-0568  
-----------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'elevazione di privilegi più elevati nella funzionalità RPC (Remote Procedure Call) di Windows per cui il motore di marshalling RPM non aggiorna correttamente il proprio stato interno. Il mancato aggiornamento dello stato interno può causare la lettura di un indicatore da una posizione errata. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568).
  
#### Fattori attenuanti della vulnerabilità legata al motore di marshalling RPC - CVE-2009-0568
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Le edizioni supportate di Microsoft Windows non sono fornite con server o client RPC soggetti allo sfruttamento di questa vulnerabilità. In una configurazione predefinita, gli utenti non possono subire un attacco volto a sfruttare questa vulnerabilità. Tuttavia, la vulnerabilità è presente nel runtime di esecuzione di Microsoft Windows RPC e può interessare applicazioni RPC di terze parti.
  
#### Soluzioni alternative per la vulnerabilità legata al motore di marshalling RPC - CVE-2009-0568
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al motore di marshalling RPC - CVE-2009-0568
...
La vulnerabilità si presenta quando il motore di marshalling RPC (Remote Procedure Call) non aggiorna il proprio stato interno in maniera corretta. Il mancato aggiornamento può causare la lettura di un indicatore da una posizione errata. Soltanto le interfacce che utilizzano il linguaggio di definizione dell'interfaccia (IDL) contenenti un array variabile non conforme possono essere interessate da questo problema.
  
**Quali applicazioni RPC possono essere interessate da questa vulnerabilità?**   
Per determinare se un'applicazione è interessata da questo problema, gli utenti devono avere accesso al file IDL utilizzato per compilare il client o l'applicazione server. Le applicazioni RPC potrebbero essere vulnerabili allo sfruttamento di questa vulnerabilità se lo stub risultante contiene un FC\_SMVARRAY o FC\_LGVARRAY seguito da FC\_VARIABLE REPEAT e FC\_VARIABLE\_OFFSET.
  
**Che cos'è RPC (Remote Procedure Call)?**    
RPC (Remote Procedure Call) di Microsoft è un meccanismo di comunicazione interprocesso (IPC) che attiva lo scambio dati e il richiamo di funzionalità che risiedono in un altro processo. Tale processo può trovarsi nello stesso computer, nell'area locale (LAN) o in Internet. Il meccanismo RPC di Microsoft utilizza altri meccanismi IPC, come named pipe, Netbios o Winsock, per stabilire le comunicazioni tra il client e il server. Con RPC, la logica essenziale del programma e il relativo codice di procedura possono esistere su computer diversi, caratteristica importante per le applicazioni distribuite. Per ulteriori informazioni, vedere l'articolo di TechNet [Che cosa significa RPC?](http://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx).
  
**Che cos'è il motore di marshalling RPC?**   
Il motore di marshalling RPC, anche conosciuto come NDR, fornisce un'interfaccia RPC comune tra client e server RPC. NDR20 è utilizzato in architetture a 32 bit e in NDR64 è ottimizzato per architetture a 64 bit. Lo stesso motore di marshalling è utilizzato sia sul lato client sia sul lato server, a prescindere dall'architettura del programma. Il client e il server negoziano il motore marshalling da utilizzare per la comunicazione.
  
**Che cosa sono i file del linguaggio di definizione dell'interfaccia (IDL) e i file di configurazione dell'applicazione (ACF)?**   
Il file del linguaggio di definizione dell'interfaccia (IDL) contiene una descrizione dell'interfaccia tra il client e i programmi del server. Le applicazioni RPC utilizzano il file di configurazione dell'applicazione (ACF) per descrivere le caratteristiche dell'interfaccia che sono specifiche dell'hardware e del sistema operativo che costituiscono un determinato ambiente operativo. Tali informazioni vengono divise in due file per tenere separata l'interfaccia del software dalle caratteristiche che interessano soltanto l'ambiente operativo.
  
Il file IDL specifica un contratto rete per ciò che viene trasmesso tra il client e tra il server. Mantenendo tali informazioni separate dalle informazioni sull'ambiente operativo il file IDL può essere trasferito in altri ambienti. Il file IDL consiste in due parti: un'[intestazione di interfaccia](http://msdn.microsoft.com/en-us/library/aa378711(vs.85).aspx) e un [testo di interfaccia](http://msdn.microsoft.com/en-us/library/aa378710(vs.85).aspx).
  
L'ACF specifica gli attributi che interessano soltanto le prestazioni locale piuttosto che il contratto di rete. Microsoft RPC consente di combinare gli attributi ACF e IDL in un unico file IDL. Inoltre, è possibile combinare interfacce multiple in un unico file IDL (e l'ACF corrispondente). Per ulteriori informazioni, vedere l'articolo di MSDN, [File IDL e ACF](http://msdn.microsoft.com/en-us/library/aa378708(vs.85).aspx).
  
**Che cosa sono le comunicazioni interprocesso (IPC)?**   
Il sistema operativo Microsoft Windows fornisce dei meccanismi per facilitare le comunicazioni e la condivisione di dati tra le applicazioni. Collettivamente, le attività attivate da questi meccanismi sono chiamate comunicazioni interprocesso (IPC). Alcuni moduli IPC facilitano la divisione del lavoro fra diversi processi specializzati. Altri moduli IPC facilitano la divisione del lavoro fra i computer su una rete. Per ulteriori informazioni, vedere l'articolo di MSDN [Comunicazioni interprocesso](http://msdn.microsoft.com/en-us/library/aa365574(vs.85).aspx).
...
Un utente malintenzionato può sfruttare la vulnerabilità creando un messaggio RPC appositamente predisposto e inviandolo a un sistema interessato tramite una porta TCP o UDP vulnerabile. Il messaggio può quindi consentire al client di scrivere dati arbitrari nella memoria dello spazio degli indirizzi del server RPC. Soltanto le interfacce IDL contenenti un array variabile non conforme sono interessati da questo problema.
...
L'aggiornamento risolve la vulnerabilità correggendo la modalità con cui il motore di marshalling RPC aggiorna il suo stato interno.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2009-0568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568).
...
<td style="border:1px solid black;">Per Microsoft Windows 2000 Service Pack 4:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB970238$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/970238">articolo della Microsoft Knowledge Base 970238</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB970238$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/??????">articolo della Microsoft Knowledge Base 970238</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
