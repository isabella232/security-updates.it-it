---
TOCTitle: 'MS09-058'
Title: 'Bollettino Microsoft sulla sicurezza MS09-058 - Importante'
ms:assetid: 'ms09-058'
ms:contentKeyID: 61240423
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-058(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-058 - Importante
==========================================================

Le vulnerabilità del kernel di Windows possono consentire l'acquisizione di privilegi più elevati (971486)
----------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 13 ottobre 2009 | Aggiornamento: lunedì 21 dicembre 2009
...
Questo aggiornamento per la protezione è considerato di livello importante per le edizioni supportate di Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008 e di livello moderato per il Service Pack 2 di edizioni di Windows Vista e Windows Server 2008. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno di questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità assicurando che il kernel di Windows possa troncare i valori a 64 bit in modo corretto, garantendo che il kernel di Windows convalidi correttamente i dati all'interno di un file eseguibile e assicurando che il kernel di Windows elimini le eccezioni in condizioni di errore. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
**Problemi noti.**[Articolo di Microsoft Knowledge Base 971486](http://support.microsoft.com/kb/971486) i problemi attualmente conosciuti che potrebbero verificarsi durante l'installazione di questo aggiornamento della protezione. L'articolo illustra inoltre le soluzioni consigliate per questi problemi. Quando i problemi noti e le soluzioni consigliate si riferiscono solo alle versioni specifiche di questo software, questo articolo fornisce collegamenti ad altri articoli.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=bdfa6583-28a2-4d6b-91d2-157a8518b664)                                | Acquisizione di privilegi più elevati       | Importante                   | [MS07-022](http://technet.microsoft.com/security/bulletin/ms07-022) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cece4c55-0756-4357-9d2d-6709e8426068)                | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5459b7d4-1fab-4a04-ab9d-b8323505c1e2)                   | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1e3f3842-f8fd-4969-a2cf-706db38d7580)                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=95286b8d-4b53-4e6c-af59-e9e18fad3559)                       | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=faef714b-5f46-47f2-bea7-881df05a1bc0)            | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97)                         | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97)                                         | Denial of Service                           | Moderato                     | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434) | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434)                             | Denial of Service                           | Moderato                     | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423)\*                           | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423)\*            | Denial of Service                           | Moderato                     | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94)\*                                | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94)\*                 | Denial of Service                           | Moderato                     | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)                    | Acquisizione di privilegi più elevati       | Importante                   | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
| [Windows Server 2008 per sistemi basati su Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)     | Denial of Service                           | Moderato                     | [MS08-064](http://technet.microsoft.com/security/bulletin/ms08-064) |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'underflow di valori integer del kernel di Windows - CVE-2009-2515</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla risoluzione del riferimento di un puntatore NULL nel kernel di Windows - CVE-2009-2516</th>
<th style="border:1px solid black;" >Vulnerabilità legata al gestore delle eccezioni nel kernel di Windows - CVE-2009-2517</th>
...
Vulnerabilità legata all'underflow di valori integer del kernel di Windows - CVE-2009-2515  
------------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al fatto che il kernel di Windows tronca in modo non corretto un valore a 64 bit in un valore a 32 bit. Un utente malintenzionato in grado di sfruttare questa vulnerabilità potrebbe eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-2515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2515).
  
#### Fattori attenuanti della vulnerabilità legata all'underflow di valori integer del kernel di Windows - CVE-2009-2515
...
-   Nei sistemi a 32 bit questa vulnerabilità può essere attivata solo se il sistema utilizza le estensioni di indirizzo fisico (PAE).
  
#### Soluzioni alternative per la vulnerabilità legata all'underflow di valori integer del kernel di Windows - CVE-2009-2515
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'underflow di valori integer del kernel di Windows - CVE-2009-2515
...
Il kernel di Windows non tronca correttamente un valore a 64 bit in un valore a 32 bit. Ne risulta un underflow di valori integer quando il valore viene in seguito sottratto a un altro valore.
...
**Che cos'è l'estensione di indirizzo fisico (PAE)?**    
Le PAE sono estensioni di indirizzo fisico fornite da Intel in grado di supportare oltre 4 GB di memoria fisica per la maggior parte delle piattaforme Intel Pentium Pro a 32 bit (IA-32) e versioni successive. Sebbene il supporto per la memoria PAE sia in genere associato al supporto per oltre 4 GB di RAM, le estensioni di indirizzo fisico possono essere abilitate in Windows XP SP2, Windows Server 2003 e in versioni a 32 bit successive di Windows per supportare la [Protezione esecuzione programmi](http://www.microsoft.com/technet/prodtechnol/winxppro/maintain/sp2mempr.mspx) imposta dall'hardware. Per ulteriori informazioni sulle PAE, vedere l'articolo [Estensione di indirizzo fisico - Memoria PAE e Windows](http://www.microsoft.com/whdc/system/platform/server/pae/paedrv.mspx).
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui il kernel di Windows tronca i valori a 64 bit.
...
Vulnerabilità legata alla risoluzione del riferimento di un puntatore NULL nel kernel di Windows - CVE-2009-2516  
----------------------------------------------------------------------------------------------------------------
  
<span></span>
Nel kernel di Windows è stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta alla convalida insufficiente di determinati dati inviati in modalità utente. Un utente malintenzionato in grado di sfruttare questa vulnerabilità potrebbe eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-2516](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2516).
  
#### Fattori attenuanti della vulnerabilità legata alla risoluzione del riferimento di un puntatore NULL nel kernel di Windows - CVE-2009-2516
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare questa vulnerabilità, un utente malintenzionato deve essere in grado di collocare un'applicazione appositamente predisposta in un sistema. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alla risoluzione del riferimento di un puntatore NULL nel kernel di Windows - CVE-2009-2516
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla risoluzione del riferimento di un puntatore NULL nel kernel di Windows - CVE-2009-2516
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
Il kernel di Windows non convalida correttamente determinati dati inviati in modalità utente.
...
**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
Per sfruttare questa vulnerabilità, un utente malintenzionato dovrebbe prima collocare un'applicazione appositamente predisposta in un sistema di destinazione. Se un utente individua la directory dove risiede l'applicazione predisposta, ciò è sufficiente per sfruttare la vulnerabilità, assumendo il controllo completo del sistema interessato. Perché ciò accada, l'utente non deve eseguire l'applicazione. È sufficiente che individui la directory in cui risiede l'applicazione predisposta.
  
Un utente malintenzionato può inoltre collocare l'applicazione appositamente predisposta in una condivisione di rete. In questo caso, se un utente individua la condivisione di rete, l'applicazione appositamente predisposta causa l'arresto e il riavvio del sistema. Perché ciò accada, l'utente non deve eseguire l'applicazione. È sufficiente che individui la condivisione di rete in cui risiede l'applicazione predisposta.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi maggiormente a rischio sono workstation e server terminal. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui il kernel di Windows convalida i dati all'interno di un file eseguibile.
...
Vulnerabilità legata al gestore delle eccezioni nel kernel di Windows - CVE-2009-2517  
-------------------------------------------------------------------------------------
  
<span></span>
Nel kernel di Windows esiste una vulnerabilità di tipo Denial of Service a causa del modo in cui il kernel gestisce determinate eccezioni. Un utente malintenzionato potrebbe sfruttare la vulnerabilità eseguendo un'applicazione appositamente predisposta che causa il riavvio del sistema.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-2517](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2517).
  
#### Fattori attenuanti della vulnerabilità legata al gestore delle eccezioni del kernel di Windows - CVE-2009-2517
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata al gestore delle eccezioni del kernel di Windows - CVE-2009-2517
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al gestore delle eccezioni del kernel di Windows - CVE-2009-2517
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità assicurando che il kernel di Windows elimini le eccezioni in condizioni di errore.
...
| **Distribuzione**                                  |                                                                                                                                                                    |  
| Installazione senza intervento dell'utente         | Windows2000-kb971486-x86-enu /quiet                                                                                                                                |  
| Installazione senza riavvio                        | Windows2000-kb971486-x86-enu /norestart                                                                                                                            |  
| Aggiornamento del file di registro                 | kb971486.log                                                                                                                                                       |  
...
| **Informazioni per la rimozione**                  | Selezionare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB971486$\\Spuninst |  
| **Informazioni sui file**                          | Vedere l'[articolo della Microsoft Knowledge Base 971486](http://support.microsoft.com/kb/971486)                                                                  |  
| **Controllo delle chiavi del Registro di sistema** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971486\\Filelist                                                                          |
...
<td style="border:1px solid black;">Selezionare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB971486$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/971486">articolo della Microsoft Knowledge Base 971486</a></td>
</tr>
<tr class="even">
...
-   Tavis Ormandy e Neel Mehta di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata all'underflow di valori integer del kernel di Windows (CVE-2009-2515)  
-   [NSFocus Security Team](http://www.nsfocus.com/) per aver segnalato la vulnerabilità legata alla risoluzione del riferimento di un puntatore NULL nel kernel di Windows (CVE-2009-2516)  
-   Tavis Ormandy e Neel Mehta di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata al gestore delle eccezioni del kernel di Windows (CVE-2009-2517)
...
-   V1.1 (21 dicembre, 2009): Aggiunto un link al Microsoft Knowledge Base Article 971486 sotto i problemi noti nel Sommario Esecutivo.
