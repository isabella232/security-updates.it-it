---
TOCTitle: 'MS09-021'
Title: 'Bollettino Microsoft sulla sicurezza MS09-021 - Critico'
ms:assetid: 'ms09-021'
ms:contentKeyID: 61240388
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-021(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-021 - Critico
=======================================================
...
<tr>
<td style="border:1px solid black;">
[Pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1 (edizioni a 32 bit)](http://www.microsoft.com/downloads/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (edizioni a 32 bit)](http://www.microsoft.com/downloads/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1 (edizioni a 64 bit)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (edizioni a 64 bit)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
Non applicabile
...
**Anche gli articoli MS09-017 e MS09-027 descrivono alcune vulnerabilità di Microsoft Office 2004 per Mac, Microsoft Office 2008 per Mac e del convertitore file in formato XML aperto per Mac. Qual è la relazione tra MS09-017, MS09-027 e questo bollettino (MS09-021)?**  
I pacchetti di aggiornamento per la protezione di Microsoft Office 2004 per Mac (KB969661), Microsoft Office 2008 per Mac (KB971822) e del convertitore file in formato XML aperto per Mac (KB971824), illustrati in questo bollettino (MS09-021), risolvono anche le vulnerabilità descritte nei bollettini [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704) e [MS09-027](http://go.microsoft.com/fwlink/?linkid=147416). Gli utenti che utilizzano Microsoft Office 2004 per Mac, Microsoft Office 2008 per Mac o il convertitore file in formato XML aperto per Mac dovranno installare i pacchetti di aggiornamento una volta sola.
...
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento del puntatore record - CVE-2009-0549
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento del record dell'oggetto - CVE-2009-0557
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria di indicizzazione della matrice - CVE-2009-0558
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al sovraccarico basato su stack della copia di stringhe - CVE-2009-0559
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria di sterilizzazione dei campi - CVE-2009-0560
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata all'overflow di valori interi dei record - CVE-2009-0561
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento del puntatore record - CVE-2009-1134
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Convertitore file in formato XML aperto di Microsoft Office per Mac
</td>
<td style="border:1px solid black;">
**Importante**  
Esecuzione di codice in modalità remota
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0549).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento del puntatore record - CVE-2009-0549
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento del puntatore record - CVE-2009-0549
...
-   Non aprire o **salvare** file Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento del puntatore record - CVE-2009-0549
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0557](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0557).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento del record dell'oggetto - CVE-2009-0557
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento del record dell'oggetto - CVE-2009-0557
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento del record dell'oggetto - CVE-2009-0557
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0558](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0558).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria di indicizzazione della matrice - CVE-2009-0558
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di indicizzazione della matrice - CVE-2009-0558

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   Non aprire o salvare file Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di indicizzazione della matrice - CVE-2009-0558
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0559](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0559).

#### Fattori attenuanti della vulnerabilità legata al sovraccarico basato su stack della copia di stringhe – CVE-2009-0559
...
#### Soluzioni alternative per la vulnerabilità legata al sovraccarico basato su stack della copia di stringhe – CVE-2009-0559

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   Non aprire o salvare file Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti relative alla vulnerabilità legata al sovraccarico basato su stack della copia di stringhe – CVE-2009-0559
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0560](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0560).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria di sterilizzazione dei campi - CVE-2009-0560
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di sterilizzazione dei campi - CVE-2009-0560
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di sterilizzazione dei campi - CVE-2009-0560
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0561](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0561).

#### Fattori attenuanti della vulnerabilità legata all'overflow di valori interi dei record - CVE-2009-0561
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow di valori interi dei record - CVE-2009-0561
...
#### Domande frequenti sulla vulnerabilità legata all'overflow di valori interi dei record - CVE-2009-0561
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-1134](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1134).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento del puntatore record - CVE-2009-1134
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento del puntatore record - CVE-2009-1134
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento del puntatore record - CVE-2009-1134
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/969683">articolo della Microsoft Knowledge Base 969683</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/969680">articolo della Microsoft Knowledge Base 969680</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Excel 2003:<br />
Vedere l'<a href="http://support.microsoft.com/kb/969681">articolo della Microsoft Knowledge Base 969681</a>.<br />
<br />
Per Excel Viewer 2003:<br />
Vedere l'<a href="http://support.microsoft.com/kb/969685">articolo della Microsoft Knowledge Base 969685</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Excel 2007:<br />
Vedere l'<a href="http://support.microsoft.com/kb/969682">articolo della Microsoft Knowledge Base 969682</a>.<br />
<br />
Per Excel Viewer:<br />
Vedere l'<a href="http://support.microsoft.com/kb/969686">articolo della Microsoft Knowledge Base 969686</a>.<br />
<br />
Per il pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007<br />
Vedere l'<a href="http://support.microsoft.com/kb/969679">articolo della Microsoft Knowledge Base 969679</a>.<br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/969737">articolo della Microsoft Knowledge Base 969737</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Bing Liu di [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) di Fortinet per aver segnalato la vulnerabilità legata al danneggiamento del puntatore record (CVE-2009-0549)  
-   Bing Liu di [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) di Fortinet per aver segnalato la vulnerabilità legata al danneggiamento del record dell'oggetto (CVE-2009-0557)  
-   Carsten H. Eiram di [Secunia](http://secunia.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria di indicizzazione della matrice (CVE-2009-0558)  
-   [TELUS Security Labs Vulnerability Research Team](http://telussecuritylabs.com/) per aver segnalato la vulnerabilità legata al sovraccarico basato su stack della copia di stringhe (CVE-2009-0559)  
-   Bing Liu di [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) di Fortinet per aver segnalato la vulnerabilità legata al danneggiamento della memoria di sterilizzazione dei campi (CVE-2009-0560)  
-   Sean Larsson e Joshua Drake di [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato la vulnerabilità legata all'overflow dei valori interi dei record (CVE-2009-0561)  
-   Carsten H. Eiram di [Secunia](http://secunia.com/) per aver segnalato la vulnerabilità legata all'overflow dei valori interi dei record (CVE-2009-0561)  
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) per aver segnalato la vulnerabilità legata al danneggiamento del puntatore record (CVE-2009-1134)
...
-   V1.1 (17 giugno 2009): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 969462 nella sottosezione Problemi noti del Riepilogo.
