---
TOCTitle: 'MS09-066'
Title: 'Bollettino Microsoft sulla sicurezza MS09-066 - Importante'
ms:assetid: 'ms09-066'
ms:contentKeyID: 61240431
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-066(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-066 - Importante
==========================================================

Una vulnerabilità in Active Directory può consentire un attacco di tipo Denial of Service (973309)
--------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per Active Directory, ADAM e AD LDS in tutte le edizioni supportate di Microsoft Windows 2000 Server, Windows XP, Windows Server 2003 e Windows Server 2008. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno della presente sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Active Directory, ADAM e AD LDS elaborano le richieste LDAP o LDAP non valide. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'overflow dello stack di ricorsione LSASS - CVE-2009-1928  
</th>
<th style="border:1px solid black;" >
...
<span></span>
È presente una vulnerabilità nelle implementazioni di Active Directory in Microsoft Windows 2000 Server, Windows Server 2003 e Windows Server 2008. Tale vulnerabilità è presente anche nelle implementazioni di Active Directory Application Mode (ADAM) installato in Windows XP e Windows Server 2003 e di Active Directory Lightweight Directory Service (AD LDS) installato in Windows Server 2008. La vulnerabilità è dovuta all'esaurimento dello spazio nello stack durante l'esecuzione di alcuni tipi di richieste LDAP o LDAPS. Un utente malintenzionato potrebbe sfruttare la vulnerabilità impedendo al sistema interessato di rispondere alle richieste.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-1928](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1928).

#### Fattori attenuanti della vulnerabilità legata all'overflow dello stack di ricorsione - CVE-2009-1928
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow dello stack di ricorsione - CVE-2009-1928
...
#### Domande frequenti sulla vulnerabilità legata all'overflow dello stack di ricorsione - CVE-2009-1928
...
Il servizio LDAP elabora richieste LDAP o LDAP specifiche in maniera errata, pertanto può causare l'esaurimento dello spazio nello stack.
...
Per impostazione predefinita, il traffico LDAP viene trasmesso senza protezione. Tuttavia, è possibile garantire la riservatezza e la protezione del traffico LDAP da eventuali modifiche utilizzando la tecnologia SSL (Secure Sockets Layer)/TLS (Transport Layer Security). Gli amministratori possono attivare LDAP su SSL (LDAPS) tramite l'installazione di un certificato digitale correttamente formattato da un'Autorità di certificazione di Microsoft o diversa da Microsoft, seguendo le indicazioni riportate nell'[articolo della Microsoft Knowledge Base 321051](http://support.microsoft.com/kb/321051).
...
**Come posso confermare se il mio server esegue il servizio di LDAP se utilizzo l'Active Directory**?  
...
Un utente malintenzionato può sfruttare la vulnerabilità impedendo al sistema di rispondere alle richieste e forzandone il riavvio.

**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità?**  
Un utente malintenzionato può tentare di sfruttare la vulnerabilità inviando pacchetti LDAP o LDAPS appositamente predisposti al server ADAM, AD LDS o Active Directory. Per Microsoft Windows 2000 Server, qualsiasi utente anonimo con accesso alla rete di destinazione può inviare un pacchetto di rete appositamente predisposto al sistema interessato per sfruttare questa vulnerabilità. Su tutte le altre le piattaforme interessate, l'utente malintenzionato deve essere in possesso di credenziali di autenticazione valide per sfruttare la vulnerabilità.

**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**  
Lightweight Directory Access Protocol (LDAP) è un requisito per Active Directory, ADAM e AD LDS. Pertanto, qualsiasi sistema che esegue un server ADAM, AD LDS o Active Directory è interessato da questa vulnerabilità.

**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve la vulnerabilità elaborando correttamente le richieste LDAP o LDAP non valide.
...
<td style="border:1px solid black;">Per Active Directory installato in Microsoft Windows 2000 Server:<br />
...
<td style="border:1px solid black;">Per Active Directory installato in Microsoft Windows Server 2000, utilizzare <strong>Installazione applicazioni</strong> nel pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB973037$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/default.aspx?ln=it">articolo della Microsoft Knowledge Base 973037</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Active Directory Application Mode (ADAM) installato in Windows XP Service Pack 2 e Windows XP Service Pack 3:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Selezionare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB973039$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/973039">articolo della Microsoft Knowledge Base 973039</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo della chiave del Registro di sistema</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Per Active Directory, utilizzare <strong>Installazione applicazioni</strong> nel pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB973037$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Active Directory Application Mode (ADAM), utilizzare <strong>Installazione applicazioni</strong> nel pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB973039$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Active Directory in Windows Server 2003, vedere l'<a href="http://support.microsoft.com/default.aspx?ln=it">articolo della Microsoft Knowledge Base 973037</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Active Directory Application Mode (ADAM) in Windows Server 2003, vedere l'<a href="http://support.microsoft.com/kb/973039">articolo della Microsoft Knowledge Base 973039</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo della chiave del Registro di sistema</strong></td>
<td style="border:1px solid black;">Per Active Directory installato in Windows Server 2003:<br />
