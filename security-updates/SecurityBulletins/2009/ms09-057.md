---
TOCTitle: 'MS09-057'
Title: 'Bollettino Microsoft sulla sicurezza MS09-057 - Importante'
ms:assetid: 'ms09-057'
ms:contentKeyID: 61240422
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-057(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-057 - Importante
==========================================================
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui il controllo ActiveX del servizio di indicizzazione elabora gli URL. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=b34d94b5-b828-4e16-a636-04344c60d945)                     | Esecuzione di codice in modalità remota     | Importante                   | [MS06-053](http://go.microsoft.com/fwlink/?linkid=70257) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=768fd74e-0a2f-4353-ac22-65d0d6321739)     | Esecuzione di codice in modalità remota     | Importante                   | [MS06-053](http://go.microsoft.com/fwlink/?linkid=70257) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=270ec100-5ba1-4f8c-aa36-105d30ad57bf)        | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                  |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=78072164-84d1-44da-8ede-2a9d212d47a9)                        | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                  |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8aa1f97d-ad53-4450-bb93-4a147dd10a87)            | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                  |
| [Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=fb5678b9-5ef1-42db-902e-c9ea02880e0a) | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                  |
...
<span></span>
**Il servizio di indicizzazione è installato su Windows per impostazione predefinita?**  
Il servizio di indicizzazione è un componente non-predefinito che deve essere installato manualmente dall'amministratore perché il sistema sia vulnerabile. La vulnerabilità può essere sfruttata su tutte le versioni interessate di Microsoft Windows 2000, Windows XP e Windows Server 2003 se il servizio di indicizzazione non è in esecuzione, sebbene debba essere stato installato manualmente.
...
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria nel servizio di indicizzazione - CVE-2009-2507</th>
...
Vulnerabilità legata al danneggiamento della memoria nel servizio di indicizzazione - CVE-2009-2507  
---------------------------------------------------------------------------------------------------
  
<span></span>
Nel servizio di indicizzazione nei sistemi Windows esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. La vulnerabilità è dovuta alla gestione non corretta del contenuto Web appositamente predisposto da parte di un controllo ActiveX compreso nel servizio. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-2507](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2507).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria nel servizio di indicizzazione - CVE-2009-2507
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.  
-   Non è possibile sfruttare la vulnerabilità automaticamente per posta elettronica Il file dannoso può essere inviato come allegato a un messaggio di posta elettronica, ma l'utente malintenzionato deve convincere l'utente ad aprire l'allegato al fine di sfruttare la vulnerabilità.  
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria nel servizio di indicizzazione - CVE-2009-2507
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Annullare la registrazione ixsso.dll**
  
    1.  Fare clic sul pulsante **Start**, scegliere **Esegui**, digitare **"%SystemRoot%\\System32\\regsvr32.exe" /u ixsso.dll** quindi fare clic su **OK**.  
    ...
    **Effetto della soluzione alternativa.** Il servizio di indicizzazione di Windows non è in grado di creare un catalogo indicizzato per facilitare una ricerca efficiente e rapida. L'esecuzione delle ricerche potrebbe richiedere più tempo.
  
    **Per annullare il risultato della soluzione alternativa.**
  
    1.  Fare clic sul pulsante **Start**, scegliere **Esegui**, digitare **"%SystemRoot%\\System32\\regsvr32.exe" ixsso.dll** quindi fare clic su **OK**.  
...
-   **Non consentire l'esecuzione dell'oggetto COM del controllo ActiveX del servizio di indicizzazione in Internet Explorer**
  
    È possibile disabilitare ogni tentativo di creare un'istanza dell'oggetto COM del controllo ActiveX del servizio di indicizzazione in Internet Explorer impostando il kill bit per il controllo nel Registro di sistema.
    ...
    **Avvertenza** L'utilizzo non corretto dell'Editor del Registro di sistema potrebbe causare problemi tali da rendere necessaria la reinstallazione del sistema operativo. Microsoft non garantisce la risoluzione di problemi dovuti a un utilizzo non corretto dell'Editor del Registro di sistema. È quindi necessario utilizzare questo strumento con grande attenzione.
    ...
    Per impostare il kill bit per il controllo ActiveX del servizio di indicizzazione, che ha il valore CLSID {A4463024-2B6F-11D0-BFBC-0020F8008024}, incollare il seguente testo in un editor di testo come Blocco note. Successivamente, salvare il file utilizzando l'estensione di nome file reg.
    ...
    **Impatto della soluzione alternativa**: Internet Explorer non è più in grado di richiamare il controllo ActiveX del servizio di indicizzazione.
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria nel servizio di indicizzazione - CVE-2009-2507
...
La vulnerabilità è causata da un componente ActiveX incluso nel servizio di indicizzazione che non gestisce correttamente il contenuto Web appositamente predisposto.
  
**Che cos'è il servizio di indicizzazione?**    
Il Servizio di indicizzazione è un servizio di base per Microsoft Windows che estrae il contenuto dai file e crea un catalogo indicizzato per facilitare una ricerca efficiente e rapida. Il Servizio di indicizzazione può estrarre informazioni di testo e proprietà dai file sull'host locale e sugli host remoti in rete. I file possono essere semplicemente membri di un file system selezionato o far parte di un sito Web virtuale ospitato, per esempio, da Internet Information Services (IIS).
...
Un utente malintenzionato può sfruttare questa vulnerabilità creando una pagina Web dannosa contenente uno script per caricare ed eseguire un binario vulnerabile tramite un oggetto COM del servizio di indicizzazione. Se il computer della vittima contiene il binario vulnerabile, all'apertura della pagina Web, il binario viene caricato ed eseguito dal componente ActiveX, concedendo all'utente malintenzionato l'accesso al sistema client con i privilegi dell'utente durante l'esplorazione della pagina Web.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi che dispongono del servizio di indicizzazione abilitato sono più esposti al rischio di attacchi basati sulla rete o sul sistema locale. Se il servizio di indicizzazione non è abilitato, il sistema non sarà interessato da questa vulnerabilità. Nessuno dei sistemi interessati abilita il servizio di indicizzazione per impostazione predefinita.
...
| **Distribuzione**                                  |                                                                                                                                                                   |  
| Installazione senza intervento dell'utente         | Windows2000-kb969059-x86-enu /quiet                                                                                                                               |  
| Installazione senza riavvio                        | Windows2000-kb969059-x86-enu /norestart                                                                                                                           |  
| Aggiornamento del file di registro                 | kb969059.log                                                                                                                                                      |  
...
| **Informazioni per la rimozione**                  | Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB969059$\\Spuninst |  
| **Informazioni sui file**                          | Vedere l'[articolo della Microsoft Knowledge Base 969059](http://support.microsoft.com/kb/969059)                                                                 |  
| **Controllo delle chiavi del Registro di sistema** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\KB969059\\Filelist                                                                              |
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB969059$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/969059">articolo della Microsoft Knowledge Base 969059</a></td>
</tr>
<tr class="even">
...
<strong>Nota</strong> È possibile evitare di riavviare il sistema per Windows Server 2003 arrestando il servizio di indicizzazione, installando l'aggiornamento e riavviando il servizio di indicizzazione. Se il servizio di indicizzazione non è stato arrestato prima dell'installazione dell'aggiornamento, il riavvio del sistema è ancora necessario.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Funzionalità di patch a caldo</td>
...
-   Yamata Li di [Palo Alto Networks](http://www.paloaltonetworks.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria nel servizio di indicizzazione (CVE-2009-2507)
