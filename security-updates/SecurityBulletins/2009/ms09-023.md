---
TOCTitle: 'MS09-023'
Title: 'Bollettino Microsoft sulla sicurezza MS09-023 - Medio'
ms:assetid: 'ms09-023'
ms:contentKeyID: 61240390
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-023(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-023 - Medio
=====================================================
...
Questo aggiornamento per la protezione è considerato di livello moderato per il componente Ricerca di Windows installato in tutte le edizioni supportate di Windows XP e Windows Server 2003. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno di questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Ricerca di Windows limita l'ambiente in cui vengono eseguiti gli script. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| Windows XP Service Pack 2 e Windows XP Service Pack 3 | [Ricerca di Windows 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=759f22cb-ea7f-49dd-a200-19cb83fffd8d) | Intercettazione di informazioni personali   | Moderato                     | Nessuno                                       |
| Windows XP Professional x64 Edition Service Pack 2    | [Ricerca di Windows 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=50c56dd6-c34d-4632-a779-8bcf8fdb341b) | Intercettazione di informazioni personali   | Moderato                     | Nessuno                                       |
| Windows Server 2003 Service Pack 2                    | [Ricerca di Windows 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=e72ef31f-5161-4fe6-8ed3-6206e02cef31) | Intercettazione di informazioni personali   | Moderato                     | Nessuno                                       |
| Windows Server 2003 x64 Edition Service Pack 2        | [Ricerca di Windows 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=7ffc3680-f9bf-423b-96a7-102f4cc9c240) | Intercettazione di informazioni personali   | Moderato                     | Nessuno                                       |

**Software non interessato**

| Sistema operativo                                                                                              | Componente             |
|----------------------------------------------------------------------------------------------------------------|------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                          | Ricerca di Windows 4.0 |
| Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2                                     | Ricerca di Windows 4.0 |
| Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2 | Ricerca di Windows 4.0 |
| Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2             | Ricerca di Windows 4.0 |
| Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2                       | Ricerca di Windows 4.0 |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'esecuzione di script in Ricerca di Windows – CVE-2009-0239</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Ricerca di Windows 4.0 installato in Windows XP Service Pack 2</td>
...
<tr class="even">
<td style="border:1px solid black;">Ricerca di Windows 4.0 installato in Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Moderato</strong> <br />
Intercettazione di informazioni personali</td>
<td style="border:1px solid black;"><strong>Moderato</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Ricerca di Windows 4.0 installato in Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Moderato</strong> <br />
Intercettazione di informazioni personali</td>
<td style="border:1px solid black;"><strong>Moderato</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Ricerca di Windows 4.0 installato in Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Moderato</strong> <br />
Intercettazione di informazioni personali</td>
<td style="border:1px solid black;"><strong>Moderato</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Ricerca di Windows 4.0 installato in Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Moderato</strong> <br />
Intercettazione di informazioni personali</td>
<td style="border:1px solid black;"><strong>Moderato</strong></td>
</tr>
...
Vulnerabilità legata all'esecuzione di script in Ricerca di Windows – CVE-2009-0239  
-----------------------------------------------------------------------------------
  
<span></span>
In Ricerca di Windows esiste una vulnerabilità legata all'intercettazione di informazioni personali dovuta alla modalità con cui vengono generate le anteprime file. Lo sfruttamento di questa vulnerabilità richiede un'interazione con l'utente. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire uno script HTML dannoso in grado di divulgare informazioni, inoltrare i dati utente a terze parti o accedere a tutti i dati sui sistemi interessati che erano accessibili all'utente connesso. Si noti che questa vulnerabilità non consente di eseguire codice o acquisire direttamente diritti utente più elevati, ma può essere utilizzata per produrre informazioni utili al fine di compromettere ulteriormente il sistema interessato.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0239).
  
#### Fattori attenuanti della vulnerabilità legata all'esecuzione di script in Ricerca di Windows – CVE-2009-0239
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per impostazione predefinita, il componente Ricerca di Windows non è preinstallato in Microsoft Windows XP e Windows Server 2003. È un componente facoltativo disponibile per il download.  
-   Il componente Ricerca di Windows installato nelle edizioni supportate di Windows Vista e Windows Server 2008 non è interessato da questa vulnerabilità.
  
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di script in Ricerca di Windows – CVE-2009-0239
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di script in Ricerca di Windows – CVE-2009-0239
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Questa vulnerabilità riguarda l'intercettazione di informazioni personali. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire uno script HTML dannoso in grado di divulgare informazioni, inoltrare i dati utente a terze parti o accedere a tutti i dati sui sistemi interessati che erano accessibili all'utente connesso. Si noti che questa vulnerabilità non consente di eseguire codice o acquisire direttamente diritti utente più elevati, ma potrebbe essere utilizzata per raccogliere informazioni utili al fine di compromettere ulteriormente il sistema interessato.
  
**Quali sono le cause di questa vulnerabilità?**    
Ricerca di Windows non limita correttamente l'ambiente in cui vengono eseguiti gli script.
  
**Che cosa significa Ricerca di Windows?**    
Tramite Ricerca di Windows è possibile compiere una ricerca immediata dei tipi di file e di dati più comuni, come posta elettronica, contatti, appuntamenti di calendario, documenti, foto, file multimediali e altri formati concessi da terze parti. Queste funzionalità consentono ai consumatori e agli information worker di trovare, gestire e organizzare in modo più efficiente la quantità crescente di dati presenti negli ambienti aziendali e casalinghi. Per ulteriori informazioni, vedere l'[articolo della Microsoft Knowledge Base 940157](http://support.microsoft.com/kb/940157).
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**    
Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire uno script dannoso sul lato client. L'eventuale esecuzione dello script avviene con un'autorizzazione speciale in genere non concessa ad uno script in esecuzione in una pagina Web. Tali autorizzazioni possono consentire la divulgazione di informazioni riservate, l'inoltro di dati utente a terze parti o l'accesso ai dati sui sistemi interessati a cui poteva accedere l'utente connesso.
  
**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
Per sfruttare questa vulnerabilità, un file appositamente predisposto deve essere collocato sul sistema o all'interno di un messaggio di posta elettronica in una casella di posta indicizzata. Se un utente esegue una ricerca che restituisce tale file come primo risultato, può verificarsi l'esecuzione di script HTML arbitrari. Se il file appositamente predisposto non è il primo risultato, l'utente deve selezionare e visualizzare il file in anteprima per far sì che la vulnerabilità venga sfruttata.
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Ricerca di Windows limita l'ambiente in cui vengono eseguiti gli script.
...
| Software                                                                                   | MBSA 2.1 |  
|--------------------------------------------------------------------------------------------|----------|  
| Ricerca in Windows 4.0 installato in Windows XP Service Pack 2 e Windows XP Service Pack 3 | No       |  
| Ricerca di Windows 4.0 installato in Windows XP Professional x64 Edition Service Pack 2    | No       |  
| Ricerca di Windows 4.0 installato in Windows Server 2003 Service Pack 2                    | No       |  
| Ricerca di Windows 4.0 installato in Windows Server 2003 x64 Edition Service Pack 2        | No       |
...
|--------------------------------------------------------------------------------------------|---------|--------------------|-------------------|----------------------------|  
| Ricerca in Windows 4.0 installato in Windows XP Service Pack 2 e Windows XP Service Pack 3 | No      | No                 | No                | No                         |  
| Ricerca di Windows 4.0 installato in Windows XP Professional x64 Edition Service Pack 2    | No      | No                 | No                | No                         |  
| Ricerca di Windows 4.0 installato in Windows Server 2003 Service Pack 2                    | No      | No                 | No                | No                         |  
| Ricerca di Windows 4.0 installato in Windows Server 2003 x64 Edition Service Pack 2        | No      | No                 | No                | No                         |
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB963093$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/963093">articolo della Microsoft Knowledge Base 963093</a></td>
</tr>
<tr class="even">
...
-   Yair Amit di [IBM Rational Application Security](http://www-01.ibm.com/software/rational/offerings/websecurity/webappsecurity.html) per aver segnalato la vulnerabilità legata all'esecuzione di script in Ricerca di Windows (CVE-2009-0239)
