---
TOCTitle: 'MS09-029'
Title: 'Bollettino Microsoft sulla sicurezza MS09-029 - Critico'
ms:assetid: 'ms09-029'
ms:contentKeyID: 61240396
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-029(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-029 - Critico
=======================================================
...
Data di pubblicazione: martedì 14 luglio 2009 | Aggiornamento: martedì 25 agosto 2009
...
L'aggiornamento risolve la vulnerabilità correggendo la modalità con cui il componente EOT di Microsoft Windows analizza il contenuto e i file che includono caratteri incorporati. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=1efbbd95-cd72-43df-b1ce-7e2b0c0cb9e2)                                                                                | Esecuzione di codice in modalità remota     | Critico                      | [MS06-002](http://go.microsoft.com/fwlink/?linkid=55919) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b)                                                                                            | Esecuzione di codice in modalità remota     | Critico                      | [MS06-002](http://go.microsoft.com/fwlink/?linkid=55919) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b)                                                                                            | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b8b019e-e6d8-4ce2-8f1f-3a6399b252d1)                                                                   | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=018ef53d-f78e-4084-940d-7c86bf59d83c)                                                                                   | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7f5fc902-f5d8-4a87-a73f-68632f9a0935)                                                                       | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7df0fce2-543c-4e82-85e6-012bfc8bf130)                                                            | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c67d85c4-25c5-4821-8db9-91764888f893)                                           | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f8ae651-59f7-48e1-9e8c-8e07c6806964)       | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=91f6ee68-0e39-4ec3-b4cd-45f05404e2fb)\*                 | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cdc3014-97b3-47b5-a6b7-cd0e12ec60e4)\*                           | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
| [Windows Server 2008 per sistemi basati su Itanium e Windows Server 2008 per sistemi basati su Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=03330a14-9cfa-4146-a3d3-4b7a76975d2d) | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                  |
...
<span></span>
**Perché Microsoft ha rivisto il bollettino in data 25 agosto 2009?**
Microsoft ha rivisto il bollettino per comunicare il nuovo rilascio dell'aggiornamento in lingua giapponese per tutte le versioni supportate di Windows XP al fine di risolvere un problema di qualità che potrebbe provocare causare l'arresto dello spooler di stampa. I clienti che hanno installato l'aggiornamento in lingua giapponese per Windows XP Service Pack 2, Windows XP Service Pack 3 o Windows XP Professional x64 Edition Service Pack 2 devono installare il nuovo aggiornamento offerto automaticamente per risolvere problema dello spooler descritto sopra e per conservare la soluzione contro la vulnerabilità descritta in questo bollettino. Il nuovo rilascio dell'aggiornamento non interessa altri aggiornamenti o altre impostazione internazionali.

**Perché Microsoft ha rilasciato di nuovo questo bollettino in data 11 agosto 2009?**
Microsoft ha rilasciato un nuovo bollettino per offrire nuovamente gli aggiornamenti per le piattaforme seguenti:
...
Gli aggiornamenti per la protezione rivisti risolvono un problema degli aggiornamenti per la protezione originali che causava l'arresto dello spooler di stampa in determinate situazioni. Gli aggiornamenti rivisti sono messi a disposizione attraverso tutti i canali di distribuzione già utilizzati per gli aggiornamenti originali, compresi gli Aggiornamenti automatici, Windows Update e Windows Server Update Services. Tuttavia, ai clienti di Windows XP che hanno già installato gli aggiornamenti originali non verranno offerti automaticamente gli aggiornamenti rivisti; essi andranno installati manualmente dall'Area download Microsoft. Ai clienti di Microsoft Windows 2000 e Windows Server 2003 verranno offerti automaticamente i nuovi aggiornamenti anche se in precedenza avevano installato gli aggiornamenti originali. I clienti che eseguono le piattaforme software interessate possono scaricare e installare i nuovi aggiornamenti manualmente. Microsoft consiglia di applicare l'aggiornamento immediatamente.

Per ulteriori informazioni su questo problema, consultare l'[articolo della Microsoft Knowledge Base 961371](http://support.microsoft.com/kb/961371).
...
**La versione Windows 7 Beta è interessata da questa vulnerabilità?**  
Sì. Queste vulnerabilità sono state segnalate dopo il rilascio di Windows 7 Beta. Ai clienti che utilizzano questa piattaforma si consiglia di scaricare l'aggiornamento e di installarlo nei sistemi in uso
...
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow degli heap dei caratteri Embedded OpenType - CVE-2009-0231</th>
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2009-0232</th>
...
Vulnerabilità legata all'overflow degli heap dei caratteri Embedded OpenType - CVE-2009-0231  
--------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui la tecnologia dei caratteri Embedded OpenType (EOT) di Microsoft Windows analizza i record dei dati nei caratteri incorporati appositamente predisposti. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0231](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0231).
  
#### Fattori attenuanti della vulnerabilità legata all'overflow degli heap dei caratteri Embedded OpenType - CVE-2009-0231
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow degli heap dei caratteri Embedded OpenType - CVE-2009-0231
...
-   **Disattivare il supporto per l'analisi dei caratteri incorporati in Internet Explorer**
    ...
    Disattivare il supporto per l'analisi dei caratteri incorporati in Internet Explorer impedisce che l'applicazione venga utilizzata come un vettore di attacco. Tuttavia, altri vettori di attacco, come i caratteri incorporati all'interno di un documento di Microsoft Office, possono comunque essere sfruttati.
...
-   [Strumenti e impostazioni principali di Criteri di gruppo](http://technet.microsoft.com/it-it/library/cc784165.aspx)
    ...
    5.  Nella finestra di dialogo **Proprietà Internet**, accertarsi che l'area **Internet** sia selezionata, quindi premere **Livello personalizzato**.  
    6.  Scorrere fino a **Download** e impostare **Download dei caratteri** su **Chiedi conferma** o **Disattiva**.  
    7.  Premere **OK** per ritornare alla finestra di dialogo di Proprietà Internet.  
    ...
    **Utilizzo di uno script di distribuzione gestita**
    ...
    Per salvare questa impostazione su "Chiedi conferma" per le aree Internet e intranet locale incollare il testo seguente in un file .REG, quindi importarlo nei computer gestiti come parte del processi di distribuzione gestito dalla propria organizzazione:
    ...
    Per salvare questa impostazione su "Disattiva" per le aree Internet e intranet locale incollare il testo seguente in un file .REG, quindi importarlo nei computer gestiti come parte del processi di distribuzione gestito dalla propria organizzazione:
    ...
    **Effetto della soluzione alternativa.** I siti Web che utilizzando la tecnologia dei caratteri incorporati non vengono visualizzati correttamente.
...
-   **Negare l'accesso a T2EMBED.DLL**
    ...
    **Per WindowsVista** **e Windows Server 2008:**
    ...
    **Effetto della soluzione alternativa.** Le applicazioni che si basano sulla tecnologia dei caratteri incorporati non vengono visualizzati correttamente.
...
#### Domande frequenti sulla vulnerabilità legata all'overflow degli heap dei caratteri Embedded OpenType - CVE-2009-0231
...
In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato può inviare un messaggio con un file Microsoft Word o PowerPoint contenente un carattere EOT appositamente predisposto incorporato nel documento e convincere l'utente ad aprire o visualizzare in anteprima il file.
...
L'aggiornamento risolve il problema correggendo la modalità con cui il motore per caratteri Embedded OpenType analizza il contenuto e i file che includono caratteri incorporati.
...
Vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2009-0232  
---------------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui la tecnologia dei caratteri Embedded OpenType (EOT) di Microsoft Windows analizza le tabelle dei nomi nei caratteri incorporati appositamente predisposti. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0232).
  
#### Fattori attenuanti della vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2009-0232
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2009-0232
...
#### Domande frequenti sulla vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2009-0232
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo in remoto del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata da un overflow dei valori interi quando un componente di Microsoft Windows, il motore per caratteri Embedded OpenType, analizza le tabelle dei nomi all'interno di file e contenuto appositamente predisposti che contengono caratteri incorporati.
...
In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato può inviare un messaggio con un file Microsoft Word o PowerPoint contenente un carattere EOT appositamente predisposto come allegato e convincere l'utente ad aprire o visualizzare in anteprima il file.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB961371$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/961371">articolo della Microsoft Knowledge Base 961371</a></td>
</tr>
<tr class="even">
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato la vulnerabilità legata all'overflow degli heap dei caratteri Embedded OpenType (CVE-2009-0231)  
-   Thomas Garnier per aver segnalato la vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType (CVE-2009-0232).
...
-   V1.1 (15 luglio 2009): Sono state aggiornate le descrizioni dei requisiti di riavvio per tutti gli aggiornamenti nella sezione **Informazioni sull'aggiornamento** per chiarire alcuni casi, questo aggiornamento non richiede un riavvio.  
-   V1.2 (4 agosto 2009): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 961371 nella sottosezione Problemi noti del Riepilogo e sono stati rimossi i riferimenti alla soluzione di fix dalle sezioni delle soluzioni alternative per le entrambe vulnerabilità.  
-   V2.0 (11 agosto 2009): nuovo rilascio del bollettino per offrire nuovamente gli aggiornamenti per tutte le edizioni supportate di Microsoft Windows 2000, Windows XP e Windows Server 2003, per risolvere un problema noto degli aggiornamenti originali di queste piattaforme. Microsoft consiglia di applicare l'aggiornamento immediatamente.  
-   V2.1 (13 agosto 2009): Il bollettino è stato rivisto per chiarire la voce "Perché Microsoft ha rilasciato di nuovo questo bollettino in data 11 agosto 2009?" nella sezione **Domande frequenti sull'aggiornamento per la protezione** e per correggere i nomi file degli aggiornamenti rilasciati di nuovo nella sezione **Distribuzione dell'aggiornamento per la protezione**.  
-   V3.0 (25 agosto 2009): È stata aggiunta una voce alla sezione **Domande frequenti sull'aggiornamento per la protezione** per comunicare il nuovo rilascio dell'aggiornamento in lingua giapponese per Windows XP Service Pack 2, Windows XP Service Pack 3 e Windows XP Professional x64 Edition Service Pack 2. I clienti che necessitano dell'aggiornamento in lingua giapponese devono installare il nuovo aggiornamento. Il nuovo rilascio dell'aggiornamento non interessa altri aggiornamenti o altre impostazione internazionali.
