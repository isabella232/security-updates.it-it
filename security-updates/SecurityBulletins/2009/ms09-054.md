---
TOCTitle: 'MS09-054'
Title: 'Bollettino Microsoft sulla sicurezza MS09-054 - Critico'
ms:assetid: 'ms09-054'
ms:contentKeyID: 61240420
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-054(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-054 - Critico
=======================================================

Aggiornamento cumulativo per la protezione di Internet Explorer (974455)
------------------------------------------------------------------------

Data di pubblicazione: martedì 13 ottobre 2009 | Aggiornamento: mercoledì 28 ottobre 2009
...
Questo aggiornamento per la protezione è considerato critico per tutte le versioni supportate di Internet Explorer: Internet Explorer 5.01, Internet Explorer 6, Internet Explorer 6 Service Pack 1, Internet Explorer 7 e Internet Explorer 8. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve queste vulnerabilità modificando il modo in cui Internet Explorer elabora le intestazioni del flusso di dati, convalida gli argomenti e gestisce gli oggetti nella memoria. Per ulteriori informazioni su tali vulnerabilità, vedere la sottosezione Domande frequenti all'interno della sezione successiva **Informazioni sulle vulnerabilità**.
...
Questo aggiornamento contiene una modifica al sistema di difesa che consente a WinINET di utilizzare la protezione estesa per l'autenticazione. Per ulteriori informazioni, vedere l'[Advisory Microsoft sulla sicurezza 973811](http://technet.microsoft.com/security/advisory/973811).

Questo aggiornamento contiene anche una modifica al sistema di difesa per Internet Explorer 8 in Windows 7 e in Windows Server 2008 R2 che consente di risolvere i problemi resi pubblici [nell'Advisory Microsoft sulla sicurezza 973882](http://technet.microsoft.com/security/advisory/973882). Queste modifiche limitano gli attacchi noti all'interno di Internet Explorer 8 per i componenti e i controlli che sono stati sviluppati con le versioni di ATL descritte in questo advisory.

**Dove si trova la sezione Informazioni sui file?**  
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 974455](http://support.microsoft.com/kb/974455).
...
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento dell'intestazione del flusso di dati- CVE-2009-1547
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata alla gestione di componenti HTML - CVE-2009-2529
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2009-2530
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2009-2531
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento dell'intestazione del flusso di dati - CVE-2009-1547

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento dell'intestazione del flusso di dati - CVE-2009-1547
...
Quando Internet Explorer elabora un'intestazione del flusso di dati appositamente predisposta, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
L'aggiornamento modifica il modo in cui Internet Explorer elabora le intestazioni del flusso di dati.
...
<span></span>
Una vulnerabilità legata all'esecuzione di codice in modalità remota si presenta, in situazioni specifiche, quando Internet Explorer gestisce la convalida degli argomenti di una variabile. Un utente malintenzionato potrebbe sfruttare la vulnerabilità creando una pagina Web dannosa. Se un utente visualizza la pagina Web, la vulnerabilità potrebbe consentire l'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente connesso. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-2529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2529).

#### Fattori attenuanti della vulnerabilità legata alla gestione di componenti HTML – CVE-2009-2529
...
#### Soluzioni alternative per la vulnerabilità legata alla gestione di componenti HTML – CVE-2009-2529
...
-   **Disattivazione delle applicazioni browser XAML in Internet Explorer**
    ...
    È possibile contribuire a una protezione più efficace dai rischi connessi a questa vulnerabilità modificando le impostazioni affinché venga richiesta la conferma prima di eseguire le applicazioni browser XAML o affinché tali applicazioni vengano disattivate nell'area di protezione Internet e Intranet locale. A tale scopo, attenersi alla seguente procedura:
    ...
    **Impatto della soluzione alternativa.** La visualizzazione di una richiesta di conferma prima dell'esecuzione delle applicazioni browser XAML può avere effetti collaterali. Numerosi siti Web su Internet o su una rete Intranet utilizzano le applicazioni browser XAML per offrire funzionalità aggiuntive. Un sito di e-commerce o di online banking, ad esempio, può utilizzare applicazioni browser XAML per la visualizzazione dei menu, dei moduli d'ordine o degli estratti conto. La richiesta di conferma prima dell'esecuzione delle applicazioni browser XAML è un'impostazione globale per tutti i siti Internet e Intranet. Se si utilizza questa soluzione alternativa, le richieste di conferma verranno visualizzate di frequente. A ogni richiesta di conferma, se si ritiene che il sito da visitare sia attendibile, fare clic su **Sì** per consentire l'esecuzione delle applicazioni browser XAML. Se non si desidera che venga richiesta conferma per tutti i siti, utilizzare la procedura descritta in "Aggiungere i siti ritenuti attendibili all'area Siti attendibili di Internet Explorer".

    **Aggiungere i siti ritenuti attendibili all'area Siti attendibili di Internet Explorer**

    Dopo l'impostazione della richiesta di conferma prima dell'esecuzione delle applicazioni browser XAML nelle aree Internet e Intranet locale, è possibile aggiungere i siti ritenuti attendibili all'area Siti attendibili di Internet Explorer. In questo modo è possibile continuare a utilizzare i siti Web attendibili nel modo abituale, proteggendo al tempo stesso il sistema da eventuali attacchi dai siti non attendibili. Si raccomanda di aggiungere all'area Siti attendibili solo i siti effettivamente ritenuti attendibili.
...
#### Domande frequenti sulla vulnerabilità legata alla gestione di componenti HTML – CVE-2009-2529

**Se si utilizza Firefox, quale aggiornamento di Internet Explorer è necessario installare?**  
Se un sistema informatico è configurato per scaricare automaticamente gli aggiornamenti, l'aggiornamento corretto viene scaricato e messo a disposizione per l'installazione a seconda della configurazione degli Aggiornamenti automatici. Se un sistema informatico non è configurato per scaricare automaticamente gli aggiornamenti, gli utenti devono verificare quale versione del sistema operativo di Windows e di Internet Explorer è installata sul proprio sistema e scaricare gli aggiornamenti appropriati.

**Se si installa questo aggiornamento per la protezione, è necessario disattivare il plug-in di Windows Presentation Foundation in Firefox per essere protetti dalla vulnerabilità?**  
No. I clienti che hanno installato gli aggiornamenti per la protezione inclusi in questo bollettino sulla sicurezza sono protetti dalla vulnerabilità.

**Se l'aggiornamento per la protezione non è stato ancora installato, come è possibile disattivare il plug-in di Windows Presentation Foundation in Firefox?**  
Se l'aggiornamento non è stato ancora installato, è possibile disattivare il plug-in di Windows Presentation Foundation in Firefox per bloccare la vulnerabilità. Per fare questo, avviare il browser di Firefox, selezionare **Strumenti** dal menu a discesa, quindi fare clic su **Componenti aggiuntivi**. Selezionare l'icona **Plug-in** nella parte superiore della finestra Componenti aggiuntivi. Nell'elenco dei Plug-in, selezionare **Windows Presentation Foundation 3.5.30729.1** e fare clic su **Disattiva**.

**Se si disinstalla l'estensione .NET Framework Assistant, il plug-in di Windows Presentation Foundation viene disattivato o rimosso?**  
Se l'estensione .NET Framework Assistant viene disinstallata, il plug-in di Windows Presentation Foundation non viene disattivato o rimosso. I plug-in di .NET Framework Assistant e Windows Presentation Foundation sono controllati in diverse schermate della finestra di gestione componenti aggiuntivi di Firefox.

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente connesso. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

**Quali sono le cause di questa vulnerabilità?**  
In situazioni specifiche, Internet Explorer convalida gli argomenti in maniera errata. Di conseguenza, una pagina Web appositamente predisposta potrebbe essere visualizzata in maniera tale da permettere ad un utente malintenzionato di eseguire codice non autorizzato nel contesto dell'utente collegato.
...
**Se si utilizza Internet Explorer in Windows Server 2003 e Windows Server 2008, il problema ha una portata più limitata?**  
Sì. La [configurazione Protezione avanzata](http://msdn.microsoft.com/library/ms537180(vs.85).aspx) è costituita da un gruppo di impostazioni di Internet Explorer preconfigurate che riduce la probabilità che un utente o un amministratore scarichi ed esegua contenuto Web appositamente predisposto in un server. Questo è un fattore attenuante per i siti Web che non sono stati aggiunti all'area Siti attendibili di Internet Explorer. Consultare anche il documento relativo alla [gestione della Protezione avanzata di Internet Explorer](http://go.microsoft.com/fwlink/?linkid=92055).

**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento modifica il modo in cui Internet Explorer convalida gli argomenti.

**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**  
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2009-2529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2529).
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-2530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2530).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2009-2530
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2009-2530
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2009-2530
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-2531](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2531).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2009-2531
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2009-2531

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria non inizializzata - CVE-2009-2531
...
| Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2               | No      | No                | Vedere di seguito la **Nota su Windows** **Vista** **e Windows Server 2008** | No                         |
...
\*SMS 2.0 e SMS 2003 supportano tutte le versioni interessate di Internet Explorer ad eccezione di Internet Explorer 7 e Internet Explorer 8. Per ulteriori informazioni vedere l'[articolo della Microsoft Knowledge Base 924178](http://support.microsoft.com/kb/924178).
...
<td style="border:1px solid black;">Per Internet Explorer 5.01 Service Pack 4 in tutte le edizioni supportate di Windows 2000:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB974455-IE501SP4-20090925.120000$\Spuninst<br />
<br />
Per Internet Explorer 6 Service Pack 1 installato in tutte le edizioni supportate di Windows 2000:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB974455-IE6SP1-20090925.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/974455">articolo della Microsoft Knowledge Base 974455</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 per tutte le edizioni supportate di Windows XP:<br />
Selezionare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB974455$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie7updates\KB974455-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 per tutte le edizioni supportate di Windows XP:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\ie8updates\KB974455-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/974455">articolo della Microsoft Knowledge Base 974455</a></td>
...
\Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB974455$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
-   SkyLined di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata al danneggiamento dell'intestazione del flusso di dati (CVE-2009-1547)  
-   Mark Dowd di [IBM ISS X-Force](http://www.iss.net/) per aver segnalato la vulnerabilità legata alla gestione di componenti HTML (CVE-2009-2529)  
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria non inizializzata (CVE-2009-2530)  
-   Sam Thomas di [eshu.co.uk](http://www.tippingpoint.com/), collaboratore di [TippingPoint](http://www.zerodayinitiative.com/) e Zero Day Initiative, per aver segnalato la vulnerabilità legata al danneggiamento della memoria non inizializzata (CVE-2009-2531)
...
-   V1.1 (18 ottobre 2009): È stato rivisto il Riepilogo e sono state aggiunte alcune voci alle Domande frequenti per CVE-2009-2529 con lo scopo di fornire indicazioni agli utenti Firefox.  
-   V1.2 (19 ottobre 2009): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 974455 nella sottosezione Problemi noti del Riepilogo.  
-   V1.3 (28 ottobre 2009): È stato corretto un nodo nei nomi dei file di registro, nei nomi della cartella spuninst e nei valori della chiave del Registro per Microsoft Windows 2000.
