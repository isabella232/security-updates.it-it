---
TOCTitle: 'MS09-024'
Title: 'Bollettino Microsoft sulla sicurezza MS09-024 - Critico'
ms:assetid: 'ms09-024'
ms:contentKeyID: 61240391
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-024(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-024 - Critico
=======================================================
...
Data di pubblicazione: martedì 9 giugno 2009 | Aggiornamento: martedì 13 ottobre 2009
...
Questo aggiornamento per la protezione è considerato di livello critico per le edizioni supportate di Microsoft Office Word 2000 e di livello importante per le edizioni supportate di Microsoft Office Word 2002, Microsoft Office Word 2003 con il convertitore file di Microsoft Works 6 - 9 e Microsoft Office Word 2007 Service Pack 1 e Microsoft Works 8.5 e Microsoft Works 9. Per ulteriori informazioni, vedere la sottosezione, **Software interessato e Software non interessato**, in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Microsoft Office apre i file di Works. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<span></span>
**Perché Microsoft ha rivisto questo bollettino in data 13 ottobre 2009?**  
Microsoft ha rivisto questo bollettino per comunicare che all'aggiornamento per Works 9 sono state aggiunte versioni localizzate. Le lingue aggiuntive sono: croato, ceco, estone, lettone, lituano, macedone, slovacco, sloveno e ucraino. Works 9 non era disponibile in queste lingue quando questo bollettino è stato rilasciato inizialmente. I clienti che hanno già applicato l'aggiornamento originale a Works 9 non sono interessati da questa revisione.
...
**Anche l'articolo MS09-017 descrive alcune vulnerabilità di Microsoft Works 8.5 e Microsoft Works 9. Qual è la relazione tra MS09-017 e questo bollettino (MS09-024)?**  
I pacchetti di aggiornamento per la protezione di Microsoft Works 8.5 (KB967043) e Microsoft Works 9 (KB967044), illustrati in questo bollettino (MS09-024), risolvono anche le vulnerabilità descritte nel bollettino [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704). Gli utenti che utilizzano Microsoft Works 8.5 o Microsoft Works 9 dovranno installare i pacchetti di aggiornamento una volta sola.

**Che cos'è il convertitore file di Microsoft Works 6-9?**  
Il convertitore di Microsoft Works 6-9 consente a Microsoft Office Word 2003 di aprire, modificare e salvare i file in formato Elaboratore di testi di Works supportato dalle versioni 6, 7, 8, e 9 di Works. Per ulteriori informazioni, vedere [Convertitore file di Microsoft Works 6–9](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en).
...
<th style="border:1px solid black;" >
Vulnerabilità legata al sovraccarico del buffer del convertitore file - CVE-2009-1533
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Una vulnerabilità legata all'esecuzione di codice in modalità remota è dovuta al modo in cui Works per i convertitori dei documento di Windows gestisce i file di Works appositamente predisposti. La vulnerabilità può consentire l'esecuzione di codice in modalità remota se un utente apre un file .wps appositamente predisposto. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-1533](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1533).

#### Fattori attenuanti della vulnerabilità legata al sovraccarico del buffer del convertitore file - CVE-2009-1533

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   Microsoft Office System 2007 Service Pack 2 non è interessato dalla vulnerabilità.
-   Microsoft Office Word 2003 è interessato solo se il convertitore di Works è installato. Per ulteriori informazioni, vedere [Convertitore file di Microsoft Works 6–9](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en).
...
#### Soluzioni alternative per la vulnerabilità legata al sovraccarico del buffer del convertitore file - CVE-2009-1533

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Per Word 2000 e Word 2002, disabilitare il convertitore Works 4.x limitando l'accesso**

    Un amministratore può applicare un elenco di controllo di accesso ai convertitori interessati al fine di impedire che essi vengano caricati da Works e Office. Questa procedura previene efficacemente lo sfruttamento della vulnerabilità mediante questo vettore di attacco.

    **Per Microsoft Windows 2000, Windows XP e Windows Server 2003**
    ...
    **Effetto della soluzione alternativa.** Dopo avere implementato la soluzione alternativa, l'utente non sarà più in grado di aprire o salvare documenti Works 4.x. Se si tenta di aprire un documento Works 4.x viene visualizzato un messaggio di errore che comunica che il file potrebbe essere danneggiato.

-   **Per Word 2003 con il** [**Convertitore file di Microsoft Works 6–9**](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en) **e Word 2007, disabilitare il convertitore file di Works 6-9 limitando l'accesso**
    ...
    **Effetto della soluzione alternativa.** Dopo avere implementato la soluzione alternativa, l'utente non sarà più in grado di aprire o salvare documenti Works 6-9. Se si tenta di aprire un documento Works 6-9 viene visualizzato un messaggio di errore che comunica che il file potrebbe essere danneggiato.

#### Domande frequenti sulla vulnerabilità legata al sovraccarico del buffer del convertitore file - CVE-2009-1533

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

**Quali sono le cause di questa vulnerabilità?**  
L'apertura di un file di Works appositamente predisposto può danneggiare la memoria di sistema consentendo a un utente malintenzionato di eseguire codice non autorizzato.
...
Questa vulnerabilità può essere sfruttata solo se un utente apre un file di Works appositamente predisposto con una versione interessata del software.
...
In uno scenario di attacco dal Web, un sito Web potrebbe contenere un file di Works predisposto per sfruttare questa vulnerabilità. Un utente malintenzionato deve convincere gli utenti a visitare il sito Web e ad aprire un file di Works appositamente predisposto, in genere inducendoli a fare clic su un collegamento contenuto in un messaggio di posta elettronica o di messaggistica immediata che li indirizzi al sito Web dell'utente malintenzionato.
...
L'aggiornamento risolve la vulnerabilità modificando il modo in cui Microsoft Office apre i file di Works.
...
| Microsoft Office 2007 Service Pack 1 | No       |
...
|--------------------------------------|---------|--------------------|-------------------|----------------------------|
| Office 2000 Service Pack 3           | No      | No                 | No                | No                         |
| Office XP Service Pack 3             | No      | No                 | No                | No                         |
| Office 2003 Service Pack 3           | No      | No                 | No                | No                         |
| Microsoft Office 2007 Service Pack 1 | No      | No                 | No                | No                         |
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/957838">articolo della Microsoft Knowledge Base 957838</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/957646">articolo della Microsoft Knowledge Base 957646</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
#### Word 2003 (tutte le edizioni) con il convertitore file di Microsoft Works 6–9
...
<tr class="even">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Microsoft Office Word 2003 con il convertitore file di Microsoft Works 6-9:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/968326">articolo della Microsoft Knowledge Base 968326</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/969559">articolo della Microsoft Knowledge Base 969559</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Shaun Colley di [NGS Software](http://www.ngssoftware.com/) e Yuji Ukai di [Fourteenforty Research Institute, Inc.](http://www.fourteenforty.jp/) per aver segnalato la vulnerabilità legata al sovraccarico del buffer del convertitore file (CVE-2009-1533)
...
-   V1.1 (13 ottobre 2009): Il bollettino è stato rivisto per comunicare che all'aggiornamento per Works 9 sono state aggiunte versioni localizzate. I clienti che hanno già applicato l'aggiornamento originale a Works 9 non sono interessati da questa revisione.
