---
TOCTitle: 'MS09-067'
Title: 'Bollettino Microsoft sulla sicurezza MS09-067 - Importante'
ms:assetid: 'ms09-067'
ms:contentKeyID: 61240432
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-067(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-067 - Importante
==========================================================

Alcune vulnerabilità di Microsoft Office Excel possono consentire l'esecuzione di codice in modalità remota (972652)
--------------------------------------------------------------------------------------------------------------------
...
\*Per Microsoft Office Excel 2007 Service Pack 1 e Microsoft Office Excel 2007 Service Pack 2, oltre al pacchetto di aggiornamento per la protezione KB973593, gli utenti devono installare anche l'aggiornamento per la protezione per il [pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 Service Pack 1 e il pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa) (KB973704) per essere protetti dalle vulnerabilità descritte nel bollettino.
...
Sì. Dopo aver installato questo aggiornamento per la protezione, se un utente apre un file di Excel appositamente predisposto, Excel potrebbe chiudersi inaspettatamente, tuttavia le vulnerabilità risolte in questo aggiornamento non saranno sfruttabili.
...
**L'articolo MS09-068 descrive inoltre alcune vulnerabilità di Microsoft Office 2004 per MAC, Microsoft Office 2008 per MAC e del convertitore file in formato XML aperto per MAC. Qual è la relazione tra l'articolo MS09-068 e il presente bollettino (MS09-067)?**  
I pacchetti di aggiornamento per la protezione di Microsoft Office 2004 per Mac (KB976830), Microsoft Office 2008 per Mac (KB976828) e del convertitore file in formato XML aperto per Mac (KB976831), illustrati in questo bollettino (MS09-067), risolvono anche le vulnerabilità descritte nel bollettino MS09-068. Gli utenti che utilizzano Microsoft Office 2004 per Mac, Microsoft Office 2008 per Mac o il convertitore file in formato XML aperto per Mac dovranno installare i pacchetti di aggiornamento una volta sola.
...
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria cache in Excel - CVE-2009-3127
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria SxView in Excel - CVE-2009-3128
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria con record Featheader in Excel - CVE-2009-3129
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata all'overflow degli heap di analisi dei documenti Excel - CVE-2009-3130
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria di analisi delle formule in Excel - CVE-2009-3131
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata all'analisi degli indici in Excel - CVE-2009-3132
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria di analisi di documenti Excel - CVE-2009-3133
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata alla sterilizzazione dei campi in Excel - CVE-2009-3134
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Office Excel gestisce file di Excel appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-3127](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria cache in Excel - CVE-2009-3127
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria cache in Excel - CVE-2009-3127
...
-   **Utilizzare il criterio del blocco dei file di Microsoft Office per bloccare l'apertura di documenti di Office 2003 e versioni precedenti di dubbia provenienza**
    ...
    **Effetto della soluzione alternativa.** Gli utenti che hanno configurato il criterio del blocco dei file e non hanno configurato una "directory esente" come discusso nell'[articolo della Microsoft Knowledge Base 922848](http://support.microsoft.com/default.aspx?ln=it) non potranno aprire i file di Office 2003 o versioni precedenti in Office 2003 o Microsoft Office System 2007.
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria cache in Excel - CVE-2009-3127
...
È stata riscontrata una vulnerabilità nel modo in cui Microsoft Office Excel analizza il formato file di un foglio di calcolo di Excel durante l'apertura di un foglio di calcolo di Excel appositamente predisposto
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Office Excel gestisce i file di Excel appositamente predisposti contenenti un oggetto record non valido. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-3128](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria SxView in Excel - CVE-2009-3128
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria SxView in Excel - CVE-2009-3128
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria SxView in Excel - CVE-2009-3128
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-3129](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria record di Featheader in Excel - CVE-2009-3129
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria record di Featheader in Excel - CVE-2009-3129
...
-   **Utilizzare il criterio del blocco dei file di Microsoft Office per bloccare l'apertura di documenti di Office 2003 e versioni precedenti di dubbia provenienza**
    ...
    **Nota** La modifica non corretta del Registro di sistema potrebbe provocare problemi tali da rendere necessaria la reinstallazione del sistema operativo. Microsoft non garantisce la risoluzione di problemi dovuti a una modifica non corretta del Registro di sistema. È quindi necessario eseguire questa modifica con grande attenzione.
    ...
    -   Per Office 2007
        ...
        "BinaryFiles"=dword:00000001
        **Nota** Per utilizzare "FileOpenBlock" con Office 2007 è necessario applicare tutti gli aggiornamenti per la protezione di Office 2007 più recenti a partire da maggio 2007.
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria record di Featheader in Excel - CVE-2009-3129
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Office Excel gestisce file di Excel appositamente predisposti con record BIFF non validi. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-3130](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130).

#### Fattori attenuanti della vulnerabilità legata all'overflow degli heap di analisi dei documenti Excel - CVE-2009-3130
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow degli heap di analisi dei documenti Excel - CVE-2009-3130

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   Non aprire file Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata all'overflow degli heap di analisi dei documenti Excel - CVE-2009-3130

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo in remoto del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità è causata da un'errata gestione da parte di Excel dei file con record BIFF (Binary File Format) non validi, che possono provocare il danneggiamento della memoria in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Office Excel analizza i documenti contenenti una formula appositamente predisposta incorporata in una cella. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare i dati, oppure creare nuovi account con diritti utente completi nel contesto dell'utente connesso.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-3131](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria di analisi delle formule in Excel - CVE-2009-3131
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di analisi delle formule in Excel - CVE-2009-3131

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   Non aprire file Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di analisi delle formule in Excel - CVE-2009-3131

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo in remoto del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

**Quali sono le cause di questa vulnerabilità?**  
È stata riscontrata una vulnerabilità nel modo in cui Microsoft Office Excel analizza il foglio di calcolo di Excel contenente una formula appositamente predisposta.
...
<span></span>
In Microsoft Office Excel è stata riscontrata una vulnerabilità legata all'esecuzione di codice in modalità remota. Tale vulnerabilità è il risultato di un processo di corruzione del puntatore che si verifica durante il caricamento di formule di Excel. La vulnerabilità può consentire l'esecuzione di codice in modalità remota durante l'apertura di un file di Excel appositamente predisposto contenente una formula non valida. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-3132](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132).

#### Fattori attenuanti della vulnerabilità legata all'analisi degli indici in Excel - CVE-2009-3132
...
#### Soluzioni alternative per la vulnerabilità legata all'analisi degli indici in Excel - CVE-2009-3132

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   Non aprire file Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata all'analisi degli indici in Excel - CVE-2009-3132
...
<span></span>
In Microsoft Office Excel è stata riscontrata una vulnerabilità legata all'esecuzione di codice in modalità remota. Tale vulnerabilità è il risultato di un processo di corruzione della memoria che si verifica durante il caricamento di record di Excel. La vulnerabilità può consentire l'esecuzione di codice in modalità remota durante l'apertura di un file di Excel appositamente predisposto contenente un oggetto non valido. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-3133](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria di analisi di documenti Excel - CVE-2009-3133
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di analisi di documenti Excel - CVE-2009-3133

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   Non aprire file Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di analisi di documenti Excel - CVE-2009-3133
...
<span></span>
In Microsoft Office Excel è stata riscontrata una vulnerabilità che può consentire l'esecuzione di codice in modalità remota durante l'apertura di un file Excel appositamente predisposto che contenga un oggetto record non valido. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-3134](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134).

#### Fattori attenuanti della vulnerabilità legata alla sterilizzazione dei campi in Excel - CVE-2009-3134
...
#### Soluzioni alternative per la vulnerabilità legata alla sterilizzazione dei campi in Excel - CVE-2009-3134
...
#### Domande frequenti sulla vulnerabilità legata alla sterilizzazione dei campi in Excel - CVE-2009-3134
...
| Software                                                                                                                                                                                                                        | MBSA 2.1.1 |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| Microsoft Office Excel 2002 Service Pack 3                                                                                                                                                                                      | No         |
| Microsoft Office Excel 2003 Service Pack 3                                                                                                                                                                                      | No         |
| Microsoft Office Excel 2007 Service Pack 1 e Microsoft Office Excel 2007 Service Pack 2                                                                                                                                         | No         |
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|-------------------|-------------------|----------------------------|
| Microsoft Office Excel 2002 Service Pack 3                                                                                                                                                                                      | No      | No                | No                | No                         |
| Microsoft Office Excel 2003 Service Pack 3                                                                                                                                                                                      | No      | No                | No                | No                         |
| Microsoft Office Excel 2007 Service Pack 1 e Microsoft Office Excel 2007 Service Pack 2                                                                                                                                         | No      | No                | No                | No                         |
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/973471">articolo della Microsoft Knowledge Base 973471</a></td>
</tr>
<tr class="even">
...
#### Excel 2003 (tutte le edizioni) e Excel Viewer 2003
...
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Excel 2003:<br />
Vedere l'<a href="http://support.microsoft.com/kb/973475">articolo della Microsoft Knowledge Base 973475</a><br />
<br />
Per Excel Viewer 2003:<br />
Vedere l'<a href="http://support.microsoft.com/kb/973484">articolo della Microsoft Knowledge Base 973484</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Excel 2007:<br />
Vedere l'<a href="http://support.microsoft.com/kb/973593">articolo della Microsoft Knowledge Base 973593</a><br />
<br />
Per Excel Viewer:<br />
Vedere l'<a href="http://support.microsoft.com/kb/973707">articolo della Microsoft Knowledge Base 973707</a><br />
<br />
Per il pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007<br />
Vedere l'<a href="http://support.microsoft.com/kb/973704">articolo della Microsoft Knowledge Base 973704</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Bing Liu di [FortiGuard Labs di Fortinet](http://www.fortiguard.com) per aver segnalato la vulnerabilità legata al danneggiamento della memoria cache in Excel (CVE-2009-3127)  
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria cache in Excel (CVE-2009-3127)  
-   Bing Liu di [FortiGuard Labs di Fortinet](http://www.fortiguard.com) per aver segnalato la vulnerabilità legata al danneggiamento della memoria SxView in Excel (CVE-2009-3128)  
-   Sean Larsson di [VeriSign iDefense Labs](http://labs.idefense.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria record di Featheader in Excel (CVE-2009-3129)  
-   Nicolas Joly di [VUPEN Security](http://www.vupen.com/) per aver segnalato la vulnerabilità legata all'overflow degli heap di analisi dei documenti Excel (CVE-2009-3130)  
-   Nicolas Joly di [VUPEN Security](http://www.vupen.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria di analisi delle formule in Excel (CVE-2009-3131)  
-   Nicolas Joly di [VUPEN Security](http://www.vupen.com/) per aver segnalato la vulnerabilità legata all'analisi degli indici in Excel (CVE-2009-3132)  
-   Nicolas Joly di [VUPEN Security](http://www.vupen.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria di analisi di documenti Excel (CVE-2009-3133)  
-   Bing Liu di [FortiGuard Labs di Fortinet](http://www.fortiguard.com) per aver segnalato la vulnerabilità legata alla sterilizzazione dei campi in Excel (CVE-2009-3134)
