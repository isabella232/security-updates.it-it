---
TOCTitle: 'MS09-011'
Title: 'Bollettino Microsoft sulla sicurezza MS09-011 - Critico'
ms:assetid: 'ms09-011'
ms:contentKeyID: 61240378
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-011(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-011 - Critico
=======================================================
...
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 961373](http://support.microsoft.com/kb/961373).
...
<th style="border:1px solid black;" >
Vulnerabilità legata alla decompressione dei file MJPEG - CVE-2009-0084
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2 con DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Critico**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2 con DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Critico**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2 con DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Critico**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 con SP1 per sistemi basati su Itanium e Windows Server 2003 con SP2 per sistemi basati su Itanium con DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Critico**   
Esecuzione di codice in modalità remota
...
<span></span>
È stata riscontrata una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft DirectShow gestisce i file dei formati supportati. Tale vulnerabilità può consentire l'esecuzione di codice durante l'apertura di un file MJPEG appositamente predisposto. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-0084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0084).

#### Fattori attenuanti della vulnerabilità legata alla decompressione dei file MJPEG - CVE-2009-0084

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   In uno scenario di attacco dal Web un utente malintenzionato deve pubblicare un sito Web contenente una pagina utilizzata per sfruttare la vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare un sito Web dannoso, l'utente malintenzionato dovrebbe convincere le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento che le indirizzi al sito Web di origine dell'attacco. Dopo avere fatto clic sul collegamento, alle vittime viene richiesto di eseguire diverse operazioni. L'attacco può avere luogo solo se le vittime eseguono tali operazioni.
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Soluzioni alternative per la vulnerabilità legata alla decompressione dei file MJPEG - CVE-2009-0084

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Disattivare la decodifica del contenuto di file MJPEG in Quartz.dll**
    ...
    **Utilizzo del metodo interattivo**
    ...
    2.  Individuare e fare clic sulla seguente sottochiave del Registro di sistema: HKEY\_CLASSES\_ROOT\\CLSID\\{301056D0-6DFF-11D2-9EEB-006008039E37}
    3.  Fare clic sul menu **File** e selezionare **Esporta**.
    4.  Nella finestra di dialogo Esporta file del Registro di sistema, digitare **MJPEG\_Decoder\_Backup.reg** e selezionare **Salva**.
    ...
    **Effetto della soluzione alternativa. **Viene disattivata la riproduzione del contenuto dei file MJPEG.
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    3.  Nella finestra di dialogo Importa file del Registro di sistema, selezionare **MJPEG\_Decoder\_Backup.reg** e fare clic su **Apri**.
...
-   **Annullare la registrazione di quartz.dll**
    ...
    **Effetto della soluzione alternativa. **Windows Media Player non sarà in grado di riprodurre file AVI o WAV.
...
#### Domande frequenti sulla vulnerabilità legata alla decompressione dei file MJPEG - CVE-2009-0084
...
Il componente DirectShow di Microsoft non gestisce correttamente file compressi appositamente predisposti.
...
Questa vulnerabilità può essere sfruttata solo se un utente apre un file MJPEG appositamente predisposto o riceve un flusso di contenuti appositamente predisposto da un sito Web o da qualunque applicazione fornisca contenuti Web.
...
L'aggiornamento risolve il problema correggendo il modo in cui DirectShow decomprime i file multimediali.
...
<td style="border:1px solid black;">Per Microsoft Windows 2000 Service Pack 4 con DirectX 8.1:<br />
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/961373">articolo della Microsoft Knowledge Base 961373</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza riavvio</td>
<td style="border:1px solid black;">Per tutte le edizioni a 32 bit supportate di Windows XP Service Pack 3 con DirectX 9.0, DirectX 9.0a, DirectX 9.0b o DirectX 9.0c:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB961373$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/961373">articolo della Microsoft Knowledge Base 961373</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per tutte le edizioni a 32 bit supportate di Windows Server 2003 con DirectX 9.0, DirectX 9.0a, DirectX 9.0b o DirectX 9.0c:<br />
WindowsServer2003-KB961373-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per tutte le edizioni x64 supportate di Windows Server 2003 con DirectX 9.0, DirectX 9.0a, DirectX 9.0b o DirectX 9.0c:<br />
WindowsServer2003.WindowsXP-KB961373-x64-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per tutte le edizioni basate su Itanium supportate di Windows Server 2003 con DirectX 9.0, DirectX 9.0a, DirectX 9.0b o DirectX 9.0c:<br />
...
-   Piotr Bania di [Kryptos Logic](http://www.kryptoslogic.com/) per avere segnalato la vulnerabilità legata alla decompressione dei file MJPEG (CVE-2009-0084)
...
-   V1.1 (22 aprile 2009): Microsoft Windows 2000 Service Pack 4 con DirectX 7.0 è stato aggiunto alla tabella Software non interessato. La modifica è esclusivamente informativa.
