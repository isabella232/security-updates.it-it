---
TOCTitle: 'MS09-059'
Title: 'Bollettino Microsoft sulla sicurezza MS09-059 - Importante'
ms:assetid: 'ms09-059'
ms:contentKeyID: 61240424
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms09-059(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS09-059 - Importante
==========================================================
...
Data di pubblicazione: martedì 13 ottobre 2009
...
Questo aggiornamento per la protezione è considerato di livello importante per tutte le edizioni supportate di Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 e Windows 7. Le edizioni supportate di Windows XP e Windows Server 2003 sono interessate solo se hanno precedentemente installato l'aggiornamento non correlato alla protezione descritto in KB968389. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno della presente sezione.

L'aggiornamento per la protezione risolve la vulnerabilità implementando la convalida aggiuntiva di set di valori specifici utilizzati nel processo di autenticazione. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e997ea40-668e-40df-bd50-0ca53437b375)\*                                                              | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17008892-7950-44c4-850d-002c8d73495f)\*                                                                 | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9dff4662-7771-4bdc-87ec-7899d79b3a55)\*                                                                                 | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8df7a2d9-2f97-4f18-84e8-415a1632cf09)\*                                                                     | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=83c77015-7f96-4c0d-bd56-60aef90ea2f8)\*                                                          | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=04ae306b-0d0d-4767-ab54-cc11aec477ed)                                           | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=58c995ca-f308-4e07-8e60-2e542384d95d)       | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f2f617c2-f149-4e9b-bfdd-08ed0f3f99db)\*\*               | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=deb84cb8-2ba3-47e3-9185-2bbc5b0a7e18)\*\*                         | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi basati su Itanium e Windows Server 2008 per sistemi basati su Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=abc94857-37d8-4bb8-ad9e-46e687fca40e) | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=35b85783-90df-4f67-a3cb-02351432133e)                                                                                       | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=97010f2c-6c10-4fda-84fd-6c8749968db5)                                                                                            | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi basati su x64](http://www.microsoft.com/downloads/details.aspx?familyid=597ac3a7-e02d-49a5-9b8e-d097e867acea)\*\*                                                                 | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=4aac0e3e-9b49-4a4a-ab17-707ff03b4d9b)                                                                 | Denial of Service                           | Importante                   | Nessuno                                       |

**\***Questo sistema operativo risulta interessato solo quando è stato installato KB968389, protezione estesa per l'autenticazione (vedere [Advisory Microsoft sulla sicurezza 973811](http://support.microsoft.com/kb/973811)). Per ulteriori informazioni, vedere la voce relativa della sezione **Domande frequenti sull'aggiornamento per la protezione**.

**\*\*Installazione con opzione Server Core interessata.** Per le edizioni supportate di Windows Server 2008 e Windows Server 2008 R2, a questo aggiornamento si applica il medesimo livello di gravità indipendentemente dal fatto che l'installazione sia stata effettuata usando l'opzione Server Core o meno. Per ulteriori informazioni su questa modalità di installazione, vedere gli articoli MSDN, [Server Core](http://msdn.microsoft.com/library/ms723891(vs.85).aspx) e [Server Core per Windows Server 2008 R2](http://msdn.microsoft.com/en-us/library/ee391631(vs.85).aspx). Si noti che l'opzione di installazione Server Core non è disponibile per alcune edizioni di Windows Server 2008 e Windows Server 2008 R2; vedere [Opzioni di installazione Server Core a confronto](http://msdn.microsoft.com/it-it/library/ms723891(vs.85).aspx).
...
Questa vulnerabilità interessa i sistemi Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2. La vulnerabilità interessa inoltre i sistemi Windows XP e Windows Server 2003 che hanno installato KB968389, un aggiornamento non correlato alla protezione che consente di implementare la funzionalità di protezione estesa.

**Il computer è vulnerabile se non è stato installato KB968389?**  
Le edizioni supportate di Windows XP e Windows Server 2003 nelle quale non è stato installato KB968389 non sono vulnerabili. Le edizioni supportate di Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2 nelle quali non è stato installatoKB968389 sono vulnerabili.

**Perché viene proposto soltanto KB968389 tramite Windows Update o Microsoft Update?**  
Se si ottiene KB968389 tramite Windows Update o Microsoft Update dopo il rilascio di questo aggiornamento per la protezione, KB975467 verrà installato automaticamente. Dopo avere installato KB968389, entrambi gli aggiornamenti KB968389 e MS09-059, KB975467, verrano visualizzati come installati.

Se si è installato KB968389 prima del rilascio di questo aggiornamento per la protezione, Windows Update e Microsoft Update offriranno l'aggiornamento per la protezione KB975467 per risolvere la vulnerabilità.
...
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow di valori integer in Local Security Authority Subsystem Service - CVE-2009-2524</th>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2 per sistemi basati su x64**</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denial of Service</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2 per sistemi basati su Itanium</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denial of Service</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
...
**\*Questo sistema operativo risulta interessato solo quando è stato installato KB968389, protezione estesa per l'autenticazione (vedere** [**Advisory Microsoft sulla sicurezza (973811**](http://support.microsoft.com/kb/973811)**) è stato installato.** Per ulteriori informazioni, vedere la voce relativa della sezione **Domande frequenti sull'aggiornamento per la protezione**.
  
**\*\*Installazione con opzione Server Core interessata.** Per le edizioni supportate di Windows Server 2008 e Windows Server 2008 R2, a questo aggiornamento si applica il medesimo livello di gravità indipendentemente dal fatto che l'installazione sia stata effettuata usando l'opzione Server Core o meno. Per ulteriori informazioni su questa modalità di installazione, vedere gli articoli MSDN, [Server Core](http://msdn.microsoft.com/library/ms723891(vs.85).aspx) e [Server Core per Windows Server 2008 R2](http://msdn.microsoft.com/en-us/library/ee391631(vs.85).aspx). Si noti che l'opzione di installazione Server Core non è disponibile per alcune edizioni di Windows Server 2008 e Windows Server 2008 R2; vedere [Opzioni di installazione Server Core a confronto](http://msdn.microsoft.com/it-it/library/ms723891(vs.85).aspx).
  
Vulnerabilità legata all'overflow di valori integer in Local Security Authority Subsystem Service - CVE-2009-2524  
-----------------------------------------------------------------------------------------------------------------
  
<span></span>
In Microsoft Windows Local Security Authority Subsystem Service (LSASS) esiste una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta alla gestione errata di pacchetti non validi durante l'autenticazione NTLM. Un utente malintenzionato potrebbe creare richieste di autenticazione NTLM anonime appositamente predisposte in grado di causare un arresto anomalo nel servizio LSASS, con conseguente richiesta di riavviare il computer.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2009-2524](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2524).
  
#### Fattori attenuanti della vulnerabilità legata all'overflow di valori integer in Local Security Authority Subsystem Service - CVE-2009-2524
  
Microsoft non ha individuato alcun fattore attenuante per questa vulnerabilità.
  
#### Soluzioni alternative per la vulnerabilità legata all'overflow di valori integer in Local Security Authority Subsystem Service - CVE-2009-2524
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Disinstallare KB968389 da computer Windows XP o Windows Server 2003**
  
    1.  Fare clic su **Start**, quindi su **Pannello di controllo** e successivamente fare clic su **Installazione applicazioni**.  
    2.  Selezionare **KB968389**, quindi fare clic su **Disinstalla**.
  
    **Impatto della soluzione alternativa.**I computer che eseguono Windows XP e Windows Server 2003 non traggono vantaggio dalla funzionalità di protezione estesa per l'autenticazione quando questo aggiornamento è disattivato.
  
    **Per annullare il risultato della soluzione alternativa.**Installare KB968389 scaricando il pacchetto di installazione appropriato nel sistema operativo dall'[articolo della Microsoft Knowledge Base 936389](http://support.microsoft.com/default.aspx/kb/968389?wa=wsignin1.0).
...
#### Domande frequenti sulla vulnerabilità legata all'overflow di valori integer in Local Security Authority Subsystem Service - CVE-2009-2524
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità ad attacchi di tipo Denial of Service. Un frame di autenticazione appositamente predisposto potrebbe consentire a un utente malintenzionato non autenticato di impedire al processo LSASS sul lato server di rispondere e di riavviare il computer.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è presente perché l'implementazione Windows di NTLM in LSASS non gestisce correttamente specifici pacchetti non validi durante il processo di autenticazione. Uno specifico pacchetto non valido può dare luogo a un underflow di valori integer nel processo LSASS.
...
Sfruttando questa vulnerabilità, un utente malintenzionato può causare il riavvio automatico del sistema interessato.
  
**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
Un utente malintenzionato potrebbe sfruttare questa vulnerabilità inviando un pacchetto appositamente predisposto durante il processo di autenticazione NTLM.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I server che consentono ai client di effettuare l'autenticazione utilizzando NTLM sono a rischio.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento garantisce che LSASS gestisca i valori specifici utilizzati nel processo di autenticazione in modo corretto.
...
| Windows Server 2008 R2 per sistemi basati su x64                                                                     | No      | No                | No                                                                        | No                         |  
| Windows Server 2008 R2 per sistemi basati su Itanium                                                                 | No      | No                | No                                                                        | No                         |
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB975467$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/975467">articolo della Microsoft Knowledge Base 975467</a></td>
</tr>
<tr class="even">
...
<strong>Nota</strong> È possibile evitare di riavviare il sistema per Windows Server 2003 arrestando il servizio Local Security Authority Subsystem, installando l'aggiornamento e riavviando il servizio LSAS. Se il servizio Local Security Authority Subsystem non è stato arrestato prima dell'installazione dell'aggiornamento, il riavvio del sistema è ancora necessario.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Funzionalità di patch a caldo</td>
...
<br />
Per tutte le edizioni supportate di Windows 7 basate su x64:<br />
...
<br />
Per tutte le edizioni basate su Itanium supportate di Windows Server 2008 R2:<br />
