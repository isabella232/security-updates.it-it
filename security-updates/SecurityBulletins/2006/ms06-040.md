---
TOCTitle: 'MS06-040'
Title: 'Bollettino Microsoft sulla sicurezza MS06-040 - Critico'
ms:assetid: 'ms06-040'
ms:contentKeyID: 61240181
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-040(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-040 - Critico
=======================================================

Una vulnerabilità nel servizio Server può consentire l'esecuzione di codice in modalità remota (921883)
-------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 8 agosto 2006 | Aggiornamento: martedì 12 settembre 2006
...
**Avvertenze:** L'[articolo della Microsoft Knowledge Base 921883](http://support.microsoft.com/kb/921883) descrive i problemi che gli utenti possono incontrare installando l'aggiornamento per la sicurezza. L'articolo illustra inoltre le soluzioni consigliate in grado di risolvere questi problemi. Per ulteriori informazioni, vedere l'[articolo della Microsoft Knowledge Base 921883](http://support.microsoft.com/kb/921883).

**Software verificato e posizioni per il download dell'aggiornamento per la protezione:**

**Software interessato:**

-   Microsoft Windows 2000 Service Pack 4 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=3b61153d-359f-4441-a448-24062cb2387c)
-   Microsoft Windows XP Service Pack 1 e Microsoft Windows XP Service Pack 2 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=2996b9b6-03ff-4636-861a-46b3eac7a305)
-   Microsoft Windows XP Professional x64 Edition - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=314c7c2c-9a02-4e56-98cf-97703fecf0be)
-   Microsoft Windows Server 2003 e Microsoft Windows Server 2003 Service Pack 1 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=a0058f39-6dea-4dfc-9dd6-4cb45b305dec)
-   Microsoft Windows Server 2003 per sistemi basati su Itanium e Microsoft Windows Server 2003 con SP1 per sistemi basati su Itanium - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=af970833-2044-4284-937d-3beb2e2f286d)
-   Microsoft Windows Server 2003 x64 Edition - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=3b0c1954-fca5-4e95-abb2-6066a9d6bc76)
...
L'aggiornamento risolve una vulnerabilità divulgata privatamente nonché altri problemi scoperti tramite ricerche interne.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Vulnerabilità legata al sovraccarico del buffer nel servizio Server - [CVE-2006-3439](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) | Esecuzione di codice in modalità remota | Critico      | Critico                   | Critico                   | Critico             | Critico                            |
...
-   Il livello di gravità di Windows Server 2003 e Windows Server 2003 Service Pack 1 per sistemi basati su Itanium è lo stesso del livello di gravità di Windows Server 2003.
...
Microsoft ha aggiornato il presente bollettino e i relativi aggiornamenti per risolvere i problemi identificati [nell'articolo della Microsoft Knowledge Base 921883](http://support.microsoft.com/kb/921883) che interessano Microsoft Windows Server 2003 con Service Pack 1 e Microsoft Windows XP Professional x64 Edition. In Microsoft Windows Server 2003 con Service Pack 1 e Microsoft Windows XP Professional x64 Edition con applicazioni installate che richiedono una grande quantità di memoria contigua, il sistema potrebbe arrestarsi dopo l'installazione della versione precedente di questo aggiornamento.
...
<span></span>
#### Vulnerabilità legata al sovraccarico buffer nel servizio Server - CVE-2006-3439:

Nel servizio Server è presente una vulnerabilità legata all'esecuzione di codice in modalità remota che potrebbe consentire a un utente malintenzionato in grado di sfruttare questa vulnerabilità di assumere il pieno controllo del sistema interessato.

#### Fattori attenuanti della vulnerabilità legata al sovraccarico del buffer nel servizio Server - CVE-2006-3439:
...
#### Soluzioni alternative per la vulnerabilità legata al sovraccarico buffer nel servizio Server - CVE-2006-3439:
...
Tutte le workstation e i server sono interessati da questo problema, ma i sistemi Windows 2000 sono maggiormente a rischio a causa delle particolari caratteristiche della vulnerabilità e del percorso di codice interessato.

**È possibile sfruttare questa vulnerabilità tramite Internet?**
Sì. Un utente malintenzionato può tentare di sfruttare questa vulnerabilità tramite Internet. Le configurazioni predefinite standard dei firewall e le procedure consigliate per la configurazione dei firewall consentono di proteggersi dagli attacchi provenienti da Internet. Microsoft fornisce informazioni su come è possibile proteggere il proprio PC. Informazioni per gli utenti finali: visitare il [sito Web Proteggi il tuo PC](http://www.microsoft.com/italy/athome/security/protect/windowsxp/default.mspx). Informazioni per i professionisti IT: visitare il [sito Web Security Guidance Center](http://www.microsoft.com/italy/technet/security/default.mspx).

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento elimina la vulnerabilità modificando il modo in cui il servizio Server convalida la lunghezza di un messaggio ricevuto nelle comunicazioni RPC prima di passarlo al buffer allocato.
...
Sì. L'aggiornamento per la protezione affronta la vulnerabilità attualmente sfruttata. A questa vulnerabilità è stato assegnato il numero di vulnerabilità ed esposizione ai rischi comuni CVE-2006-3439.

**Qual è la relazione tra questa vulnerabilità e la vulnerabilità corretta dal bollettino MS06-035?**
Entrambe le vulnerabilità erano presenti nel servizio Server, tuttavia il presente aggiornamento risolve una nuova vulnerabilità non affrontata nel bollettino MS06-035. MS06-035 consente di proteggere il sistema dalle vulnerabilità in esso illustrate, ma non da quella trattata nel presente bollettino. Questo aggiornamento non sostituisce il bollettino MS06-035. Per proteggere il sistema da entrambe le vulnerabilità, è necessario installare sia il presente aggiornamento che l'aggiornamento incluso nel bollettino sulla sicurezza MS06-035.
...
Gli amministratori di sistema possono rimuovere l'aggiornamento per la protezione anche mediante l'utilità Spuninst.exe, disponibile nella cartella %Windir%\\$NTUninstallKB921883$\\Spuninst.
...
|--------------|---------------|-------------|-------|------------|-----|----------|
| Netapi32.dll | 5.2.3790.559  | 17-lug-2006 | 09:38 | 324.608    | x86 | RTMGDR   |
| Netapi32.dll | 5.2.3790.559  | 17-lug-2006 | 09:56 | 324.608    | x86 | RTMQFE   |
...
| Nome file    | Versione      | Data        | Ora   | Dimensione | CPU | Cartella |
|--------------|---------------|-------------|-------|------------|-----|----------|
| Netapi32.dll | 5.1.2600.1874 | 14-lug-2006 | 15:53 | 307.200    | x86 | SP1QFE   |
| Netapi32.dll | 5.1.2600.2952 | 14-lug-2006 | 15:31 | 332.288    | x86 | SP2GDR   |
| Netapi32.dll | 5.1.2600.2952 | 14-lug-2006 | 15:41 | 336.896    | x86 | SP2QFE   |
...
|--------------|---------------|-------------|-------|------------|-----|
| Netapi32.dll | 5.0.2195.7105 | 15-lug-2006 | 02:25 | 309.520    | x86 |
...
-   [US-CERT](http://www.us-cert.gov/) per aver collaborato con noi sulla vulnerabilità legata al sovraccarico buffer nel servizio Server (CVE-2006-3439).
-   [SANS](http://www.sans.org/) per aver collaborato con noi sulla vulnerabilità legata al sovraccarico buffer nel servizio Server (CVE-2006-3439).
...
-   V1.1 (14 agosto 2006): La sezione avvertenze del bollettino è stata aggiornata per riflettere la pubblicazione di KB921883. Revisione dell'impatto nella sezione "Soluzioni alternative" per il blocco delle porte identificate.
-   V2.0 (12 settembre 2006): L'aggiornamento è stato rivisto e rilasciato nuovamente per Microsoft Windows 2003 e Microsoft Windows XP Professional x64 Edition per risolvere i problemi identificati nell'[articolo della Microsoft Knowledge Base 921883](http://support.microsoft.com/kb/921883).
