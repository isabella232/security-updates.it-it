---
TOCTitle: 'MS06-055'
Title: 'Bollettino Microsoft sulla sicurezza MS06-055 - Critico'
ms:assetid: 'ms06-055'
ms:contentKeyID: 61240196
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-055(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-055 - Critico
=======================================================

La vulnerabilità in Vector Markup Language può consentire l'esecuzione di codice in modalità remota (925486)
------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 26 settembre 2006
...
-   Microsoft Windows XP Service Pack 1 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=383c13dc-51a9-4b12-89e3-871a1a3de98f)
-   Microsoft Windows XP Service Pack 2 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=b5f19858-4e86-4fd4-a264-e4823ff6d0a9)
-   Microsoft Windows XP Professional x64 Edition - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=afd3279c-6171-4f20-a36e-b9b56ee4c7f1)
-   Microsoft Windows Server 2003 e Microsoft Windows Server 2003 Service Pack 1 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=af8f3a58-ba7a-41bf-bb1b-3a9ddfdc3e27)
-   Microsoft Windows Server 2003 per sistemi basati su Itanium e Microsoft Windows Server 2003 con SP1 per sistemi basati su Itanium - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=271e9c78-1c6a-443e-924d-43fd6d51e643)
-   Microsoft Windows Server 2003 x64 Edition - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=e2cb474f-fc1b-4b7d-a607-02a1528c6743)

**Componenti di Microsoft Windows testati:**

**Componenti interessati:**

-   Internet Explorer 5.01 Service Pack 4 in Microsoft Windows 2000 Service Pack 4 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=4c48ff93-6559-4616-9c2d-406e808b7e97)
-   Internet Explorer 6 Service Pack 1 in Microsoft Windows 2000 Service Pack 4 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=ea7de30f-d765-4e5b-bfd4-64f3fed578ff)
...
|------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Vulnerabilità di sovraccarico del buffer di VML - [CVE-2006-4868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4868) | Esecuzione di codice in modalità remota | Critico                     | Critico                   | Critico                   | Critico             | Moderato                           |
...
<span></span>
**È possibile distribuire questo aggiornamento per la protezione dopo aver applicato le soluzioni alternative fornite nell'advisory Microsoft sulla sicurezza 925568?**
Se la soluzione alternativa "Modificare l'elenco di controllo dell'accesso sul file VGX.DLL in modo da specificare impostazioni più restrittive" è stata applicata ai sistemi, gli aggiornamenti per la protezione forniti con questo bollettino sulla sicurezza potrebbero non essere installati correttamente. Vedere la sezione Soluzioni alternative per la vulnerabilità di sovraccarico del buffer di VML - CVE-2006-4868 di questo bollettino sulla sicurezza per le istruzioni su come ripristinare questa soluzione alternativa prima di applicare questo aggiornamento per la protezione.
...
| ID bollettino | Windows 2000 Service Pack 4 | Windows 2000 Service Pack 4 con Internet Explorer 6 Service Pack 1 installato | Windows XP Service Pack 1 | Windows XP Service Pack 2 | Windows Server 2003 | Windows Server 2003 Service Pack 1 |
|---------------|-----------------------------|-------------------------------------------------------------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| **MS04-028**  | Non sostituito              | Sostituito                                                                    | Non sostituito            | Non sostituito            | Non sostituito      | Non sostituito                     |
...
| Microsoft Windows Server 2003 e Microsoft Windows Server 2003 Service Pack 1                                                                 | No         | Sì                             | Sì       |
...
| Microsoft Windows Server 2003 e Microsoft Windows Server 2003 Service Pack 1                                                                 | Sì (con EST) | Sì       |
...
<span></span>
#### Vulnerabilità di sovraccarico del buffer di VML - CVE-2006-4868:
...
#### Fattori attenuanti della vulnerabilità di sovraccarico del buffer di VML - CVE-2006-4868:
...
-   In un attacco basato sulla posta elettronica, i clienti che leggono i messaggi utilizzando Outlook Express in Windows XP Service Pack 2 e Windows Server 2003 Service Pack 1 sono meno esposti a questa vulnerabilità perché l'opzione Comportamento file binari e script è disattivata per impostazione predefinita nell'area Siti con restrizioni.
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
-   Per impostazione predefinita, in Windows Server 2003 Internet Explorer viene eseguito in una modalità limitata denominata [Protezione avanzata](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp). Questa modalità consente di ridurre i rischi correlati a questa vulnerabilità in Windows Server 2003 Service Pack 1 perché l'opzione Comportamento file binari e script è disattivata per impostazione predefinita nell'area Internet.
-   Per impostazione predefinita, in Windows Server 2003 Internet Explorer viene eseguito in una modalità limitata denominata Protezione avanzata di Internet Explorer. Questa modalità consente di ridurre i rischi correlati a questa vulnerabilità in caso di attacchi tramite posta elettronica per Outlook Express poiché la configurazione predefinita per la lettura di messaggi di posta elettronica è in formato solo testo. Per ulteriori informazioni sulla Protezione avanzata di Internet Explorer, consultare la sezione Domande frequenti di questo aggiornamento per la protezione.

#### Soluzioni alternative per la vulnerabilità di sovraccarico del buffer di VML - CVE-2006-4868:
...
-   **Modificare l'elenco di controllo dell'accesso sul file VGX.DLL in modo da specificare impostazioni più restrittive**
    ...
    **Effetto della soluzione alternativa:** Le applicazioni e i siti Web che eseguono il rendering VML non funzionano e non vengono più visualizzati correttamente.
    ...
    1.  Fare clic su **Start**, selezionare **Esegui**, digitare "**cmd**" (senza virgolette) e scegliere **OK**.
    2.  Per ripristinare la configurazione ACL precedente per il file vgx.dll, digitare il seguente comando e sostituire *previous* con l'ACL registrato nel passaggio 2 di questa soluzione alternativa:
...
#### Domande frequenti sulla vulnerabilità di sovraccarico del buffer di VML - CVE-2006-4868:
...
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice CVE-2006-4868.
...
Sì. L'aggiornamento per la protezione affronta la vulnerabilità attualmente sfruttata. Questa vulnerabilità è stata identificata con il codice CVE-2006-4868.
...
#### Internet Explorer 6 Service Pack 1 per Windows XP Service Pack 1 (tutte le versioni)

**Prerequisiti**
È possibile installare la versione per Internet Explorer 6 Service Pack 1 (SP1) dell'aggiornamento nei sistemi Microsoft Windows XP Service Pack 1 che eseguono Internet Explorer 6 SP1 (versione 6.00.2800.1106).
...
Gli amministratori di sistema possono rimuovere l'aggiornamento per la protezione anche mediante l'utilità Spuninst.exe, disponibile nella cartella %Windir%\\$NTUninstallKB925486-IE6SP1-20060918.120000$\\Spuninst.
...
**Nota** L'utilizzo dell'opzione **/quiet** evita di visualizzare tutti i messaggi, inclusi i messaggi di errore. Quando viene utilizzata l'opzione **/quiet**, è opportuno che gli amministratori adottino uno dei metodi supportati per verificare che l'installazione sia avvenuta correttamente. Gli amministratori devono inoltre esaminare il file KB925486-IE501SP4-20060918.174951.log per individuare eventuali messaggi di errore registrati quando questa opzione è attivata.
...
Gli amministratori di sistema possono rimuovere l'aggiornamento per la protezione anche mediante l'utilità Spuninst.exe, disponibile nella cartella %Windir%\\$NTUninstallKB925486-IE501SP4-20060918.174951$\\Spuninst.
...
**Nota** L'utilizzo dell'opzione **/quiet** evita di visualizzare tutti i messaggi, inclusi i messaggi di errore. Quando viene utilizzata l'opzione **/quiet**, è opportuno che gli amministratori adottino uno dei metodi supportati per verificare che l'installazione sia avvenuta correttamente. Gli amministratori devono inoltre esaminare il file KB925486.log per individuare eventuali messaggi di errore registrati quando questa opzione è attivata.
...
Gli amministratori di sistema possono rimuovere l'aggiornamento per la protezione anche mediante l'utilità Spuninst.exe, disponibile nella cartella %Windir%\\$NTUninstallKB925486$\\Spuninst.
...
-   **Controllo delle chiavi del Registro di sistema**
    ...
    Per Windows XP Tablet PC Edition, Windows XP Media Center Edition, Windows XP Home Edition Service Pack 2, Windows XP Professional Service Pack 2, Windows XP Tablet PC Edition 2005 e Windows XP Media Center Edition 2005:
...
-   [ISS X-Force](http://www.iss.net/) per aver collaborato con Microsoft sulla vulnerabilità di sovraccarico del buffer di VML (CVE-2006-4868).
-   [iDEFENSE](http://www.idefense.com/) per aver collaborato con Microsoft sulla vulnerabilità di sovraccarico del buffer di VML (CVE-2006-4868).
-   Dan Hubbard di [Websense Security Labs](http://www.websense.com/securitylabs/) per aver collaborato con Microsoft sulla vulnerabilità di sovraccarico del buffer di VML (CVE-2006-4868).
...
-   V1.0 (26 settembre 2006): Pubblicazione del bollettino.
