---
TOCTitle: 'MS06-059'
Title: 'Bollettino Microsoft sulla sicurezza MS06-059 - Critico'
ms:assetid: 'ms06-059'
ms:contentKeyID: 61240200
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-059(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-059 - Critico
=======================================================

Vulnerabilità in Microsoft Excel possono consentire l'esecuzione di codice in modalità remota (924164)
------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 10 ottobre 2006 | Aggiornamento: martedì 12 dicembre 2006
...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft Excel 2000 - [Download dell'aggiornamento (KB923090)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=a4b2a672-481b-4af6-89fe-de8d321d99e0)
-   Microsoft Office XP Service Pack 3
    -   Microsoft Excel 2002 - [Download dell'aggiornamento (KB923089)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984)
-   Microsoft Office 2003 Service Pack 1 o Service Pack 2
    -   Microsoft Office Excel 2003 - [Download dell'aggiornamento (KB923088)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=a81a8537-e2b0-4629-8973-40c4f32d9728)
    -   Microsoft Office Excel Viewer 2003 - [Download dell'aggiornamento (KB923275)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=74c72657-634d-4c31-a366-c68043fe3b34)
-   Microsoft Office 2004 per Mac
    -   Microsoft Excel 2004 per Mac - [Download dell'aggiornamento (KB924999)](http://www.microsoft.com/italy/mac/default.mspx)
-   Microsoft Office v. X per Mac
    -   Microsoft Excel v. X per Mac - [Download dell'aggiornamento (KB924998)](http://www.microsoft.com/italy/mac/default.mspx)
-   Microsoft Works Suite:
    -   Microsoft Works Suite 2004 - [Download dell'aggiornamento (KB923089)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (stesso aggiornamento di Microsoft Excel 2002)
    -   Microsoft Works Suite 2005 - [Download dell'aggiornamento (KB923089)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (stesso aggiornamento di Microsoft Excel 2002)
    -   Microsoft Works Suite 2006 - [Download dell'aggiornamento (KB923089)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (stesso aggiornamento di Microsoft Excel 2002)
...
| Identificatori della vulnerabilità                                                                                                                  | Effetti della vulnerabilità             | Microsoft Excel 2000 | Microsoft Excel 2002 | Microsoft Excel 2003 e Excel Viewer 2003 | Microsoft Excel 2004 per Mac e Excel v.X per Mac |
|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|----------------------|----------------------|------------------------------------------|--------------------------------------------------|
| Vulnerabilità legata al record DATETIME non valido in Excel - [CVE-2006-2387](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2387)      | Esecuzione di codice in modalità remota | Critico              | Importante           | Importante                               | Importante                                       |
| Vulnerabilità legata al record STYLE non valido in Excel - [CVE-2006-3431](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3431)         | Esecuzione di codice in modalità remota | Critico              | Importante           | Importante                               | Importante                                       |
| Vulnerabilità legata alla gestione dei file Lotus 1-2-3 in Excel - [CVE-2006-3867](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3867) | Esecuzione di codice in modalità remota | Critico              | Importante           | Importante                               | Importante                                       |
| Vulnerabilità legata al record COLINFO non valido in Excel - [CVE-2006-3875](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3875)       | Esecuzione di codice in modalità remota | Critico              | Importante           | Importante                               | Importante                                       |
...
-   Il livello di gravità di Microsoft Works Suite 2004 è lo stesso di Microsoft Excel 2002.
-   Il livello di gravità di Microsoft Works Suite 2005 è lo stesso di Microsoft Excel 2002.
-   Il livello di gravità di Microsoft Works Suite 2006 è lo stesso di Microsoft Excel 2002.

Domande frequenti sull'aggiornamento per la protezione
------------------------------------------------------

<span></span>
**Perché Microsoft ha aggiornato questo bollettino il 12 dicembre 2006?**
Microsoft ha aggiornato il presente bollettino e i relativi aggiornamenti per la protezione per risolvere i problemi identificati nell'[articolo della Microsoft Knowledge Base 924164](http://support.microsoft.com/kb/924164) che interessano Microsoft Excel 2002.
...
| ID bollettino                                                           | Microsoft Excel 2000 | Microsoft Excel 2002 | Microsoft Excel 2003 e Excel Viewer 2003 | Microsoft Excel 2004 per Mac e Excel v.X per Mac |
|-------------------------------------------------------------------------|----------------------|----------------------|------------------------------------------|--------------------------------------------------|
| [**MS06-037**](http://technet.microsoft.com/security/bulletin/ms06-037) | Sostituito           | Sostituito           | Sostituito                               | Sostituito                                       |
...
Per informazioni più dettagliate sul rilevamento e sulla distribuzione, vedere l'[articolo della Microsoft Knowledge Base 910723](http://support.microsoft.com/kb/910723).
...
<span></span>
#### Vulnerabilità legata al record DATETIME non valido in Excel - CVE-2006-2387:

In Excel esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può sfruttare la vulnerabilità quando Excel analizza un file ed elabora un record DATETIME non valido.
...
#### Fattori attenuanti della vulnerabilità legata al record DATETIME non valido in Excel - CVE-2006-2387:
...
#### Soluzioni alternative per la vulnerabilità legata al record DATETIME non valido in Excel - CVE-2006-2387:
...
#### Domande frequenti sulla vulnerabilità legata al record DATETIME non valido in Excel - CVE-2006-2387:
...
Excel non esegue una convalida dei dati adeguata quando elabora i contenuti di un file .xls. Se in Excel viene aperto un file Excel appositamente predisposto e viene analizzato un record DATATIME non valido, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
L'aggiornamento elimina la vulnerabilità modificando il modo in cui Excel analizza il file e convalida un record prima di passarla al buffer allocato.
...
#### Vulnerabilità legata al record STYLE non valido in Excel - CVE-2006-3431:

In Excel esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può sfruttare la vulnerabilità quando Excel analizza un file ed elabora un record STYLE non valido.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti della vulnerabilità legata al record STYLE non valido in Excel - CVE-2006-3431:
...
#### Soluzioni alternative della vulnerabilità legata al record STYLE non valido in Excel - CVE-2006-3431:

Microsoft ha verificato le soluzioni alternative seguenti. Sebbene queste soluzioni alternative non eliminino la vulnerabilità sottostante, consentono di bloccare gli attacchi noti. Se una soluzione alternativa riduce la funzionalità, viene identificata nella sezione seguente.

-   Non aprire o salvare file Microsoft Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.
-   Scaricare ed eseguire lo strumento del [componente aggiuntivo di Office 2003 per le impostazioni di lingua del desktop](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=cc37e08c-1019-4ae8-a258-0d5412876dec) per modificare le impostazioni di lingua configurate per Office.
-   **Modificare il valore di "InstallLanguage" sui caratteri non DBCS (non a byte doppio)**
    La modifica della chiave del Registro di sistema "InstallLanguage" consente di proteggere il sistema interessato da tentativi di sfruttare la vulnerabilità.
    ...
    **Nota** Prendere nota delle autorizzazioni elencate in questa finestra di dialogo per poterle successivamente riportare ai valori originali.
    ...
    2.  Espandere **HKEY\_CURRENT\_USER**, quindi le seguenti sottochiavi; **Software, Microsoft, Office**, **11.0, Common**.
    3.  Scegliere **LanguageResources**, quindi fare doppio clic sul valore **InstallLanguage** per visualizzare la finestra di dialogo per la **modifica del valore DWORD**.
    4.  Sostituire il valore con uno che rappresenti il valore di una lingua diversa dalle lingue dell'Asia orientale, ad esempio con il valore 409 della lingua inglese, quindi fare clic su **OK**.

    **Nota** Per un elenco di altri ID della lingua, vedere l'[articolo della Microsoft Knowledge Base 324097](http://support.microsoft.com/?id=324097).
...
**Effetto della soluzione alternativa:** I caratteri speciali Unicode dei fogli di calcolo potrebbero non essere visualizzati correttamente.

#### Domande frequenti sulla vulnerabilità legata al record STYLE non valido in Excel - CVE-2006-3431:
...
**Quali sono le cause di questa vulnerabilità?**
Excel non esegue una convalida dei dati adeguata quando elabora i contenuti di un file .xls. Se in Excel viene aperto un file Excel appositamente predisposto e viene analizzato un record STYLE non valido, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
#### Vulnerabilità legata alla gestione dei file Lotus 1-2-3 in Excel - CVE-2006-3867:

In Excel esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può tentare di sfruttare la vulnerabilità quando Excel gestisce un file Lotus 1-2-3.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti della vulnerabilità legata alla gestione dei file Lotus 1-2-3 in Excel - CVE-2006-3867:

-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
-   In uno scenario di attacco dal Web, l'utente malintenzionato dovrebbe pubblicare un sito Web contenente un file Lotus 1-2-3 utilizzato da Excel per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti possono includere contenuti appositamente predisposti in grado di sfruttare questa vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare un sito Web dannoso, l'utente malintenzionato dovrebbe invogliare le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento che le indirizzi al sito.
-   Non è possibile sfruttare la vulnerabilità automaticamente per posta elettronica. L'attacco è possibile solo se l'utente apre un allegato a un messaggio di posta elettronica.
-   Agli utenti che hanno installato e utilizzano lo strumento [Office Document Open Confirmation Tool](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f) per Office 2000 verrà richiesto di scegliere **Apri**, **Salva** o **Annulla** prima di aprire un documento. Le funzionalità dello strumento Office Document Open Confirmation Tool sono incorporate in Office XP e Office 2003.

#### Soluzioni alternative per la vulnerabilità legata alla gestione dei file Lotus 1-2-3 in Excel - CVE-2006-3867:

-   Non aprire o salvare i file Lotus 1-2-3 in Microsoft Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata alla gestione dei file Lotus 1-2-3 in Excel - CVE-2006-3867:
...
**Quali sono le cause di questa vulnerabilità?**
Durante l'apertura in Excel di un file Lotus 1-2-3 appositamente predisposto, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice CVE-2006-3867.

**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**
No. Al momento della pubblicazione di questo bollettino Microsoft era a conoscenza dell'esistenza di codice di prova pubblicato, ma non aveva ricevuto alcuna segnalazione in merito allo sfruttamento pubblico di questa vulnerabilità a scopo di attacco.

#### Vulnerabilità legata al record COLINFO non valido - CVE-2006-3875:

In Excel esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può sfruttare la vulnerabilità quando Excel analizza un file ed elabora un record COLINFO non valido.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti della vulnerabilità legata al record COLINFO non valido - CVE-2006-3875:
...
#### Soluzioni alternative per la vulnerabilità legata al record COLINFO non valido - CVE-2006-3875:

-   Non aprire o salvare file Microsoft Excel provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata al record COLINFO non valido - CVE-2006-3875:
...
**Quali sono le cause di questa vulnerabilità?**
Excel non esegue una convalida dei dati adeguata quando elabora i contenuti di un file .xls. Se in Excel viene aperto un file Excel appositamente predisposto e viene analizzato un record COLINFO non valido, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
Per avviare il rilevamento degli aggiornamenti necessari per il computer in uso, visitare il [sito Web Office Update](http://office.microsoft.com/it-it/downloads/default.aspx) e fare clic su **Esegui rilevamento automatico aggiornamenti**. Al termine dell'operazione di rilevamento, verrà visualizzato un elenco degli aggiornamenti consigliati affinché venga approvato. Scegliere **Accetto, avvia installazione** per completare il processo.
...
1.  [Scaricare l'aggiornamento per la protezione per Excel 2000](http://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-enu.exe).
...
|-----------|------------|------------|-------|------------|
| Excel.exe | 9.0.0.8950 | 6-set-2006 | 00:37 | 7.233.581  |
...
Questo aggiornamento per la protezione sarà disponibile sul [sito Web Microsoft Update](http://technet.microsoft.com/security/bulletin/rating). Microsoft Update consolida gli aggiornamenti forniti da Windows Update e Office Update in un'unica posizione e consente di scegliere l'invio e l'installazione automatici degli aggiornamenti per la protezione o ad alta priorità. Si raccomanda di eseguire l'installazione dell'aggiornamento attraverso il sito Web Microsoft Update. Tale sito Web rileva automaticamente l'installazione presente nel computer in uso e visualizza un messaggio che indica esattamente quali componenti è necessario avere per assicurarsi che l'installazione esistente sia aggiornata.
...
1.  [Scaricare l'aggiornamento per la protezione per Excel 2002](http://download.microsoft.com/download/6/e/4/6e483fd2-420f-45e2-9d21-e725f461c097/officexp-kb923089-v2-fullfile-enu.exe).
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto di installare l'aggiornamento, scegliere **Sì**.
...
-   Per aggiornare Office 2003, deve essere installato Office 2003 Service Pack 1 o Office 2003 Service Pack 2. Prima di installare questo aggiornamento, installare [Office 2003 SP1](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=9c51d3a6-7cb1-4f61-837e-5f938254fc47) o [Office 2003 SP2](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=57e27a97-2db6-4654-9db6-ec7d5b4dd867).
-   Per installare Office 2003 Excel Viewer, deve essere installato Office 2003 Excel Viewer. Prima di installare questo aggiornamento, installare [Office Excel Viewer 2003](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=c8378bf4-996c-4569-b547-75edbd03aaf0).
...
1.  [Scaricare l'aggiornamento per la protezione per Excel 2003](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe) e/o [scaricare l'aggiornamento per la protezione per Excel 2003 Viewer](http://download.microsoft.com/download/2/2/e/22e6365d-2a66-4a8c-8867-06a723dc53cc/office2003-kb923275-fullfile-enu.exe)
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto di installare l'aggiornamento, scegliere **Sì**.
...
-   Manuel Santamarina Suarez, collaboratore di [Zero Day Initiative (ZDI)](http://www.zerodayinitiative.com/) e [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata all'overflow dell'analisi del formato file Excel - CVE-2006-2387.
-   [NSFocus Security Team](http://www.nsfocus.com/) per aver segnalato la vulnerabilità legata al record COLINFO non valido in Excel - [CVE-2006-3875](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3875).
...
-   V1.1 (29 novembre 2006): Il bollettino ha aggiornato l'articolo della Knowledge Base per "Microsoft Office Excel Viewer 2003" nella sezione "Prodotti interessati".
-   V2.0 (12 dicembre 2006): Il bollettino aggiornato è stato rivisto e rilasciato nuovamente per Microsoft Excel 2002 per risolvere i problemi identificati nell'[articolo della Microsoft Knowledge Base 924164](http://support.microsoft.com/kb/924164).
