---
TOCTitle: 'MS06-048'
Title: 'Bollettino Microsoft sulla sicurezza MS06-048 - Critico'
ms:assetid: 'ms06-048'
ms:contentKeyID: 61240189
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-048(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-048 - Critico
=======================================================

Alcune vulnerabilità in Microsoft Office possono consentire l'esecuzione di codice in modalità remota (922968)
--------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 8 agosto 2006 | Aggiornamento: mercoledì 11 ottobre 2006
...
-   Microsoft Office 2000 Service Pack 3 - [Download dell'aggiornamento (KB921568)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=b7b5615b-7c20-4c49-892f-7f4ccc2d6006)
    -   Microsoft PowerPoint 2000
-   Microsoft Office XP Service Pack 3 - [Download dell'aggiornamento (KB921567)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=a9c7e43b-a0a6-4c81-87ed-3f4ded78eaea)
    -   Microsoft PowerPoint 2002
-   Microsoft Office 2003 Service Pack 1 o Service Pack 2 - [Download dell'aggiornamento (KB921566)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=de1cb2a7-5d4c-44b8-bc40-7e0a88cc3081)
    -   Microsoft Office PowerPoint 2003
-   Microsoft Office 2004 per Mac - [Download dell'aggiornamento (KB923151)](http://www.microsoft.com/italy/mac/default.mspx)
    -   PowerPoint 2004 per Mac
-   Microsoft Office v. X per Mac - [Download dell'aggiornamento (KB923148)](http://www.microsoft.com/italy/mac/default.mspx)
    -   PowerPoint 2004 v. X per Mac
...
<span></span>
Questo aggiornamento risolve due vulnerabilità scoperte di recente e segnalate sia pubblicamente che privatamente a Microsoft. Ogni vulnerabilità è illustrata in dettaglio nella relativa sezione "Dettagli della vulnerabilità" del presente bollettino.
...
| Identificatori della vulnerabilità                                                                                                                   | Effetti della vulnerabilità             | Microsoft PowerPoint 2000 | Microsoft PowerPoint XP | Microsoft PowerPoint 2003 | Microsoft PowerPoint 2004 per Mac o Microsoft PowerPoint v. X per Mac |
|------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|---------------------------|-------------------------|---------------------------|-----------------------------------------------------------------------|
| Vulnerabilità legata a Mso.dll di Microsoft PowerPoint - [CVE-2006-3590](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3590)            | Esecuzione di codice in modalità remota | Critico                   | Importante              | Importante                | Importante                                                            |
| Vulnerabilità legata ai record non validi in Microsoft PowerPoint - [CVE-2006-3449](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3449) | Esecuzione di codice in modalità remota | Critico                   | Importante              | Importante                | Importante                                                            |
...
<span></span>
**Il bollettino è intitolato "Una vulnerabilità in Microsoft Office può consentire l'esecuzione di codice in modalità remota", ma tra i prodotti interessati viene indicato solo PowerPoint. Perché?**
La vulnerabilità esiste in un binario condiviso da diversi prodotti Office. Tuttavia, il problema si riferisce in particolare al modo in cui PowerPoint utilizza il binario condiviso.
...
| ID bollettino                                                           | Microsoft PowerPoint 2000 | Microsoft PowerPoint XP | Microsoft PowerPoint 2003 | Microsoft PowerPoint 2004 per Mac o Microsoft PowerPoint v. X per Mac |
|-------------------------------------------------------------------------|---------------------------|-------------------------|---------------------------|-----------------------------------------------------------------------|
| [**MS06-038**](http://technet.microsoft.com/security/bulletin/ms06-038) | Sostituito                | Sostituito              | Sostituito                | Sostituito                                                            |
...
<span></span>
#### Vulnerabilità legata a Mso.dll di Microsoft PowerPoint - CVE-2006-3590

Una vulnerabilità legata all'esecuzione di codice in modalità remota esiste in PowerPoint e potrebbe essere sfruttata quando un file con un contenitore di forma non valido viene analizzato da PowerPoint. Tale file potrebbe essere contenuto in un allegato di posta elettronica o ospitato su un sito web dannoso. Un utente malintenzionato può sfruttare tale vulnerabilità creando un file PowerPoint appositamente predisposto che potrebbe consentire l'esecuzione di codice in modalità remota.
...
#### Fattori attenuanti della vulnerabilità di Mso.dll di Microsoft PowerPoint - CVE-2006-3590
...
**Nota** I file PowerPoint 2000 non richiedono all'utente di scegliere **Apri**, **Salva** o **Annulla** prima di aprire un documento.

#### Soluzioni alternative per la vulnerabilità di Mso.dll di Microsoft PowerPoint - CVE-2006-3590:
...
#### Domande frequenti sulla vulnerabilità di Mso.dll in Microsoft PowerPoint - CVE-2006-3590:
...
La vulnerabilità si presenta quando PowerPoint apre un file PowerPoint appositamente predisposto e analizza una forma non valida.
...
L'aggiornamento elimina la vulnerabilità modificando il modo in cui PowerPoint analizza la lunghezza di un record prima di passarlo al buffer allocato.
...
Sì. Quest'aggiornamento per la protezione risolve la vulnerabilità. Alla vulnerabilità identificata è stato assegnato il codice CVE-2006-3590 ed è stata precedentemente descritta nell'advisory Microsoft sulla sicurezza [922970](http://technet.microsoft.com/security/advisory/922970).

#### Vulnerabilità legata ai record non validi in Microsoft PowerPoint - CVE-2006-3449

Una vulnerabilità legata all'esecuzione di codice in modalità remota esiste in PowerPoint e potrebbe essere sfruttata quando un file con record non valido viene analizzato da PowerPoint. Tale file potrebbe essere contenuto in un allegato di posta elettronica o ospitato su un sito web dannoso. Un utente malintenzionato può sfruttare tale vulnerabilità creando un file PowerPoint appositamente predisposto che potrebbe consentire l'esecuzione di codice in modalità remota.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti della vulnerabilità legata ai record non validi di Microsoft PowerPoint - CVE-2006-3449

-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
-   In Outlook 2002 e Outlook 2003, la vulnerabilità non può essere sfruttata automaticamente tramite la posta elettronica. Perché la vulnerabilità possa essere sfruttata, un utente deve fare clic su un allegato, leggere l'avvertenza visualizzata e scegliere **Apri**.
-   In uno scenario di attacco basato sul Web, l'utente malintenzionato potrebbe pubblicare un sito Web contenente una pagina utilizzata per sfruttare la vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti o annunci pubblicitari forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. In tutti questi casi, comunque, non è in alcun modo possibile obbligare gli utenti a visitare questi siti Web. L'utente malintenzionato dovrebbe invece invogliare le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento in un messaggio di posta elettronica o di Instant Messenger che le indirizzi al sito.

**Nota** I file Office 2000 non richiedono all'utente di scegliere **Apri**, **Salva** o **Annulla** prima di aprire un documento.

#### Soluzioni alternative per la vulnerabilità legata ai record non validi di Microsoft PowerPoint - CVE-2006-3449:
...
#### Domande frequenti sulla vulnerabilità legata ai record non validi di Microsoft PowerPoint - CVE-2006-3449:
...
**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità si presenta quando PowerPoint apre un file PowerPoint appositamente predisposto ed analizza un record non valido.
...
1.  Scaricare l'aggiornamento per la protezione.
...
| Mso.dll   | 11.0.8036.0 | 15-lug-2006 | 02:02 | 12.256.008 |
...
-   Office XP Service Pack 3 (SP3) deve essere installato. Prima di installare questo aggiornamento, installare [Office XP SP3](http://www.microsoft.com/downloads/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e).
...
1.  Scaricare questo aggiornamento per la protezione per Office XP.
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto di installare l'aggiornamento, scegliere **Sì**.
...
| Mso.dll   | 10.0.6811.0 | 15-lug-2006 | 03:20 | 9.816.840  |
...
1.  Scaricare questo aggiornamento per la protezione per Office 2000.
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto di installare l'aggiornamento, scegliere **Sì**.
...
| Nome file | Versione   | Data        | Ora   | Dimensione |
|-----------|------------|-------------|-------|------------|
| Mso9.dll  | 9.0.0.8948 | 20-lug-2006 | 10:25 | 5.595.185  |
...
2.  Aprire il volume **Microsoft Office 2004 per Mac 11.2.6 Security Update** sul desktop. Questo passaggio potrebbe essere stato eseguito automaticamente.
3.  Per iniziare il processo di aggiornamento, nella finestra del volume **Microsoft Office 2004 per Mac 11.2.6 Security Update**, fare doppio clic sull'applicazione **Microsoft Office 2004 per Mac 11.2.6 Security Update** e seguire le istruzioni visualizzate sullo schermo.
4.  Al termine dell'installazione, è possibile rimuovere il programma di installazione dell'aggiornamento dal disco rigido. Per verificare se l'installazione è stata completata, vedere la sezione "Verifica dell'installazione dell'aggiornamento". Per rimuovere il programma di installazione dell'aggiornamento, trascinare il volume **Microsoft Office 2004 per Mac 11.2.6 Security Update** e il file scaricato nel Cestino.
...
Se il numero di versione è **11.2.6**, l'aggiornamento è stato installato.
...
2.  Aprire il volume **Microsoft Office v. X per Mac 10.1.8 Security Update** sul desktop. Questo passaggio potrebbe essere eseguito automaticamente.
3.  Per iniziare il processo di aggiornamento, nella finestra del volume **Microsoft Office v. X per Mac 10.1.8 Security Update**, fare doppio clic sull'applicazione **Microsoft Office v. X per Mac 10.1.8 Update** e seguire le istruzioni visualizzate sullo schermo.
4.  Al termine dell'installazione, è possibile rimuovere il programma di installazione dell'aggiornamento dal disco rigido. Per verificare se l'installazione è stata completata, vedere la sezione "Verifica dell'installazione dell'aggiornamento". Per rimuovere il programma di installazione dell'aggiornamento, trascinare il volume **Microsoft Office 2004 per Mac 10.1.8 Security Update** e il file scaricato nel Cestino.
...
2.  Scegliere il file, **Microsoft Office X**.
3.  Nel menu **File**, scegliere **Informazioni** o **Mostra Info**.

Se il numero di versione è **10.0.0 (060718)**, l'aggiornamento è stato installato.
...
-   Elia Florio di [Symantec](http://www.symantec.com/index.htm) per aver segnalato la vulnerabilità legata a Mso.dll di Microsoft PowerPoint - [CVE-2006-3590](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3590)
-   Dejun Meng di Fortinet Security Research Team per aver segnalato la vulnerabilità legata a Mso.dll di Microsoft PowerPoint - [CVE-2006-3590](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3590)
-   Shih-hao Weng di [Information & Communication Security Technology Center](http://www.icst.org.tw/) per aver segnalato la vulnerabilità legata a Mso.dll di Microsoft PowerPoint - [CVE-2006-3590](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3590)
-   SoWhat di [Nevis Labs](http://www.nevisnetworks.com) per aver segnalato la vulnerabilità legata ai record non validi in Microsoft PowerPoint - [CVE-2006-3449](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3449)
...
-   V1.1 (11 ottobre 2006): Il bollettino è stato aggiornato per fornire spiegazioni aggiuntive relative a "Verifica dell'installazione dell'aggiornamento" di Office 2004 per Mac e di Office v. X per Mac nella sezione "Informazioni sull'aggiornamento per la protezione".
