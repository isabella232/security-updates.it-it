---
TOCTitle: 'MS06-058'
Title: 'Bollettino Microsoft sulla sicurezza MS06-058 - Critico'
ms:assetid: 'ms06-058'
ms:contentKeyID: 61240199
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-058(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-058 - Critico
=======================================================

Vulnerabilità in Microsoft PowerPoint possono consentire l'esecuzione di codice in modalità remota (924163)
-----------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 10 ottobre 2006 | Aggiornamento: mercoledì 21 febbraio 2007
...
-   Microsoft Office 2000 Service Pack 3 - [Download dell'aggiornamento (KB923093)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;familyid=14a61fda-bfe2-47ca-8313-40b772359994)
    -   Microsoft PowerPoint 2000
-   Microsoft Office XP Service Pack 3 - [Download dell'aggiornamento (KB923092)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;familyid=0fbd66fb-28bb-4587-9425-ad4a3f10651d)
    -   Microsoft PowerPoint 2002
-   Microsoft Office 2003 Service Pack 1 o Service Pack 2 - [Download dell'aggiornamento (KB923091)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&amp;familyid=d0e30f77-b48f-4b8b-a6fa-105a354b1a4e)
    -   Microsoft Office PowerPoint 2003
-   Microsoft Office 2004 per Mac
    -   Microsoft PowerPoint 2004 per Mac - [Download dell'aggiornamento (KB924999)](http://www.microsoft.com/italy/mac/default.mspx)
-   Microsoft Office v. X per Mac
    -   Microsoft PowerPoint v. X per Mac - [Download dell'aggiornamento (KB924998)](http://www.microsoft.com/italy/mac/default.mspx)
...
Nelle versioni di PowerPoint esposte alle vulnerabilità, se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti queste vulnerabilità può assumere il controllo completo del sistema, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Microsoft consiglia di applicare l'aggiornamento immediatamente.

**Livelli di gravità e identificatori della vulnerabilità:**

| Identificatori della vulnerabilità                                                                                                                                          | Effetti della vulnerabilità             | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft Office PowerPoint 2003 | Microsoft PowerPoint 2004 per Mac e PowerPoint v.X per Mac |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|---------------------------|---------------------------|----------------------------------|------------------------------------------------------------|
| Vulnerabilità legata al puntatore a oggetto non valido in PowerPoint - [CVE-2006-3435](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435)                     | Esecuzione di codice in modalità remota | Nessuno                   | Nessuno                   | Importante                       | Nessuno                                                    |
| Vulnerabilità legata al record di dati non valido in PowerPoint - [CVE-2006-3876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876)                          | Esecuzione di codice in modalità remota | Critico                   | Importante                | Importante                       | Importante                                                 |
...
| Vulnerabilità legata al record non valido in PowerPoint - [CVE-2006-4694](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4694)                                  | Esecuzione di codice in modalità remota | Critico                   | Importante                | Importante                       | Importante                                                 |
...
<span></span>
**Perché Microsoft ha rivisto in misura ridotta questo bollettino il 13 febbraio 2006?**
Ulteriori ricerche su CVE-2006-3877 hanno rilevato la scarsa efficacia dell'aggiornamento nella rimozione della vulnerabilità dai sistemi interessati. Il bollettino Microsoft sulla sicurezza MS07-015 è stato pubblicato per risolvere correttamente CVE-2006-3877 ed è opportuno applicare immediatamente gli aggiornamenti in esso contenuti.
...
| ID bollettino                                                           | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft Office PowerPoint 2003 | Microsoft PowerPoint 2004 per Mac e PowerPoint v.X per Mac |
|-------------------------------------------------------------------------|---------------------------|---------------------------|----------------------------------|------------------------------------------------------------|
| [**MS06-028**](http://technet.microsoft.com/security/bulletin/ms06-028) | Sostituito                | Sostituito                | Sostituito                       | Sostituito                                                 |
...
| Microsoft Office PowerPoint 2003  | Sì         | Sì       |
...
|-----------------------------------|---------|----------|
| Microsoft PowerPoint 2000         | Sì      | Sì       |
| Microsoft PowerPoint 2002         | Sì      | Sì       |
| Microsoft Office PowerPoint 2003  | Sì      | Sì       |
| Microsoft PowerPoint 2004 per Mac | No      | No       |
| Microsoft PowerPoint v. X per Mac | No      | No       |
...
<span></span>
#### Vulnerabilità legata al puntatore a oggetto non valido in PowerPoint - CVE-2006-3435:

In PowerPoint esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può tentare di sfruttare la vulnerabilità quando PowerPoint analizza un file con un puntatore a oggetto non valido.
...
#### Fattori attenuanti della vulnerabilità legata al puntatore a oggetto non valido in PowerPoint - CVE-2006-3435:
...
#### Soluzioni alternative per la vulnerabilità legata al puntatore a oggetto non valido in PowerPoint - CVE-2006-3435:
...
#### Domande frequenti sulla vulnerabilità legata al puntatore a oggetto non valido in PowerPoint - CVE-2006-3435:
...
PowerPoint non esegue una convalida dei dati adeguata quando elabora i contenuti di un file ppt. Se in PowerPoint viene aperto un file PowerPoint appositamente predisposto e viene analizzata un oggetto non valido, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
L'aggiornamento elimina la vulnerabilità modificando il modo in cui PowerPoint analizza il file e convalida il puntatore a oggetto prima di passarlo al buffer allocato.
...
#### Vulnerabilità legata al record di dati non valido in PowerPoint - CVE-2006-3876:

In PowerPoint esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può tentare di sfruttare la vulnerabilità quando PowerPoint analizza un file con un record di dati non valido.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti della vulnerabilità legata al record di dati non valido in PowerPoint - 2006-3876:
...
#### Soluzioni alternative per la vulnerabilità legata al record di dati non valido in PowerPoint - CVE-2006-3876:

-   Non aprire o salvare file Microsoft PowerPoint provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata al record di dati non valido in PowerPoint - CVE-2006-3876:
...
**Quali sono le cause di questa vulnerabilità?**
PowerPoint non esegue una convalida dei dati adeguata quando elabora i contenuti di un file ppt. Se in PowerPoint viene aperto un file PowerPoint appositamente predisposto e viene analizzata un record di dati non valido, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento elimina la vulnerabilità modificando il modo in cui PowerPoint analizza il file e convalida la lunghezza di un record di dati prima di passarlo al buffer allocato.
...
#### Vulnerabilità legata al record non valido in PowerPoint - CVE-2006-4694:

In PowerPoint esiste una vulnerabilità legata all'esecuzione di codice in modalità remota che potrebbe essere sfruttata quando PowerPoint apre un file appositamente predisposto. Tale file potrebbe essere contenuto in un allegato di posta elettronica o ospitato su un sito web dannoso. Un utente malintenzionato può sfruttare tale vulnerabilità creando un file PowerPoint appositamente predisposto che potrebbe consentire l'esecuzione di codice in modalità remota.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti della vulnerabilità legata al record non valido di PowerPoint - CVE-2006-4694:
...
#### Soluzioni alternative per la vulnerabilità legata al record non valido di PowerPoint - CVE-2006-4694:
...
**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità è causata da un errore nel modo in cui PowerPoint apre un file PowerPoint appositamente predisposto. Questo errore può consentire l'accesso alla memoria al fuori delle aree previste quando PowerPoint analizza i dati segnaposto.
...
1.  [Scaricare l'aggiornamento per la protezione per PowerPoint 2000.](http://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-enu.exe)
...
1.  [Scaricare l'aggiornamento per la protezione per](http://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923092-fullfile-enu.exe) PowerPoint 2002.
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Gestione risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto se installare l'aggiornamento, scegliere **Sì**.
...
1.  [Scaricare l'aggiornamento per la protezione per PowerPoint 2002](http://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923092-fullfile-enu.exe).
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse, individuare la cartella contenente il file salvato. Fare clic su **Start**, scegliere **Esegui**, digitare il comando seguente, quindi fare clic su **OK** per estrarre il file .msp:
    **\[percorso\\nome del file EXE\] /c /t:C:\\AdminUpdate**
...
1.  [Scaricare l'aggiornamento per la protezione per](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe)PowerPoint 2003.
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Gestione risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto se installare l'aggiornamento, scegliere **Sì**.
...
1.  [Scaricare l'aggiornamento per la protezione per PowerPoint 2003](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe).
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse, individuare la cartella contenente il file salvato. Fare clic su **Start**, scegliere **Esegui**, digitare il comando seguente, quindi fare clic su **OK** per estrarre il file .msp:
    **\[percorso\\nome del file EXE\] /c /t:C:\\AdminUpdate**
...
-   Arnaud Dovi, collaboratore di [Zero Day Initiative (ZDI)](http://www.zerodayinitiative.com/) e [TippingPoint](http://tippingpoint.com), per aver segnalato la vulnerabilità legata al puntatore a oggetto non valido in PowerPoint - [CVE-2006-3435](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435).
-   Dejun Meng di [Fortinet Inc](http://www.fortinet.com/). per aver segnalato la vulnerabilità legata al record di dati non valido in PowerPoint - [CVE-2006-3876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876).
-   Chris Ries di [VigilantMinds Inc.](http://www.vigilantminds.com) per aver segnalato la vulnerabilità legata al danneggiamento della memoria con record non validi in PowerPoint - [CVE-2006-3877](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877).
...
-   V1.1 (21 febbraio 2007): Bollettino aggiornato: ulteriori ricerche su CVE-2006-3877 hanno rilevato la scarsa efficacia dell'aggiornamento nella rimozione della vulnerabilità dai sistemi interessati. Il bollettino Microsoft sulla sicurezza MS07-015 è stato pubblicato per risolvere correttamente CVE-2006-3877 ed è opportuno applicare immediatamente gli aggiornamenti in esso contenuti.
