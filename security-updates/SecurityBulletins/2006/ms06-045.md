---
TOCTitle: 'MS06-045'
Title: 'Bollettino Microsoft sulla sicurezza MS06-045 - Critico'
ms:assetid: 'ms06-045'
ms:contentKeyID: 61240186
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-045(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-045 - Critico
=======================================================

Una vulnerabilità in Esplora risorse può consentire l'esecuzione di codice in modalità remota (921398)
------------------------------------------------------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=38cee83e-b17a-4c08-90ce-fb836b9615ad)
-   Microsoft Windows XP Service Pack 1 e Microsoft Windows XP Service Pack 2 – [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=6ef68858-4c91-47fb-ae34-0be556f10ede)
-   Microsoft Windows XP Professional x64 Edition – [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=50935f4e-e383-493e-97c6-599cbb2b87cc)
-   Microsoft Windows Server 2003 e Microsoft Windows Server 2003 Service Pack 1 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=759435a3-98f9-4115-b52e-d7fa9d024f16)
-   Microsoft Windows Server 2003 per sistemi basati su Itanium e Microsoft Windows Server 2003 con SP1 per sistemi basati su Itanium - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=462131c6-a728-4b3c-94de-85deccc42c3e)
-   Microsoft Windows Server 2003 x64 Edition – [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=50eef5c5-861d-4802-85a2-6b0627aafc2a)
...
|------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Vulnerabilità legata all'esecuzione di codice GUID cartella - [CVE-2006-3281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3281) | Esecuzione di codice in modalità remota | Importante   | Importante                | Importante                | Importante          | Importante                         |
...
|---------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| **MS05-016**  | Sostituito   | Sostituito                | Sostituito                | Sostituito          | Non applicabile                    |
...
<span></span>
#### Vulnerabilità legata all'esecuzione di codice GUID cartella - CVE-2006-3281:

Esplora risorse presenta una vulnerabilità legata all'esecuzione di codice in modalità remota a causa del modo in cui gestisce gli eventi di trascinamento. Un utente malintenzionato potrebbe sfruttare la vulnerabilità creando una pagina Web dannosa in grado di consentirgli di salvare un file nel sistema dell'utente se quest'ultimo ha visitato un sito Web dannoso o ha aperto un messaggio di posta elettronica dannoso. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato Per sfruttare la vulnerabilità è necessaria l'interazione dell'utente.

#### Fattori attenuanti della vulnerabilità legata all'esecuzione di codice GUID cartella - CVE-2006-3281:
...
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di codice GUID cartella - CVE-2006-3281:
...
-   **Utilizzare le impostazioni dei criteri di gruppo per disabilitare il servizio Web Client in tutti i sistemi interessati che non richiedono questa funzionalità.**
    ...
    **Nota** Si consiglia inoltre di leggere la [Guida per la protezione di Windows Server 2003](http://www.microsoft.com/technet/security/prodtech/windowsserver2003/w2003hg/sgch00.mspx) che include informazioni sulla modalità di disabilitazione di questi servizi.
    ...
    -   [Criteri di gruppo in Windows Server 2003](http://www.microsoft.com/windowsserver2003/techinfo/overview/gpintro.mspx)

    **Effetto della soluzione alternativa:** Se il servizio Web Client è disabilitato, le richieste di Web Distributed Authoring and Versioning (WebDAV) non verranno trasmesse. Se il servizio Web Client è disabilitato, tutti i servizi che dipendono esplicitamente da esso non verranno avviati e in questi casi verrà registrato un messaggio di errore nel registro eventi di sistema. Gli utenti di Windows Server 2003 non potranno utilizzare la funzionalità Apri come cartella Web.

-   **Disattivare il gestore file: protocolli**.
    ...
    **Nota** Prima di modificare il Registro di sistema, è consigliabile eseguirne il backup.
    ...
    Per disattivare il gestore file: protocolli, attenersi alla seguente procedura:

    1.  Chiudere tutte le istanze di Internet Explorer
    2.  Fare clic su **Start**, quindi su **Esegui**, digitare "**regedt32**" (senza virgolette) e fare clic su **OK**.
    3.  Nell'Editor del Registro di sistema, individuare la chiave del Registro di sistema: HKEY\_LOCAL\_MACHINE\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer.
    4.  Aggiungere o modificare il valore DWORD **NoFileUrl**.
    5.  Impostare il valore su **1**.

    **Effetto della soluzione alternativa:** Gli URL che utilizzano il gestore file: non funzioneranno.
...
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di codice GUID cartella - CVE-2006-3281:
...
La gestione inadeguata da parte di Esplora risorse degli eventi di trascinamento. Per sfruttare la vulnerabilità è necessaria l'interazione dell'utente.

**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**
Un utente malintenzionato che riesce a indurre un utente a visitare il proprio sito web e salvare un file appositamente predisposto nel sistema interessato potrebbe assumere il pieno controllo del sistema dell'utente.
...
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice CVE-2006-3281 ed è stata anche definita dagli addetti alla sicurezza Vulnerabilità legata all'esecuzione del file HTA e all'intercettazione di informazioni personali in Microsoft Internet Explorer.
...
**Qual è la relazione tra questa vulnerabilità e la vulnerabilità corretta dal bollettino MS06-015?**
Entrambe le vulnerabilità interessavano Esplora risorse. Tuttavia, il presente aggiornamento risolve una nuova vulnerabilità non affrontata nel bollettino MS05-015. MS06-015 consente di proteggere il sistema dalle vulnerabilità in esso illustrate, ma non da quella trattata nel presente bollettino. Quest'aggiornamento non sostituisce MS06-015
...
|--------------|---------------|-------------|-------|------------|-----|----------|
| Shell32.dll  | 6.0.3790.559  | 13-lug-2006 | 12:42 | 8.173.056  |     | RTMGDR   |
| Shell32.dll  | 6.0.3790.559  | 13-lug-2006 | 12:59 | 8.174.080  | x86 | RTMQFE   |
| Shell32.dll  | 6.0.3790.2746 | 13-lug-2006 | 12:55 | 8.382.976  | x86 | SP1GDR   |
| Shell32.dll  | 6.0.3790.2746 | 13-lug-2006 | 13:06 | 8.384.512  | x86 | SP1QFE   |
| W03a2409.dll | 5.2.3790.2746 | 13-lug-2006 | 09:48 | 26.624     | x86 | SP1QFE   |
...
| Nome file     | Versione      | Data        | Ora   | Dimensione | CPU   | Cartella    |
|---------------|---------------|-------------|-------|------------|-------|-------------|
| Shell32.dll   | 6.0.3790.559  | 13-lug-2006 | 13:54 | 12.969.984 | IA-64 | RTMGDR      |
| Wshell32.dll  | 6.0.3790.559  | 13-lug-2006 | 13:54 | 8.173.056  |       | RTMGDR\\WOW |
| Shell32.dll   | 6.0.3790.559  | 13-lug-2006 | 13:55 | 12.973.056 | IA-64 | RTMQFE      |
| Wshell32.dll  | 6.0.3790.559  | 13-lug-2006 | 13:55 | 8.174.080  | x86   | RTMQFE\\WOW |
| Shell32.dll   | 6.0.3790.2746 | 13-lug-2006 | 14:08 | 13.254.656 | IA-64 | SP1GDR      |
| Wshell32.dll  | 6.0.3790.2746 | 13-lug-2006 | 14:08 | 8.382.976  | x86   | SP1GDR\\WOW |
| Shell32.dll   | 6.0.3790.2746 | 13-lug-2006 | 13:55 | 13.258.240 | IA-64 | SP1QFE      |
| W03a2409.dll  | 5.2.3790.2746 | 13-lug-2006 | 13:55 | 25.600     | IA-64 | SP1QFE      |
| Wshell32.dll  | 6.0.3790.2746 | 13-lug-2006 | 13:55 | 8.384.512  | x86   | SP1QFE\\WOW |
| Ww03a2409.dll | 5.2.3790.2746 | 13-lug-2006 | 13:55 | 26.624     | x86   | SP1QFE\\WOW |
...
| Nome file     | Versione      | Data        | Ora   | Dimensione | CPU | Cartella    |
|---------------|---------------|-------------|-------|------------|-----|-------------|
| Shell32.dll   | 6.0.3790.2746 | 13-lug-2006 | 14:07 | 10.499.584 | x64 | SP1GDR      |
| Wshell32.dll  | 6.0.3790.2746 | 13-lug-2006 | 14:07 | 8.382.976  | x86 | SP1GDR\\WOW |
| Shell32.dll   | 6.0.3790.2746 | 13-lug-2006 | 13:55 | 10.502.144 | x64 | SP1QFE      |
| W03a2409.dll  | 5.2.3790.2746 | 13-lug-2006 | 13:55 | 27.136     | x64 | SP1QFE      |
| Wshell32.dll  | 6.0.3790.2746 | 13-lug-2006 | 13:55 | 8.384.512  | x86 | SP1QFE\\WOW |
| Ww03a2409.dll | 5.2.3790.2746 | 13-lug-2006 | 13:55 | 26.624     | x86 | SP1QFE\\WOW |
...
-   **Controllo delle chiavi del Registro di sistema**
    ...
    **Nota** Questa chiave del Registro di sistema potrebbe non contenere un elenco completo dei file installati. Inoltre, se un amministratore o un OEM integra o esegue lo slipstreaming dell'aggiornamento per la protezione 921398 nei file di origine dell'installazione di Windows, è possibile che questa chiave del Registro di sistema non venga creata correttamente.
...
| Shell32.dll  | 6.0.2800.1873 | 13-lug-2006 | 13:46 | 8.353.280  | x86 | SP1QFE                                            |
| Sxs.dll      | 5.1.2600.1579 | 20-ago-2004 | 22:01 | 700.928    | x86 | SP1QFE                                            |
| Comctl32.dll | 6.0.2800.1873 | 13-lug-2006 | 13:46 | 925,184    | x86 | SP1QFE\\ASMS\\60\\MSFT\\WINDOWS\\COMMON\\CONTROLS |
| Controls.man |               | 13-lug-2006 | 14:02 | 1.812      |     | SP1QFE\\ASMS\\60\\MSFT\\WINDOWS\\COMMON\\CONTROLS |
| Comctl.man   |               | 13-lug-2006 | 14:02 | 621        |     | SP1QFE\\ASMS\\60\\POLICY\\60\\COMCTL              |
| Shell32.dll  | 6.0.2900.2951 | 13-lug-2006 | 13:33 | 8.453.632  | x86 | SP2GDR                                            |
| Shell32.dll  | 6.0.2900.2951 | 13-lug-2006 | 14:03 | 8.457.728  | x86 | SP2QFE                                            |
| Xpsp3res.dll | 5.1.2600.2951 | 13-lug-2006 | 11:22 | 150.016    | x86 | SP2QFE                                            |
...
-   **Controllo delle chiavi del Registro di sistema**
    ...
    **Nota** Queste chiavi del Registro di sistema potrebbero non contenere un elenco completo dei file installati. Inoltre, se un amministratore o un OEM integra o esegue lo slipstreaming dell'aggiornamento per la protezione 921398 nei file di origine dell'installazione di Windows, è possibile che queste chiavi del Registro di sistema non vengano create correttamente.
...
|-------------|---------------|-------------|-------|------------|-----|
| Shell32.dll | 5.0.3900.7105 | 13-lug-2006 | 19:39 | 2.362.640  | x86 |
