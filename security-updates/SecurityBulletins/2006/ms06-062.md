---
TOCTitle: 'MS06-062'
Title: 'Bollettino Microsoft sulla sicurezza MS06-062 - Critico'
ms:assetid: 'ms06-062'
ms:contentKeyID: 61240203
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-062(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-062 - Critico
=======================================================

Alcune vulnerabilità in Microsoft Office possono consentire l'esecuzione di codice in modalità remota (922581)
--------------------------------------------------------------------------------------------------------------
...
-   Microsoft Office 2000 Service Pack 3 - [Download dell'aggiornamento (KB923274)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=e0c7e1e4-7859-4c7e-898e-1cf05014885b)
    ...
    -   Microsoft Word 2000
-   Microsoft Office XP Service Pack 3 - [Download dell'aggiornamento (KB923273)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=958ee063-d88d-4e45-8555-4d1c4730f5c8)
    ...
    -   Microsoft Word 2002
-   Microsoft Office 2003 Service Pack 1 o Service Pack 2 - [Download dell'aggiornamento (KB923272)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=0d399f68-ec0d-4768-9846-b16b3dadf247)
...
-   Microsoft Project 2000 Service Release 1 - [Download dell'aggiornamento (KB923274)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=266a9870-cd03-45ca-877b-b5ad2c873fe5)
-   Microsoft Project 2002 Service Pack 1 - [Download dell'aggiornamento (KB923273)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=a77dea18-d237-4bb0-9464-ce31b6ae52d6)
-   Microsoft Visio 2002 Service Pack 2 - [Download dell'aggiornamento (KB923273)](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=fd4b7660-0fc5-43e5-9683-b6dae96136bb)
...
| Identificatori della vulnerabilità                                                                                                                                      | Effetti della vulnerabilità             | Microsoft Office 2000 | Microsoft Office XP | Microsoft Office 2003 | Microsoft Office 2004 per Mac o Microsoft Office v. X per Mac |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-----------------------|---------------------|-----------------------|---------------------------------------------------------------|
| Vulnerabilità relativa all'accesso alla memoria non autorizzato in Office - [CVE-2006-3434](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)            | Esecuzione di codice in modalità remota | Critico               | Importante          | Importante            | Importante                                                    |
| Vulnerabilità legata al record di diagramma non valido in Office - [CVE-2006-3650](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)                     | Esecuzione di codice in modalità remota | Critico               | Importante          | Importante            | Importante                                                    |
| Vulnerabilità legata al danneggiamento della memoria con record non validi in Office - [CVE-2006-3864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864) | Esecuzione di codice in modalità remota | Critico               | Importante          | Importante            | Importante                                                    |
| Vulnerabilità legata all'analisi degli smart tag in Microsoft Office - [CVE-2006-3868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3868)                 | Esecuzione di codice in modalità remota | Nessuno               | Importante          | Importante            | Nessuno                                                       |
...
| ID bollettino                                                           | Microsoft Office 2000 | Microsoft Office XP, Project 2002 Service Pack 1 o Visio 2002 Service Pack 2 | Microsoft Office 2003 | Microsoft Office 2004 per Mac o Microsoft Office v. X per Mac |
|-------------------------------------------------------------------------|-----------------------|------------------------------------------------------------------------------|-----------------------|---------------------------------------------------------------|
| [**MS06-048**](http://technet.microsoft.com/security/bulletin/ms06-048) | Sostituito            | Sostituito                                                                   | Sostituito            | Sostituito                                                    |
...
| Project 2000 Service Pack 2   | Sì         | Sì       |
| Project 2002 Service Pack 1   | Sì         | Sì       |
| Visio 2002 Service Pack 2     | Sì         | Sì       |
...
La seguente tabella contiene le informazioni di riepilogo di SMS per questo aggiornamento per la protezione.
...
<span></span>
#### Vulnerabilità relativa all'accesso alla memoria non autorizzato in Office - CVE-2006-3434:

In Office esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può tentare di sfruttare la vulnerabilità quando Office analizza un file con una stringa non valida.
...
#### Fattori attenuanti della vulnerabilità relativa all'accesso alla memoria non autorizzato in Office - CVE-2006-3434:
...
#### Soluzione alternative per la vulnerabilità relativa all'accesso alla memoria non autorizzato in Office - CVE-2006-3434:
...
#### Domande frequenti sulla vulnerabilità relativa all'accesso alla memoria non autorizzato in Office - CVE-2006-3434:
...
**Credevo che Word facesse parte di Microsoft Works Suite, ma Microsoft Works Suite viene elencato come software non interessato. Perché?**
Microsoft Works Suite non viene fornito con la versione completa di Word e non è dunque interessato da queste vulnerabilità.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento elimina la vulnerabilità modificando il modo in cui Office analizza il file e convalida la lunghezza di una stringa prima di passarla al buffer allocato.
...
#### Vulnerabilità legata al record di diagramma non valido in Office - CVE-2006-3650:

In Office esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può tentare di sfruttare la vulnerabilità quando Office analizza un file con record di diagrammi non validi.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti della vulnerabilità legata al record dei diagrammi non valido in Office - CVE-2006-3650:
...
#### Soluzioni alternative per la vulnerabilità legata al record di diagrammi non valido in Office - CVE-2006-3650:

-   Non aprire o salvare file Microsoft Office provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata al record di diagrammi non valido in Office - CVE-2006-3650:
...
**Quali sono le cause di questa vulnerabilità?**
Office non esegue una convalida dei dati adeguata quando elabora i contenuti di un file. Se in Office viene aperto un file appositamente predisposto e viene analizzato un record di diagrammi non valido, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
#### Vulnerabilità legata al danneggiamento della memoria con record non validi in Office - CVE-2006-3864:

In Office esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Un utente malintenzionato può tentare di sfruttare la vulnerabilità quando Office analizza un file con un record non valido.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti per la vulnerabilità legata al danneggiamento della memoria con record non validi in Office - CVE-2006-3864:
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria con record non validi in Office - CVE-2006-3864:

-   Non aprire o salvare file Microsoft Office provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria con record non validi in Office - CVE-2006-3864:
...
#### Vulnerabilità legata all'analisi degli smart tag in Microsoft Office - CVE-2006-3868:

In Microsoft Office esiste una vulnerabilità legata all'esecuzione di codice in modalità remota che può essere sfruttata quando Office apre un file appositamente predisposto e analizza uno smart tag non valido. Tale file appositamente predisposto potrebbe essere contenuto in un allegato di posta elettronica o ospitato su un sito Web dannoso. La visualizzazione o l'anteprima di un messaggio di posta elettronica non valido in Outlook non comporta lo sfruttamento di questa vulnerabilità. Un utente malintenzionato può sfruttare tale vulnerabilità creando un file Office appositamente predisposto che potrebbe consentire l'esecuzione di codice in modalità remota.

Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

#### Fattori attenuanti della vulnerabilità legata all'analisi degli smart tag in Microsoft Office - CVE-2006-3868:

-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
-   In uno scenario di attacco dal Web, l'utente malintenzionato dovrebbe pubblicare un sito Web contenente un file di Office utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti possono includere contenuti appositamente predisposti in grado di sfruttare questa vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare un sito Web dannoso, l'utente malintenzionato dovrebbe invogliare le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento che le indirizzi al sito.
-   Non è possibile sfruttare la vulnerabilità automaticamente per posta elettronica. L'attacco è possibile solo se l'utente apre un allegato a un messaggio di posta elettronica.

#### Soluzioni alternative per la vulnerabilità legata all'analisi degli smart tag in Microsoft Office - CVE-2006-3868:

-   Non aprire o salvare file Microsoft Office provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata all'analisi degli smart tag in Microsoft Office - CVE-2006-3868:
...
**Quali sono le cause di questa vulnerabilità?**
Durante l'apertura in Microsoft Office di un file Office appositamente predisposto e l'analisi di uno smart tag non valido, la memoria di sistema può essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento elimina la vulnerabilità modificando il modo in cui Microsoft Office convalida la lunghezza di uno smart tag prima di passarlo al buffer allocato.

**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice CVE-2006-3868.
...
|-----------|------------|------------|-------|------------|
| Mso9.dll  | 9.0.0.8950 | 6-set-2006 | 05:58 | 5.595.185  |
...
1.  [Scaricare questo aggiornamento per la protezione per Office XP](http://download.microsoft.com/download/08/04/04/4842fc39-5d06-4eeb-8293-ac84074106ac/officexp-kb923273-fullfile-enu.exe) e/o [Project 2002 Service Pack 1](http://download.microsoft.com/download/0/6/7/067865cf-7805-4933-bc3c-f9ed874e008e/officexp-kb923273-fullfile-enu.exe) e/o [Visio Service Pack 2](http://download.microsoft.com/download/e/3/0/e30ee874-8089-4bb9-bb44-a655e5e1017f/visio2002-kb923273-fullfile-enu.exe).
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto di installare l'aggiornamento, scegliere **Sì**.
...
1.  [Scaricare l'aggiornamento per la protezione](http://download.microsoft.com/download/0/a/c/0ac9daa9-5d89-4613-a28e-de1e0c39c22d/office2003-kb923272-fullfile-enu.exe) per Office 2003.
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto di installare l'aggiornamento, scegliere **Sì**.
...
1.  [Scaricare l'aggiornamento per la protezione per Office 2003](http://download.microsoft.com/download/0/a/c/0ac9daa9-5d89-4613-a28e-de1e0c39c22d/office2003-kb923272-fullfile-enu.exe).
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse, individuare la cartella contenente il file salvato. Fare clic su **Start**, scegliere **Esegui**, digitare il comando seguente e scegliere **OK** per estrarre il file .msp:
    **\[percorso\\nome del file EXE\] /c /t:C:\\AdminUpdate**
...
-   Dejun Meng di [Fortinet Inc](http://www.fortinet.com/). per aver segnalato la vulnerabilità relativa all'accesso alla memoria non autorizzato in Office - [CVE-2006-3434](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)
-   Arnaud Dovi che collabora con [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) per aver segnalato la Vulnerabilità legata al record di diagramma non valido in Office - [CVE-2006-3650](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)
-   Sowhat di [Nevis Labs](http://www.nevisnetworks.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria con record non validi in Office - [CVE-2006-3864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864)
