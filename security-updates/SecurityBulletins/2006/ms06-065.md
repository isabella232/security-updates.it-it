---
TOCTitle: 'MS06-065'
Title: 'Bollettino Microsoft sulla sicurezza MS06-065 - Medio'
ms:assetid: 'ms06-065'
ms:contentKeyID: 61240206
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-065(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-065 - Medio
=====================================================

Una vulnerabilità in Windows Packager può consentire l'esecuzione di codice in modalità remota (924496)
-------------------------------------------------------------------------------------------------------
...
-   Microsoft Windows XP Service Pack 1 e Microsoft Windows XP Service Pack 2 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=86c2b78e-53bf-4ddd-88f6-5d12c6d18c90)
-   Microsoft Windows XP Professional x64 Edition - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=2ac72356-7772-41b6-b4a6-7215c89f7347)
-   Microsoft Windows Server 2003 e Microsoft Windows Server 2003 Service Pack 1 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=e2f5b9f9-4481-44f9-9aef-1af0afae8319)
-   Microsoft Windows Server 2003 per sistemi basati su Itanium e Microsoft Windows Server 2003 con SP1 per sistemi basati su Itanium - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=8c9a22a6-bd61-4fd4-9aa4-012d745046da)
-   Microsoft Windows Server 2003 x64 Edition - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=ec4f4f72-8467-4964-ad28-ed9ea7562e0b)
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Vulnerabilità legata allo spoofing della finestra di dialogo Packager - [CVE-2006-4692](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4692) | Esecuzione di codice in modalità remota | Moderato                  | Moderato                  | Basso               | Basso                              |
...
<span></span>
#### Vulnerabilità legata allo spoofing della finestra di dialogo Packager - CVE-2006-4692:

In Windows Packager esiste una vulnerabilità legata all'esecuzione di codice in modalità remota provocata dal modo in cui vengono gestite le estensioni dei file. Un utente malintenzionato potrebbe sfruttare la vulnerabilità creando un file appositamente predisposto in grado di consentire l'esecuzione di codice in modalità remota, se un utente visita il sito Web appositamente predisposto. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato Per poter sfruttare questa vulnerabilità è tuttavia necessaria una certa interazione dell'utente.

#### Fattori attenuanti della vulnerabilità legata allo spoofing della finestra di dialogo Packager - CVE-2006-4692:
...
#### Soluzione alternative per la vulnerabilità legata allo spoofing della finestra di dialogo Packager - CVE-2006-4692:

Non abbiamo individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata allo spoofing della finestra di dialogo Packager - CVE-2006-4692:

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Se la vulnerabilità viene sfruttata, può consentire a un utente malintenzionato di assumere in remoto il controllo completo del sistema interessato, riuscendo quindi a installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Per sfruttare questa vulnerabilità è tuttavia necessaria l'interazione dell'utente. Gli utenti dovrebbero considerare l'installazione dell'aggiornamento Per sfruttare la vulnerabilità l'utente dovrebbe aprire un file .rtf e fare clic su un oggetto in esso contenuto. Una volta fatto clic sull'oggetto, l'utente dovrebbe fare clic sull'oggetto contenuto nel file e accettare una finestra di dialogo fuorviante indicante che l'utente sta per accedere a un tipo di file diverso.

**Quali sono le cause di questa vulnerabilità?**
Una gestione errata dei file da parte di Packager.

**Che cos'è Packager?**
Packager è uno strumento che può essere utilizzato per creare un pacchetto da inserire in un file. Per ulteriori informazioni su Packager, consultare la seguente [documentazione Microsoft.](http://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/packager_what_is_obj_pkg.mspx?mfr=true)
...
Un utente malintenzionato può tentare di sfruttare la vulnerabilità creando un file appositamente predisposto e inviandolo a un utente in un sistema interessato tramite un messaggio di posta elettronica in cui l'utente deve selezionare un collegamento per accettare il file. Una volta ricevuto il file, l'utente dovrebbe fare clic sull'oggetto contenuto nel file e accettare una finestra di dialogo fuorviante indicante che l'utente sta per accedere a un tipo di file differente. Il file può quindi costringere il sistema interessato a eseguire codice.
...
L'aggiornamento rimuove la vulnerabilità modificando il modo in cui Windows Explorer gestisce i file di Packager per visualizzare in modo appropriato il tipo di file del pacchetto.
...
Gli amministratori di sistema possono rimuovere l'aggiornamento per la protezione anche mediante l'utilità Spuninst.exe, disponibile nella cartella %Windir%\\$NTUninstallKB924496$\\Spuninst.
...
|--------------|---------------|-------------|-------|------------|----------|
| Browseui.dll | 6.0.2800.1892 | 4-sett-2006 | 06:23 | 1.027.072  | SP1QFE   |
| Shdocvw.dll  | 6.0.2800.1892 | 4-sett-2006 | 06:23 | 1.351.680  | SP1QFE   |
| Shdocvw.dll  | 6.0.2900.2987 | 4-sett-2006 | 06:08 | 1.494.016  | SP2GDR   |
| Shdocvw.dll  | 6.0.2900.2987 | 4-sett-2006 | 06:12 | 1.497.088  | SP2QFE   |

Windows XP Professional x64:

| Nome file    | Versione      | Data        | Ora   | Dimensione | CPU | Cartella    |
|--------------|---------------|-------------|-------|------------|-----|-------------|
| Shdocvw.dll  | 6.0.3790.2783 | 4-sett-2006 | 06:57 | 2.436.096  | x64 | SP1GDR      |
| Wshdocvw.dll | 6.0.3790.2783 | 4-sett-2006 | 06:58 | 1.513.984  | x86 | SP1GDR\\WOW |
| Shdocvw.dll  | 6.0.3790.2783 | 4-sett-2006 | 06:55 | 2.437.120  | x64 | SP1QFE      |
| Wshdocvw.dll | 6.0.3790.2783 | 4-sett-2006 | 06:55 | 1.515.008  | x86 | SP1QFE\\WOW |
...
| Nome file    | Versione      | Data        | Ora   | Dimensione | CPU | Cartella |
|--------------|---------------|-------------|-------|------------|-----|----------|
| Shdocvw.dll  | 6.0.3790.588  | 4-sett-2006 | 06:09 | 1.398.272  | x86 | RTMGDR   |
| Browseui.dll | 6.0.3790.550  | 23-giu-2006 | 20:54 | 1.057.280  | x86 | RTMQFE   |
| Shdocvw.dll  | 6.0.3790.588  | 4-sett-2006 | 06:14 | 1.399.296  | x86 | RTMQFE   |
| Shdocvw.dll  | 6.0.3790.2783 | 4-sett-2006 | 06:27 | 1.513.984  | x86 | SP1GDR   |
| Shdocvw.dll  | 6.0.3790.2783 | 4-sett-2006 | 06:31 | 1.515.008  | x86 | SP1QFE   |
...
| Nome file     | Versione      | Data        | Ora   | Dimensione | CPU   | Cartella    |
|---------------|---------------|-------------|-------|------------|-------|-------------|
| Shdocvw.dll   | 6.0.3790.588  | 4-sett-2006 | 06:55 | 3.375.104  | IA-64 | RTMGDR      |
| Wshdocvw.dll  | 6.0.3790.588  | 4-sett-2006 | 06:55 | 1.398.272  | x86   | RTMGDR\\WOW |
| Browseui.dll  | 6.0.3790.550  | 4-sett-2006 | 06:55 | 2.538.496  | IA-64 | RTMQFE      |
| Shdocvw.dll   | 6.0.3790.588  | 4-sett-2006 | 06:55 | 3.381.248  | IA-64 | RTMQFE      |
| Wbrowseui.dll | 6.0.3790.550  | 4-sett-2006 | 06:55 | 1.057.280  | x86   | RTMQFE\\WOW |
| Wshdocvw.dll  | 6.0.3790.588  | 4-sett-2006 | 06:55 | 1.399.296  | x86   | RTMQFE\\WOW |
| Shdocvw.dll   | 6.0.3790.2783 | 4-sett-2006 | 06:59 | 3.677.696  | IA-64 | SP1GDR      |
| Wshdocvw.dll  | 6.0.3790.2783 | 4-sett-2006 | 06:59 | 1.513.984  | x86   | SP1GDR\\WOW |
| Shdocvw.dll   | 6.0.3790.2783 | 4-sett-2006 | 06:55 | 3.678.720  | IA-64 | SP1QFE      |
| Wshdocvw.dll  | 6.0.3790.2783 | 4-sett-2006 | 06:55 | 1.515.008  | x86   | SP1QFE\\WOW |
...
-   Andreas Sandblad di [Secunia Research](http://www.secunia.com/) per aver segnalato la vulnerabilità legata allo spoofing della finestra di dialogo Packager - CVE-2006-4692
