---
TOCTitle: 'MS06-050'
Title: 'Bollettino Microsoft sulla sicurezza MS06-050 - Importante'
ms:assetid: 'ms06-050'
ms:contentKeyID: 61240191
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms06-050(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS06-050 - Importante
==========================================================

Alcune vulnerabilità nella libreria di oggetti Collegamento ipertestuale di Microsoft Windows possono consentire l'esecuzione di codice in modalità remota (920670)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=bfe3f869-08be-4f13-97a1-7274ad44c7fb)
-   Microsoft Windows XP Service Pack 1 e Microsoft Windows XP Service Pack 2 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=2d014bac-f03d-474a-a7ab-49e8ead8edb0)
-   Microsoft Windows XP Professional x64 Edition - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=cae094e4-64a0-4577-986b-4d6c131806d9)
-   Microsoft Windows Server 2003 e Microsoft Windows Server 2003 Service Pack 1 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=21d1e864-4517-4353-8477-b4cd3c6187c0)
-   Microsoft Windows Server 2003 per sistemi basati su Itanium e Microsoft Windows Server 2003 con SP1 per sistemi basati su Itanium - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=bc60b6c3-ada8-48ab-a63d-b2f1c9320b0d)
-   Microsoft Windows Server 2003 x64 Edition - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?familyid=9d2ba5d1-6f91-47b4-8cc1-dcd44baaa6ce)
...
L'aggiornamento risolve due vulnerabilità scoperte di recente. Ogni vulnerabilità è illustrata in dettaglio nella relativa sottosezione della sezione "Dettagli della vulnerabilità" del presente bollettino.
...
Perché un utente malintenzionato possa sfruttare queste vulnerabilità è necessaria l'interazione dell'utente.

Microsoft consiglia di installare l'aggiornamento il più presto possibile.

**Livelli di gravità e identificatori della vulnerabilità:**

| Identificatori della vulnerabilità                                                                                                                                   | Effetti della vulnerabilità             | Windows 2000 Service Pack 4 | Windows XP Service Pack 1 e Windows XP Service Pack 2 | Windows Server 2003 e Windows Server 2003 Service Pack 1 |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|-----------------------------|-------------------------------------------------------|----------------------------------------------------------|
| Vulnerabilità legata all'overflow del buffer di oggetti Collegamento ipertestuale - [CVE-2006-3086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086) | Esecuzione di codice in modalità remota | Importante                  | Importante                                            | Importante                                               |
| Vulnerabilità legata al funzionamento degli oggetti Collegamento ipertestuale - [CVE-2006-3438](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438)     | Esecuzione di codice in modalità remota | Importante                  | Importante                                            | Importante                                               |
...
| ID bollettino                                                           | Windows 2000 | Windows XP Service Pack 1 e Windows XP Service Pack 2 | Windows Server 2003 | Windows Server 2003 Service Pack 1 |
|-------------------------------------------------------------------------|--------------|-------------------------------------------------------|---------------------|------------------------------------|
| [**MS05-015**](http://technet.microsoft.com/security/bulletin/ms05-015) | Sostituito   | Sostituito                                            | Sostituito          | Non applicabile                    |
...
<span></span>
#### Vulnerabilità legata all'overflow del buffer di oggetti COM Collegamento ipertestuale - CVE-2006-3086:

Nella libreria di oggetti Collegamento ipertestuale esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Questo problema è causato da un buffer non controllato nel codice utilizzato per la gestione dei collegamenti. Un utente malintenzionato potrebbe sfruttare la vulnerabilità creando un collegamento ipertestuale dannoso potenzialmente in grado di portare all'esecuzione di codice in modalità remota se un utente seleziona un collegamento dannoso all'interno di un file Office o di un messaggio di posta elettronica. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere pieno controllo del sistema interessato. Per sfruttare la vulnerabilità è necessaria l'interazione dell'utente.

#### Fattori attenuanti della vulnerabilità legata all'overflow del buffer di oggetti COM Collegamento ipertestuale - CVE-2006-3086:

-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
-   Non è possibile sfruttare la vulnerabilità automaticamente per posta elettronica. L'attacco è possibile solo se l'utente malintenzionato induce una vittima a selezionare un collegamento presente in un messaggio di posta elettronica o aprire un file Office e selezionare un collegamento contenuto in quest'ultimo.

#### Soluzioni alternative per la vulnerabilità legata all'overflow del buffer di oggetti COM Collegamento ipertestuale - CVE-2006-3086:

Microsoft ha verificato le soluzioni alternative seguenti. Sebbene queste soluzioni alternative non eliminino la vulnerabilità sottostante, consentono di bloccare gli attacchi noti. È possibile che una soluzione alternativa non riesca a bloccare tutti i vettori di attacco. Se una soluzione alternativa riduce la funzionalità, viene identificata nella sezione seguente.

-   **Modificare l'elenco ACL per negare a tutti gli utenti l'accesso a Hlink.dll**
    La disattivazione della chiave Hlink.dll del Registro di sistema consente di proteggere il sistema interessato dai tentativi di sfruttare questa vulnerabilità. Per modificare la chiave del Registro di sistema Hlink.dll:

    -   Fare clic su **Start**, scegliere **Esegui**, digitare **cacls "%windir%\\system32\\hlink.dll" /d everyone** (senza virgolette) e scegliere **OK**.

    **Effetto della soluzione alternativa:** Gli utenti di applicazioni Office non saranno in grado di modificare i collegamenti o fare clic sui collegamenti incorporati nei documenti Office.

-   **Modificare l'elenco ACL per disattivare la chiave del Registro di sistema Protocollo HLINK**
    La modifica dell'elenco ACL nella chiave del Registro di sistema "**HLINK**" consente di proteggere il sistema interessato dai tentativi di sfruttare questa vulnerabilità. Per modificare la chiave del Registro di sistema, attenersi alla seguente procedura.
    ...
    **Nota** Prendere nota delle autorizzazioni elencate in questa finestra di dialogo per poterle successivamente riportare ai valori originali.
    ...
    2.  Espandere **HKEY\_CLASSES\_ROOT**, **CLSID** e fare clic su **{79eac9d0-baf9-11ce-8c82-00aa004ba90b}.**
    ...
    **Nota** Prendere nota delle autorizzazioni elencate in questa finestra di dialogo per poterle successivamente riportare ai valori originali.
    ...
    6.  Viene visualizzato un messaggio che indica che nessuno sarà in grado di accedere a questa chiave del Registro di sistema. Fare clic su **Sì**, quindi su **OK** per chiudere la finestra di dialogo **Autorizzazioni per {79eac9d0-baf9-11ce-8c82-00aa004ba90b}**.
...
-   **Non fare clic sui collegamenti nei documenti Microsoft Office provenienti da fonti non attendibili.**

#### Domande frequenti sulla vulnerabilità legata all'overflow del buffer di oggetti COM dei collegamenti - CVE-2006-3086:
...
Un buffer non controllato nella libreria di oggetti Collegamento ipertestuale.

**Che cos'è la libreria di oggetti Collegamento ipertestuale?**
La libreria di oggetti Collegamento ipertestuale è una raccolta di interfacce API (Application Programming Interface) che forniscono agli sviluppatori di software le funzionalità per la gestione dei collegamenti ipertestuali. Per ulteriori informazioni sui collegamenti, vedere la [documentazione del prodotto](http://msdn.microsoft.com/library/default.asp?url=/workshop/misc/hlink/overview/overview.asp).
...
L'aggiornamento elimina la vulnerabilità modificando il modo in cui la libreria di oggetti Collegamento ipertestuale convalida la lunghezza di un messaggio prima di passarlo al buffer allocato.

**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice CVE-2006-3086. Questo bollettino sulla sicurezza risolve la vulnerabilità divulgata privatamente e pubblicamente nonché altri problemi scoperti tramite ricerche interne.
...
Sì. Questo aggiornamento per la protezione risolve la vulnerabilità che può essere sfruttata utilizzando il codice di prova esistente pubblicato. Questa vulnerabilità è stata identificata con il codice CVE-2006-3086.

#### Vulnerabilità legata al funzionamento degli oggetti Collegamento ipertestuale - CVE-2006-3438:

Nella libreria di oggetti Collegamento ipertestuale esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Questo problema si verifica quando la libreria di oggetti Collegamento ipertestuale utilizza un file contenente una funzione non valida durante la gestione dei collegamenti. Un utente malintenzionato potrebbe sfruttare la vulnerabilità creando un collegamento ipertestuale dannoso potenzialmente in grado di portare all'esecuzione di codice in modalità remota se un utente seleziona un collegamento dannoso all'interno di un file Office o di un messaggio di posta elettronica. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere pieno controllo del sistema interessato. Per sfruttare la vulnerabilità è necessaria l'interazione dell'utente.

#### Fattori attenuanti della vulnerabilità nel funzionamento degli oggetti Collegamento ipertestuale - CVE-2006-3438:

-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
-   Non è possibile sfruttare la vulnerabilità automaticamente per posta elettronica. L'attacco è possibile solo se l'utente malintenzionato induce una vittima a selezionare un collegamento presente in un messaggio di posta elettronica o aprire un file Office e selezionare un collegamento contenuto in quest'ultimo.

#### Soluzioni alternative per la vulnerabilità nel funzionamento degli oggetti Collegamento ipertestuale - CVE-2006-3438:
...
#### Domande frequenti sulla vulnerabilità nel funzionamento degli oggetti Collegamento ipertestuale - CVE-2006-3438:
...
Gli amministratori di sistema possono rimuovere l'aggiornamento per la protezione anche mediante l'utilità Spuninst.exe, disponibile nella cartella %Windir%\\$NTUninstallKB920670$\\Spuninst.
...
|-----------|---------------|-------------|-------|------------|-----|----------|
| Hlink.dll | 5.2.3790.560  | 17-lug-2006 | 22:17 | 71.680     | x86 | RTMGDR   |
| Hlink.dll | 5.2.3790.560  | 17-lug-2006 | 22:37 | 71.680     | x86 | RTMQFE   |
| Hlink.dll | 5.2.3790.2748 | 17-lug-2006 | 22:40 | 72.704     | x86 | SP1GDR   |
| Hlink.dll | 5.2.3790.2748 | 17-lug-2006 | 22:45 | 72.704     | x86 | SP1QFE   |

| Nome file  | Versione      | Data        | Ora   | Dimensione | CPU   | Cartella    |
|------------|---------------|-------------|-------|------------|-------|-------------|
| Hlink.dll  | 5.2.3790.560  | 17-lug-2006 | 23:09 | 231.936    | IA-64 | RTMGDR      |
| Whlink.dll | 5.2.3790.560  | 17-lug-2006 | 23:09 | 71.680     | x86   | RTMGDR\\WOW |
| Hlink.dll  | 5.2.3790.560  | 17-lug-2006 | 23:09 | 231.936    | IA-64 | RTMQFE      |
| Whlink.dll | 5.2.3790.560  | 17-lug-2006 | 23:09 | 71.680     | x86   | RTMQFE\\WOW |
| Hlink.dll  | 5.2.3790.2748 | 17-lug-2006 | 23:13 | 246.784    | IA-64 | SP1GDR      |
| Whlink.dll | 5.2.3790.2748 | 17-lug-2006 | 23:13 | 72.704     | x86   | SP1GDR\\WOW |
| Hlink.dll  | 5.2.3790.2748 | 17-lug-2006 | 23:11 | 246.784    | IA-64 | SP1QFE      |
| Whlink.dll | 5.2.3790.2748 | 17-lug-2006 | 23:11 | 72.704     | x86   | SP1QFE\\WOW |
...
| Nome file  | Versione      | Data        | Ora   | Dimensione | CPU | Cartella    |
|------------|---------------|-------------|-------|------------|-----|-------------|
| Hlink.dll  | 5.2.3790.2748 | 17-lug-2006 | 23:11 | 156.160    | x64 | SP1GDR      |
| Whlink.dll | 5.2.3790.2748 | 17-lug-2006 | 23:11 | 72.704     | x86 | SP1GDR\\WOW |
| Hlink.dll  | 5.2.3790.2748 | 17-lug-2006 | 23:08 | 156.160    | x64 | SP1QFE      |
| Whlink.dll | 5.2.3790.2748 | 17-lug-2006 | 23:08 | 72.704     | x86 | SP1QFE\\WOW |
...
-   **Controllo delle chiavi del Registro di sistema**
    ...
    **Nota** Questa chiave del Registro di sistema potrebbe non contenere un elenco completo dei file installati. Inoltre, se un amministratore o un OEM integra o esegue lo slipstreaming dell'aggiornamento per la protezione 920670 nei file di origine dell'installazione di Windows, è possibile che questa chiave del Registro di sistema non venga creata correttamente.
...
| Nome file | Versione      | Data        | Ora   | Dimensione | CPU | Cartella |
|-----------|---------------|-------------|-------|------------|-----|----------|
| Hlink.dll | 5.2.3790.2748 | 21-lug-2006 | 08:30 | 72.704     | x86 | SP1QFE   |
| Hlink.dll | 5.2.3790.2748 | 21-lug-2006 | 08:24 | 72.704     | x86 | SP2GDR   |
| Hlink.dll | 5.2.3790.2748 | 21-lug-2006 | 08:26 | 72.704     | x86 | SP2QFE   |
...
-   **Controllo delle chiavi del Registro di sistema**
    ...
    **Nota** Queste chiavi del Registro di sistema potrebbero non contenere un elenco completo dei file installati. Inoltre, se un amministratore o un OEM integra o esegue lo slipstreaming dell'aggiornamento per la protezione 920670 nei file di origine dell'installazione di Windows, è possibile che queste chiavi del Registro di sistema non vengano create correttamente.
...
|-----------|---------------|-------------|-------|------------|
| Hlink.dll | 5.2.3790.2748 | 22-lug-2006 | 03:38 | 72.704     |
...
-   Pedram Amini di [TippingPoint Security Research Team](http://www.tippingpoint.com/security) per aver segnalato la vulnerabilità legata all'overflow del buffer di oggetti Collegamento ipertestuale - [CVE-2006-3086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086).
-   Steve Tai di [CSC Australia Pty Limited](http://au.country.csc.com/en/) per aver segnalato la vulnerabilità legata al funzionamento degli oggetti Collegamento ipertestuale - [CVE-2006-3438](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438).
...
-   V1.1 (13 settembre 2006): Aggiornata la sezione “Informazioni sull'aggiornamento per la sicurezza”, con una modifica alla chiave del Registro di sistema per Windows 2003.
