...
| **Livello di gravità aggregato per tutte le vulnerabilità**                                                                                                                                                                              |                                         | Critico                                                              | Importante                                                                       | Importante                               | Importante                                               | Critico                   | Importante                |
...
#### Soluzioni alternative per la vulnerabilità legata a una descrizione non valida che può consentire l'esecuzione di codice in modalità remota in Microsoft Office Excel - CVE-2006-0029:
...
#### Domande frequenti sulla vulnerabilità legata a un record non valido che può consentire l'esecuzione di codice in modalità remota in Microsoft Office Excel - CVE-2006-0031:
...
#### Una vulnerabilità legata a una lista di distribuzione non valida può consentire l'esecuzione di codice in modalità remota in Microsoft Office Excel - CVE-2006-0009
...
Outlook 2002 (questi file sono installati in tutti i sistemi operativi):
...
Outlook 2002 (file installati solo sui sistemi operativi Windows NT Workstation 4.0 Service Pack 6a, Windows NT Server 4.0 Service Pack 6a, Windows NT Server 4.0 Terminal Server Edition Service Pack 6 e versioni successive):
...
-   Deve essere installato Office 2003 Service Pack 1 o Office 2003 Service Pack 2. Prima di installare questo aggiornamento, installare [Office 2003 SP1](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=9c51d3a6-7cb1-4f61-837e-5f938254fc47) o [Office 2003 SP2](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=57e27a97-2db6-4654-9db6-ec7d5b4dd867).
-   Deve essere installata la versione più recente di Excel 2003 Viewer. Prima di installare questo aggiornamento, installare [Excel 2003 Viewer](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=c8378bf4-996c-4569-b547-75edbd03aaf0).
...
1.  Scaricare la versione client appropriata dell'aggiornamento per la protezione: [Excel 2003](http://download.microsoft.com/download/e/0/8/e08b0dc8-d563-4a3d-8625-38757949b81a/office2003-kb905756-fullfile-enu.exe) o [Excel 2003 Viewer](http://download.microsoft.com/download/6/c/3/6c34fc83-4c74-4a21-a5ec-0d3393de1205/office2003-kb914451-fullfile-enu.exe)
2.  Fare clic su **Salva l'applicazione su disco** e quindi scegliere **OK**.
3.  Fare clic su **Salva**.
4.  In Esplora risorse individuare la cartella contenente il file salvato e fare doppio clic su quest'ultimo.
5.  Se viene richiesto di installare l'aggiornamento, scegliere **Sì**.
...
Per questo aggiornamento per la protezione deve essere installato Excel v. X per Mac dalla versione 10.0 alla 10.1.6.
...
Per questo aggiornamento per la protezione deve essere installato Excel 2004 per Mac dalla versione 11.0.0 alla 11.2.2.
...
Se il numero di versione è 11.2.3, l’aggiornamento è stato installato.
...
-   Ollie Whitehouse di [Symantec](http://symantec.com/) per aver segnalato la vulnerabilità legata a una lista di distribuzione non valida che può consentire l'esecuzione di codice in modalità remota in Microsoft Office Excel - CVE-2006-0009
-   [FelicioX](mailto:feliciox@gmail.com) per aver collaborato con Microsoft sulla vulnerabilità legata a un intervallo non valido che può consentire l'esecuzione di codice in modalità remota in Microsoft Office Excel – CVE-2005-4131
-   Peter Winter-Smith di [NGS Software](http://www.ngssoftware.com/) per aver identificato un comportamento simile alla vulnerabilità legata all'esecuzione di codice in modalità remota in Microsoft Office Excel - CVE-2005-4131
-   Arnaud Dovi di [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) per aver segnalato la vulnerabilità legata all'analisi di un formato file non valido che può consentire l'esecuzione di codice in modalità remota in Microsoft Office Excel - CVE-2006-0028
-   Dejun di [Fortinet Security Response Team](http://www.fortinet.com) per aver segnalato la vulnerabilità legata a una descrizione non valida che può consentire l'esecuzione di codice in modalità remota in Microsoft Office Excel - CVE-2006-0029
-   Eyas di [XFOCUS Security Team](http://www.xfocus.org/) per aver segnalato la vulnerabilità legata a un record non valido che può consentire l'esecuzione di codice in modalità remota in Microsoft Office Excel – CVE-2006-0031
...
-   Nella sezione dedicata alla sicurezza del sito Web [Microsoft TechNet](http://www.microsoft.com/italy/technet/security/default.mspx) sono disponibili ulteriori informazioni sulla protezione dei prodotti Microsoft.
...
-   V1.2 (17 marzo 2006): Bollettino rivisto: Sono stati rimossi i bollettini MS05-012 e MS06-010 da "Quali aggiornamenti sostituisce questo bollettino"? nella sezione "Domande frequenti relative a questo aggiornamento per la protezione". È stata aggiornata la sezione "Fattori attenuanti e soluzioni alternative" per tutte le vulnerabilità per fornire ulteriori informazioni relative a Office 2000 oltre alla sezione "Ringraziamenti" per CVE-2006-0028.
-   V1.3 (29 novembre 2006): Bollettino aggiornato: "Quali aggiornamenti sostituisce questo bollettino?" per la sezione "Domande frequenti relative a questo aggiornamento per la protezione".
