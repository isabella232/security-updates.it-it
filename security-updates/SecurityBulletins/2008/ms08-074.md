---
TOCTitle: 'MS08-074'
Title: 'Bollettino Microsoft sulla sicurezza MS08-074 - Critico'
ms:assetid: 'ms08-074'
ms:contentKeyID: 61240363
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-074(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS08-074 - Critico
=======================================================

Alcune vulnerabilità di Microsoft Office Excel possono consentire l'esecuzione di codice in modalità remota (959070)
--------------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 9 dicembre 2008 | Aggiornamento: mercoledì 28 gennaio 2009
...
**Problemi noti.** L'[articolo della Microsoft Knowledge Base 959070](http://support.microsoft.com/kb/959070) descrive i problemi attualmente conosciuti che potrebbero verificarsi installando il presente aggiornamento per la protezione. L'articolo illustra inoltre le soluzioni consigliate in grado di risolvere questi problemi.
...
\*Per Microsoft Office Excel 2007 e Microsoft Office Excel 2007 Service Pack 1, oltre al pacchetto di aggiornamento per la protezione KB958437, i clienti devono installare anche l'aggiornamento per la protezione del [Pacchetto di compatibilità di Microsoft Office per i file in formato Word, Excel e PowerPoint 2007](http://www.microsoft.com/downloads/details.aspx?familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f) (KB958439) per essere protetti dalle vulnerabilità descritte in questo bollettino. Per i clienti che hanno già installato entrambi i pacchetti di aggiornamento KB958437 e KB958439, non è necessario eseguire una nuova installazione.
...
<span></span>
**Perché Microsoft ha rivisto questo bollettino in data 28 gennaio 2009?**  
Microsoft ha rivisto questo bollettino per comunicare che per le versioni supportate di Microsoft Office Excel 2007, oltre al pacchetto di aggiornamento per la protezione KB958437, i clienti devono installare anche l'aggiornamento per la protezione del [Pacchetto di compatibilità di Microsoft Office per i file in formato Word, Excel e PowerPoint 2007](http://www.microsoft.com/downloads/details.aspx?familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f) (KB958439) per essere protetti dalle vulnerabilità descritte in questo bollettino. I clienti che hanno già installato entrambi i pacchetti di aggiornamento per la protezione KB958437 e KB958439 non devono eseguire una nuova installazione.

**Perché è necessario l'aggiornamento KB958439 per Excel 2007?**  
Le versioni supportate di Microsoft Office Excel 2007 contengono il componente convertitore di Excel vulnerabile che viene aggiornato tramite l'aggiornamento per il Pacchetto di compatibilità di Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 (KB958439). L'aggiornamento per Microsoft Office Excel 2007 e Microsoft Office Excel 2007 Service Pack 1 (KB958437) non aggiorna il componente convertitore di Excel.

**Dove si trova la sezione Informazioni sui file?**  
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 959070](http://support.microsoft.com/kb/959070).

**Anche MS08-072 descrive alcune vulnerabilità di Microsoft Office 2004 per MAC, Microsoft Office 2008 per MAC e del convertitore file in formato XML aperto per MAC. Qual è la relazione tra l'articolo MS08-072 e il presente bollettino (MS08-074)?**  
Questo aggiornamento per la protezione per Microsoft Office 2004 per MAC (960402), Microsoft Office 2008 per MAC (960401) e il convertitore file in formato XML aperto per MAC (960403) risolve anche le vulnerabilità descritte in MS08-072. Gli utenti che utilizzano Microsoft Office 2004 per MAC, Microsoft Office 2008 per MAC o il convertitore file in formato XML aperto per MAC sono tenuti a installare questo aggiornamento per la protezione, che non dovrà essere installato di nuovo.
...
<th style="border:1px solid black;" >Vulnerabilità legata all'analisi del formato file - CVE-2008-4265</th>
<th style="border:1px solid black;" >Vulnerabilità legata all'analisi del formato file - CVE-2008-4264</th>
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria della matrice globale di Excel - CVE-2008-4266</th>
...
Vulnerabilità legata all'analisi del formato file - CVE-2008-4265  
-----------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-4265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4265).
  
#### Fattori attenuanti della vulnerabilità legata all'analisi del formato file - CVE-2008-4265
...
#### Soluzioni alternative per la vulnerabilità legata all'analisi del formato file - CVE-2008-4265
...
#### Domande frequenti sulla vulnerabilità legata all'analisi del formato file - CVE-2008-4265
...
In Microsoft Office Excel è stata riscontrata una vulnerabilità che può consentire a un utente malintenzionato di eseguire del codice quando un utente di una versione interessata di Excel apre un foglio di calcolo di Excel appositamente predisposto fornito dall'utente malintenzionato. La vulnerabilità è dovuta al modo in cui Microsoft Office Excel analizza il formato file di un foglio di calcolo di Excel.
...
Vulnerabilità legata all'analisi del formato file - CVE-2008-4264  
-----------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-4264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4264).
  
#### Fattori attenuanti della vulnerabilità legata all'analisi del formato file - CVE-2008-4264
...
#### Soluzioni alternative per la vulnerabilità legata all'analisi del formato file - CVE-2008-4264
...
#### Domande frequenti sulla vulnerabilità legata all'analisi del formato file - CVE-2008-4264
...
Vulnerabilità legata al danneggiamento della memoria della matrice globale di Excel - CVE-2008-4266  
---------------------------------------------------------------------------------------------------
  
<span></span>
In Microsoft Office Excel è stata riscontrata una vulnerabilità legata all'esecuzione di codice in modalità remota. Tale vulnerabilità è il risultato di un processo di corruzione dello stack che si verifica durante il caricamento di record di Excel. La vulnerabilità può consentire l'esecuzione di codice in modalità remota durante l'apertura di un file di Excel appositamente predisposto contenente un oggetto non valido. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-4266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4266).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria della matrice globale di Excel - CVE-2008-4266
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria della matrice globale di Excel - CVE-2008-4266
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   Non aprire o salvare file Microsoft Office provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.
  
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria della matrice globale di Excel - CVE-2008-4266
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/959070">articolo della Microsoft Knowledge Base 959070</a></td>
</tr>
<tr class="even">
...
-   Joshua J. Drake di [VeriSign iDefense Labs](http://labs.idefense.com/) per avere segnalato la vulnerabilità legata all'analisi del formato file (CVE-2008-4265)  
-   Claes M Nyberg di [signedness.org](http://www.signedness.org/) per avere segnalato la vulnerabilità legata all'analisi del formato file (CVE-2008-4264)  
-   Dyon Balding di [Secunia](http://secunia.com/) per avere segnalato la vulnerabilità legata al danneggiamento della memoria della matrice globale di Excel (CVE-2008-4266)
