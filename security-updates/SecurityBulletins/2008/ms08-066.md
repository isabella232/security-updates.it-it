---
TOCTitle: 'MS08-066'
Title: 'Bollettino Microsoft sulla sicurezza MS08-066 - Importante'
ms:assetid: 'ms08-066'
ms:contentKeyID: 61240355
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-066(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS08-066 - Importante
==========================================================

Una vulnerabilità nel driver di funzioni ausiliario di Microsoft può consentire l'acquisizione di privilegi più elevati (956803)
--------------------------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 14 ottobre 2008 | Aggiornamento: martedì 13 gennaio 2009
...
Questo aggiornamento per la protezione risolve una vulnerabilità segnalata privatamente nel driver di funzioni ausiliario di Microsoft. Sfruttando questa vulnerabilità, un utente malintenzionato locale potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Questo è un aggiornamento per la protezione di livello importante per tutte le edizioni supportate di Windows XP e Windows Server 2003. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno della presente sezione.

Questo aggiornamento per la protezione risolve la vulnerabilità convalidando correttamente l'input inviato al kernel di Windows in modalità utente tramite il componente AFD. Per ulteriori informazioni su tale vulnerabilità, vedere la sottosezione Domande frequenti nella sezione successiva, **Informazioni sulle vulnerabilità**.

**Raccomandazione.** Microsoft consiglia di installare l'aggiornamento quanto prima.

**Problemi noti.** L'[articolo della Microsoft Knowledge Base 956803](http://support.microsoft.com/kb/956803) descrive i problemi attualmente conosciuti che potrebbero verificarsi installando il presente aggiornamento per la protezione. L'articolo illustra inoltre le soluzioni consigliate in grado di risolvere questi problemi.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9)                                                                 | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5b607efc-c6fb-4079-8478-e4f3262386d3)                              | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074)                                               | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ab4d94d3-458c-4946-ab7f-03a279629d25)                                      | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP1 per sistemi basati su Itanium e Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=63234f85-6e5d-4ef6-b7cf-d1d2c78a5517) | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
...
Microsoft ha rivisto questo bollettino sulla sicurezza per annunciare una modifica di rilevamento per il presente aggiornamento per la protezione. Conseguentemente a questa correzione, il rilevamento offre l'aggiornamento per la protezione ai sistemi interessati ai quali precedentemente non veniva offerto. I clienti che hanno già aggiornato i propri sistemi non devono reinstallare questo aggiornamento.

**Dove si trova la sezione Informazioni sui file?**  
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 956803](http://support.microsoft.com/kb/956803).

**Quali sono i problemi conosciuti che potrebbero verificarsi quando si installa questo aggiornamento per la protezione?**  
L'[articolo della Microsoft Knowledge Base 956803](http://support.microsoft.com/kb/956803) descrive i problemi attualmente conosciuti che potrebbero verificarsi quando si installa questo aggiornamento per la protezione. L'articolo illustra inoltre le soluzioni consigliate in grado di risolvere questi problemi.
...
<th style="border:1px solid black;" >Vulnerabilità legata alla sovrascrittura del kernel AFD - CVE-2008-3464</th>
...
Vulnerabilità legata alla sovrascrittura del kernel AFD - CVE-2008-3464  
-----------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati nel driver di funzioni ausiliario (afd.sys) dovuta al modo in cui Windows esegue la convalida dell'input inviato in modalità utente al kernel. Questa vulnerabilità potrebbe consentire a un utente malintenzionato di eseguire codice con privilegi elevati. Sfruttando questa vulnerabilità, un utente malintenzionato locale può eseguire codice arbitrario e acquisire il controllo completo del sistema interessato. Inoltre, può installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-3464](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464).
  
#### Fattori attenuanti per la vulnerabilità legata alla sovrascrittura del kernel AFD - CVE-2008-3464
...
#### Soluzioni alternative per la vulnerabilità legata alla sovrascrittura del kernel AFD - CVE-2008-3464
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla sovrascrittura del kernel AFD - CVE-2008-3464
...
Se i dati sono inviati al kernel in modalità utente, il componente AFD non convalida correttamente l'input fornito dall'utente.
  
**Che cos'è il componente AFD?**    
Il componente AFD fornisce il "driver di funzioni ausiliario" che supporta applicazioni Windows Sockets ed è contenuto nel file afd.sys. Il driver afd.sys viene eseguito in modalità kernel e gestisce il protocollo di comunicazione TCP/IP Winsock. Tale interfaccia kernel Winsock fornisce accesso ai trasporti TDI. Per ulteriori informazioni sul componente AFD, vedere il seguente [sito Web Microsoft](http://msdn.microsoft.com/it-it/library/aa940505.aspx).
  
**Che cos'è il componente TDI?**  
L'acronimo TDI (Transport Driver Interface) definisce un'interfaccia di rete in modalità kernel esposta al bordo superiore di tutti gli stack del protocollo di trasporto. Il driver di protocollo di livello più alto in ciascuno di tali stuck supporta l'interfaccia TDI per client di rete in modalità kernel di livello ancora più elevato. Per ulteriori informazioni sul componente TDI, vedere il seguente [sito Web Microsoft](http://msdn.microsoft.com/it-it/library/ms801224.aspx).
...
L'aggiornamento rimuove la vulnerabilità convalidando correttamente l'input inviato al kernel Windows in modalità utente tramite il componente AFD.
...
<td style="border:1px solid black;">Dopo l'applicazione dell'aggiornamento per la protezione è necessario riavviare il sistema.<br />
</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Utilizzare Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB956803$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/956803">articolo della Microsoft Knowledge Base 956803</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB956803$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/956803">articolo della Microsoft Knowledge Base 956803</a></td>
...
-   Fabien Le Mentec di [SkyRecon](http://www.skyrecon.com/) per aver segnalato la vulnerabilità legata alla sovrascrittura del kernel AFD (CVE-2008-3464)
...
-   V1.1 (13 gennaio 2009): È stata aggiunta una voce alla sezione **Domande frequenti sull'aggiornamento per la protezione**, che spiega che questa revisione rappresenta una modifica di rilevamento del presente aggiornamento per la protezione. Il rilevamento corretto consente di offrire l'aggiornamento per la protezione ai sistemi interessati ai quali precedentemente non veniva offerto. I clienti che hanno già aggiornato i propri sistemi non devono reinstallare questo aggiornamento.
