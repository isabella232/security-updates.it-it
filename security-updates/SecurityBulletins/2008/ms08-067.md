---
TOCTitle: 'MS08-067'
Title: 'Bollettino Microsoft sulla sicurezza MS08-067 - Critico'
ms:assetid: 'ms08-067'
ms:contentKeyID: 61240356
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-067(v=Security.10)'
author: SharonSears
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=e22eb3ae-1295-4fe2-9775-6f43c5c2aed3)                                | Esecuzione di codice in modalità remota     | Critico                      | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0d5f9b6e-9265-44b9-a376-2067b73d6a03)                                            | Esecuzione di codice in modalità remota     | Critico                      | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=0d5f9b6e-9265-44b9-a376-2067b73d6a03)                                            | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                             |
| [Windows XP Professional x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=4c16a372-7bf8-4571-b982-dac6b2992b25)                                  | Esecuzione di codice in modalità remota     | Critico                      | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c16a372-7bf8-4571-b982-dac6b2992b25)                   | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                             |
| [Windows Server 2003 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f26d395d-2459-4e40-8c92-3de1c52c390d)                                   | Esecuzione di codice in modalità remota     | Critico                      | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f26d395d-2459-4e40-8c92-3de1c52c390d)                                   | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                             |
| [Windows Server 2003 x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=c04d2afb-f9d0-4e42-9e1f-4b944a2de400)                                      | Esecuzione di codice in modalità remota     | Critico                      | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c04d2afb-f9d0-4e42-9e1f-4b944a2de400)                       | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                             |
| [Windows Server 2003 con SP1 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ab590756-f11f-43c9-9dcc-a85a43077acf)            | Esecuzione di codice in modalità remota     | Critico                      | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ab590756-f11f-43c9-9dcc-a85a43077acf)            | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                             |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=18fdff67-c723-42bd-ac5c-cac7d8713b21)                         | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a976999d-264f-4e6a-9bd6-3ad9d214a4bd) | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi a 32 bit\*](http://www.microsoft.com/downloads/details.aspx?familyid=25c17b07-1efe-43d7-9b01-3dfdf1ce0bd7)                           | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi x64\*](http://www.microsoft.com/downloads/details.aspx?familyid=7b12018e-0cc1-4136-a68c-be4e1633c8df)                                | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2bcf89ef-6446-406c-9c53-222e0f0baf7a)                    | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |

**\*Sono interessate le installazioni di Windows Server 2008 con opzione Server Core.** Per le edizioni supportate di Windows Server 2008, a questo aggiornamento si applica il medesimo livello di gravità indipendentemente dal fatto che l'installazione sia stata effettuata usando l'opzione Server Core o meno. Per ulteriori informazioni su questa opzione di installazione, vedere [Server Core](http://msdn.microsoft.com/it-it/library/ms723891(en-us,vs.85).aspx). Si noti che l'opzione di installazione di Server Core non è disponibile per alcune edizioni di Windows Server 2008; vedere [Compare Server Core Installation Options](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).
...
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 958644](http://support.microsoft.com/kb/958644).
...
<th style="border:1px solid black;" >Vulnerabilità nel servizio Server - CVE-2008-4250</th>
...
Vulnerabilità nel servizio Server - CVE-2008-4250  
-------------------------------------------------
  
<span></span>
Nel servizio Server nei sistemi Windows esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. La vulnerabilità è causata dalla gestione non corretta delle richieste RPC appositamente predisposte da parte del servizio Server. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-4250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4250).
  
#### Fattori attenuanti della vulnerabilità nel servizio Server - CVE-2008-4250
...
-   In Windows Vista e Windows Server 2008, solo gli utenti autenticati possono accedere al percorso di codice vulnerabile. Tale vulnerabilità non viene attivata se l'utente malintenzionato non è autenticato.
  
#### Soluzioni alternative per la vulnerabilità nel servizio Server - CVE-2008-4250
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Disattivare il servizio Server e il servizio Browser di computer**
  
    La disattivazione del servizio Browser di computer e del servizio Server nei sistemi interessati consente di protegge i sistemi dai tentativi di sfruttare questa vulnerabilità in modalità remota.
  
    Tali servizi possono essere disattivati eseguendo la procedura riportata di seguito:
  
    1.  Fare clic su **Start**, quindi su **Pannello di controllo** (oppure scegliere **Impostazioni**, quindi fare clic su **Pannello di controllo**).  
    ...
    7.  Ripetere i passaggi da 4 a 6 per il servizio **Server**
  
    **Impatto della soluzione alternativa**. Se il servizio Browser di computer è disabilitato, i servizi che dipendono esplicitamente da questo potrebbero registrare un messaggio di errore nel log degli eventi di sistema. Per ulteriori informazioni sui servizi Browser di Computer, vedere l'[articolo della Microsoft Knowledge Base 188001](http://support.microsoft.com/kb/188001). Se il servizio Server è disattivato, non sarà possibile condividere file o stampanti dal computer. Tuttavia, sarà possibile visualizzare e utilizzare le condivisioni di file e le risorse di stampa negli altri sistemi.
  
    **Per annullare il risultato della soluzione alternativa.** È possibile attivare questi servizi eseguendo la procedura indicata di seguito:
  
    1.  Scegliere **Start**, quindi fare clic su **Pannello di controllo** (oppure scegliere **Impostazioni**, quindi fare clic su **Pannello di controllo**).  
    2.  Fare doppio clic su **Strumenti di amministrazione**.  
    3.  Fare doppio clic su **Servizi**.  
    4.  Fare doppio clic sul servizio **Browser di computer**.  
...
-   **In Windows** **Vista** **e Windows Server 2008, filtrare l'identificatore RPC interessato**
  
    Oltre a bloccare le porte con Windows Firewall, le edizioni Windows Vista e Windows Server 2008 possono filtrare selettivamente gli identificatori univoci universali (UUID) RPC. Per evitare questa vulnerabilità, aggiungere una regola che blocchi tutte le richieste RPC con l'identificatore univoco universale uguale a 4b324fc8-1670-01d3-1278-5a47bf6ee188. Ciò è possibile tramite la shell di rete. Per accedere alla shell di rete, da un prompt dei comandi di livello elevato, digitare quanto segue:
  
    `netsh`
  
    Una volta nell'ambiente netsh, inserire quanto segue:
    ...
    La chiave filtro è un UUID generato casualmente specifico di ciascun sistema. Per confermare l'applicazione del filtro, al prompt dei comandi di livello elevato, digitare quanto segue:
  
    `netsh rpc filter show filter`
  
    Se i comandi sono corretti, il sistema visualizza le seguenti informazioni:
  
    `Elenco di tutti i filtri RPC.---------------------------------FilterKey: xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxxdisplayData.name: RPCFilterdisplayData.description: RPC FilterfilterId: 0x12f79layerKey: umweight: Digitare: FWP_EMPTY Value: Emptyaction.type: blocknumFilterConditions: 1`
  
    Dove **filterKey:** ***xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx**** *è uguale all'UUID generato casualmente specifico del sistema.
  
    **Impatto della soluzione alternativa.** Alcune applicazioni che utilizzano il protocollo SMB (Server Message Block) di Microsoft non potrebbero non funzionare correttamente. Tuttavia, sarà possibile visualizzare e utilizzare le condivisioni di file e le risorse di stampa negli altri sistemi.
...
-   **Per assicurare la protezione contro i tentativi di sfruttare questa vulnerabilità con attacchi basati sulla rete, utilizzare un firewall personale, come ad esempio il Firewall connessione Internet**
    ...
    Per tutte le edizioni supportate di Windows XP e Windows Server 2003, utilizzare la funzionalità Firewall connessione Internet per aumentare la protezione della connessione Internet tramite il blocco del traffico in ingresso non richiesto. Microsoft consiglia di bloccare tutte le comunicazioni in ingresso non richieste provenienti da Internet. In Windows XP Service Pack 2 e Windows XP Service Pack 3, questa funzionalità è chiamata Windows Firewall.
  
    Per impostazione predefinita, la funzionalità Windows Firewall di Windows XP consente di proteggere la connessione Internet bloccando il traffico in ingresso non richiesto. Si consiglia di bloccare tutte le comunicazioni in ingresso non richieste provenienti da Internet.
...
#### Domande frequenti relative alla vulnerabilità nel servizio Server - CVE-2008-4250
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo in remoto del sistema interessato. Nei sistemi Windows Server 2003, Microsoft Windows 2000 e Windows XP, un utente malintenzionato può sfruttare questa vulnerabilità tramite RPC senza autenticazione per eseguire il codice arbitrario. È possibile che questa vulnerabilità sia utilizzata per creare uno scenario suscettibile ad attacco da worm. Sfruttando questa vulnerabilità, un utente malintenzionato può installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata dalla gestione non corretta delle richieste RPC appositamente predisposte da parte del servizio Windows Server.
...
Un utente malintenzionato può tentare di sfruttare la vulnerabilità inviando un messaggio appositamente predisposto a un sistema interessato. Nei sistemi Windows Server 2003, Microsoft Windows 2000 e Windows XP, qualsiasi utente anonimo con accesso alla rete di destinazione può inviare pacchetti di rete appositamente predisposti al sistema interessato per sfruttare questa vulnerabilità. Tuttavia, nei sistemi Windows Vista e Windows Server 2008, solo un utente autenticato con accesso alla rete di destinazione può inviare pacchetti di rete appositamente predisposti al sistema interessato per sfruttare questa vulnerabilità.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
Tutte le workstation e i server sono interessati da questo problema, ma i sistemi Microsoft Windows 2000, Windows XP o Windows Server 2003 sono maggiormente a rischio a causa delle particolari caratteristiche della vulnerabilità e del percorso di codice interessato.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui il servizio Server gestisce le richieste RPC.
...
**L'applicazione di questo aggiornamento per la protezione consente di proteggere i clienti da codice che tenti di sfruttare la vulnerabilità?**    
Sì. L'aggiornamento per la protezione affronta la vulnerabilità attualmente sfruttata. Questa vulnerabilità è stata identificata con il codice [CVE-2008-4250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4250).
...
| Windows Server 2008 per sistemi x64                                                                                   | No      | No                 | Vedere la **Nota su Windows** **Vista** **e Windows Server 2008** di seguito | No                         |  
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Utilizzare Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB958644$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/958644">articolo della Microsoft Knowledge Base 958644</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB958644$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/958644">articolo della Microsoft Knowledge Base 958644</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB958644$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/958644">articolo della Microsoft Knowledge Base 958644</a></td>
...
-   V1.0 (23 ottobre 2008): Pubblicazione del bollettino.
