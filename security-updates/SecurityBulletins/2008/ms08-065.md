---
TOCTitle: 'MS08-065'
Title: 'Bollettino Microsoft sulla sicurezza MS08-065 - Importante'
ms:assetid: 'ms08-065'
ms:contentKeyID: 61240354
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-065(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS08-065 - Importante
==========================================================

Una vulnerabilità in Accodamento messaggi può consentire l'esecuzione di codice in modalità remota (951071)
-----------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve una vulnerabilità segnalata privatamente nel servizio di Accodamento messaggi (MSMQ) nei sistemi Microsoft Windows 2000. La vulnerabilità può consentire l'esecuzione di codice in modalità remota nei sistemi Microsoft Windows con il servizio MSMQ attivato.

La vulnerabilità descritta in questo bollettino ha un livello di gravità importante per tutte le edizioni supportate di Microsoft Windows 2000. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno della presente sezione.

L'aggiornamento per la protezione risolve la vulnerabilità sostituendo le API dalle stringhe vulnerabili, che sono elaborate da MSMQ. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=899e2728-2433-4ccb-a195-05b5d65e5469) | Esecuzione di codice in modalità remota     | Importante                   | [MS07-065](http://technet.microsoft.com/security/bulletin/ms07-065) |
...
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 951071](http://support.microsoft.com/kb/951071).
...
<th style="border:1px solid black;" >Vulnerabilità legata all'esecuzione di codice in modalità remota del servizio di Accodamento messaggi - CVE-2008-3479</th>
...
Vulnerabilità legata all'esecuzione di codice in modalità remota del servizio di Accodamento messaggi - CVE-2008-3479  
---------------------------------------------------------------------------------------------------------------------
  
<span></span>
Nel servizio di Accodamento messaggi esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta a un difetto specifico nell'analisi di una richiesta RPC al servizio di Accodamento messaggi.
  
Un utente malintenzionato potrebbe sfruttare la vulnerabilità inviando una richiesta URI appositamente predisposta. Una richiesta heap può essere controllata e successivamente soggetta a overflow durante un'operazione non controllata di copia delle stringhe. Lo sfruttamento di questa vulnerabilità può portare ad un accesso completo al sistema interessato nel contesto del SISTEMA. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-3479](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3479).
  
#### Fattori attenuanti della vulnerabilità legata all'esecuzione di codice in modalità remota nel servizio di Accodamento messaggi - CVE-2007-3479
...
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di codice in modalità remota nel servizio di Accodamento messaggi - CVE-2007-3479
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Bloccare le seguenti porte a livello di firewall perimetrale**  
...
#### Domande frequenti relative alla vulnerabilità legata all'esecuzione di codice in modalità remota del servizio di Accodamento messaggi - CVE-2008-3479
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota nei sistemi Microsoft Windows 2000 con servizio MSMQ attivato. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo in remoto del sistema interessato. L'utente malintenzionato riuscirebbe quindi a installare programmi o a visualizzare, modificare o eliminare dati.
  
**Quali sono le cause di questa vulnerabilità?**    
Il servizio MSMQ non analizza correttamente le richieste RPC appositamente predisposte.
...
Microsoft RPC è un modello per la programmazione in un ambiente informatico distribuito. Lo scopo di RPC è quello di fornire una comunicazione trasparente in modo tale che il client sembri comunicare direttamente con il server. L'implementazione di RPC di Microsoft è compatibile con RPC DCE (Distributed Computing Environment) OSF (Open Software Foundation). Per ulteriori informazioni su RPC, vedere il [sito RPC MSDN](http://msdn.microsoft.com/it-it/library/ms691207(vs.85).aspx).
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**    
Un utente malintenzionato non autenticato potrebbe causare l'esecuzione di codice non autorizzato in modalità remota nel contesto del SISTEMA inviando una richiesta RPC appositamente predisposta al servizio MSMQ. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
Un utente malintenzionato potrebbe sfruttare questa vulnerabilità inviando una richiesta RPC appositamente predisposta al servizio MSMQ. Una richiesta heap può essere controllata e successivamente soggetta a overflow durante un'operazione non controllata di copia delle stringhe. Lo sfruttamento di questa vulnerabilità può portare ad un accesso completo al sistema interessato nel contesto del SISTEMA.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi Microsoft Windows 2000 con il servizio MSMQ attivato sono a rischio.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento rimuove la vulnerabilità modificando il modo in cui il servizio MSMQ convalida i parametri nelle API delle stringhe, che vengono richiamati da MSMQ.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Utilizzare Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB951071$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/951071">articolo della Microsoft Knowledge Base 951071</a></td>
</tr>
<tr class="even">
...
-   Cody Pierce e Aaron Portnoy di [TippingPoint DVLabs](http://dvlabs.tippingpoint.com) per aver segnalato la vulnerabilità legata all'esecuzione di codice in modalità remota nel servizio di Accodamento messaggi (CVE-2008-3479)
...
-   V1.1 (15 ottobre 2008): nella tabella Software interessato è stato aggiunto un collegamento a MS07-065, il bollettino sostituito dal presente aggiornamento.
