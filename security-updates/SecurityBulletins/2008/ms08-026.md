---
TOCTitle: 'MS08-026'
Title: 'Bollettino Microsoft sulla sicurezza MS08-026 - Critico'
ms:assetid: 'ms08-026'
ms:contentKeyID: 61240315
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-026(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS08-026 - Critico
=======================================================

Alcune vulnerabilità in Microsoft Word possono consentire l'esecuzione di codice in modalità remota (951207)
------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 13 maggio 2008 | Aggiornamento: mercoledì 14 maggio 2008
...
Questo aggiornamento per la protezione risolve diverse vulnerabilità segnalate privatamente in Microsoft Word che potrebbe consentire l'esecuzione di codice in modalità remota se un utente apre un file di Word appositamente predisposto. Sfruttando queste vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Questo aggiornamento per la protezione è considerato di livello critico per le edizioni supportate di Microsoft Word 2000 e Microsoft Outlook 2007 e di livello importante per le edizioni supportate di Microsoft Word 2002, Microsoft Word 2003, Microsoft Word Viewer 2003 e Microsoft Word Viewer 2003 Service Pack 3, Microsoft Word 2007, il pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007, Microsoft Office 2004 per Mac e Microsoft Office 2008 per Mac. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione corregge la vulnerabilità modificando il modo in cui Microsoft Word gestisce file di Word appositamente predisposti. Per ulteriori informazioni sulle vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione seguente **Informazioni sulle vulnerabilità**.

**Nota** Questo aggiornamento contiene fattori attenuanti aggiuntivi contro attacchi pubblici che utilizzano Microsoft Word per sfruttare le vulnerabilità nel modulo di gestione di database Microsoft Jet descritto nell'[Advisory Microsoft sulla sicurezza 950627](http://technet.microsoft.com/security/advisory/950627). In aggiunta a tale aggiornamento, si consiglia di installare quello fornito nel [bollettino Microsoft sulla sicurezza MS08-028: Una vulnerabilità nel modulo di gestione di database Microsoft Jet può consentire l'esecuzione di codice in modalità remota (950749)](http://technet.microsoft.com/security/bulletin/ms08-028) per la protezione più aggiornata contro questi tipi di attacchi.
...
<td style="border:1px solid black;">
[Microsoft Word 2000 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=9215ff71-38c0-416a-b89a-fe3474160f41)  
(KB950250)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Word 2002 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=b348a518-221e-4567-a797-999715a8b2ef)  
(KB950243)
</td>
<td style="border:1px solid black;">
Esecuzione di codice in modalità remota
...
<td style="border:1px solid black;">
[Microsoft Word 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=bc33d144-f917-47b8-961f-744ca847e14c)  
(KB950241)
</td>
<td style="border:1px solid black;">
Esecuzione di codice in modalità remota
...
<td style="border:1px solid black;">
[Microsoft Word 2003 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=bc33d144-f917-47b8-961f-744ca847e14c)  
(KB950241)
</td>
<td style="border:1px solid black;">
Esecuzione di codice in modalità remota
...
<td style="border:1px solid black;">
[Microsoft Word 2007](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)
</td>
<td style="border:1px solid black;">
Esecuzione di codice in modalità remota
...
<td style="border:1px solid black;">
[Microsoft Outlook 2007](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)
</td>
<td style="border:1px solid black;">
Esecuzione di codice in modalità remota
...
<td style="border:1px solid black;">
[Microsoft Word 2007 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)
</td>
<td style="border:1px solid black;">
Esecuzione di codice in modalità remota
...
<td style="border:1px solid black;">
[Microsoft Outlook 2007 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)
</td>
<td style="border:1px solid black;">
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
[Microsoft Word Viewer 2003](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=bce7ea31-2bf0-4930-aff9-837bcc82a682)  
(KB950625)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Word Viewer 2003 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=bce7ea31-2bf0-4930-aff9-837bcc82a682)  
(KB950625)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr>
<td style="border:1px solid black;">
[Pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=2d718f37-c5d1-4e15-a7e1-5a15fedef52f)  
(KB951808)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=2d718f37-c5d1-4e15-a7e1-5a15fedef52f)  
(KB951808)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2004 per Mac](http://www.microsoft.com/downloads/details.aspx?familyid=99f54471-ccf9-4d94-a882-a05ecd128adc)  
(KB952332)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2008 per Mac](http://www.microsoft.com/downloads/details.aspx?familyid=395d1487-a3a6-4106-a0f8-4d6e1d6d89d2)  
(KB952331)
</td>
<td style="border:1px solid black;">
Non applicabile
...
<span></span>
**Perché questo aggiornamento è di livello critico per Outlook 2007?** 
L'aggiornamento per Outlook 2007 è classificato come Critico a causa del vettore di attacco tramite posta elettronica descritto nella sezione Domande frequenti della Vulnerabilità legata all'analisi dell'oggetto- CVE-2008-1091 nel presente bollettino. Gli utenti di Outlook 2007 devono applicare l'aggiornamento immediatamente per proteggere i computer contro gli attacchi che tentano di sfruttare questa vulnerabilità tramite il riquadro di anteprima.
...
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 951207](http://support.microsoft.com/kb/951207).
...
Sì. Oltre alle modifiche indicate nella sezione Dettagli della vulnerabilità del presente bollettino, questo aggiornamento contiene misure logiche relative agli avvisi di protezione che attenuano Word come vettore di attacco utilizzato per sfruttare le vulnerabilità nel modulo di gestione di database Microsoft Jet descritto nell'[Advisory Microsoft sulla sicurezza 950627](http://technet.microsoft.com/security/advisory/950627). Prima di questo aggiornamento, Word era vulnerabile agli attacchi all'apertura di un documento Word appositamente predisposto contenente un file di database Jet dannoso. Una volta applicato questo aggiornamento, all'apertura di documenti Word verrà richiesta conferma prima di eseguire comandi o query SQL. Oltre ad installare questo aggiornamento, si consiglia di installare l'aggiornamento fornito nel bollettino [Microsoft sulla sicurezza MS08-028: Alcune vulnerabilità nel modulo di gestione di database Microsoft Jet possono consentire l'esecuzione di codice in modalità remota (950749)](http://technet.microsoft.com/security/bulletin/ms08-028) per la protezione più aggiornata contro questi tipi di attacchi.

**Questo è un aggiornamento relativo a Microsoft Word. Perché Microsoft Outlook 2007 e Microsoft Outlook 2007 Service Pack 1 sono riportati nella tabella "Software interessato"?**  
I file che sono stati aggiornati per risolvere le vulnerabilità documentate nel presente bollettino sono dei file essenziali di Microsoft Word. In Microsoft Word 2007 e Microsoft Word 2007 Service Pack 1, alcuni di questi file essenziali sono condivisi con Microsoft Outlook 2007 e Microsoft Outlook 2007 Service Pack 1 e forniscono a Outlook funzionalità quali l'esecuzione di modifiche. Pertanto, è necessario aggiornare anche Outlook 2007 e Outlook 2007 Service Pack 1. Inoltre, Word 2007 e Word 2007 Service Pack 1 vengono gestiti con lo stesso pacchetto di Outlook 2007 e Outlook 2007 Service Pack 1.
...
**Perché questo aggiornamento è classificato come critico per Word 2000 ma solo importante per tutte le altre versioni interessate di Word?**  
Gli utenti che eseguono Word 2002 e versioni successive dispongono di una funzionalità che chiederà all'utente di aprire, salvare o annullare prima di aprire un documento. Questo fattore attenuante riduce la vulnerabilità a un livello importante perché richiede più azioni dell'utente per sfruttarla.
...
<th style="border:1px solid black;" >Vulnerabilità legata all'analisi dell'oggetto- CVE-2008-1091</th>
<th style="border:1px solid black;" >Vulnerabilità nei file CSS di Word - CVE-2008-1434</th>
...
Vulnerabilità legata all'analisi dell'oggetto- CVE-2008-1091  
------------------------------------------------------------
  
<span></span>
In Microsoft Office esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta alla gestione di file rtf (Rich Text Format) appositamente predisposti. La vulnerabilità potrebbe consentire l'esecuzione di codice in modalità remota se un utente apre in Word un file rtf appositamente predisposto con stringhe non valide o visualizza in anteprima un file rtf appositamente predisposto con stringhe non valide nei messaggi di posta elettronica in formato RTF. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-1091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1091).
  
#### Fattori attenuanti della vulnerabilità legata all'analisi dell'oggetto - CVE-2008-1091
...
#### Soluzioni alternative per la vulnerabilità legata all'analisi dell'oggetto - CVE-2008-1091
...
-   Leggere i messaggi di posta elettronica nel formato testo normale per proteggersi contro gli attacchi tramite posta elettronica.  
...
#### Domande frequenti sulla vulnerabilità legata all'analisi dell'oggetto - CVE-2008-1091
...
Questa vulnerabilità può essere sfruttata solo se un utente apre un file rtf appositamente predisposto con una versione interessata di Microsoft Word.
  
In uno scenario di attacco da posta elettronica, l'utente malintenzionato potrebbe sfruttare la vulnerabilità inviando un messaggio in formato RTF appositamente predisposto a un sistema che utilizza Word come editor predefinito e l'anteprima dei messaggi di posta elettronica in formato RTF o HTML.
...
I sistemi in cui vengono utilizzati Microsoft Word e/o Microsoft Outlook sono principalmente a rischio. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento elimina la vulnerabilità modificando il modo in cui Word calcola lo spazio richiesto per l'allocazione in memoria durante l'apertura di file rtf.
...
Vulnerabilità nei file CSS di Word - CVE-2008-1434  
--------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Word gestisce file di Word appositamente predisposti. La vulnerabilità potrebbe consentire l'esecuzione di codice in modalità remota se un utente apre un file Word appositamente predisposto contenente un valore CSS non valido. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-1434](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1434).
  
#### Fattori attenuanti per la vulnerabilità nei file CSS di Word - CVE-2008-1434
...
#### Soluzioni alternative per la vulnerabilità nei file CSS di Word - CVE-2008-1434
...
-   **Utilizzare il criterio del blocco dei file di Microsoft Office per impedire l'apertura di documenti di Office 2003 e versioni precedenti di dubbia provenienza.**
    ...
    **Effetto della soluzione alternativa**: Gli utenti che hanno configurato il criterio del blocco dei file e non hanno configurato una "directory esente" come discusso [nell'Articolo della Microsoft Knowledge Base 922848](http://support.microsoft.com/kb/922848) non potranno aprire i documenti HTML in Word o Outlook.
    ...
    **Effetto della soluzione alternativa**: Gli utenti che hanno configurato il criterio del blocco dei file e non hanno configurato una "directory esente" come discusso nell'[articolo della Microsoft Knowledge Base 922848](http://support.microsoft.com/kb/922848) non potranno aprire i documenti HTML in Word 2003 o in Microsoft Office System 2007.
...
#### Domande frequenti sulla vulnerabilità nei file CSS di Word - CVE-2008-1434
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è dovuta a un errore di gestione della memoria durante l'elaborazione di valori CSS in un file Word appositamente predisposto. La memoria di sistema potrebbe essere danneggiata in modo da permettere a un utente malintenzionato di eseguire codice non autorizzato.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento elimina la vulnerabilità modificando il modo in cui Word gestisce la memoria durante l'elaborazione di valori CSS all'apertura di file Word.
...
| Microsoft Word Viewer 2003                                                                                     | No       |  
| Microsoft Word Viewer 2003 Service Pack 3                                                                      | No       |  
| Microsoft Word 2007                                                                                            | No       |  
| Microsoft Word 2007 Service Pack 1                                                                             | No       |  
| Microsoft Outlook 2007                                                                                         | No       |  
| Microsoft Outlook 2007 Service Pack 1                                                                          | No       |  
...
| Microsoft Word Viewer 2003                                                                                     | No      | No                 | No                | No        |  
| Microsoft Word Viewer 2003 Service Pack 3                                                                      | No      | No                 | No                | No        |  
| Microsoft Word 2007                                                                                            | No      | No                 | No                | No        |  
| Microsoft Word 2007 Service Pack 1                                                                             | No      | No                 | No                | No        |  
| Microsoft Outlook 2007                                                                                         | No      | No                 | No                | No        |  
| Microsoft Outlook 2007 Service Pack 1                                                                          | No      | No                 | No                | No        |  
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/951207">articolo della Microsoft Knowledge Base 951207</a></td>
</tr>
<tr class="even">
...
#### Word 2003 e Word 2003 Viewer (tutte le edizioni)
...
#### Word 2007 e pacchetto di compatibilità Microsoft Office per i file in formato Word, Excel e PowerPoint 2007 (tutte le edizioni)
...
Scaricare e installare la versione della lingua appropriata per l'aggiornamento di Microsoft Office 2004 per Mac 11.4.2 dall'[Area download Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=99f54471-ccf9-4d94-a882-a05ecd128adc).
...
-   Aprire il volume dell'aggiornamento di Microsoft Office 2004 per Mac 11.4.2 sul desktop. Questo passaggio potrebbe essere stato eseguito automaticamente.  
-   Per iniziare il processo di aggiornamento, nella finestra del volume dell'aggiornamento di Microsoft Office 2004 per Mac 11.4.2, fare doppio clic sull'applicazione Aggiornamento di Microsoft Office 2004 per Mac 11.4.2 e seguire le istruzioni visualizzate sullo schermo.  
-   Al termine dell'installazione, è possibile rimuovere il programma di installazione dell'aggiornamento dal disco rigido. Per verificare se l'installazione è stata completata, vedere il seguente titolo "Verifica dell'installazione dell'aggiornamento". Per rimuovere il programma di installazione dell'aggiornamento, trascinare il volume dell'aggiornamento di Microsoft Office 2004 per Mac 11.4.2 e il file scaricato nel Cestino.
...
Se il numero di versione è **11.4.2**, l’aggiornamento è stato installato.
...
Scaricare e installare la versione della lingua appropriata per Microsoft Office 2008 per Mac Service Pack 1 dall'[Area download Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=395d1487-a3a6-4106-a0f8-4d6e1d6d89d2).
  
-   Chiudere tutte le applicazioni in esecuzione, incluse le applicazioni antivirus, tutte le applicazioni Microsoft Office, Microsoft Messenger per Mac e Notifiche di Office, in quanto potrebbero interferire con l'installazione.  
-   Aprire il volume Microsoft Office 2008 per Mac Service Pack 1 sul desktop. Questo passaggio potrebbe essere stato eseguito automaticamente.  
-   Per iniziare il processo di aggiornamento, nella finestra del volume Microsoft Office 2008 per Mac Service Pack 1, fare doppio clic su Microsoft Office 2008 per Mac Service Pack 1 e seguire le istruzioni visualizzate sullo schermo.  
-   Al termine dell'installazione, è possibile rimuovere il programma di installazione dell'aggiornamento dal disco rigido. Per verificare se l'installazione è stata completata, vedere il seguente titolo "Verifica dell'installazione dell'aggiornamento". Per rimuovere il programma di installazione dell'aggiornamento, trascinare il volume Microsoft Office 2008 per Mac Service Pack 1 e il file scaricato nel Cestino.
...
Se il numero di versione è **12.1.0**, l’aggiornamento è stato installato.
...
-   Jun Mao, di [iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità nei file CSS di Word - CVE-2008-1434.  
-   wushi del [team509](http://www.team509.com/) di [Zero Day Initiative](http://www.zerodayinitiative.com/), per aver segnalato la vulnerabilità legata all'analisi dell'oggetto - CVE-2008-1091.
...
-   V1.1 (14 maggio 2008): sono state aggiornate le sezioni Informazioni per la distribuzione per Office 2004 per Mac e Office 2008 per Mac per specificare il collegamento all'Area download Microsoft. Inoltre, è stata aggiunta una voce per aggiornare le Domande frequenti in modo da chiarire perché l'aggiornamento per Outlook 2007 è stato classificato come Critico.
