---
TOCTitle: 'MS08-063'
Title: 'Bollettino Microsoft sulla sicurezza MS08-063 - Importante'
ms:assetid: 'ms08-063'
ms:contentKeyID: 61240352
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-063(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS08-063 - Importante
==========================================================

Una vulnerabilità in SMB (Server Message Block) può consentire l'esecuzione di codice in modalità remota (957095)
-----------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve una vulnerabilità segnalata privatamente nel protocollo SMB (Server Message Block) di Microsoft. La vulnerabilità potrebbe consentire l'esecuzione di codice in modalità remota su un server che condivide file o cartelle. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui SMB gestisce la convalida di lunghezza del nome file e la condivisione di file. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=9ed29c3a-0682-4586-bbc2-a73deaa18e4c)                                          | Esecuzione di codice in modalità remota     | Importante                   | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2f7e5981-6eef-4f08-86c0-c6a7607ea5d0)                                            | Esecuzione di codice in modalità remota     | Importante                   | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2f7e5981-6eef-4f08-86c0-c6a7607ea5d0)                                            | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows XP Professional x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=4e1675eb-6b06-48e9-9765-23a2c7737bdc)                                  | Esecuzione di codice in modalità remota     | Importante                   | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e1675eb-6b06-48e9-9765-23a2c7737bdc)                   | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2003 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=dbbebb3f-f1c7-402c-bd16-6f88da0d042c)                                   | Esecuzione di codice in modalità remota     | Importante                   | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dbbebb3f-f1c7-402c-bd16-6f88da0d042c)                                   | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2003 x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=989ac6f1-515c-467d-a200-2aabe66d9319)                                      | Esecuzione di codice in modalità remota     | Importante                   | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=989ac6f1-515c-467d-a200-2aabe66d9319)                       | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2003 con SP1 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=91589cfb-15ba-4dd2-9e3b-107899fbcba6)            | Esecuzione di codice in modalità remota     | Importante                   | [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063) |
| [Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=91589cfb-15ba-4dd2-9e3b-107899fbcba6)            | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=72dd6015-25d1-45f4-a769-88ac43074b44)                         | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f793af16-5464-4db1-a42b-1c5f17c538ed) | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=cf6744e6-b54c-40f6-a78d-7ba9453133c0)\*                           | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=223236e8-7b19-4b47-8a90-bfc35eb9318a)\*                                | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
| [Windows Server 2008 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=077b697c-04a0-45bd-b08c-331d5c30cb47)                    | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                                             |
...
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 957095](http://support.microsoft.com/kb/957095).
...
<th style="border:1px solid black;" >Vulnerabilità legata all'underflow di buffer SMB - CVE-2008-4038</th>
...
Vulnerabilità legata all'underflow di buffer SMB - CVE-2008-4038  
----------------------------------------------------------------
  
<span></span>
Una vulnerabilità legata all'esecuzione di codice in modalità remota è stata riscontrata nel modo in cui il protocollo SMB (Server Message Block) di Microsoft gestisce i nomi file appositamente predisposti. Il tentativo di sfruttare tale vulnerabilità richiede l'autenticazione poiché la funzione vulnerabile si ottiene solo se il tipo di condivisione è di disco che, per impostazione predefinita, richiede sempre l'autenticazione. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-4038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4038).
  
#### Fattori attenuanti per la vulnerabilità legata all'underflow di buffer SMB - CVE-2008-4038
...
#### Soluzioni alternative per la vulnerabilità legata all'underflow di buffer SMB - CVE-2008-4038
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'underflow di buffer SMB - CVE-2008-4038
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata da convalida insufficiente di nomi file appositamente predisposti dal protocollo SMB (Server Message Block) di Microsoft.
...
Un utente malintenzionato su un client dannoso può sfruttare questa vulnerabilità inviando pacchetti appositamente predisposti a un server. Per sfruttare questa vulnerabilità, un utente malintenzionato deve conoscere l'indirizzo IP dell'host di destinazione, il nome di computer NetBIOS e il numero di porta, al fine di inviare traffico dannoso.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
Qualsiasi sistema Windows che consente la condivisione di file può essere a rischio.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento elimina la vulnerabilità aggiungendo la convalida SMB di lunghezze del nome file particolari.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Utilizzare Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB957095$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/957095">articolo della Microsoft Knowledge Base 957095</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB957095$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/957095">articolo della Microsoft Knowledge Base 957095</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB957095$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/957095">articolo della Microsoft Knowledge Base 957095</a></td>
...
-   Joshua Morin di [Codenomicon](http://www.codenomicon.com/) per aver segnalato la vulnerabilità legata all'underflow di buffer SMB (CVE-2008-4038)
...
-   V1.1 (15 ottobre 2008): bollettino aggiornato per chiarire che gli aggiornamenti per Windows Vista e Windows 2008 non richiedono il riavvio del sistema e per correggere la voce di verifica della chiave del Registro di sistema per Windows XP.
