---
TOCTitle: 'MS08-030'
Title: 'Bollettino Microsoft sulla sicurezza MS08-030 - Critico'
ms:assetid: 'ms08-030'
ms:contentKeyID: 61240319
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-030(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS08-030 - Critico
=======================================================

Una vulnerabilità nello stack Bluetooth può consentire l'esecuzione di codice in modalità remota (951376)
---------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 10 giugno 2008 | Aggiornamento: giovedì 19 giugno 2008
...
Questo aggiornamento per la protezione è considerato di livello critico per tutte le edizioni supportate di Windows XP e Windows Vista. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui lo stack Bluetooth gestisce un gran numero di richieste di descrizione di servizio. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=980bb421-950f-4825-8039-44cc961a47b8)                     | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=81ab56ca-933f-4974-a393-290a54c30a78) | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=6524debe-be50-44d1-8543-af0bfaf086ad)                              | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6adee8b9-3455-4f3b-8bdd-2585c8ff83b8)                     | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
...
<span></span>
**Perché questo aggiornamento per la protezione è stato proposto nuovamente in data 19 giugno 2008?**  
Microsoft propone nuovamente gli aggiornamenti descritti nel [Bollettino Microsoft sulla sicurezza MS08-030](http://technet.microsoft.com/it-it/security/default.aspx) - [Una vulnerabilità nello stack Bluetooth può consentire l'esecuzione di codice in modalità remota (951376)](http://technet.microsoft.com/it-it/security/default.aspx) a causa di problemi che riguardano l'aggiornamento di Windows XP Service Pack 2 e Windows XP Service Pack 3. L'aggiornamento di Windows XP Service Pack 2 e Windows XP Service Pack 3 offerto nel [Bollettino Microsoft sulla sicurezza MS08-030](http://technet.microsoft.com/it-it/security/default.aspx) non ha risolto completamente la vulnerabilità descritta nel bollettino sulla sicurezza. Tutte le altre versioni dell'aggiornamento per la protezione assicurano la protezione contro i problemi trattati nel bollettino sulla sicurezza.

Questo bollettino è stato pubblicato nuovamente al fine di fornire la versione aggiornata dell'aggiornamento per la protezione che interessa Windows XP Service Pack 2 e Windows XP Service Pack 3. Ai clienti che utilizzano Windows XP Service Pack 2 e Windows XP Service Pack 3 si consiglia di scaricare e installare questo nuovo aggiornamento per la protezione. I clienti che utilizzano Windows XP Professional X64 Edition, Windows XP Professional x64 Edition Service Pack 2 e tutte le versioni supportate di Windows Vista ed hanno già applicato questi aggiornamenti per la protezione originali non devono eseguire alcuna operazione. Le versioni aggiornate degli aggiornamenti per la protezione interessati saranno messe a disposizione attraverso tutti i canali di distribuzione già utilizzati per gli aggiornamenti per la protezione originali, tra cui Aggiornamenti automatici, Windows Update e Windows Server Update Services.

**Dove si trova la sezione Informazioni sui file?**  
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 951376](http://support.microsoft.com/kb/951376).
...
<th style="border:1px solid black;" >Vulnerabilità del Bluetooth - CVE-2008-1453</th>
...
Vulnerabilità del Bluetooth - CVE-2008-1453  
-------------------------------------------
  
<span></span>
Nello stack Bluetooth in Microsoft Windows esiste una vulnerabilità legata all'esecuzione di codice in modalità remota dovuta al fatto che lo stack Bluetooth non è in grado di gestire correttamente numerose richieste di descrizione di servizio. Questa vulnerabilità potrebbe consentire a un utente malintenzionato di eseguire codice con privilegi elevati. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-1453](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1453).
  
#### Fattori attenuanti della vulnerabilità del Bluetooth - CVE-2008-1453
...
#### Soluzioni alternative per la vulnerabilità del Bluetooth - CVE-2008-1453
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità.
  
-   **Blocco di nuove connessioni Bluetooth**
  
**Metodo interattivo**
  
1.  Nel **Pannello di controllo** selezionare **Visualizzazione classica**.  
2.  Scegliere **Dispositivi Bluetooth**.  
3.  Fare clic sulla scheda **Opzioni**.  
4.  Deselezionare la casella di controllo **Consenti ai dispositivi Bluetooth di individuare il computer**.  
5.  Fare clic su **OK**.
...
2.  Scegliere **Dispositivi Bluetooth**.  
3.  Fare clic sulla scheda **Opzioni**.  
4.  Selezionare la casella di controllo **Consenti ai dispositivi Bluetooth di individuare il computer**.  
5.  Fare clic su **OK**.
  
**Metodo script PowerShell**
  
Eseguire i comandi seguenti in qualità di amministratore con privilegi elevati:
...
-   **Disattivazione del driver di Bluetooth**
  
È possibile inoltre interrompere e disattivare il driver immettendo la riga seguente al prompt dei comandi (disponibile in Windows XP e versioni successive e nel Windows 2000 Resource Kit):
  
sc config bthport start= disabled
  
**Per annullare il risultato della soluzione alternativa**
  
È possibile riattivare il driver Bluetooth immettendo la riga seguente al prompt dei comandi (disponibile in Windows XP e versioni successive e nel Windows 2000 Resource Kit):
  
sc config bthport start= demand
  
#### Domande frequenti relative alla vulnerabilità del Bluetooth - CVE-2008-1453:
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Nello stack Bluetooth di Microsoft Windows esiste una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe eseguire codice con privilegi elevati. Quindi, potrebbe assumere il pieno controllo di un sistema interessato.
  
**Quali sono le cause di questa vulnerabilità?**    
Lo stack di Bluetooth di Windows non è in grado di gestire correttamente un gran numero di richieste di descrizione di servizio.
  
**Che cosa si intende per Bluetooth?**    
Per Bluetooth si intende un protocollo standard di settore in grado di attivare una connessione wireless tra computer, periferiche portatili, telefoni cellulari e altre periferiche. Per ulteriori informazioni vedere l'[articolo di MSDN sulla tecnologia Bluetooth](http://msdn.microsoft.com/library/aa362932(vs.85).aspx).
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**    
Se sfruttata, questa vulnerabilità può consentire a un utente malintenzionato di assumere il controllo completo del sistema interessato, Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
Per sfruttare questa vulnerabilità, un utente malintenzionato deve inviare rapidamente un gran numero di pacchetti SDP (Service Discovery Protocol) appositamente predisposti a un sistema interessato. Il modo in cui il sistema reagisce a tali pacchetti consente all'utente malintenzionato di assumere il controllo completo del sistema interessato.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
Tutti i sistemi che hanno attivato Bluetooth sono esposti a questa vulnerabilità.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento elimina la vulnerabilità migliorando il modo in cui lo stack Bluetooth gestisce un gran numero di pacchetti SDP.
...
| Windows Vista e Windows Vista Service Pack 1                                             | No      | No                 | Vedere **Nota su Windows** **Vista** di seguito | No        |  
| Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1                     | No      | No                 | Vedere **Nota su Windows** **Vista** di seguito | No        |
...
<td style="border:1px solid black;">Scegliere Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB951376$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/951376">articolo della Microsoft Knowledge Base 951376</a></td>
</tr>
<tr class="even">
...
-   Tombkeeper di [NSFocus](http://www.nsfocus.com/) e Sowhat di [Nevis Labs](http://www.nevisnetworks.com/), per l'aiuto dato con la nuova versione dell'aggiornamento per la vulnerabilità del Bluetooth– (CVE-2008-1453).
...
-   V2.0 (19 giugno 2008): La voce, "Perché in data 19 giugno 2008 è stato nuovamente proposto questo aggiornamento per la protezione?", è stata aggiunta alle domande frequenti sull'aggiornamento e avvertire i clienti che utilizzano Windows XP Service Pack 2 e Windows XP Service Pack 3 della disponibilità di una versione rivista dell'aggiornamento per la protezione.
