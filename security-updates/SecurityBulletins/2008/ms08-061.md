---
TOCTitle: 'MS08-061'
Title: 'Bollettino Microsoft sulla sicurezza MS08-061 - Importante'
ms:assetid: 'ms08-061'
ms:contentKeyID: 61240350
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms08-061(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS08-061 - Importante
==========================================================

Alcune vulnerabilità del kernel di Windows possono consentire l'acquisizione di privilegi più elevati (954211)
--------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 14 ottobre 2008
...
L'aggiornamento per la protezione risolve le vulnerabilità correggendo la convalida delle proprietà di una nuova finestra durante la creazione della stessa, il modo in cui vengono gestite le chiamate di sistema provenienti da più thread e la convalida dei parametri trasmessi al kernel di Windows in modalità utente. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.

**Raccomandazione.** Microsoft consiglia di installare l'aggiornamento quanto prima.

**Problemi noti.** L'[articolo della Microsoft Knowledge Base 954211](http://support.microsoft.com/kb/954211) descrive i problemi attualmente conosciuti che gli utenti potrebbero riscontrare installando questo aggiornamento per la protezione. L'articolo illustra inoltre le soluzioni consigliate in grado di risolvere questi problemi.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=3a6165a6-d7e7-4526-9291-290caf0639b4)                                                                                           | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607)                                                                                             | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607)                                                                                             | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b06d3a02-b6e4-4d40-913a-3759a31f20f3)                              | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e696762-d652-4a8f-ab8f-622f9746c320)                                               | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=57ca28ea-e5e1-4191-a3d6-84aa90a3d668)                                      | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 con SP1 per sistemi basati su Itanium e Windows Server 2003 con SP2 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1e6c3f81-85bb-48e6-a5af-635a7e540c93) | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=3483b400-cedc-441f-ba8e-594e3df89190)                                                                          | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=905ab030-14a5-4a3d-aa11-e8f957f6a1ea)                                                  | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=8b97114a-71aa-47a2-b9e7-f4e158c18c80)\*                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=6e641db2-90c8-458f-9795-3e46b70a5203)\*                                                                                 | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 per sistemi basati su Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=b6546e1c-bf7b-4354-8574-6c16fa707de0)                                                                     | Acquisizione di privilegi più elevati       | Importante                   | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
...
La sezione Informazioni sui file è disponibile nell'[articolo della Microsoft Knowledge Base 954211](http://support.microsoft.com/kb/954211).
...
<th style="border:1px solid black;" >Vulnerabilità del kernel di Windows durante la creazione di una finestra - CVE-2008-2250</th>
<th style="border:1px solid black;" >Vulnerabilità legata alle eccezioni non gestite del kernel di Windows - CVE-2008-2251</th>
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria del kernel di Windows - CVE-2008-2252</th>
...
Vulnerabilità del kernel di Windows durante la creazione di una finestra - CVE-2008-2250  
----------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al fatto che il kernel di Windows non convalida correttamente le proprietà di una nuova finestra trasmesse durante il processo di creazione della stessa. Un utente malintenzionato in grado di sfruttare questa vulnerabilità potrebbe eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-2250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2250).
  
#### Fattori attenuanti della vulnerabilità del kernel di Windows durante la creazione di una finestra - CVE-2008-2250
...
#### Soluzioni alternative per la vulnerabilità del kernel di Windows durante la creazione di una finestra - CVE-2008-2250
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità del kernel di Windows durante la creazione di una finestra - CVE-2008-2250
...
Durante la creazione di una nuova finestra, il kernel di Windows non elabora correttamente l'input inviato da una finestra padre a una finestra figlio.
...
L'aggiornamento risolve la vulnerabilità convalidando correttamente le proprietà di una finestra trasmesse durante il processo di creazione della stessa.
...
Vulnerabilità legata alle eccezioni non gestite del kernel di Windows - CVE-2008-2251  
-------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta a una condizione "double free" del kernel di Windows. Questa vulnerabilità potrebbe consentire a un utente malintenzionato di eseguire codice con privilegi elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-2251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2251).
  
#### Fattori attenuanti della vulnerabilità legata alle eccezioni non gestite del kernel di Windows - CVE-2008-2251
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Un utente malintenzionato deve essere in possesso di credenziali di accesso valide e in grado di accedere in locale a un sistema vulnerabile per sfruttare questa vulnerabilità. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alle eccezioni non gestite del kernel di Windows - CVE-2008-2251
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alle eccezioni non gestite del kernel di Windows - CVE-2008-2251
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata dal fatto che il kernel di Windows non gestisce correttamente le chiamate di sistema provenienti da più thread.
...
Un utente malintenzionato può fare in modo che un sistema interessato, durante l'esecuzione di un programma opportunamente predisposto, tenti di rilasciare o "liberare" memoria riservata allo scopo di utilizzarla più volte. Il rilascio di memoria già liberata può provocare danni alla memoria. Un utente malintenzionato potrebbe aggiungere codice non autorizzato alla memoria e fare in modo che venga eseguito quando si verifica il danneggiamento. Il codice potrà essere quindi eseguito con privilegi di sistema.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui vengono gestite le chiamate di sistema provenienti da più thread.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni su questa vulnerabilità erano state pubblicamente divulgate al momento della pubblicazione del presente bollettino sulla sicurezza. Questa vulnerabilità è stata identificata con il codice [CVE-2008-2251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2251).
  
**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**    
No. Al momento della pubblicazione del presente bollettino, Microsoft non aveva ricevuto alcuna segnalazione in merito allo sfruttamento di questa vulnerabilità a scopo di attacco, né dell'esistenza di un codice di prova pubblicato.
  
Vulnerabilità legata al danneggiamento della memoria del kernel di Windows - CVE-2008-2252  
------------------------------------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2008-2252](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2252).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria del kernel di Windows - CVE-2008-2252
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Un utente malintenzionato deve essere in possesso di credenziali di accesso valide e in grado di accedere in locale a un sistema vulnerabile per sfruttare questa vulnerabilità. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria del kernel di Windows - CVE-2008-2252
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria del kernel di Windows - CVE-2008-2252
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è dovuta al fatto che il kernel di Windows non esegue in modo corretto la convalida dell'input inviato al kernel in modalità utente.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento rimuove la vulnerabilità convalidando correttamente i parametri inviati al kernel di Windows in modalità utente.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Utilizzare Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB954211$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/954211">articolo della Microsoft Knowledge Base 954211</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare Installazione applicazioni dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB954211$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/954211">articolo della Microsoft Knowledge Base 954211</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB954211$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/954211">articolo della Microsoft Knowledge Base 954211</a></td>
...
-   Paul Caton di [iShadow](http://www.ishadow.com/) per avere segnalato la vulnerabilità del kernel di Windows durante la creazione di una finestra - (CVE-2008-2250)  
-   Thomas Garnier di [SkyRecon](http://www.skyrecon.com/) per avere segnalato la vulnerabilità legata al danneggiamento della memoria del kernel di Windows - (CVE-2008-2252)
