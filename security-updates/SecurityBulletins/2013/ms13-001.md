---
TOCTitle: 'MS13-001'
Title: 'Bollettino Microsoft sulla sicurezza MS13-001 - Critico'
ms:assetid: 'ms13-001'
ms:contentKeyID: 61240725
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms13-001(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS13-001 - Critico
=======================================================

Una vulnerabilità nei componenti dello spooler di stampa di Windows può consentire l'esecuzione di codice in modalità remota (2769369)
--------------------------------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 8 gennaio 2013
...
Questo aggiornamento per la protezione risolve una vulnerabilità di Microsoft Windows che è stata segnalata privatamente. La vulnerabilità può consentire l'esecuzione di codice in modalità remota se un server di stampa riceve un processo di stampa appositamente predisposto. Le configurazioni predefinite standard dei firewall e le procedure consigliate per la configurazione dei firewall consentono di proteggere le reti dagli attacchi sferrati dall'esterno del perimetro aziendale. È consigliabile che i sistemi connessi direttamente a Internet abbiano un numero minimo di porte esposte.

Questo aggiornamento per la protezione è considerato di livello Critico per tutte le edizioni supportate di Windows 7 e Windows Server 2008 R2. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui lo spooler di stampa di Windows gestisce lavori di stampa appositamente predisposti. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
Gli hash SHA1 e SHA2 degli aggiornamenti per la protezione possono essere utilizzati per verificare l'autenticità dei pacchetti di aggiornamento per la protezione scaricati. Per le informazioni sugli hash pertinenti a questo aggiornamento, vedere [l'articolo della Microsoft Knowledge Base 2769369](https://support.microsoft.com/kb/2769369).

**Si esegue Windows Server 2008 R2 (installazione Server Core), che è elencato nella tabella Software interessato. Perché non viene offerto l'aggiornamento KB2769369 per la protezione?**
L'aggiornamento KB2769369 viene offerto solo ai sistemi su cui è in esecuzione un'opzione di installazione Server Core di Windows Server 2008 R2, quando l'impostazione Printing-ServerCore-Role è attivata.
...
<th style="border:1px solid black;" >
Vulnerabilità dei componenti dello spooler di stampa di Windows - CVE-2013-0011
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Una vulnerabilità legata all'esecuzione di codice in modalità remota è stata riscontrata nel modo in cui lo spooler di stampa di Microsoft Windows gestisce lavori di stampa appositamente predisposti. La vulnerabilità può danneggiare la memoria in modo da consentire a un utente malintenzionato di eseguire codice arbitrario.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2013-0011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0011).

#### Fattori attenuanti per la vulnerabilità dei componenti dello spooler di stampa di Windows - CVE-2013-0011
...
#### Soluzioni alternative per la vulnerabilità dei componenti dello spooler di stampa di Windows - CVE-2013-0011
...
#### Domande frequenti per la vulnerabilità dei componenti dello spooler di stampa di Windows - CVE-2013-0011

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota.

**Quali sono le cause di questa vulnerabilità?**
Questa vulnerabilità è causata quando lo spooler di stampa di Windows non riesce a gestire un lavoro di stampa appositamente predisposto.
...
Un utente malintenzionato remoto non autenticato può sfruttare la vulnerabilità inviando un lavoro di stampa appositamente predisposto al server di stampa.

**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**
Le workstation e i server sono principalmente a rischio.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui lo spooler di stampa di Windows gestisce lavori di stampa appositamente predisposti.
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2769369">articolo della Microsoft Knowledge Base 2769369</a></td>
</tr>
<tr class="odd">
