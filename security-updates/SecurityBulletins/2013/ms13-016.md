---
TOCTitle: 'MS13-016'
Title: 'Bollettino Microsoft sulla sicurezza MS13-016 - Importante'
ms:assetid: 'ms13-016'
ms:contentKeyID: 61240740
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms13-016(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS13-016 - Importante
==========================================================

Alcune vulnerabilità nel driver in modalità kernel di Windows possono consentire l'acquisizione di privilegi più elevati (2778344)
----------------------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per tutte le versioni supportate di Microsoft Windows, tranne Windows 8, Windows Server 2012 e Windows RT. Per Windows 8, Windows Server 2012 e Windows RT, questo aggiornamento per la protezione non presenta un livello di gravità. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui il driver in modalità kernel gestisce gli oggetti in memoria. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
KB2779030 in [MS12-078](http://go.microsoft.com/fwlink/?linkid=271624)
</td>
</tr>
...
<td style="border:1px solid black;">
KB2778930 in [MS13-005](http://go.microsoft.com/fwlink/?linkid=273826)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<sup>[2]</sup>I livelli di gravità non si applicano a questo aggiornamento per il software specificato perché i vettori di attacco conosciuti per queste vulnerabilità sono bloccati. Tuttavia, come misura di difesa in profondità, Microsoft consiglia ai clienti di questo software di applicare questo aggiornamento per la protezione.
...
<th style="border:1px solid black;" >
Vulnerabilità legata alla race condition in Win32k:
CVE-2013-1248
CVE-2013-1249
</th>
<th style="border:1px solid black;" >
...
Vulnerabilità legate alla race condition in Win32k
--------------------------------------------------
...
<table style="border:1px solid black;">
<caption>Vulnerabilità legate alla race condition in Win32k</caption>
<tbody>
<tr class="odd">
...
#### Fattori attenuanti della vulnerabilità legata alla race condition in Win32k
...
#### Soluzioni alternative per la vulnerabilità legata alla race condition in Win32k

-   Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata alla race condition in Win32k
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2778344$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2778344">articolo della Microsoft Knowledge Base 2778344</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2778344$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2778344](http://support.microsoft.com/kb/2778344)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Per rimuovere un aggiornamento installato tramite WUSA, utilizzare l'opzione del programma di installazione /Uninstall o fare clic su <strong>Pannello di controllo</strong>, selezionare <strong>Sistema e sicurezza</strong>, quindi in <strong>Windows Update</strong>, fare clic su <strong>Aggiornamenti installati</strong> e selezionarne uno dall'elenco.
<div>
...
| **Informazioni sui file**                 | Consultare l'[articolo della Microsoft Knowledge Base 2778344](http://support.microsoft.com/kb/2778344)                                                        |
...
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) e il [Tencent Security Team](http://security.tencent.com/) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1248)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) e il [Tencent Security Team](http://security.tencent.com/) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1249)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1250)  
-   [Gynvael Coldwind](http://gynvael.coldwind.pl) e [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1251)  
-   [Gynvael Coldwind](http://gynvael.coldwind.pl) e [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1252)  
-   [Gynvael Coldwind](http://gynvael.coldwind.pl) e [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1253)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1254)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1255)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1256)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1257)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1258)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1259)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1260)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1261)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1262)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1263)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1264)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1265)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1266)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1267)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1268)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1269)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1270)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1271)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1272)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1273)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1274)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1275)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1276)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition in Win32k (CVE-2013-1277)
...
-   V1.1 (12 febbraio 2013): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2778344 nella sottosezione Problemi noti del Riepilogo.  
-   
