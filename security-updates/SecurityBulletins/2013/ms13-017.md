---
TOCTitle: 'MS13-017'
Title: 'Bollettino Microsoft sulla sicurezza MS13-017 - Importante'
ms:assetid: 'ms13-017'
ms:contentKeyID: 61240741
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms13-017(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS13-017 - Importante
==========================================================

Alcune vulnerabilità del kernel di Windows possono consentire l'acquisizione di privilegi più elevati (2799494)
---------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve le vulnerabilità modificando il modo in cui il kernel di Windows gestisce gli oggetti in memoria. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
KB2724197 in [MS12-068](http://go.microsoft.com/fwlink/?linkid=257912)
</td>
</tr>
...
<th style="border:1px solid black;" >
Vulnerabilità legata alla race condition nel kernel - 2013-1278
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata alla race condition nel kernel - CVE-2013-1279
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al conteggio dei riferimenti nel kernel di Windows - CVE-2013-1280
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
Vulnerabilità legata alla race condition nel kernel - CVE-2013-1278
-------------------------------------------------------------------

<span></span>
Una vulnerabilità legata all'acquisizione di privilegi più elevati si presenta quando il kernel di Windows gestisce erroneamente gli oggetti nella memoria. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Questi è in grado di installare programmi, visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2013-1278](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1278).

#### Fattori attenuanti della vulnerabilità legata alla race condition nel kernel - CVE-2013-1278
...
#### Soluzioni alternative per la vulnerabilità legata alla race condition nel kernel - CVE-2013-1278

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata alla race condition nel kernel - CVE-2013-1278
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2013-1279](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1279).

#### Fattori attenuanti della vulnerabilità legata alla race condition nel kernel - CVE-2013-1279

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale.

#### Soluzioni alternative per la vulnerabilità legata alla race condition nel kernel - CVE-2013-1279

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata alla race condition nel kernel - CVE-2013-1279
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2013-1280](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1280).

#### Fattori attenuanti della vulnerabilità legata al conteggio dei riferimenti nel kernel di Windows - CVE-2013-1280

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale.

#### Soluzioni alternative per la vulnerabilità legata al conteggio dei riferimenti nel kernel di Windows - CVE-2013-1280

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata al conteggio dei riferimenti nel kernel di Windows - CVE-2013-1280
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2799494$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2799494">articolo della Microsoft Knowledge Base 2799494</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2799494$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2799494](http://support.microsoft.com/kb/2799494)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **Informazioni sui file**                 | Consultare l'[articolo della Microsoft Knowledge Base 2799494](http://support.microsoft.com/kb/2799494)                                                        |
...
-   [Gynvael Coldwind](http://gynvael.coldwind.pl/) e [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition nel kernel (CVE-2013-1278)  
-   [Gynvael Coldwind](http://gynvael.coldwind.pl/) e [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/) di [Google Inc](http://www.google.com) per aver segnalato la vulnerabilità legata alla race condition nel kernel (CVE-2013-1279)
...
-   V1.1 (12 febbraio 2013): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2799494 nella sottosezione Problemi noti del Riepilogo.
