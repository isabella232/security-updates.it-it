---
TOCTitle: 'MS13-006'
Title: 'Bollettino Microsoft sulla sicurezza MS13-006 - Importante'
ms:assetid: 'ms13-006'
ms:contentKeyID: 61240730
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms13-006(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS13-006 - Importante
==========================================================

Una vulnerabilità in Microsoft Windows può consentire l'elusione della funzione di protezione (2785220)
-------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve una vulnerabilità segnalata privatamente nell'implementazione di SSL e TLS in Microsoft Windows. La vulnerabilità può consentire l'elusione della funzione di protezione se un utente malintenzionato intercetta handshake di traffico Web crittografati.
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui il componente provider di Windows SSL gestisce i pacchetti di rete crittografati. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'elusione della funzione di protezione per il protocollo SSL versione 3 e TLS di Microsoft - CVE-2013-0013
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
È stata riscontrata una vulnerabilità legata all'elusione della funzione di protezione dovuta al modo in cui SSL/TLS (Secure Socket Layer e Transport Layer Security) di Microsoft Windows gestisce i protocolli SSL versione 3 (SSLv3) e TLS. La vulnerabilità può consentire l'elusione della funzione di protezione se un utente malintenzionato immette contenuto appositamente predisposto in una sessione SSL/TLS.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2013-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0013).

#### Fattori attenuanti per la vulnerabilità legata all'elusione della funzione di protezione per i protocolli SSL versione 3 e TLS di Microsoft - CVE-2013-0013

Microsoft non ha individuato alcun fattore attenuante per questa vulnerabilità.

#### Soluzioni alternative per la vulnerabilità legata all'elusione della funzione di protezione per i protocolli SSL versione 3 e TLS di Microsoft - CVE-2013-0013

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Configurare Internet Explorer in modo da disattivare SSLv2**

    La modifica delle impostazioni in modo che SSLv2 venga disattivato assicura la protezione del computer da questa vulnerabilità in Internet Explorer. A tale scopo, utilizzare la procedura seguente:

    1.  In Internet Explorer, scegliere **Opzioni Internet** dal menu **Strumenti**.
    2.  Fare clic sulla scheda **Avanzate**.
    3.  Scorrere fino alla sezione **Protezione**.
    4.  Rimuovere il segno di spunta dalla casella accanto a **Usa SSL 2.0**.
    5.  Fare clic su **OK** per tornare a Internet Explorer.

    **Impatto della soluzione alternativa.** La disattivazione di SSLv2 può avere effetti collaterali. Alcuni siti Web su Internet o su una rete Intranet potrebbero utilizzare SSLv2 per fornire una comunicazione protetta. Dopo la disattivazione di SSLv2, non sarà possibile utilizzare questi siti Web.
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    2.  Fare clic sulla scheda **Avanzate**.
    3.  Scorrere fino alla sezione **Protezione**.
    4.  Selezionare la casella accanto a **Usa SSL 2.**0.
    5.  Fare clic su **OK** per tornare a Internet Explorer.

-   **Configurare Internet Information Services in modo da disattivare SSLv2**

    **Avvertenza** La modifica non corretta del Registro di sistema potrebbe provocare problemi tali da rendere necessaria la reinstallazione del sistema operativo. Microsoft non garantisce la risoluzione di problemi dovuti a una modifica non corretta del Registro di sistema. È quindi necessario eseguire questa modifica con grande attenzione.

    La modifica delle impostazioni in modo che SSLv2 venga disattivato assicura la protezione del computer da questa vulnerabilità nei siti Web IIS. A tale scopo, utilizzare la procedura seguente:

    1.  Fare clic sul pulsante **Start**, scegliere **Esegui**, digitare **regedit**, quindi fare clic su **OK**.
    2.  Nell'Editor del Registro di sistema, individuare la seguente chiave/cartella di registro di sistema:

        `HKey_Local_Machine\System\CurrentControlSet\Control\SecurityProviders \SCHANNEL\Protocols\SSL 2.0  `

    3.  Fare clic con il pulsante destro del mouse sulla cartella **SSL 2.0**, quindi selezionare **Nuovo** e fare clic su **Chiave**. Denominare il nuovo **Server** della cartella.
    4.  Nella cartella **Server**, fare clic sul menu **Modifica**, selezionare **Nuovo**, quindi fare clic su **Valore DWORD (32 bit)**.
    5.  Inserire **Attivato** come nome e premere **Invio**.
    6.  Assicurarsi che, sotto la colonna Dati, venga visualizzato 0x00000000 (0) (come dovrebbe per impostazione predefinita). In caso contrario, fare clic con il pulsante destro del mouse e selezionare **Modifica**, quindi inserire 0 nella casella dati Valore.
    7.  Riavviare il computer.

    **Impatto della soluzione alternativa.** Con la disattivazione di SSLv2, possono verificarsi effetti collaterali. Alcuni browser Web potrebbero utilizzare SSLv2 per instaurare una comunicazione protetta. Dopo la disattivazione di SSLv2 gli utenti non potranno visualizzare tali siti Web.
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    3.  Nella cartella **Server**, fare clic con il pulsante destro del mouse sul valore DWORD **Attivato**, quindi selezionare **Elimina**. Selezionare **Sì**.
    4.  Riavviare il computer.

#### Domande frequenti per la vulnerabilità legata all'elusione della funzione di protezione per i protocolli SSL versione 3 e TLS di Microsoft - CVE-2013-0013

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità legata all'elusione della funzione di protezione. Un utente malintenzionato che ha sfruttato con successo questa vulnerabilità potrebbe ignorare le funzioni di protezione in SSL versione 3 o TLS che contrasta la riduzione della connessione a SSL versione 2.

**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità si presenta quando Windows non riesce a gestire correttamente la negoziazione tra le versioni della sessione SSL/TLS.
...
Un utente malintenzionato che tiene costantemente monitorata una comunicazione crittografata e ha sfruttato questa vulnerabilità potrebbe declassare automaticamente la connessione SSL versione 3 o TLS alla versione 2, che supporta le cifre di crittografia deboli.

**In che modo un utente malintenzionato può sfruttare questa** **vulnerabilità?**
In un attacco di tipo "man-in-the-middle", un utente malintenzionato potrebbe immettere traffico non valido in una sessione di browser SSL versione 3 o TLS tra Internet Explorer e un server di terze parti o un client di terze parti e un server di Microsoft, declassando automaticamente la connessione a SSL versione 2.
...
I sistemi maggiormente a rischio sono quelli che inviano e ricevono traffico crittografato SSL/TLS.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità modificando il modo in cui il componente provider di Windows SSL gestisce i pacchetti di rete crittografati.
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2785220">articolo della Microsoft Knowledge Base 2785220</a></td>
</tr>
<tr class="odd">
...
| **Informazioni sui file**                 | Consultare l'[articolo della Microsoft Knowledge Base 2785220](http://support.microsoft.com/kb/2785220)                                                        |
...
-   [Katayama Kenichiro](https://twitter.com/pin_ptr) per aver segnalato la vulnerabilità legata all'elusione della funzione di protezione per il protocollo SSL versione 3 e TLS di Microsoft (CVE-2013-0013)
...
-   V1.1 (12 febbraio 2013): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2785220 nella sottosezione Problemi noti del Riepilogo.  
-   V1.2 (9 luglio 2013): Il bollettino è stato rivisto per comunicare un modifica di rilevamento nei pacchetti di Windows Vista affinché l'aggiornamento 2785220 corregga un problema che si è ripresentato in Windows Update. Si tratta di una modifica solo al rilevamento. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.  
-   V1.3 (16 dicembre 2013): Il bollettino è stato rivisto per comunicare una modifica al rilevamento e correggere un problema di offerta per Windows RT (2785220). Si tratta di una modifica solo al rilevamento. Non sono previste modifiche ai file di aggiornamento. I clienti che hanno già installato questo aggiornamento non devono eseguire ulteriori operazioni.
