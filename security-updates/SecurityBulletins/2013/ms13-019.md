---
TOCTitle: 'MS13-019'
Title: 'Bollettino Microsoft sulla sicurezza MS13-019 - Importante'
ms:assetid: 'ms13-019'
ms:contentKeyID: 61240743
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms13-019(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS13-019 - Importante
==========================================================

Una vulnerabilità nel sottosistema runtime client/server di Windows (CSRSS) può consentire l'acquisizione di privilegi più elevati (2790113)
--------------------------------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per tutte le edizioni supportate di Windows 7 e Windows 2008 R2. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno della presente sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Windows CSRSS gestisce gli oggetti in memoria. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
[Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=d4d02ef9-b0a4-46a3-ad92-7508aa26ad3b)  
(KB2790113)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2567680 in [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864)
</td>
</tr>
...
<th style="border:1px solid black;" >
Vulnerabilità legata al conteggio dei riferimenti - CVE-2013-0076
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2013-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0076).

#### Fattori attenuanti della vulnerabilità legata al conteggio dei riferimenti - CVE-2013-0076
...
#### Soluzioni alternative per la vulnerabilità legata al conteggio dei riferimenti - CVE-2013-0076

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata al conteggio dei riferimenti - CVE-2013-0076
...
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2013-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0076).
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2790113">articolo della Microsoft Knowledge Base 2790113</a></td>
</tr>
<tr class="odd">
...
-   Max DeLiso per aver collaborato con noi alla vulnerabilità legata al conteggio dei riferimenti (CVE-2013-0076)
