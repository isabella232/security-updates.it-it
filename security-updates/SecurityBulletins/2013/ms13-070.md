---
TOCTitle: 'MS13-070'
Title: 'Bollettino Microsoft sulla sicurezza MS13-070 - Critico'
ms:assetid: 'ms13-070'
ms:contentKeyID: 61240794
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms13-070(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS13-070 - Critico
=======================================================

Una vulnerabilità in OLE può consentire l'esecuzione di codice in modalità remota (2876217)
-------------------------------------------------------------------------------------------
...
| Articolo della Microsoft Knowledge Base | [2876217](https://support.microsoft.com/kb/2876217) |
|-----------------------------------------|-----------------------------------------------------|
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f2d9dbf4-a0b7-4585-a3dd-e727cf691ba9)  
(2876217)
</td>
<td style="border:1px solid black;">
Esecuzione di codice in modalità remota
...
<th style="border:1px solid black;" >
Vulnerabilità legata alla proprietà OLE - CVE-2013-3863
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2013-3863](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3863).
...
Questa vulnerabilità è causata quando Windows gestisce in modo errato gli oggetti OLE nella memoria.
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2876217$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni</strong> <strong>sui</strong> <strong>file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2876217">articolo della Microsoft Knowledge Base 2876217</a></td>
</tr>
<tr class="even">
