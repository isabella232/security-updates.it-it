---
TOCTitle: 'MS12-032'
Title: 'Bollettino Microsoft sulla sicurezza MS12-032 - Importante'
ms:assetid: 'ms12-032'
ms:contentKeyID: 61240673
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-032(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-032 - Importante
==========================================================

Una vulnerabilità in TCP/IP può consentire l'acquisizione di privilegi più elevati (2688338)
--------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve una vulnerabilità divulgata pubblicamente e una vulnerabilità segnalata privatamente in Microsoft Windows. La più grave di queste vulnerabilità può consentire l'acquisizione di privilegi più elevati se un utente malintenzionato accede a un sistema ed esegue un'applicazione appositamente predisposta.
...
L'aggiornamento per la protezione risolve le vulnerabilità modificando il modo in cui Windows Firewall gestisce i pacchetti broadcast in uscita e modificando il modo in cui lo stack TCP/IP di Windows gestisce l'associazione di un indirizzo IPv6 a un'interfaccia locale. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
La soluzione KB2588516 in [MS11-083](http://go.microsoft.com/fwlink/?linkid=229071) è stata sostituita dalla soluzione KB2688338
</td>
</tr>
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'elusione di Windows Firewall - CVE-2012-0174
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata alla condizione double free in TCP/IP - CVE-2012-0179
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'elusione della funzione di protezione in Windows dovuta al modo in cui Windows Firewall gestisce i pacchetti broadcast in uscita. Sfruttando questa vulnerabilità, un utente malintenzionato può ignorare il meccanismo di difesa in profondità di Windows Firewall per facilitare lo sfruttamento di altre vulnerabilità.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0174](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0174).

#### Fattori attenuanti della vulnerabilità legata all'elusione di Windows Firewall - CVE-2012-0174

Microsoft non ha individuato alcun fattore attenuante per questa vulnerabilità.

#### Soluzioni alternative per la vulnerabilità legata all'elusione di Windows Firewall - CVE-2012-0174

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata all'elusione di Windows Firewall - CVE-2012-0174

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità legata all'elusione della funzione di protezione. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe eludere Windows Firewall per facilitare lo sfruttamento di altre vulnerabilità.

**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità si presenta quando Windows Firewall non riesce a filtrare correttamente i pacchetti broadcast in uscita con una regola del firewall in uscita applicata.

**Quale** **componente è interessato dalla vulnerabilità?**
Il componente interessato da questa vulnerabilità è lo stack TCP/IP (tcpip.sys).
...
Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe eludere Windows Firewall. Un utente malintenzionato può quindi utilizzare un'altra vulnerabilità per acquisire informazioni sul sistema di destinazione o eseguire codice sul sistema di destinazione.

**In quale modo un utente malintenzionato può sfruttare questa** **vulnerabilità?**
Per utilizzare questa vulnerabilità, un utente malintenzionato dovrebbe accedere innanzi tutto alla subnet locale del computer di destinazione. Un utente malintenzionato può quindi utilizzare un'altra vulnerabilità per acquisire informazioni sul sistema di destinazione o eseguire codice sul sistema di destinazione.

**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**
Le workstation e i server sono principalmente a rischio.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità modificando il modo in cui Windows Firewall gestisce i pacchetti broadcast in uscita.

**Quali sono i criteri di firewall in uscita predefiniti?**
I criteri di firewall in uscita predefiniti sono configurati per consentire tutto il traffico di rete in uscita dall'host. Per bloccare il traffico di rete in uscita non desiderato, i clienti dovranno creare regole di firewall per bloccare il traffico. Per ulteriori informazioni sull'aggiunta di regole di firewall in uscita, vedere l'articolo di TechNet [Creare regole di blocco del traffico di rete in uscita non desiderato](http://technet.microsoft.com/en-us/library/cc732306(v=ws.10).aspx).
...
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati nello stack TCP/IP di Windows che interessa Windows 7 e Windows Server 2008 R2. Tutte le edizioni di Microsoft Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008 non sono interessate. Questa vulnerabilità so presenta quando lo stack TCP/IP di Windows non riesce a gestire correttamente l'associazione di indirizzi IPv6.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0179](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179).

#### Fattori attenuanti della vulnerabilità legata alla condizione double free in TCP/IP - CVE-2012-0179
...
#### Soluzioni alternative per la vulnerabilità legata alla condizione double free in TCP/IP - CVE-2012-0179

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata alla condizione double free in TCP/IP - CVE-2012-0179

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati.

**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità è presente quando lo stack TCP/IP di Windows non riesce a gestire correttamente l'associazione di un indirizzo IPv6 a un'interfaccia locale.
...
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**
Le workstation e i server sono interessati da questa vulnerabilità.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità modificando il modo in cui lo stack TCP/IP di Windows gestisce l'associazione di un indirizzo di IPv6 a un'interfaccia locale.

**Al momento del rilascio di questo bollettino, le informazioni sulla vulnerabilità erano disponibili pubblicamente?**
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2012-0179](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179).
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2688338">articolo della Microsoft Knowledge Base 2688338</a></td>
</tr>
<tr class="odd">
...
-   Bojan Zdrnja di [INFIGO IS](http://www.infigo.hr/) per aver segnalato la vulnerabilità legata all'elusione di Windows Firewall (CVE-2012-0174)  
-   Anatoliy Glagolev di [Genesys Telecommunications](http://www.genesyslab.com/) per aver collaborato con noi sulla vulnerabilità legata alla condizione double free in TCP/IP (CVE-2012-0179)
...
-   V1.1 (9 maggio 2012): Sono stati corretti i fattori attenuanti per CVE-2012-0174 e CVE-2012-0179 nella sezione **Informazioni sulle vulnerabilità**.
