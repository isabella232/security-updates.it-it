---
TOCTitle: 'MS12-003'
Title: 'Bollettino Microsoft sulla sicurezza MS12-003 - Importante'
ms:assetid: 'ms12-003'
ms:contentKeyID: 61240644
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-003(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-003 - Importante
==========================================================

Una vulnerabilità nel sottosistema runtime client/server di Windows può consentire l'acquisizione di privilegi più elevati (2646524)
------------------------------------------------------------------------------------------------------------------------------------
...
Tale vulnerabilità può consentire l'acquisizione di privilegi più elevati se un utente malintenzionato accede al sistema interessato ed esegue un'applicazione appositamente predisposta. L'utente malintenzionato potrebbe assumere il pieno controllo del sistema interessato e installare programmi, visualizzare, modificare o cancellare dati o creare nuovi account con i diritti utente completi. Questa vulnerabilità può essere sfruttata solamente sui sistemi configurati con le impostazioni locali del sistema in lingua cinese, giapponese o coreana.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui il sottosistema runtime client/server (CSRSS) elabora i caratteri Unicode. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cfc38dc2-c4c7-4a44-8e5a-b98bb9bc0396)                                 | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3956db98-88d9-49fc-be51-247b40bfc272)        | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=39f5f8fb-ee4d-4b7a-9cd7-3d1e9c8abd8c)                        | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e27d85f8-a285-4e95-85a0-0868286cc2b9)            | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=b69bd01d-9925-4ff1-bfeb-b4473631578c)           | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73682d4b-3179-4488-8ba9-94ed68c4896b)                              | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b5c33025-13d9-43d2-a415-a8a4d683a821)                  | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fbf119cf-a8ed-4266-a673-442149992f7c)\* | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e8e68f89-27f4-4142-94ca-58f086a98157)\*      | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fc6491e8-6c3e-43a1-bc56-16c9a2fd2749)    | Acquisizione di privilegi più elevati       | Importante                   | [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) |
...
**Questa vulnerabilità interessa tutte le versioni delle lingue di Windows?**
Sebbene tutte le versioni delle lingue dei sistemi operativi interessati contengano la vulnerabilità, non è possibile sfruttarla a meno che il sistema non sia configurato con le impostazioni locali del sistema cinese, giapponese o coreano. Come misura di difesa preventiva, Microsoft consiglia di installare l'aggiornamento su tutte le versioni delle lingue dei sistemi operativi interessati. I pacchetti vengono offerti mediante gli Aggiornamenti automatici, a prescindere della configurazione di lingua del sistema.

**Che cosa sono le impostazioni locali del sistema?**
Le impostazioni locali del sistema determinano il set di caratteri predefinito (lettere, simboli e numeri) ed il carattere utilizzato per visualizzare e inserire informazioni nei programmi che non utilizzano unicode. Questo permette di eseguire programmi non unicode sul computer che utilizza le lingue specificate. Le impostazioni locali del sistema non interessano le lingue nei menu e le finestre di dialogo di Windows o di altri programmi che utilizzano unicode.

**Come è possibile determinare o modificare le attuali impostazioni locali del sistema in risorse del computer?**
Le impostazioni locali predefinite del sistema dipendono dalla versione della lingua installata di Windows. Per visualizzare o modificare le impostazioni locali del sistema:

1.  Fare clic su **Start** e scegliere **Pannello di controllo**.
2.  In **Opzioni internazionali e della lingua**, fare clic sulla scheda **Avanzate**.
3.  Nella sezione **Lingua per programmi non unicode**, selezionare le impostazioni locali del sistema desiderate.

**Nota** È necessario eseguire l'accesso come amministratore per visualizzare o modificare le impostazioni locali del sistema.
...
<th style="border:1px solid black;" >Vulnerabilità legata all'acquisizione di privilegi più elevati in CSRSS - CVE-2012-0005</th>
...
Vulnerabilità legata all'acquisizione di privilegi più elevati in CSRSS - CVE-2012-0005  
---------------------------------------------------------------------------------------
  
<span></span>
In Windows CSRSS è stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui CSRSS elabora una sequenza di caratteri Unicode appositamente predisposti. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario nel contesto di protezione del sistema locale. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0005](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0005).
  
#### Fattori attenuanti della vulnerabilità legata all'acquisizione di privilegi più elevati in CSRSS - CVE-2012-0005
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   L'utente malintenzionato deve essere in possesso di credenziali di accesso valide ed essere in grado di accedere al sistema in modalità locale o remota per sfruttare questa vulnerabilità.  
-   Questa vulnerabilità può essere sfruttata solamente sui sistemi configurati con le impostazioni locali del sistema in lingua cinese, giapponese o coreana.
  
#### Soluzioni alternative per la vulnerabilità legata all'acquisizione di privilegi più elevati in CSRSS - CVE-2012-0005
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'acquisizione di privilegi più elevati in CSRSS - CVE-2012-0005
  
**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'acquisizione di privilegi più elevati nel contesto del sistema locale.
  
**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità è causata nei sistemi di Windows che sono configurati con impostazioni locali del sistema in lingua cinese, giapponese o coreana quando CSRSS elabora una sequenza di caratteri Unicode appositamente predisposti e tenta di accedere al contenuto di un buffer di memoria che non è stato correttamente inizializzato.
...
Le workstation ed i terminal server più a rischio sono quelli eseguiti con le impostazioni locali del sistema delle lingue multibyte (cinese, giapponese o coreano). I server possono essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve il modo in cui CSRSS elabora i caratteri Unicode.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2646524$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2646524">articolo della Microsoft Knowledge Base 2646524</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2646524$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2646524](http://support.microsoft.com/kb/2646524)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Kang Wu del [dipartimento di ricerca di Shenzhen Jowto](http://www.jowto.com) per aver segnalato la vulnerabilità legata all'acquisizione di privilegi più elevati di CSRSS (CVE-2012-0005)
