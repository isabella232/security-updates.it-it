---
TOCTitle: 'MS12-017'
Title: 'Bollettino Microsoft sulla sicurezza MS12-017 - Importante'
ms:assetid: 'ms12-017'
ms:contentKeyID: 61240658
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-017(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-017 - Importante
==========================================================

Una vulnerabilità del server DNS può consentire un attacco di tipo Denial of Service (2647170)
----------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 13 marzo 2012 | Aggiornamento: mercoledì 18 aprile 2012
...
Questo aggiornamento per la protezione risolve una vulnerabilità di Microsoft Windows che è stata segnalata privatamente. La vulnerabilità può consentire un attacco di tipo Denial of Service se un utente malintenzionato remoto non autenticato invia una query DNS appositamente predisposta al server DNS di destinazione.

Questo aggiornamento per la protezione è considerato di livello importante per tutte le edizioni supportate di Windows Server 2003, per tutte le edizioni a 32 bit e x64 di Windows Server 2008 e per le edizioni x64 di Windows Server 2008 R2. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno di questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui il server DNS gestisce gli oggetti in memoria. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=92f3af60-9a9b-4419-9e95-55f5cb54cf00">Windows Server 2003 con SP2 per sistemi Itanium</a></td>
<td style="border:1px solid black;">Denial of Service</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=238474">MS12-009</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=233c62b7-f2b1-49ce-9a7f-e51435be0d26">Windows Server 2008 per sistemi a 32 bit Service Pack 2</a>*</td>
<td style="border:1px solid black;">Denial of Service</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">Windows Server 2008 per sistemi x64 Service Pack 2</a>*</td>
<td style="border:1px solid black;">Denial of Service</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per sistemi x64 Service Pack 1</a>*</td>
<td style="border:1px solid black;">Denial of Service</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
...
L'aggiornamento può essere installato solo se DNS è abilitato sui sistemi operativi contenuti nella tabella Software interessato. Per impostazione predefinita, DNS non è abilitato su questi sistemi operativi; per ricevere l'aggiornamento è quindi necessario abilitarlo.
...
<th style="border:1px solid black;" >Vulnerabilità ad attacchi di tipo Denial of Service in DNS - CVE-2012-0006</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
Vulnerabilità ad attacchi di tipo Denial of Service in DNS - CVE-2012-0006  
--------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità ad attacchi di tipo Denial of Service dovuta al modo in cui il server DNS gestisce erroneamente gli oggetti in memoria quando cerca un record di risorse per un dominio. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può fare in modo che il server DNS sul sistema di destinazione non risponda e venga avviato automaticamente.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0006](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006).
  
#### Fattori attenuanti della vulnerabilità ad attacchi di tipo Denial of Service in DNS - CVE-2012-0006
  
Microsoft non ha individuato alcun fattore attenuante per questa vulnerabilità.
  
#### Soluzioni alternative per la vulnerabilità ad attacchi di tipo Denial of Service in DNS - CVE-2012-0006
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Cancellare periodicamente la cache DNS**
  
    Eseguire il comando dnscmd seguente, come descritto nell'articolo [Sintassi Dnscmd](http://technet.microsoft.com/en-us/library/cc756116(v=ws.10).aspx):
  
    `dnscmd [ServerName] /clearcache`
  
    Questo comando può essere eseguito come attività pianificata o quando necessario.
  
    **Impatto della soluzione alternativa.** Cancellare la memoria cache DNS dei record di risorse sul server DNS specificato.
  
    **Per annullare il risultato della soluzione alternativa.**
  
    Eliminare o disabilitare qualsiasi attività pianificata che esegue il comando dnscmd.
  
#### Domande ricorrenti sulla vulnerabilità ad attacchi di tipo Denial of Service in DNS - CVE-2012-0006
  
**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità ad attacchi di tipo Denial of Service.
  
**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando il server DNS gestisce erroneamente gli oggetti in memoria durante la ricerca di un record di risorse.
...
Un utente malintenzionato remoto non autenticato può sfruttare questa vulnerabilità inviando una query DNS appositamente predisposta al server DNS di destinazione.
...
L'aggiornamento risolve la vulnerabilità modificando il modo in cui il server DNS gestisce gli oggetti in memoria.
...
<td style="border:1px solid black;" colspan="2">
Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2647170$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2647170](http://support.microsoft.com/kb/2647170)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2647170">articolo della Microsoft Knowledge Base 2647170</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (18 aprile 2012): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2647170 nella sottosezione Problemi noti nel Riepilogo ed è stato Riepilogo e sono state corrette le informazioni sul bollettino sostitutivo per Windows Server 2003 Service Pack 2, Windows Server 2003 x64 Edition Service Pack 2 e Windows Server 2003 con SP2 per i sistemi Itanium. Questa modifica riguarda solo il bollettino. Non sono state apportate modifiche al rilevamento o ai file di aggiornamento della protezione.
