---
TOCTitle: 'MS12-069'
Title: 'Bollettino Microsoft sulla sicurezza MS12-069 - Importante'
ms:assetid: 'ms12-069'
ms:contentKeyID: 61240710
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-069(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-069 - Importante
==========================================================

Una vulnerabilità in Kerberos può consentire un attacco di tipo Denial of Service (2743555)
-------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 9 ottobre 2012 | Aggiornamento: mercoledì 29 maggio 2013
...
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui l'implementazione Microsoft Kerberos gestisce una sessione appositamente predisposta. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
KB2425227 in [MS11-013](http://go.microsoft.com/fwlink/?linkid=208523) sostituito da KB2743555
</td>
</tr>
...
**Dove si trovano gli hash dell'aggiornamento per la protezione?**
Gli hash SHA1 e SHA2 dell'aggiornamento per la protezione possono essere utilizzati per verificare l'autenticità dei pacchetti di aggiornamento per la protezione scaricati. Per le informazioni sugli hash pertinenti a questo aggiornamento, vedere [l'articolo della Microsoft Knowledge Base KB2743555](http://support.microsoft.com/kb/2743555).
...
<th style="border:1px solid black;" >
Vulnerabilità legata alla risoluzione del riferimento NULL in Kerberos - CVE-2012-2551
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità ad attacchi di tipo Denial of Service quando l'implementazione Microsoft Kerberos non riesce a gestire correttamente una sessione appositamente predisposta. Sfruttando questa vulnerabilità, un utente malintenzionato può impedire al sistema di rispondere alle richieste e può forzarne il riavvio automatico.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-2551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2551).

#### Fattori attenuanti della vulnerabilità legata alla risoluzione del riferimento NULL in Kerberos - CVE-2012-2551
...
#### Soluzioni alternative per la vulnerabilità legata alla risoluzione del riferimento NULL in Kerberos - CVE-2012-2551

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata alla risoluzione del riferimento NULL in Kerberos - CVE-2012-2551
...
La vulnerabilità è causata quando l'implementazione Microsoft Kerberos in Microsoft Windows non riesce a gestire correttamente una sessione appositamente predisposta.
...
Un utente malintenzionato remoto può sfruttare questa vulnerabilità inviando una sessione appositamente predisposta al server Kerberos.

**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**
Le workstation e i server sono principalmente a rischio.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui l'implementazione Microsoft Kerberos gestisce una sessione appositamente predisposta.
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2743555">articolo della Microsoft Knowledge Base 2743555</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (29 maggio 2013): Sono state corrette le voci relative all'aggiornamento sostitutivo nella tabella Software interessato per le edizioni basate su x64 di Windows Server 2008 R2. Si tratta di una modifica che riguarda esclusivamente il bollettino. Non sono state apportate modifiche alla logica di rilevamento o ai file di aggiornamento della protezione.
