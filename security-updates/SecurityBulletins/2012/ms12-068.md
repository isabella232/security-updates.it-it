---
TOCTitle: 'MS12-068'
Title: 'Bollettino Microsoft sulla sicurezza MS12-068 - Importante'
ms:assetid: 'ms12-068'
ms:contentKeyID: 61240709
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-068(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-068 - Importante
==========================================================

Una vulnerabilità del kernel di Windows può consentire l'acquisizione di privilegi più elevati (2724197)
--------------------------------------------------------------------------------------------------------
...
<td style="border:1px solid black;">
KB2707511 in [MS12-042](http://go.microsoft.com/fwlink/?linkid=252515) sostituito da KB2724197
</td>
</tr>
...
<td style="border:1px solid black;">
KB971486 in [MS09-058](http://technet.microsoft.com/it-it/security/default.aspx) sostituito da KB2724197
</td>
</tr>
<tr>
<th colspan="4">
...
<td style="border:1px solid black;">
KB979683 in [MS10-021](http://www.microsoft.com/italy/technet/security/bulletin/ms10-021.mspx) sostituito da KB2724197
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2633171 in [MS11-098](http://go.microsoft.com/fwlink/?linkid=232424) sostituito da KB2724197
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2556532 in [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) sostituito da KB2724197
</td>
</tr>
<tr>
<th colspan="4">
...
<tr>
<td style="border:1px solid black;">
[Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=593a29c3-c459-4a39-9f25-016a5268fc7d)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<td style="border:1px solid black;">
KB2709715 in [MS12-042](http://go.microsoft.com/fwlink/?linkid=252515) sostituito da KB2724197
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'overflow di valori integer nel kernel di Windows - CVE-2012-2529
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Una vulnerabilità legata all'acquisizione di privilegi più elevati si presenta quando il kernel di Windows gestisce erroneamente gli oggetti nella memoria. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-2529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2529).

#### Fattori attenuanti della vulnerabilità legata all'overflow di valori integer nel kernel di Windows - CVE-2012-2529
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow di valori integer nel kernel di Windows - CVE-2012-2529

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata all'overflow di valori integer nel kernel di Windows - CVE-2012-2529
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2724197$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2724197">articolo della Microsoft Knowledge Base 2724197</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2724197$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2724197](http://support.microsoft.com/kb/2724197)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Un ricercatore anonimo, che collabora con [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata all'overflow di valori integer nel kernel di Windows (CVE-2012-2529)
