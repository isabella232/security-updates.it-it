---
TOCTitle: 'MS12-042'
Title: 'Bollettino Microsoft sulla sicurezza MS12-042 - Importante'
ms:assetid: 'ms12-042'
ms:contentKeyID: 61240683
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-042(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-042 - Importante
==========================================================

Alcune vulnerabilità del kernel di Windows possono consentire l'acquisizione di privilegi più elevati (2711167)
---------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per tutte le edizioni a 32 bit di Windows XP e per Windows Server 2003, Windows 7 per i sistemi x64 e Windows Server 2008 R2 per i sistemi x64. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui l'utilità di pianificazione in modalità utente di Windows gestisce una richiesta di sistema particolare e il modo in cui Windows gestisce la ROM BIOS. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
La soluzione KB2633171 in [MS11-098](http://go.microsoft.com/fwlink/?linkid=232424) è stata sostituita dalla soluzione KB2707511
</td>
</tr>
...
<td style="border:1px solid black;">
La soluzione KB2556532 in [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) è stata sostituita dalla soluzione KB2709715
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria nell'utilità di pianificazione in modalità utente - CVE-2012-0217
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della ROM BIOS - CVE-2012-1515
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati nel modo in cui l'utilità di pianificazione in modalità utente di Windows gestisce le richieste di sistema. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0217](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0217).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria nell'utilità di pianificazione in modalità utente - CVE-2012-0217
...
-   Questa vulnerabilità interessa solo le versioni Intel x64 di Windows 7 e Windows Server 2008 R2.
-   I sistemi con CPU basate su AMD o ARM non sono interessati da questa vulnerabilità.

#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria nell'utilità di pianificazione in modalità utente - CVE-2012-0217

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria nell'utilità di pianificazione in modalità utente - CVE-2012-0217

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati.

**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità è causata dalla gestione errata da parte dell'utilità di pianificazione in modalità utente di una particolare richiesta di sistema.

**Che cos'è** **l'utilità di pianificazione in modalità utente (UMS)?**
L'utilità di pianificazione in modalità utente (UMS) è un meccanismo leggero con API di sistema che le applicazioni possono utilizzare per pianificare i propri thread. Un'applicazione può passare da un thread UMS a un altro nella modalità utente senza coinvolgere l'utilità di pianificazione di sistema e può recuperare il controllo del processore se un thread UMS crea un blocco nel kernel.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui l'utilità di pianificazione in modalità utente di Windows gestisce una particolare richiesta di sistema.
...
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati nel modo in cui Windows gestisce la memoria BIOS. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della ROM BIOS - CVE-2012-1515

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.

#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della ROM BIOS - CVE-2012-1515

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata al danneggiamento della ROM BIOS - CVE-2012-1515

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati.

**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità è causata quando Windows non protegge correttamente la ROM BIOS.
...
**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui Windows gestisce la ROM BIOS.

**Al momento del rilascio di questo bollettino, le informazioni sulla vulnerabilità erano disponibili pubblicamente?**
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515).
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2707511$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2707511">articolo della Microsoft Knowledge Base 2707511</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2707511$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2707511](http://support.microsoft.com/kb/2707511)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2709715">articolo della Microsoft Knowledge Base 2709715</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
...
-   Rafal Wojtczuk di [Bromium](http://www.bromium.com/) e Jan Beulich di [SUSE](http://www.suse.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria nell'utilità di pianificazione in modalità utente (CVE-2012-0217)
