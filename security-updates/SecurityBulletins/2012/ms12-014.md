---
TOCTitle: 'MS12-014'
Title: 'Bollettino Microsoft sulla sicurezza MS12-014 - Importante'
ms:assetid: 'ms12-014'
ms:contentKeyID: 61240655
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-014(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-014 - Importante
==========================================================

La vulnerabilità nel codec Indeo può consentire l'esecuzione di codice in modalità remota (2661637)
---------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 14 febbraio 2012 | Aggiornamento: mercoledì 22 febbraio 2012
...
La vulnerabilità descritta in questo bollettino ha un livello di gravità importante per Windows XP Service Pack 3. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno della presente sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui il codec Indeo carica le librerie esterne. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|----------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=32e5c9ad-b610-4afb-b6f0-bb0b5fbdd1f6) | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
...
Sì, la vulnerabilità legata al caricamento non sicuro delle librerie nel codec Indeo (CVE-2010-3138), risolta dal presente aggiornamento, è correlata alle vulnerabilità descritte nell'[Advisory Microsoft sulla sicurezza 2269637](http://technet.microsoft.com/security/advisory/2269637) che interessano le modalità con cui le applicazioni caricano le librerie esterne. Questo aggiornamento per la protezione risolve un'istanza particolare di questo tipo di vulnerabilità.
...
<th style="border:1px solid black;" >
Vulnerabilità legata al caricamento non sicuro delle librerie nel codec Indeo - CVE-2010-3138
</th>
<th colspan="2">
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui il codec Indeo gestisce il caricamento dei file DLL. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138).

#### Fattori attenuanti della vulnerabilità legata al caricamento non sicuro delle librerie nel codec Indeo - CVE-2010-3138
...
-   L'attacco è possibile solo se l'utente visita un file system remoto o una condivisione WebDAV di dubbia provenienza e apre un file multimediale (ad esempio un file .avi).

#### Soluzioni alternative per la vulnerabilità legata al caricamento non sicuro delle librerie nel codec Indeo - CVE-2010-3138
...
#### Domande frequenti sulla vulnerabilità legata al caricamento non sicuro delle librerie nel codec Indeo - CVE-2010-3138
...
La vulnerabilità si verifica quando il codec Indeo limita in maniera errata il percorso utilizzato per il caricamento delle librerie esterne.

**Che cos'è il codec Indeo?**
Il codec Indeo è un codec che decomprime file multimediali digitali utilizzati in applicazioni quali Windows Media Player. Per ulteriori informazioni sui codec, vedere [Codec: domande frequenti](http://windows.microsoft.com/en-us/windows7/codecs-frequently-asked-questions).

**Che cos'è un file multimediale AVI?**
Audio Video Interleave (AVI) è un formato multimediale di archiviazione, definito da Microsoft, che utilizza Resource Interchange File Format (RIFF). AVI è definito da Microsoft. Il formato di file AVI è comunemente utilizzato per i dati audio e video del computer.
...
Un utente malintenzionato può convincere un utente ad aprire un file multimediale legittimo (ad esempio un file .avi) situato nella stessa directory di rete di un file della libreria di collegamento dinamico (DLL) appositamente predisposto. Quindi, durante l'apertura del file legittimo, il codec Indeo può tentare di caricare il file DLL ed eseguire il codice contenuto al suo interno.

In uno scenario di attacco tramite posta elettronica, un utente malintenzionato può sfruttare la vulnerabilità inviando ad un utente un file legittimo (ad esempio un file .avi), convincendolo a salvare l'allegato in una directory che contiene un file DLL appositamente predisposto e ad aprire il file legittimo. Quindi, durante l'apertura del file legittimo, il codec Indeo può tentare di caricare il file DLL ed eseguire il codice contenuto al suo interno.

In uno scenario di attacco di rete, un utente malintenzionato può collocare un file legittimo (ad esempio un file .avi) e un file DLL appositamente predisposto in una condivisione di rete, un percorso UNC o WebDAV e convincere poi l'utente ad aprire il file.

**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**
Le workstation, dove è probabile che gli utenti possano aprire file da percorsi di rete non attendibili, sono principalmente a rischio.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità modificando il modo in cui il codec Indeo carica le librerie esterne.
...
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138).
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2661637$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2661637">articolo della Microsoft Knowledge Base 2661637</a></td>
</tr>
<tr class="even">
...
-   V1.1 (22 febbraio 2012): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2661637 nella sottosezione Problemi noti del Riepilogo.
