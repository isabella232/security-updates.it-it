---
TOCTitle: 'MS12-018'
Title: 'Bollettino Microsoft sulla sicurezza MS12-018 - Importante'
ms:assetid: 'ms12-018'
ms:contentKeyID: 61240659
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-018(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-018 - Importante
==========================================================

La vulnerabilità nei driver in modalità kernel di Windows può consentire l'acquisizione di privilegi più elevati (2641653)
--------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui il driver in modalità kernel di Windows gestisce gli errori dei messaggi di Windows. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2922411c-9755-461b-9904-f6940322af19)                                                                              | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e72b6b1f-68f5-4e1a-878e-290a5f03ca30)                                                     | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=599e5db1-3bf1-4d44-bc7c-81bc545c58ec)                                                                     | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=482c2890-8d4c-4e13-820f-d5ff256b6a3a)                                                         | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ccd0f116-73c2-4471-a6d9-e07d1dbdd406)                                                        | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f4e73a92-583b-4352-b19d-7a8e3ef162b7)                                                                           | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ead9d29b-becf-448e-bff4-d5bb12d02c64)                                                               | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dd547364-f6bb-453c-9e4d-6b80dfc47fbb)\*                                              | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=%205ff65fc2-5969-4d7e-9c72-9a2096dafdcf)\*                                                | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eeb5385c-fb81-4d33-af2a-986e6cf14ee2)                                                 | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows 7 per sistemi a 32 bit e Windows 7 per sistemi a 32 bit Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=75fd93ff-5be5-42b5-ab00-3378e545c271)                         | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows 7 per sistemi x64 e Windows 7 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=71ffba4c-d816-45a9-abef-131915885bc8)                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=22d6a234-6447-4854-8119-4fddd3c6e1bb)\*       | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008 R2 per sistemi Itanium e Windows Server 2008 R2 per sistemi Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cb5ac981-e8e5-4df7-84bb-7a2a916d0ce9) | Acquisizione di privilegi più elevati       | Importante                   | [MS12-008](http://go.microsoft.com/fwlink/?linkid=238387) |
...
<th style="border:1px solid black;" >Vulnerabilità legata alla funzione PostMessage - CVE-2012-0157</th>
...
Vulnerabilità legata alla funzione PostMessage - CVE-2012-0157  
--------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui il driver in modalità kernel di Windows gestisce la funzione PostMessage. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Questi è in grado di installare programmi, visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0157](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0157).
  
#### Fattori attenuanti della vulnerabilità legata alla funzione PostMessage - CVE-2012-0157
...
#### Soluzioni alternative per la vulnerabilità legata alla funzione PostMessage - CVE-2012-0157
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande ricorrenti sulla vulnerabilità legata alla funzione PostMessage - CVE-2012-0157
  
**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati.
  
**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando il driver in modalità kernel di Windows gestisce erroneamente l'input inviato tramite la funzione PostMessage.
...
L'aggiornamento risolve la vulnerabilità modificando il modo in cui il driver in modalità kernel di Windows gestisce gli errori dei messaggi di Windows.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2641653$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2641653">articolo della Microsoft Knowledge Base 2641653</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2641653$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2641653](http://support.microsoft.com/kb/2641653)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Nikolaos Bougalis](https://technet.microsoft.com/it-IT/mailto:nikb@bougalis.net) per aver segnalato la vulnerabilità legata alla funzione PostMessage (CVE-2012-0157)
