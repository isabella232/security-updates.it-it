---
TOCTitle: 'MS12-058'
Title: 'Bollettino Microsoft sulla sicurezza MS12-058 - Critico'
ms:assetid: 'ms12-058'
ms:contentKeyID: 61240699
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-058(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-058 - Critico
=======================================================

Alcune vulnerabilità in Microsoft Exchange Server WebReady Document Viewing possono consentire l'esecuzione di codice in modalità remota (2740358)
--------------------------------------------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 14 agosto 2012 | Aggiornamento: martedì 20 novembre 2012
...
Questo aggiornamento per la protezione risolve anche le vulnerabilità descritte in precedenza nell'[Advisory Microsoft sulla sicurezza 2737111](http://technet.microsoft.com/security/advisory/2737111) per le edizioni interessate di Microsoft Exchange Server.
...
<span></span>
**Sono stati già installati gli aggiornamenti KB2734323, KB2743248 o KB2706690 originali. È necessario applicare i pacchetti di aggiornamento (KB2756497, KB2756496 o KB2756485) con nuovo rilascio in data 9 ottobre 2012?**
Sì. In tutti i casi, i clienti devono applicare i pacchetti di aggiornamento con nuovo rilascio.

**Nota** l'applicabilità di questi pacchetti di aggiornamento non dipende dalla versione di Microsoft Windows su cui Microsoft Exchange è installato.

**Perché Microsoft ha rivisto questo bollettino in data 9 ottobre 2012?**
Microsoft ha rivisto questo bollettino per offrire il nuovo rilascio di aggiornamenti per Microsoft Exchange Server 2007 Service Pack 3 (KB2756497), Microsoft Exchange Server 2010 Service Pack 1 (KB2756496) e Microsoft Exchange Server 2010 Service Pack 2 (KB2756485) per risolvere un problema riguardante specifici certificati digitali generati da Microsoft senza attributi corretti per il timestamp. Per ulteriori informazioni, vedere l'[Advisory Microsoft sulla sicurezza 2749655](http://technet.microsoft.com/security/advisory/2749655).

Gli aggiornamenti rilasciati nuovamente, KB2756497, KB2756496 e KB2756485, sostituiscono rispettivamente gli aggiornamenti originali KB2734323, KB2743248 e KB2706690.

**Se è stata applicata la soluzione alternativa per Microsoft Exchange Server illustrata nell'Advisory Microsoft sulla sicurezza 2737111, è necessario annullare la soluzione alternativa prima di applicare questo aggiornamento?**
Non è necessario che i clienti che hanno implementato la soluzione alternativa dell'[Advisory Microsoft sulla sicurezza 2737111](http://technet.microsoft.com/security/advisory/2737111) per disattivare WebReady Document Viewing annullino la soluzione alternativa prima di applicare questo aggiornamento. Tuttavia, per riattivare la funzionalità WebReady Document Viewing, è possibile annullare la soluzione alternativa dopo aver applicato l'aggiornamento.

Microsoft consiglia di applicare l'aggiornamento a tutti i server prima di riattivare la funzionalità WebReady Document Viewing.

**Vengono trattate** **varie vulnerabilità** **nell'** **Advisory Microsoft sulla sicurezza 2737111,** **in che modo** **le vulnerabilitàvengono risolte da questo** **aggiornamento?**
Le vulnerabilità CVE-2012-1766, CVE-2012-1767, CVE-2012-1768, CVE-2012-1769, CVE-2012-1770, CVE-2012-1771, CVE-2012-1772, CVE-2012-1773, CVE-2012-3106, CVE-2012-3107, CVE-2012-3108, CVE-2012-3109 e CVE-2012-3110 trattate nell'[Advisory Microsoft sulla sicurezza 2737111](http://technet.microsoft.com/security/advisory/2737111) riguardano Microsoft Exchange Server e vengono risolte da questo aggiornamento.
...
-   Per l'aggiornamento cumulativo 8 per Exchange Server 2007 Service Pack 3 (KB2756497), vedere l'[articolo della Microsoft Knowledge Base 2756497](http://support.microsoft.com/kb/2756497).
-   Per l'aggiornamento cumulativo 7 per Exchange 2010 Service Pack 1 (KB2756496), vedere l'[articolo della Microsoft Knowledge Base 2756496](http://support.microsoft.com/kb/2756496).
-   Per l'aggiornamento cumulativo 4 per Exchange 2010 Service Pack 2 (KB2756485), vedere l'[articolo della Microsoft Knowledge Base 2756485](http://support.microsoft.com/kb/2756485).

**Dove si trova la sezione Informazioni sui file?**
Fare riferimento alle tabelle contenute nella sezione **Distribuzione dell'aggiornamento per la protezione** per individuare la sezione Informazioni sui file.

**Dove** **si trovano gli hash degli aggiornamenti per la** **protezione?**
Gli hash SHA1 e SHA2 degli aggiornamenti per la protezione possono essere utilizzati per verificare l'autenticità dei pacchetti di aggiornamento per la protezione scaricati. Per le informazioni sugli hash pertinenti a questo aggiornamento, vedere [l'articolo della Microsoft Knowledge Base 2740358](http://support.microsoft.com/kb/2740358).
...
<span></span>
Sono presenti vulnerabilità legate all'esecuzione di codice in modalità remota in Microsoft Exchange Server tramite la funzionalità WebReady Document Viewing. Questa vulnerabilità possono consentire l'esecuzione di codice in modalità remota come Sistema locale se un utente visualizza un file appositamente predisposto tramite Outlook Web Access in un browser. Sfruttando tali vulnerabilità, un utente malintenzionato può eseguire il codice sul server interessato, ma solo come LocalService. L'account LocalService dispone di privilegi minimi sul computer locale e presenta credenziali anonime sulla rete.
...
**Che cos'è** **WebReady** **Document Viewer?**  
...
Sfruttando queste vulnerabilità, un utente malintenzionato può eseguire codice arbitrario come LocalService sul server Exchange interessato. L'account LocalService dispone di privilegi minimi sul computer locale e presenta credenziali anonime sulla rete.
  
**In che modo un utente malintenzionato può sfruttare** **queste vulnerabilità?**  
Un utente malintenzionato potrebbe inviare un messaggio di posta elettronica contenente un file appositamente predisposto a un utente su una versione di Exchange interessata. Quando l'utente vede in anteprima nel browser il file appositamente predisposto, su Exchange Server potrebbe essere eseguito codice arbitrario. Inoltre, un utente malintenzionato potrebbe installare programmi; vedere, modificare o eliminare dei dati. Potrebbe eseguire ulteriori operazioni consentite dall'accesso ai processi del server.
...
| Microsoft Exchange Server 2010 Service Pack 1 | No   |  
...
| Microsoft Exchange Server 2010 Service Pack 1 | No                | No                                  |  
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2740358">articolo della Microsoft Knowledge Base 2740358</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Microsoft Exchange Server 2010 Service Pack 1:<br />
...
-   V2.0 (9 ottobre 2012): Bollettino rivisto per offrire il nuovo rilascio di aggiornamenti per Microsoft Exchange Server 2007 Service Pack 3 (KB2756497), Microsoft Exchange Server 2010 Service Pack 1 (KB2756496) e Microsoft Exchange Server 2010 Service Pack 2 (KB2756485). I clienti devono applicare gli aggiornamenti rilasciati nuovamente per evitare un problema relativo ai certificati digitali descritto nell'Advisory Microsoft sulla sicurezza 2749655.
-   V2.1 (10 ottobre 2012): Per gli aggiornamenti di KB2756497, KB2756496 e KB2756485 con nuovo rilascio, è stata aggiunta una voce alla sezione Domande frequenti per fornire informazioni sulla distribuzione. Per ulteriori informazioni, vedere le Domande frequenti sull'aggiornamento.
-   V2.2 (20 novembre 2012): Sono stati corretti i nomi del pacchetto di aggiornamento, le chiavi del Registro di sistema e i nomi dei file di registro per gli aggiornamenti KB2756497 e KB2756496. Le modifiche sono esclusivamente informative. Le pagine di download e gli articoli della Knowledge Base associati contengono già le informazioni corrette.
