---
TOCTitle: 'MS12-082'
Title: 'Bollettino Microsoft sulla sicurezza MS12-082 - Importante'
ms:assetid: 'ms12-082'
ms:contentKeyID: 61240723
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-082(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-082 - Importante
==========================================================

Una vulnerabilità in DirectPlay può consentire l'esecuzione di codice in modalità remota (2770660)
--------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 11 dicembre 2012 | Aggiornamento: martedì 9 luglio 2013
...
Questo aggiornamento per la protezione risolve una vulnerabilità di Microsoft Windows che è stata segnalata privatamente. La vulnerabilità può consentire l'esecuzione di codice in modalità remota se un utente malintenzionato convince un utente a visualizzare un documento di Office appositamente predisposto con contenuto incorporato. Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente corrente. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Questo aggiornamento per la protezione è considerato di livello importante per tutte le versioni supportate di Microsoft Windows, eccetto Windows RT. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui DirectPlay gestisce il contenuto appositamente predisposto. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.

**Raccomandazione.** Se la funzionalità Aggiornamenti automatici è abilitata, gli utenti non devono intraprendere alcuna azione, poiché questo aggiornamento per la protezione viene scaricato e installato automaticamente. Gli utenti che non hanno attivato la funzionalità Aggiornamenti automatici devono verificare la disponibilità di aggiornamenti e installare questo aggiornamento manualmente. Per informazioni sulle opzioni di configurazione specifiche relative agli aggiornamenti automatici, vedere l'[articolo della Microsoft Knowledge Base 294871](http://support.microsoft.com/kb/294871).

Per gli amministratori e le installazioni delle organizzazioni o gli utenti finali che desiderano installare manualmente questo aggiornamento per la protezione, Microsoft consiglia di applicare l'aggiornamento quanto prima utilizzando il software di gestione degli aggiornamenti o verificando la disponibilità degli aggiornamenti tramite il servizio [Microsoft Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it). Vedere anche la sezione, **Strumenti e informazioni sul rilevamento e sulla distribuzione**, riportata di seguito nel presente bollettino.
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'overflow degli heap in DirectPlay - CVE-2012-1537
</th>
<th colspan="2">
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui DirectPlay gestisce contenuto appositamente predisposto. La vulnerabilità può consentire l'esecuzione di codice in modalità remota se un utente malintenzionato convince un utente a visualizzare un documento di Office appositamente predisposto con contenuto incorporato. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1537](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1537).

#### Fattori attenuanti della vulnerabilità legata all'overflow degli heap in DirectPlay - CVE-2012-1537

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente corrente. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
-   Il documento di Office appositamente predisposto può essere inviato come allegato a un messaggio di posta elettronica, ma l'utente malintenzionato deve convincere l'utente ad aprire l'allegato al fine di sfruttare la vulnerabilità.
-   Per impostazione predefinita, il controllo ActiveX di DirectPlay non è compreso nell'elenco Consenti predefinito dei controlli ActiveX in Internet Explorer. Soltanto gli utenti che hanno approvato esplicitamente questo controllo utilizzando la funzione ActiveX con consenso esplicito sono esposti ai rischi derivanti da questa vulnerabilità. Tuttavia, se un cliente ha utilizzato il controllo ActiveX in una versione precedente di Internet Explorer, il controllo ActiveX viene consentito in Internet Explorer, anche se il cliente non l'ha approvato esplicitamente utilizzando la funzione ActiveX con consenso esplicito.

#### Soluzioni alternative per la vulnerabilità legata all'overflow degli heap in DirectPlay - CVE-2012-1537

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Utilizzare il criterio del blocco dei file di Microsoft Office** **per bloccare l'apertura di documenti di** **Word** **2003 e versioni precedenti di dubbia provenienza**
    ...
    **Per Microsoft** **Word** **2003 e Microsoft** **Word** **2007**
...
<table style="border:1px solid black;">
<caption>Software Microsoft Office</caption>
<tbody>
<tr class="odd">
...
5.  Assicurarsi che la casella di controllo **Aperto** sia selezionata per i tipi di file seguenti:
    ...
    - Documenti e modelli di Word 2003
...
Per Microsoft Word 2003 e Microsoft Word 2007, utilizzare gli script del Registro di sistema seguenti per annullare le impostazioni utilizzate per impostare i criteri del blocco dei file:
...
#### Domande frequenti sulla vulnerabilità legata all'overflow degli heap in DirectPlay - CVE-2012-1537

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando Windows DirectPlays non riesce a gestire correttamente i documenti di Office appositamente predisposti.

**Quale componente è interessato dalla vulnerabilità?**  
Il componente interessato da questa vulnerabilità è Microsoft DirectX (DirectX 9.0 in tutte le edizioni supportate di Windows XP; DirectX 10.1 in tutte le edizioni supportate di Windows Server 2003, Windows Vista e Windows Server 2008; DirectX 11.0 in tutte le edizioni supportate di Windows 7 e Windows Server 2008 R2; DirectX 11.1 in tutte le edizioni supportate di Windows 8 e Windows Server 2012).

**Che cos'è DirectPlay?**  
DirectPlay è un protocollo di rete fornito con Microsoft DirectX per aiutare gli sviluppatori di videogiochi a creare giochi in rete a più giocatori senza dover implementare protocolli di rete sofisticati.
...
In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato può sfruttare tale vulnerabilità inviando un file Office appositamente predisposto e convincendo l'utente ad aprirlo.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui DirectPlay gestisce il contenuto appositamente predisposto.
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2770660$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2770660">articolo della Microsoft Knowledge Base 2770660</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2770660$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2770660](http://support.microsoft.com/kb/2770660)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Aniway](mailto:aniway.anyway@gmail.com), che collabora con [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata all'overflow degli heap in DirectPlay (CVE-2012-1537)
...
-   V1.1 (12 dicembre 2012): Sono stati corretti i requisiti di riavvio per tutto il software interessato. La modifica è esclusivamente informativa. Non sono previsti aggiornamenti ai file sull'aggiornamento per la protezione.  
-   V1.2 (9 luglio 2013): Il bollettino è stato rivisto per comunicare un modifica di rilevamento nei pacchetti di Windows Vista affinché l'aggiornamento 2770660 corregga un problema che si è ripresentato in Windows Update. Si tratta di una modifica solo al rilevamento. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.
