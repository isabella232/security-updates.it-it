---
TOCTitle: 'MS12-072'
Title: 'Bollettino Microsoft sulla sicurezza MS12-072 - Critico'
ms:assetid: 'ms12-072'
ms:contentKeyID: 61240713
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-072(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-072 - Critico
=======================================================

Alcune vulnerabilità nella Shell di Windows possono consentire l'esecuzione di codice in modalità remota (2727528)
------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve due vulnerabilità segnalate privatamente in Microsoft Windows. Le vulnerabilità possono consentire l'esecuzione di codice in modalità remota se un utente naviga a una cartella di sincronia file appositamente predisposta in Esplora risorse. Sfruttando tale vulnerabilità, un utente malintenzionato può eseguire codice non autorizzato nel contesto dell'utente corrente. Se l'utente corrente è connesso con privilegi di amministratore, un utente malintenzionato può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Questo aggiornamento per la protezione è considerato di livello critico per tutte le edizioni supportate di Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 (eccetto per Windows Server 2008 per sistemi Itanium), Windows 7, Windows Server 2008 R2 (eccetto per Windows Server 2008 R2 per sistemi Itanium), Windows 8 (eccetto per Windows RT) e Windows Server 2012. Windows Server 2008 per sistemi Itanium, Windows Server 2008 R2 per sistemi Itanium e Windows RT non sono interessati dalle vulnerabilità. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità modificando il modo in cui Microsoft Windows gestisce una cartella di sincronia file appositamente predisposta. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<span></span>
**Se si esegue Windows Server 2008, perché non viene offerto l'aggiornamento per la protezione KB2727528?**
L'aggiornamento KB2727528 è applicabile solo ai sistemi che eseguono edizioni supportate di Windows Server 2008 se la [funzionalità Esperienza desktop](http://technet.microsoft.com/library/cc772567(v=ws.10)) facoltativa è stata installata e abilitata. I clienti di Windows Server 2008 che hanno installato e abilitato la funzionalità Esperienza desktop vedranno risolta la vulnerabilità del componente vulnerabile dalla soluzione KB2727528, quindi dovranno installare questo aggiornamento per la protezione. I clienti che non hanno installato la funzionalità Esperienza desktop o che l'hanno installata ma non abilitata, non vedranno risolta la vulnerabilità del componente vulnerabile e, pertanto, non usufruiranno del pacchetto di aggiornamento per la protezione KB2727528.

**Se si esegue Windows Server 2008 R2, perché non viene offerto l'aggiornamento per la protezione KB2727528?**
L'aggiornamento KB2727528 è applicabile solo ai sistemi che eseguono edizioni supportate di Windows Server 2008 se la [funzionalità Esperienza desktop](http://technet.microsoft.com/library/cc772567) facoltativa è stata installata e abilitata. I clienti di Windows Server 2008 R2 che hanno installato e abilitato la funzionalità Esperienza desktop vedranno risolta la vulnerabilità del componente vulnerabile dalla soluzione KB2727528, quindi dovranno installare questo aggiornamento per la protezione. I clienti che non hanno installato la funzionalità Esperienza desktop o che l'hanno installata ma non abilitata, non vedranno risolta la vulnerabilità del componente vulnerabile e, pertanto, non usufruiranno del pacchetto di aggiornamento per la protezione KB2727528.

**Dove si trova la sezione Informazioni sui file?**
Fare riferimento alle tabelle contenute nella sezione **Distribuzione dell'aggiornamento per la protezione** per individuare la sezione Informazioni sui file.

**Dove** **si trovano gli hash degli aggiornamenti per la** **protezione?**
Gli hash SHA1 e SHA2 degli aggiornamenti per la protezione possono essere utilizzati per verificare l'autenticità dei pacchetti di aggiornamento per la protezione scaricati. Per le informazioni sugli hash pertinenti a questo aggiornamento, vedere [l'articolo della Microsoft Knowledge Base 2727528](https://support.microsoft.com/kb/2727528).
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'underflow dei valori integer nella Sincronia file di Windows - CVE-2012-1527
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata all'overflow di valori integer nella Sincronia file di Windows - CVE-2012-1528
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nella funzionalità Sincronia file in Windows. Un utente malintenzionato può sfruttare la vulnerabilità convincendo un utente ad aprire una cartella di sincronia file appositamente predisposta. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario nel contesto di protezione dell'utente corrente.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1527](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1527).

#### Fattori attenuanti della vulnerabilità legata all'underflow dei valori integer nella Sincronia file di Windows - CVE-2012-1527
...
#### Soluzioni alternative per la vulnerabilità legata all'underflow dei valori integer nella Sincronia file di Windows - CVE-2012-1527

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Disinstallare l'estensione shell dello spazio dei nomi della cartella Sincronia file**

    **Avvertenza** L'utilizzo non corretto dell'Editor del Registro di sistema potrebbe causare problemi tali da rendere necessaria la reinstallazione del sistema operativo. Microsoft non garantisce la risoluzione di problemi dovuti a un utilizzo non corretto dell'Editor del Registro di sistema. È quindi necessario utilizzare questo strumento con grande attenzione.

    1.  Creare una copia di backup delle chiavi del Registro di sistema eseguendo il comando riportato di seguito da un prompt dei comandi di livello elevato:

        `Regedit.exe /e briefcase_workaround_rollback.reg HKEY_CLASSES_ROOT\CLSID\{85BBD920-42A0-1069-A2E4-08002B30309D}`

    2.  Creare un file di testo denominato Disable\_briefcase.reg con i contenuti seguenti:

        `Editor del Registro di sistema di Windows versione 5.00[-HKEY_CLASSES_ROOT\CLSID\{85BBD920-42A0-1069-A2E4-08002B30309D}]`

    3.  Eseguire Disable\_briefcase.reg con il comando seguente da un prompt dei comandi di livello elevato:

        `Regedit.exe /s Disable_briefcase.reg`

    **Impatto della soluzione alternativa.** Se si disinstalla l'estensione shell dello spazio dei nomi della cartella Sincronia file, il meccanismo di sincronizzazione della cartella non sarà più disponibile.
...
#### Domande frequenti sulla vulnerabilità legata all'underflow dei valori integer nella Sincronia file di Windows - CVE-2012-1527
...
La vulnerabilità è causata quando Windows non gestisce correttamente una cartella di sincronia file appositamente predisposta.

**Che cos'è la Sincronia file?**
La Sincronia file è una funzionalità in Windows che sincronizza il contenuto di due cartelle. La Sincronia file aiuta gli utenti a sincronizzare le cartelle tra periferiche, come le unità USB ed i computer. Per ulteriori informazioni, vedere [Eseguire la sincronizzazione utilizzando Sincronia file](http://windows.microsoft.com/it-it/windows7/sync-using-briefcase).
...
Un utente malintenzionato potrebbe ospitare una cartella Sincronia file appositamente predisposta su una condivisione di rete e convincere l'utente a navigare alla posizione utilizzando Esplora risorse.

**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**
Le workstation in cui gli utenti potrebbero navigare a percorsi di rete non attendibili. Anche i server potrebbero essere a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano questa attribuzione di privilegi.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità modificando il modo in cui Microsoft Windows gestisce una cartella di sincronia file appositamente predisposta.
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nella funzionalità Sincronia file in Windows. Un utente malintenzionato può sfruttare la vulnerabilità convincendo un utente ad aprire una Sincronia file di Windows appositamente predisposta. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario nel contesto di protezione dell'utente corrente.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1528](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1528).

#### Fattori attenuanti della vulnerabilità legata all'overflow di valori integer nella Sincronia file di Windows - CVE-2012-1528
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow di valori integer nella Sincronia file di Windows - CVE-2012-1528
...
-   **Disinstallare l'estensione shell dello spazio dei nomi della cartella Sincronia file**
    ...
    **Impatto della soluzione alternativa.** Se si disinstalla l'estensione shell dello spazio dei nomi della cartella Sincronia file, il meccanismo di sincronizzazione della cartella smetterà di funzionare.
...
#### Domande frequenti sulla vulnerabilità legata all'overflow di valori integer nella Sincronia file di Windows - CVE-2012-1528
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2727528$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2727528">articolo della Microsoft Knowledge Base 2727528</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2727528$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2727528](http://support.microsoft.com/kb/2727528)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Tal Zeltzer, che collabora con [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata all'underflow dei valori integer nella Sincronia file di Windows (CVE-2012-1527)  
-   Tal Zeltzer, che collabora con [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata all'overflow dei valori integer nella Sincronia file di Windows (CVE-2012-1528)
...
-   V1.1 (14 novembre 2012): È stato chiarito che sui sistemi che eseguono delle edizioni supportate di Windows Server 2008 e Windows Server 2008 R2, quest'aggiornamento si applica solo se la funzionalità Esperienza desktop facoltativa è stata installata e abilitata. Per ulteriori informazioni, vedere le Domande frequenti sull'aggiornamento.
