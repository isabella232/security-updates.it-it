---
TOCTitle: 'MS12-049'
Title: 'Bollettino Microsoft sulla sicurezza MS12-049 - Importante'
ms:assetid: 'ms12-049'
ms:contentKeyID: 61240690
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-049(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-049 - Importante
==========================================================

Una vulnerabilità in TLS può consentire l'intercettazione di informazioni personali (2655992)
---------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 10 luglio 2012 | Aggiornamento: martedì 9 luglio 2013
...
Questo aggiornamento per la protezione risolve una vulnerabilità divulgata pubblicamente in TLS. Tale vulnerabilità può consentire la divulgazione di informazioni nel caso in cui un utente malintenzionato intercetti il traffico Web crittografato da un sistema interessato. Tutti i pacchetti di crittografia che non utilizzano la modalità CBC non sono interessati.
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui i componenti Windows Secure Channel (SChannel) e Cryptography API: Next Generation (CNG) gestiscono i pacchetti di rete codificati. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
La soluzione KB980436 in [MS10-049](http://go.microsoft.com/fwlink/?linkid=197104) è stata sostituita dalla soluzione KB2655992
</td>
</tr>
...
<td style="border:1px solid black;">
La soluzione KB2585542 in [MS12-006](http://go.microsoft.com/fwlink/?linkid=232510) è stata sostituita dalla soluzione KB2655992
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
La soluzione KB2207566 in [MS10-085](http://go.microsoft.com/fwlink/?linkid=201705) è stata sostituita dalla soluzione KB2655992
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=97030267-6b19-46ae-84ce-0bb1f91ab951) (installazione Server Core)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Intercettazione di informazioni personali
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8a5f6e84-5e5b-42c3-a5b7-65defdb0665f) (installazione Server Core)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Intercettazione di informazioni personali
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4) (installazione Server Core)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Intercettazione di informazioni personali
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4) (installazione Server Core)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Intercettazione di informazioni personali
...
<th style="border:1px solid black;" >
Vulnerabilità legata al protocollo TLS - CVE-2012-1870
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'intercettazione di informazioni personali nel protocollo di crittografia TLS. Questa vulnerabilità influenza il protocollo e non è specifica del sistema operativo Windows. Si tratta di una vulnerabilità legata all'intercettazione di informazioni personali che consente la decifratura di traffico TLS crittografato. Questa vulnerabilità principalmente si ripercuote sul traffico HTTPS poiché il browser è il vettore di attacco principale e interessa tutto il traffico Web servito tramite HTTPS o tramite il contenuto misto HTTP/HTTPS.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870).

#### Fattori attenuanti della vulnerabilità legata al protocollo TLS - CVE-2012-1870

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   Tutti i pacchetti di crittografia che non utilizzano la modalità CBC non sono interessati.

#### Soluzioni alternative per la vulnerabilità legata al protocollo TLS - CVE-2012-1870
...
#### Domande frequenti sulla vulnerabilità legata al protocollo TLS - CVE-2012-1870

**Qual è la portata o l'impatto di questa vulnerabilità?**
Questa vulnerabilità riguarda l'intercettazione di informazioni personali.

**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità è causata da un difetto di progetto nel protocollo TLS, quando viene utilizzata la modalità operativa Cipher-Block Chaining (CBC).
...
L'aggiornamento modifica il modo in cui i componenti Windows Secure Channel (SChannel) e Cryptography API: Next Generation (CNG) gestiscono i pacchetti di rete codificati.

**Al momento del rilascio di questo bollettino, le informazioni sulla vulnerabilità erano disponibili pubblicamente?**
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870).
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2655992$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2655992">articolo della Microsoft Knowledge Base 2655992</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2655992$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2655992](http://support.microsoft.com/kb/2655992)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   V1.1 (9 luglio 2013): Il bollettino è stato rivisto per comunicare un modifica di rilevamento nei pacchetti di Windows Vista affinché l'aggiornamento 2655992 corregga un problema che si è ripresentato in Windows Update. Si tratta di una modifica solo al rilevamento. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.
