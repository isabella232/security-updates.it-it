---
TOCTitle: 'MS12-005'
Title: 'Bollettino Microsoft sulla sicurezza MS12-005 - Importante'
ms:assetid: 'ms12-005'
ms:contentKeyID: 61240646
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-005(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-005 - Importante
==========================================================

Una vulnerabilità in Microsoft Windows può consentire l'esecuzione di codice in modalità remota (2584146)
---------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Windows Packager controlla i file non sicuri. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=1bcb1d1e-9261-4a36-9256-90d3df9bd4fb)                                                                              | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c687796-4c41-4d17-b738-511d2fbfc126)                                                     | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c39be84-1eab-4794-b3ed-e529643aca21)                                                                     | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3cf29dfd-239e-4707-92e6-952133c1c1c2)                                                         | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=623c1c7d-6902-4876-9614-1b6e1ef80831)                                                        | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=038970b6-aeec-4e18-8dfe-887b260a7c87)                                                                           | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=23abeb12-f2fe-43fd-9c4a-4d3d244832f8)                                                               | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d089d9cb-382c-4e64-94c5-69b9864010b1)\*\*                                            | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ac8a368-4298-4c1d-9cfd-924d6df563af)\*\*                                                 | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e08b242-2516-4cf6-b38e-35ec2b8b788d)                                                 | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit e Windows 7 per sistemi a 32 bit Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7422605b-7a02-4161-b7f8-92b3ccffef64)                         | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64 e Windows 7 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ba46bc7-af7a-445a-84f2-b0c13674409b)                                   | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=db3a4814-a409-4def-944d-4eaa540b83b0)\*\*     | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium e Windows Server 2008 R2 per sistemi Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2101663a-ed3d-4850-b79a-16960ab56b45) | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
...
**Questo aggiornamento per la protezione è correlato al bollettino** **MS12-002?**
No. Sebbene entrambi questi aggiornamenti per la protezione interessino Windows Packager, gli aggiornamenti riguardano componenti diversi e non sono correlati. Gli aggiornamenti possono essere applicati in qualunque ordine.

**L'aggiornamento include modifiche di funzionalità relative alla sicurezza?**
Sì, questo aggiornamento modifica il modo in cui Windows Packager identifica i file pericolosi.
...
<span></span>
I seguenti livelli di gravità presuppongono il livello massimo di impatto potenziale della vulnerabilità. Per informazioni relative al rischio, entro 30 giorni dalla pubblicazione del presente bollettino sulla sicurezza, di sfruttamento della vulnerabilità in relazione al livello di gravità e all'impatto sulla protezione, vedere l'Exploitability Index nel [riepilogo dei bollettini di gennaio](http://technet.microsoft.com/en-us/security/bulletin/ms12-jan). Per ulteriori informazioni, vedere [Microsoft Exploitability Index](http://technet.microsoft.com/it-it/security/cc998259.aspx).
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'esecuzione di assembly - CVE-2012-0013
</th>
<th colspan="2">
...
<span></span>
È stata riscontrata una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Windows Packager carica le applicazioni ClickOnce incorporate nei file di Microsoft Office.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0013).

#### Fattori attenuanti della vulnerabilità legata all'esecuzione di assembly - CVE-2012-0013
...
-   Per essere distribuiti attraverso una rete, il manifest di distribuzione ed il manifest dell'applicazione di una distribuzione ClickOnce devono entrambi essere firmati con un certificato digitale.

#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di assembly - CVE-2012-0013

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Rimuovere l'** **associazione file** **.application**
    ...
    **Nota** L'utilizzo non corretto dell'Editor del Registro di sistema potrebbe causare problemi tali da rendere necessaria la reinstallazione del sistema operativo. Microsoft non garantisce la risoluzione di problemi dovuti a un utilizzo non corretto dell'Editor del Registro di sistema. È quindi necessario utilizzare questo strumento con grande attenzione. Per informazioni sulla modifica del Registro di sistema, vedere l'argomento relativo alla modifica delle chiavi e dei valori nella Guida dell'Editor del Registro di sistema (Regedit.exe) o gli argomenti relativi all'aggiunta e all'eliminazione di informazioni nel Registro di sistema nonché alla modifica dei dati del Registro di sistema (Regedt32.exe).
    ...
    Per rimuovere l'associazione file .application, eseguire i passaggi seguenti:

    **Utilizzo del metodo interattivo**

    1.  Fare clic sul pulsante **Start**, scegliere **Esegui**, digitare **regedit**, quindi fare clic su **OK.**
    2.  Espandere **HKEY\_CLASSES\_ROOT**, fare clic su **.application**, quindi sul menu **File** e selezionare **Esporta.**
    3.  Nella finestra di dialogo **Esporta file del Registro di sistema**, digitare **application HKCR file association registry backup.reg** e fare clic su **Salva**.
    ...
    5.  Espandere **HKEY\_CURRENT\_USER**, quindi **Software**, **Microsoft**, **Windows**, **CurrentVersion**, **Explorer** e **FileExts**.
    6.  Fare clic su **.application**, quindi sul menu **File** e selezionare **Esporta.**
    7.  Nella finestra di dialogo **Esporta file del Registro di sistema**, digitare **application HKCU** **file association registry backup.reg** e fare clic su **Salva**.
        **Nota** Questa procedura crea per impostazione predefinita un backup della chiave del Registro di sistema nella cartella Documenti**.**
    8.  Premere il tasto **CANC** sulla tastiera per eliminare la chiave del Registro di sistema. Quando viene richiesto di eliminare la chiave del Registro di sistema, fare clic su **Sì.**

    **Utilizzo di uno script di distribuzione gestita:**

    1.  Eseguire una copia di backup delle chiavi del Registro di sistema utilizzando il comando seguente:
    ...
    2.  Salvare quanto segue in un file con estensione .REG (ad esempio Delete\_Application\_File\_Association.reg):

        `Editor del Registro di sistema di Windows versione 5.00[-HKEY_CLASSES_ROOT\.application][-HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.application]`
    ...
    **Impatto della soluzione alternativa.** Questa soluzione alternativa rimuove l'associazione file .application. Facendo doppio clic su un file di applicazione non verrà più avviata l'applicazione.
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    3.  Nella finestra di dialogo Importa file del Registro di sistema, selezionare **application HKCR file association registry backup.reg** e fare clic su **Apri**.
    4.  Fare clic sul menu **File** e selezionare **Importa**.
    5.  Nella finestra di dialogo Importa file del Registro di sistema, selezionare **application HKCU** **file association registry backup.reg** e fare clic su **Apri**.
...
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di assembly - CVE-2012-0013
...
Questa vulnerabilità è causata dal fatto che i tipi di file dell'applicazione ClickOnce non fanno parte dell'elenco dei tipi di file non sicuri di Windows Packager, consentendo quindi alle applicazioni ClickOnce di essere incorporate nei documenti di Microsoft Office.

**Che cos'è ClickOnce?**
ClickOnce è un tecnologia di distribuzione che consente agli sviluppatori di creare delle applicazioni basate su Windows che si aggiornano automaticamente e che possono essere installate ed eseguite con la minima interazione da parte dell'utente. Un'applicazione ClickOnce è qualunque Windows Presentation Foundation (.xbap), Windows Forms (.exe), applicazione di console (.exe) o soluzione di Office (.dll) pubblicata utilizzando la tecnologia ClickOnce. Le applicazioni ClickOnce possono essere pubblicate in tre modi diversi: da una pagina Web, da una condivisione di file di rete o da un supporto come un CD-ROM. Per ulteriori informazioni, vedere l'articolo MSDN [Sicurezza e distribuzione di ClickOnce](http://msdn.microsoft.com/en-us/library/t71a733d.aspx).

**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**
Questa vulnerabilità consente a un utente malintenzionato di incorporare i programmi di installazione delle applicazione ClickOnce nei documenti di Microsoft Office e di eseguire il codice senza l'interazione dell'utente.

**In quale modo un utente malintenzionato può sfruttare questa** **vulnerabilità?**
Questa vulnerabilità può essere sfruttata solo se un utente apre un file Microsoft Office appositamente predisposto.

In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato può sfruttare tale vulnerabilità inviando un file Microsoft Office appositamente predisposto con un'applicazione ClickOnce incorporata e convincendo il ricevente ad aprirlo.
...
L'aggiornamento modifica il modo in cui Windows Packager controlla i file pericolosi.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2584146$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2584146">articolo della Microsoft Knowledge Base 2584146</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2584146$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2584146](http://support.microsoft.com/kb/2584146)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Yorick Koster che collabora con il programma [SecuriTeam Secure Disclosure di Beyond Security](http://www.beyondsecurity.com/ssd.html) per aver segnalato la vulnerabilità legata all'esecuzione di assembly - (CVE-2012-0013)
