---
TOCTitle: 'MS12-047'
Title: 'Bollettino Microsoft sulla sicurezza MS12-047 - Importante'
ms:assetid: 'ms12-047'
ms:contentKeyID: 61240688
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-047(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-047 - Importante
==========================================================

Alcune vulnerabilità nei driver in modalità kernel di Windows possono consentire l'acquisizione di privilegi più elevati (2718523)
----------------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui il driver in modalità kernel di Windows gestisce i file di layout della tastiera e convalida i parametri di callback quando crea una procedura hook. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
La soluzione KB2709162 in [MS12-041](http://go.microsoft.com/fwlink/?linkid=251707) è stata sostituita dalla soluzione KB2718523
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc) (installazione Server Core)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1) (installazione Server Core)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (installazione Server Core)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (installazione Server Core)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<th style="border:1px solid black;" >
Vulnerabilità legata al layout della tastiera - CVE-2012-1890
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata alla gestione errata della digitazione in Win32k - CVE-2012-1893
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati nel modo in cui il driver in modalità kernel di Windows gestisce layout di tastiera specifici. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Questi è in grado di installare programmi, visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890).

#### Fattori attenuanti della vulnerabilità legata al layout della tastiera - CVE-2012-1890
...
#### Soluzioni alternative per la vulnerabilità legata al layout della tastiera - CVE-2012-1890

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata al layout della tastiera - CVE-2012-1890
...
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890).
...
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati quando il driver in modalità kernel di Windows convalida erroneamente dei parametri durante una procedura hook. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893).

#### Fattori attenuanti della vulnerabilità legata alla gestione errata della digitazione in Win32k - CVE-2012-1893

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale.

#### Soluzioni alternative per la vulnerabilità legata alla gestione errata della digitazione in Win32k - CVE-2012-1893

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata alla gestione errata della digitazione in Win32k - CVE-2012-1893

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati.

**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità si verifica quando il driver in modalità kernel di Windows convalida erroneamente dei parametri durante la creazione di una procedura hook.
...
**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui il driver in modalità kernel di Windows convalida i parametri di callback quando crea una procedura hook.
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2718523$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2718523">articolo della Microsoft Knowledge Base 2718523</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2718523$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2718523](http://support.microsoft.com/kb/2718523)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Disponibilità nei</strong> <strong>Service Pack</strong> <strong>futuri</strong></td>
<td style="border:1px solid black;">L'aggiornamento per il problema illustrato verrà incluso in un service pack o rollup di aggiornamento futuro</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Distribuzione</strong></td>
...
-   Nicolas Economou di [Core Security Technologies](http://www.coresecurity.com/) per aver segnalato la vulnerabilità legata al layout della tastiera (CVE-2012-1890)  
-   Il [Qihoo 360 Security Center](http://www.360.cn/) per aver segnalato la vulnerabilità legata al layout della tastiera (CVE-2012-1890)  
-   Lufeng Li di Neusoft Corporation, che collabora con [Secunia Research](http://secunia.com/), per aver segnalato la vulnerabilità legata alla gestione errata della digitazione in Win32k (CVE-2012-1893)
