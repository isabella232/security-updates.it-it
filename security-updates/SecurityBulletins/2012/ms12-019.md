---
TOCTitle: 'MS12-019'
Title: 'Bollettino Microsoft sulla sicurezza MS12-019 - Medio'
ms:assetid: 'ms12-019'
ms:contentKeyID: 61240660
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-019(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-019 - Medio
=====================================================

Una vulnerabilità in DirectWrite può consentire un attacco di tipo Denial of Service (2665364)
----------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve una vulnerabilità divulgata pubblicamente in Windows DirectWrite. In uno scenario di attacco basato su Instant Messenger, la vulnerabilità potrebbe consentire un attacco di tipo Denial of Service se un utente malintenzionato invia una sequenza appositamente predisposta di caratteri Unicode direttamente a un client Instant Messenger. L'applicazione di destinazione potrebbe non rispondere quando DirectWrite esegue il rendering della sequenza appositamente predisposta di caratteri Unicode.

Questo aggiornamento per la protezione è considerato di livello moderato per tutte le edizioni supportate di Windows Vista, Windows Server 2008 (eccetto Windows Server 2008 per i sistemi Itanium), Windows 7 e Windows Server 2008 R2. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno di questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui DirectWrite esegue il rendering dei caratteri Unicode. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7da5b341-6a6f-46de-8d01-448da38e9908)                                                                           | Denial of Service                           | Moderato                     | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ba25d9c-0fef-471f-8e30-045fe9586a9c)                                                               | Denial of Service                           | Moderato                     | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=45a4784e-5051-4628-9a19-d53f30c1fdf3)\*\*                                            | Denial of Service                           | Moderato                     | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=503cb9c0-d6db-4deb-a555-67af0b25739b)\*\*                                                 | Denial of Service                           | Moderato                     | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit e Windows 7 per sistemi a 32 bit Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f3a14012-38ae-490e-a48e-7c851f82a7e6)                         | Denial of Service                           | Moderato                     | Nessuno                                       |
| [Windows 7 per sistemi x64 e Windows 7 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=760b5aa4-4e65-4ff1-9ae2-771234803bf0)                                   | Denial of Service                           | Moderato                     | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=86095b20-5869-4b55-8777-ee0af82aaf37)\*\*     | Denial of Service                           | Moderato                     | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium e Windows Server 2008 R2 per sistemi Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=dc5c336f-329c-4a56-8b24-555e3c8afd50) | Denial of Service                           | Moderato                     | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità ad attacchi di tipo Denial of Service dell'applicazione DirectWrite - CVE-2012-0156</th>
...
Vulnerabilità ad attacchi di tipo Denial of Service dell'applicazione DirectWrite - CVE-2012-0156  
-------------------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità ad attacchi di tipo Denial of Service dovuta al modo in cui DirectWrite esegue il rendering di una sequenza appositamente predisposta di caratteri Unicode. Un utente malintenzionato può sfruttare tale vulnerabilità impedendo la risposta dell'applicazione di destinazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0156](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156).
  
#### Fattori attenuanti della vulnerabilità ad attacchi di tipo Denial of Service dell'applicazione DirectWrite - CVE-2012-0156
  
Microsoft non ha individuato alcun fattore attenuante per questa vulnerabilità.
  
#### Soluzioni alternative per la vulnerabilità ad attacchi di tipo Denial of Service dell'applicazione DirectWrite - CVE-2012-0156
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande ricorrenti sulla vulnerabilità ad attacchi di tipo Denial of Service dell'applicazione DirectWrite - CVE-2012-0156
  
**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità ad attacchi di tipo Denial of Service.
  
**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando DirectWrite esegue erroneamente il rendering di una sequenza appositamente predisposta di caratteri Unicode nella memoria.
  
**Che cos'è** **DirectWrite?**  
DirectWrite è un'API di rendering di testo Unicode completa, multiformato, indipendente dalla risoluzione, che supporta la misurazione, la compilazione e l'hit testing del testo. Per ulteriori informazioni su DirectWrite, vedere l'articolo MSDN [Introduzione a DirectWrite](http://msdn.microsoft.com/en-us/library/windows/desktop/dd371554(v=vs.85).aspx).
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**  
Un utente malintenzionato che ha sfruttato con successo questa vulnerabilità può impedire la risposta da parte di un'applicazione di destinazione, quale Windows Live Messenger.
  
**In quale modo un utente malintenzionato può sfruttare questa** **vulnerabilità?**  
In uno scenario di attacco dal Web, un utente malintenzionato non autenticato deve ospitare un sito Web contenente una sequenza appositamente predisposta di caratteri Unicode. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti possono presentare contenuti appositamente predisposti che possono essere utilizzati per sfruttare questa vulnerabilità. Perché la vulnerabilità sia sfruttata, la sequenza appositamente predisposta di caratteri Unicode deve essere analizzata da un'applicazione che esegue il rendering del contenuto Web utilizzando DirectWrite. L'applicazione interessata potrebbe smettere di rispondere quando DirectWrite esegue il rendering della sequenza appositamente predisposta di caratteri Unicode. In ogni caso, un utente malintenzionato non può in alcun modo forzare gli utenti a visitare un sito Web che presenta nel contenuto una sequenza appositamente predisposta di caratteri Unicode. L'utente malintenzionato dovrebbe invece convincere gli utenti a visitare il sito Web, in genere inducendoli a fare clic su un collegamento in un messaggio di posta elettronica o di Instant Messenger che li indirizzi al sito.
  
In uno scenario di attacco basato su Instant Messenger, un utente malintenzionato non autenticato può sfruttare tale vulnerabilità inviando una sequenza appositamente predisposta di caratteri Unicode direttamente a un client Instant Messenger, quale Windows Live Messenger. L'applicazione di destinazione potrebbe non rispondere quando DirectWrite esegue il rendering della sequenza appositamente predisposta di caratteri Unicode.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**  
I sistemi più esposti a questa vulnerabilità sono le workstation e i server terminal. I server possono essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve la vulnerabilità modificando il modo in cui DirectWrite esegue il rendering dei caratteri Unicode.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**  
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2012-0156](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156).
  
**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**  
No. Al momento della pubblicazione del presente bollettino, Microsoft non ha ricevuto alcuna segnalazione in merito allo sfruttamento di questa vulnerabilità a scopo di attacco
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2665364">articolo della Microsoft Knowledge Base 2665364</a></td>
</tr>
<tr class="odd">
...
-   Khaled M. Salameh per aver segnalato la vulnerabilità agli attacchi di tipo Denial of Service dell'applicazione DirectWrite (CVE-2012-0156)
