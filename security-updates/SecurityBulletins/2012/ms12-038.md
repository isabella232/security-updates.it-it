---
TOCTitle: 'MS12-038'
Title: 'Bollettino Microsoft sulla sicurezza MS12-038 - Critico'
ms:assetid: 'ms12-038'
ms:contentKeyID: 61240679
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-038(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-038 - Critico
=======================================================

Una vulnerabilità in .NET Framework può consentire l'esecuzione di codice in modalità remota (2706726)
------------------------------------------------------------------------------------------------------
...
<span></span>
**Microsoft .NET Framework 3.5 e Microsoft .NET Framework 4.5 in Windows Consumer Preview e Microsoft .NET Framework 4.5 Consumer Preview sono interessati da questa vulnerabilità?**
Sì. Questa vulnerabilità è stata segnalata dopo il rilascio di Windows Consumer Preview e di Microsoft .NET Framework 4.5 Consumer Preview. Ai clienti che utilizzano il software Consumer Preview si consiglia di scaricare e applicare l'aggiornamento ai sistemi in uso. Per ulteriori informazioni, compresi i collegamenti dell'Area download Microsoft, vedere gli articoli della Microsoft Knowledge Base seguenti:

| Software interessato                                                                                     | Articolo della Microsoft Knowledge Base                                                    |
|----------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| Microsoft .NET Framework 3.5 in Windows Consumer Preview                                                 | [Articolo della Microsoft Knowledge Base 2686868](http://support.microsoft.com/kb/2686868) |
| Microsoft .NET Framework 4.5 in Windows Consumer Preview                                                 | [Articolo della Microsoft Knowledge Base 2686837](http://support.microsoft.com/kb/2686837) |
| Microsoft .NET Framework 4.5 Consumer Preview in Windows Server 2008, Windows 7 e Windows Server 2008 R2 | [Articolo della Microsoft Knowledge Base 2686838](http://support.microsoft.com/kb/2686838) |

Gli aggiornamenti per la protezione sono disponibili da [Microsoft Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it) e [Windows Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it).

**Microsoft .NET Framework 3.5 e Microsoft .NET Framework 4.5 in Windows Release Preview e Windows RT e Microsoft .NET Framework 4.5 Release Candidate sono interessati da questa vulnerabilità?
**No. La vulnerabilità è stata segnalata prima del rilascio di Windows Release Preview, Windows RT e Microsoft .NET Framework 4.5 Release Candidate, quindi la soluzione per vulnerabilità risolta in questo bollettino sulla sicurezza è stata inclusa in quelle versioni.
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'accesso alla memoria di .NET Framework - CVE-2012-1855
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota in Microsoft .NET Framework dovuta all'esecuzione errata di un puntatore di funzione. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1855](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1855).

#### Fattori attenuanti della vulnerabilità legata all'accesso alla memoria di .NET Framework - CVE-2012-1855
...
#### Soluzioni alternative per la vulnerabilità legata all'accesso alla memoria di .NET Framework - CVE-2012-1855
...
#### Domande frequenti sulla vulnerabilità legata all'accesso alla memoria di .NET Framework - CVE-2012-1855
...
La vulnerabilità è il risultato dell'esecuzione errata da parte di .NET Framework di un puntatore di funzione.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui .NET Framework convalida i valori passati ai puntatori di funzione.
...
Per ulteriori informazioni, vedere [System Center Configuration Manager](http://www.microsoft.com/italy/server/systemcenter/configmgr/default.mspx).
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2706726">articolo della Microsoft Knowledge Base 2706726</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Per Microsoft .NET Framework 2.0 Service Pack 2 installato in tutte le edizioni a 32 bit supportate di Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft .NET Framework 2.0 Service Pack 2 installato in tutte le edizioni x64 supportate di Windows XP Professional:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft .NET Framework 4 installato in tutte le edizioni x64 supportate di Windows XP Professional:<br />
...
-   Vitaliy Toropov, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [Tipping Point](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata all'accesso alla memoria in .NET Framework (CVE-2012-1855)
...
-   V1.0 (12 giugno): Pubblicazione del bollettino.
