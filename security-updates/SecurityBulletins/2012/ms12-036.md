---
TOCTitle: 'MS12-036'
Title: 'Bollettino Microsoft sulla sicurezza MS12-036 - Critico'
ms:assetid: 'ms12-036'
ms:contentKeyID: 61240677
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-036(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-036 - Critico
=======================================================

Una vulnerabilità del Desktop remoto può consentire l'esecuzione di codice in modalità remota (2685939)
-------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 12 giugno 2012 | Aggiornamento: martedì 9 luglio 2013
...
Questo aggiornamento per la protezione è considerato di livello critico per tutte le edizioni supportate di Windows Server 2003 e Windows Server 2008; per Windows 7 per sistemi a 32 bit Service Pack 1 e Windows 7 per sistemi x64 Service Pack 1 e per tutte le edizioni supportate di Windows Server 2008 R2. L'aggiornamento per la protezione è considerato anche di livello moderato per tutte le edizioni supportate di Windows XP e Windows Vista, per Windows 7 per sistemi a 32 bit e Windows 7 per sistemi x64. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.
...
<td style="border:1px solid black;">
La soluzione KB2621440 in [MS12-020](http://go.microsoft.com/fwlink/?linkid=232664) è stata sostituita dalla soluzione KB2685939
</td>
</tr>
...
<th style="border:1px solid black;" >
Vulnerabilità legata al protocollo RDP (Remote Desktop Protocol) - CVE-2012-0173
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0173](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0173).

#### Fattori attenuanti della vulnerabilità legata al protocollo RDP (Remote Desktop Protocol) - CVE-2012-0173
...
#### Soluzioni alternative per la vulnerabilità legata al protocollo RDP (Remote Desktop Protocol) - CVE-2012-0173
...
-   **Abilitazione dell'Autenticazione a livello di rete sui sistemi che eseguono le versioni supportate di Windows Vista, Windows 7, Windows Server 2008 e Windows Server 2008 R2**
    ...
    **
    Nota** Vedere l'[articolo della Microsoft Knowledge Base 2685939](http://support.microsoft.com/kb/2685939) per utilizzare la soluzione di fix automatico di **Microsoft** in modo da abilitare tale soluzione alternativa.
...
#### Domande frequenti sulla vulnerabilità legata al protocollo RDP (Remote Desktop Protocol) - CVE-2012-0173
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2685939$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2685939">articolo della Microsoft Knowledge Base 2685939</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2685939$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2685939](http://support.microsoft.com/kb/2685939)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   V1.1 (13 giugno 2012): È stata aggiunta una soluzione alternativa nella sezione **Informazioni sulle vulnerabilità** che spiega come attivare l'Autenticazione a livello di rete su Windows Vista, Windows 7, Windows Server 2008 e Windows Server 2008 R2.  
-   V1.2 (10 luglio 2012): Il bollettino MS11-065 è stato rimosso e sostituito dall'aggiornamento KB2685939 per Windows XP Service Pack 3, Windows XP Professional x64 Edition Service Pack 2, Windows Server 2003 Service Pack 2, Windows Server 2003 x64 Edition Service Pack 2 e Windows Server 2003 con SP2 per sistemi Itanium. La modifica è esclusivamente informativa. Non sono previste modifiche alla logica di rilevamento o ai file di aggiornamento.  
-   V1.3 (9 luglio 2013): Il bollettino è stato rivisto per comunicare un modifica di rilevamento nei pacchetti di Windows Vista affinché l'aggiornamento 2685939 corregga un problema che si è ripresentato in Windows Update. Si tratta di una modifica solo al rilevamento. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.
