---
TOCTitle: 'MS12-028'
Title: 'Bollettino Microsoft sulla sicurezza MS12-028 - Importante'
ms:assetid: 'ms12-028'
ms:contentKeyID: 61240669
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-028(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-028 - Importante
==========================================================

Una vulnerabilità di Microsoft Office può consentire l'esecuzione di codice in modalità remota (2639185)
--------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 10 aprile 2012 | Aggiornamento: mercoledì 25 aprile 2012
...
Questo aggiornamento per la protezione è considerato di livello importante per Microsoft Office 2007 Service Pack 2, Microsoft Works 9 e per il convertitore file di Microsoft Works 6–9. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità disattivando il convertitore di Microsoft Works vulnerabile. Si consiglia di utilizzare la versione più recente del convertitore di Microsoft Works, che non è interessato dalla vulnerabilità. Dopo l'installazione dell'aggiornamento, i clienti con il convertitore obsoleto di Microsoft Works, che non hanno ancora scaricato la versione più recente del convertitore di Microsoft Works, quando tentano di aprire un file Works riceveranno istruzioni su come scaricare la versione più recente del convertitore di Microsoft Works. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
La soluzione KB969559 in [MS09-024](http://go.microsoft.com/fwlink/?linkid=128104) è stata sostituita dalla soluzione KB2596871
</td>
</tr>
<tr>
<th colspan="4">
...
<td style="border:1px solid black;">
La soluzione KB2431831 in [MS10-105](http://go.microsoft.com/fwlink/?linkid=147425) è stata sostituita dalla soluzione KB2680317
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
La soluzione KB968326 in [MS09-024](http://go.microsoft.com/fwlink/?linkid=128104) è stata sostituita dalla soluzione KB2680326
</td>
</tr>
</table>
...
<span></span>
**Sul PC è stato installato Microsoft Office 2007 Service Pack 3. Se non è interessato dalla vulnerabilità, perché viene offerto questo aggiornamento?**
Sebbene la vulnerabilità descritta in CVE-2012-0177 non interessi Microsoft Office 2007 Service Pack 3, il meccanismo di aggiornamento offre l'aggiornamento perché rileva una versione dei file del sistema precedente a quella del pacchetto di aggiornamento.

**Dove si trova la sezione Informazioni sui file?**
Fare riferimento alle tabelle contenute nella sezione **Distribuzione dell'aggiornamento per la protezione** per individuare la sezione Informazioni sui file.

**Che cos'è il convertitore file di Microsoft Works 6-9?**
Il convertitore file di Microsoft Works 6-9 è un download facoltativo che consente alle applicazioni Microsoft Office di aprire, modificare e salvare i file nel formato Works Word Processor supportato dalle versioni 6, 7, 8 e 9 di Works.
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'overflow degli heap nel convertitore dei file WPS di Office - CVE-2012-0177
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel convertitore file di Microsoft Office Works. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0177](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0177).

#### Fattori attenuanti della vulnerabilità legata all'overflow degli heap nel convertitore dei file WPS di Office - CVE-2012-0177

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   In uno scenario di attacco dal Web, l'utente malintenzionato potrebbe pubblicare un sito contenente un file appositamente predisposto per sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti o annunci pubblicitari forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. In tutti questi casi, comunque, non è in alcun modo possibile obbligare gli utenti a visitare questi siti Web. L'utente malintenzionato, invece, deve convincere gli utenti a visitare il sito Web, in genere inducendoli a fare clic su un collegamento contenuto in un messaggio di posta elettronica o di messaggistica immediata che li indirizzi al sito Web dell'utente malintenzionato. Successivamente, deve convincerli ad aprire il file appositamente predisposto.
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow degli heap nel convertitore dei file WPS di Office - CVE-2012-0177

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Non aprire file Works provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili**

    Non aprire file Works (.wps) provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto.

#### Domande frequenti sulla vulnerabilità legata all'overflow degli heap nel convertitore dei file WPS di Office - CVE-2012-0177

**Qual è la portata o l'impatto di questa vulnerabilità?**
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota.

**Quali sono le cause di questa vulnerabilità?**
La vulnerabilità è causata quando il convertitore di Microsoft Works non convalida correttamente il formato file .wps quando analizza un file appositamente predisposto.
...
Questa vulnerabilità può essere sfruttata solo se un utente apre un file .wps appositamente predisposto con una versione interessata di Microsoft Office.

In uno scenario di attacco tramite posta elettronica, un utente malintenzionato può sfruttare tale vulnerabilità inviando un file appositamente predisposto e convincendo il ricevente ad aprirlo.

In uno scenario di attacco dal Web, l'utente malintenzionato dovrebbe pubblicare un sito Web contenente un file Works appositamente predisposto utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti possono presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare questi siti Web, l'utente malintenzionato dovrebbe convincere le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento che le indirizzi al sito.

**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**
I sistemi più esposti sono le workstation e i server terminal in cui sono installate le versioni interessate di Microsoft Office o Microsoft Works. I server possono essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento risolve la vulnerabilità disattivando il convertitore di Microsoft Works vulnerabile. Si consiglia di utilizzare la versione più recente del convertitore di Microsoft Works, che non è interessato dalla vulnerabilità. Dopo l'installazione dell'aggiornamento, i clienti con il convertitore obsoleto di Microsoft Works, che non hanno ancora scaricato la versione più recente del convertitore di Microsoft Works, quando tentano di aprire un file Works riceveranno istruzioni su come scaricare la versione più recente del convertitore di Microsoft Works.
...
| Convertitore file di Microsoft Works 6–9 | No   |
...
| Convertitore file di Microsoft Works 6–9 | No                | No                         |
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2596871">articolo della Microsoft Knowledge Base 2596871</a></td>
</tr>
<tr class="even">
...
#### Convertitore file di Works 9 e Works 6–9
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Microsoft Works 9:<br />
Works9_KB2680317_en-US.msp /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per il convertitore file di Microsoft Works 6–9:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Microsoft Works 9, vedere l'<a href="http://support.microsoft.com/kb/2680317">articolo della Microsoft Knowledge Base 2680317</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per il convertitore file di Microsoft Works 6–9 vedere l'<a href="http://support.microsoft.com/kb/2680326">articolo della Microsoft Knowledge Base 2680326</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Shaun Colley di [IOActive, Ltd.](http://ioactive.co.uk/) per aver segnalato la vulnerabilità legata all'overflow degli heap nel convertitore dei file WPS di Office (CVE-2012-0177)
...
-   V1.1 (25 aprile 2012): È stata aggiunta una voce alla sezione Domande frequenti sull'aggiornamento al fine di chiarire il motivo per cui questo aggiornamento è offerto ai clienti che eseguono Microsoft Office 2007 Service Pack 3.
