---
TOCTitle: 'MS12-064'
Title: 'Bollettino Microsoft sulla sicurezza MS12-064 - Critico'
ms:assetid: 'ms12-064'
ms:contentKeyID: 61240705
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-064(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-064 - Critico
=======================================================

Alcune vulnerabilità in Microsoft Word possono consentire l'esecuzione di codice in modalità remota (2742319)
-------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato critico per tutte le edizioni supportate di Microsoft Word 2007 e per Microsoft Word 2010. Questo aggiornamento per la protezione è anche considerato di livello importante per tutte le edizioni supportate di Microsoft Word 2003 e tutte le versioni supportate di Microsoft Word Viewer, del pacchetto di compatibilità Microsoft Office, Microsoft Word Automation Services in Microsoft SharePoint Server 2010 e Microsoft Office Web Apps. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui Microsoft Office gestisce la memoria quando analizza file appositamente predisposti. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
KB2598332 in [MS12-029](http://go.microsoft.com/fwlink/?linkid=248419) sostituito da KB2687483
</td>
</tr>
...
<td style="border:1px solid black;">
KB2596917 in [MS12-029](http://go.microsoft.com/fwlink/?linkid=248419) sostituito da KB2687315
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2345009 in [MS10-079](http://go.microsoft.com/fwlink/?linkid=201696) sostituito da KB2687485
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2596880 in [MS12-029](http://go.microsoft.com/fwlink/?linkid=248419) sostituito da KB2687314
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Gli hash SHA1 e SHA2 degli aggiornamenti per la protezione possono essere utilizzati per verificare l'autenticità dei pacchetti di aggiornamento per la protezione scaricati. Per le informazioni sugli hash pertinenti a questo aggiornamento, vedere [l'articolo della Microsoft Knowledge Base 2742319](http://support.microsoft.com/kb/2742319).
  
**In che modo Microsoft Outlook è interessato dalle vulnerabilità?**    
Outlook non è direttamente interessato poiché le vulnerabilità sono presenti in Microsoft Word. Tuttavia, se Word viene selezionato come programma di posta elettronica, impostazione predefinita nel caso di Microsoft Outlook 2007 e Outlook 2010, un utente malintenzionato può sfruttare Outlook per un attacco tramite posta elettronica al fine di sfruttare CVE-2012-2528, inviando all'utente designato un messaggio in formato RTF appositamente predisposto.
  
**Qual è la relazione tra il presente aggiornamento per la protezione e il bollettino MS12-066?**    
Il pacchetto di aggiornamento per la protezione per Microsoft Office Web Apps 2010 Service Pack 1 (KB2687401) offerto in questo bollettino risolve anche la vulnerabilità descritta nel bollettino sulla sicurezza [MS12-066](http://go.microsoft.com/fwlink/?linkid=260957).
...
<span></span>
I seguenti livelli di gravità presuppongono il livello massimo di impatto potenziale della vulnerabilità. Per informazioni relative al rischio, entro 30 giorni dalla pubblicazione del presente bollettino sulla sicurezza, di sfruttamento della vulnerabilità in relazione al livello di gravità e all'impatto sulla protezione, vedere l'Exploitability Index nel [riepilogo dei bollettini di settembre](http://technet.microsoft.com/security/bulletin/ms12-sep). Per ulteriori informazioni, vedere [Microsoft Exploitability Index](http://technet.microsoft.com/security/cc998259).
...
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della sezione PAPX di Word - CVE-2012-0182</th>
<th style="border:1px solid black;" >Vulnerabilità di tipo Use-After-Free nella proprietà listid dei file RTF - CVE-2012-2528</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Word Automation Services in Microsoft SharePoint Server 2010</td>
<td style="border:1px solid black;">Non applicabile</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
...
Vulnerabilità legata al danneggiamento della sezione PAPX di Word - CVE-2012-0182  
---------------------------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0182](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0182).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della sezione PAPX di Word - CVE-2012-0182
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della sezione PAPX di Word - CVE-2012-0182
...
-   **Utilizzare il criterio del blocco dei file di Microsoft Office per bloccare l'apertura di documenti di Office 2003 e versioni precedenti di dubbia provenienza**
    ...
    **Nota** Per utilizzare "FileOpenBlock" con Microsoft Office 2007, è necessario applicare tutti gli ultimi aggiornamenti per la protezione di Office 2007.
    ...
    `Editor del Registro di sistema di Windows versione 5.00 [HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.0\Word\Security\FileOpenBlock] "BinaryFiles"=dword:00000001`
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    `Editor del Registro di sistema di Windows versione 5.00 [HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.0\Word\Security\FileOpenBlock] "BinaryFiles"=dword:00000000`
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della sezione PAPX di Word - CVE-2012-0182

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità è causata quando Microsoft Word gestisce erroneamente la memoria quando analizza file di Word appositamente predisposti.
...
In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato può sfruttare tale vulnerabilità inviando un file Word appositamente predisposto e convincendo il ricevente ad aprirlo.

In uno scenario di attacco dal Web, l'utente malintenzionato potrebbe pubblicare un sito Web contenente un file Word appositamente predisposto utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti possono presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. Non è in alcun modo possibile obbligare gli utenti a visitare un sito Web appositamente predisposto. L'utente malintenzionato deve convincerli a visitare il sito, in genere inducendoli a fare clic su un collegamento che li indirizzi al sito e quindi ad aprire il file di Word appositamente predisposto.
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Microsoft Word gestisce la memoria quando analizza i file di Word appositamente predisposti.
...
Vulnerabilità di tipo Use-After-Free nella proprietà listid dei file RTF - CVE-2012-2528
----------------------------------------------------------------------------------------

<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Office gestisce file RTF appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-2528](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2528).

#### Fattori attenuanti della vulnerabilità di tipo Use-After-Free nella proprietà listid dei file RTF - CVE-2012-2528
...
#### Soluzioni alternative per la vulnerabilità di tipo Use-After-Free nella proprietà listid dei file RTF - CVE-2012-2528
...
#### Domande frequenti sulla vulnerabilità di tipo Use-After-Free nella proprietà listid dei file RTF - CVE-2012-2528

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità è causata se Microsoft Office gestisce erroneamente la memoria quando analizza i file RTF appositamente predisposti.
...
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**  
Sfruttando questa vulnerabilità, un utente malintenzionato può eseguire codice arbitrario nel contesto di protezione dell'utente che apre un file RTF appositamente predisposto oppure visualizza in anteprima o apre un messaggio di posta elettronica RTF appositamente predisposto. Se l'utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Nel caso della conversione di un file RTF appositamente predisposto utilizzando Word Automation Services, un utente malintenzionato che ha sfruttato con successo questa vulnerabilità potrebbe causare codice arbitrario da eseguire nel contesto dell'account di servizio che esegue Word Automation Services sul server SharePoint interessato.

**In quale modo un utente malintenzionato può sfruttare questa vulnerabilità?**  
Per Microsoft Word, questa vulnerabilità può essere sfruttata solo se un utente apre un file Word appositamente predisposto con una versione interessata di Microsoft Word.

In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato può sfruttare tale vulnerabilità inviando un file Word appositamente predisposto e convincendo il ricevente ad aprirlo.

In uno scenario di attacco dal Web, l'utente malintenzionato potrebbe pubblicare un sito Web contenente un file RTF appositamente predisposto utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti possono presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. Non è in alcun modo possibile obbligare gli utenti a visitare un sito Web appositamente predisposto. L'utente malintenzionato deve convincerli a visitare il sito, in genere inducendoli a fare clic su un collegamento che li indirizzi al sito e quindi ad aprire il file RTF appositamente predisposto in Microsoft Word.

In uno scenario di attacco attraverso Word Automation Services, un file Word appositamente predisposto potrebbe essere collocato in una libreria di SharePoint e messo in coda per la conversione con Word Automation Services. La vulnerabilità potrebbe essere sfruttata quando il file appositamente predisposto è analizzato da Word Automation Services.
...
**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui Microsoft Office gestisce la memoria quando analizza file RTF appositamente predisposti.
...
<sup>[1]</sup>La tabella di rilevamento descritta sopra si basa su distribuzioni per un server singolo di Microsoft SharePoint Server 2010. Gli strumenti di rilevamento non rilevano l'applicabilità dell'aggiornamento a sistemi configurati come parte di una server farm SharePoint comprendente più sistemi.
...
<td style="border:1px solid black;">Vedere gli <a href="http://support.microsoft.com/kb/2687483">articoli della Microsoft Knowledge Base 2687483</a> e <a href="http://support.microsoft.com/kb/2687485">2687485</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere gli <a href="http://support.microsoft.com/kb/2687315">articoli della Microsoft Knowledge Base 2687315</a> e <a href="http://support.microsoft.com/kb/2687314">2687314</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2553488">articolo della Microsoft Knowledge Base 2553488</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere gli <a href="http://support.microsoft.com/kb/2598237">articoli della Microsoft Knowledge Base 2598237</a> e <a href="http://support.microsoft.com/kb/2687401">2687401</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Un ricercatore anonimo, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/)[di TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/), per aver segnalato la vulnerabilità legata al danneggiamento della sezione PAPX di Word (CVE-2012-0182)  
-   Un ricercatore anonimo, che collabora con il programma [SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html) di Beyond Security, per aver segnalato la vulnerabilità di tipo Use-After-Free nella proprietà listid dei file RTF (CVE-2012-2528)
