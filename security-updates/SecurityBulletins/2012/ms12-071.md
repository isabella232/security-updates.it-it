---
TOCTitle: 'MS12-071'
Title: 'Bollettino Microsoft sulla sicurezza MS12-071 - Critico'
ms:assetid: 'ms12-071'
ms:contentKeyID: 61240712
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-071(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-071 - Critico
=======================================================

Aggiornamento cumulativo per la protezione di Internet Explorer (2761451)
-------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve tre vulnerabilità di Internet Explorer segnalate privatamente. Queste vulnerabilità possono consentire l'esecuzione di codice in modalità remota se un utente visualizza una pagina Web appositamente predisposta con Internet Explorer. Sfruttando queste vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente corrente. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
...
<td style="border:1px solid black;">
KB2744842 in [MS12-063](http://go.microsoft.com/fwlink/?linkid=255505) è stato sostituito da KB2761451
</td>
</tr>
...
<th style="border:1px solid black;" >
Vulnerabilità legata a un errore di tipo use-after-free in CFormElement - CVE-2012-1538
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata a un errore di tipo use-after-free in CTreePos - CVE-2012-1539
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata a un errore di tipo use-after-free in CTreeNode - CVE-2012-4775
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1538](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538).

#### Fattori attenuanti della vulnerabilità legata a un errore di tipo use-after-free in CFormElement - CVE-2012-1538
...
#### Soluzioni alternative per la vulnerabilità legata a un errore di tipo use-after-free in CFormElement - CVE-2012-1538
...
#### Domande frequenti sulla vulnerabilità legata a un errore di tipo use-after-free in CFormElement - CVE-2012-1538
...
Questa vulnerabilità può essere sfruttata per l'esecuzione di azioni dannose solo se un utente è connesso al sistema e visita un sito Web. Pertanto, i sistemi maggiormente a rischio sono quelli in cui Internet Explorer 9 viene utilizzato frequentemente, come le workstation o i server terminal.
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1539](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539).

#### Fattori attenuanti della vulnerabilità legata a un errore di tipo use-after-free in CTreePos - CVE-2012-1539
...
#### Soluzioni alternative per la vulnerabilità legata a un errore di tipo use-after-free in CTreePos - CVE-2012-1539
...
#### Domande frequenti sulla vulnerabilità legata a un errore di tipo use-after-free in CTreePos - CVE-2012-1539
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-4775](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775).

#### Fattori attenuanti della vulnerabilità legata a un errore di tipo use-after-free in CTreeNode - CVE-2012-4775
...
#### Soluzioni alternative per la vulnerabilità legata a un errore di tipo use-after-free in CTreeNode - CVE-2012-4775
...
#### Domande frequenti sulla vulnerabilità legata a un errore di tipo use-after-free in CTreeNode - CVE-2012-4775
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2761451">articolo della Microsoft Knowledge Base 2761451</a></td>
</tr>
<tr class="odd">
...
-   Jose A. Vazquez di spa-s3c.blogspot.com, che collabora con [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata a un errore di tipo use-after-free di CFormElement (CVE-2012-1538)  
-   [Omair](http://krash.in/) per aver segnalato la vulnerabilità legata a un errore di tipo use-after-free in CFormElement (CVE-2012-1538)  
-   Jose A. Vazquez di spa-s3c.blogspot.com, che collabora con [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata a un errore di tipo use-after-free di CTreePos (CVE-2012-1539)  
-   Cheng-da Tsai (Orange), Sung-ting Tsai e Ming-chieh Pan (Nanika) di [Trend Micro](http://www.trendmicro.com) per aver segnalato la vulnerabilità legata a un errore di tipo use-after-free di CTreeNode (CVE-2012-4775)
