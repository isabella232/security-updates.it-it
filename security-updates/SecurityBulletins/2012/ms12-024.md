---
TOCTitle: 'MS12-024'
Title: 'Bollettino Microsoft sulla sicurezza MS12-024 - Critico'
ms:assetid: 'ms12-024'
ms:contentKeyID: 61240665
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-024(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-024 - Critico
=======================================================

Una vulnerabilità in Windows può consentire l'esecuzione di codice in modalità remota (2653956)
-----------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 10 aprile 2012 | Aggiornamento: martedì 31 luglio 2012
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui la funzione di verifica della firma Authenticode di Windows esegue la verifica della firma Authenticode di Windows quando controlla i file PE. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=734ff97a-7d72-4bfe-9557-7fac91902f8e">Windows Server 2003 con SP2 per sistemi Itanium</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c36c20f7-a742-4151-b8f2-85ef80479d06">Windows Server 2008 per sistemi a 32 bit Service Pack 2</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=330cea47-221d-439e-b106-58a146fc28ee">Windows Server 2008 per sistemi x64 Service Pack 2</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1ec74522-ec1e-4b3c-bfeb-6a505cc4f11a">Windows Server 2008 per sistemi Itanium Service Pack 2</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">Windows 7 per sistemi 32-bit</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">Windows 7 per sistemi a 32 bit Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">Windows 7 per sistemi x64</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">Windows 7 per sistemi x64 Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">Nessuno</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">Windows Server 2008 R2 per sistemi x64</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">Windows Server 2008 R2 per sistemi x64 Service Pack 1</a>*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">Nessuno</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">Windows Server 2008 R2 per sistemi Itanium</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">La soluzione KB978601 in <a href="http://www.microsoft.com/italy/technet/security/bulletin/ms10-019.mspx">MS10-019</a> è stata sostituita dalla soluzione KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">Windows Server 2008 R2 per sistemi Itanium Service Pack 1</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Critico</td>
<td style="border:1px solid black;">Nessuno</td>
...
Sì. L'aggiornamento KB2653956 è disponibile per la versione Windows Developer Preview. Agli utenti di Windows Developer Preview si consiglia di applicare l'aggiornamento nei sistemi in uso. L'aggiornamento è disponibile solo su [Windows Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it).
  
**Windows** **8** **Consumer** **Preview è interessato dalla vulnerabilità risolta in questo bollettino?**  
Sì. L'aggiornamento KB2653956 è disponibile per la versione Windows 8 Consumer Preview. Agli utenti di Windows Consumer Preview si consiglia di applicare l'aggiornamento nei sistemi in uso. L'aggiornamento è disponibile solo su [Windows Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it).
  
**Dopo aver applicato questo aggiornamento la firma digitale del software in uso non è valida; come bisogna comportarsi?** **  
**Questo aggiornamento causa l'esecuzione di un controllo severo dei file PE da parte della funzione di verifica della firma Authenticode di Windows. I file PE vengono considerati "non firmati" se Windows è in grado di identificare contenuto non conforme alle specifiche di Authenticode nel file. Questo può avere un impatto su alcuni programmi di installazione. Se si sta utilizzando un programma di installazione interessato dal problema, Microsoft consiglia di utilizzare un programma di installazione che estragga il contenuto solo dalle parti convalidate del file firmato.
  
I file PE saranno considerati "non firmati" anche quando viene inserito contenuto aggiuntivo al file dopo l'applicazione della firma. La firma dell'applicazione dovrebbe essere il passaggio finale nel processo di creazione prima del rilascio dei file binari. Per ulteriori informazioni riguardanti questi e altri problemi noti relativi a questo aggiornamento per la protezione, consultare l'[articolo della Microsoft Knowledge Base 2653956](http://support.microsoft.com/kb/2653956).
  
**L'aggiornamento include modifiche di funzionalità relative alla sicurezza?**  
Sì. Oltre alle modifiche elencate nella sezione Informazioni sulle vulnerabilità di questo bollettino, l'aggiornamento contiene gli aggiornamenti di difesa in profondità che migliorano le funzionalità di protezione in Windows.
...
<th style="border:1px solid black;" >Vulnerabilità legata alla convalida della firma WinVerifyTrust - CVE-2012-0151</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
Vulnerabilità legata alla convalida della firma WinVerifyTrust - CVE-2012-0151  
------------------------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0151](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0151).
  
#### Fattori attenuanti per la vulnerabilità legata alla convalida della firma WinVerifyTrust - CVE-2012-0151
  
Microsoft non ha individuato alcun fattore attenuante per questa vulnerabilità.
  
#### Soluzioni alternative per la vulnerabilità legata alla convalida della firma WinVerifyTrust - CVE-2012-0151
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla convalida della firma WinVerifyTrust - CVE-2012-0151
  
**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota.
  
**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità è causata quando la funzione di verifica della firma Authenticode di Windows convalida erroneamente il digest del file di un file PE appositamente predisposto.
  
**Che cos'è la funzione di verifica della firma Authenticode di Windows?** **  
**La funzione di verifica della firma Authenticode di Windows, o WinVerifyTrust, esegue un'azione di verifica dell'attendibilità su un oggetto specificato. La funzione trasferisce la domanda a un provider dell'attendibilità che supporta l'identificatore dell'azione, se esistente. La funzione WinVerifyTrust esegue due azioni: il controllo della firma su un oggetto specificato e la verifica dell'attendibilità. Per informazioni più tecniche riguardanti la funzione WinVerifyTrust, vedere l'articolo MSDN [Funzione WinVerifyTrust](http://msdn.microsoft.com/en-us/library/aa388208(vs.85).aspx).
  
Per un'introduzione all'Authenticode, vedere l'articolo MSDN [Introduzione alla firma codice](http://msdn.microsoft.com/en-us/library/ms537361(v=vs.85).aspx).
...
L'aggiornamento risolve la vulnerabilità modificando il modo in cui la funzione di verifica della firma Authenticode di Windows esegue la verifica della firma Authenticode di Windows quando controlla i file PE.
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2653956$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2653956">articolo della Microsoft Knowledge Base 2653956</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2653956$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2653956](http://support.microsoft.com/kb/2653956)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Robert Zacek ed Igor Glucksmann di [Avast Software](http://www.avast.com/) per aver segnalato la vulnerabilità legata alla convalida della firma WinVerifyTrust (CVE-2012-0151)
...
-   V1.1 (31 luglio 2012): Il bollettino è stato rivisto per comunicare un modifica di rilevamento nei pacchetti di Windows Vista affinché KB2653956 corregga un problema che si è ripresentato in Windows Update. Si tratta di una modifica solo al rilevamento. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.
