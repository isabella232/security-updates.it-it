---
TOCTitle: 'MS12-055'
Title: 'Bollettino Microsoft sulla sicurezza MS12-055 - Importante'
ms:assetid: 'ms12-055'
ms:contentKeyID: 61240696
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-055(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-055 - Importante
==========================================================

La vulnerabilità nei driver in modalità kernel di Windows può consentire l'acquisizione di privilegi più elevati (2731847)
--------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve le vulnerabilità modificando il modo in cui il driver in modalità kernel di Windows gestisce gli oggetti in memoria. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<td style="border:1px solid black;">
KB2718523 in [MS12-047](http://go.microsoft.com/fwlink/?linkid=254380) sostituita dalla soluzione KB2731847
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ec759712-2f38-41a9-8b6d-c6908cc58479) (installazione Server Core)  
(KB2731847)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=caf68d77-3315-4383-a901-ba0385ffe561) (installazione Server Core)  
(KB2731847)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242) (installazione Server Core)  
(KB2731847)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242) (installazione Server Core)  
(KB2731847)
</td>
<td style="border:1px solid black;">
Acquisizione di privilegi più elevati
...
<th style="border:1px solid black;" >
Vulnerabilità legata a un errore di tipo use-after-free in Win32k - CVE-2012-2527
</th>
<th colspan="2">
Livello di gravità aggregato
</th>
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-2527](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2527).

#### Fattori attenuanti della vulnerabilità legata a un errore di tipo use-after-free in Win32k - CVE-2012-2527
...
#### Soluzioni alternative per la vulnerabilità legata a un errore di tipo use-after-free in Win32k - CVE-2012-2527

Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.

#### Domande frequenti sulla vulnerabilità legata a un errore di tipo use-after-free in Win32k - CVE-2012-2527
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2731847-v2$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2731847">articolo della Microsoft Knowledge Base 2731847</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2731847-v2$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2731847](http://support.microsoft.com/kb/2731847)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Matthew Jurczyk di [Google Inc](http://www.google.com/) per aver segnalato la vulnerabilità legata a un errore di tipo use-after-free in Win32k (CVE-2012-2527)
...
-   V2.1 (10 ottobre 2012): Per il rilascio dell'aggiornamento KB2731847, è stata aggiunta una sezione alla voce Domande frequenti per fornire informazioni sulla distribuzione. Per ulteriori informazioni, vedere le Domande frequenti sull'aggiornamento.
