---
TOCTitle: 'MS12-045'
Title: 'Bollettino Microsoft sulla sicurezza MS12-045 - Critico'
ms:assetid: 'ms12-045'
ms:contentKeyID: 61240686
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-045(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-045 - Critico
=======================================================

Una vulnerabilità in Microsoft Data Access Components può consentire l'esecuzione di codice in modalità remota (2698365)
------------------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 10 luglio 2012 | Aggiornamento: martedì 11 settembre 2012
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Microsoft Data Access Components gestisce gli oggetti nella memoria. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<sup>[1]</sup>L'aggiornamento KB2698365 si applica anche a Windows Data Access Components 6.1. I clienti che hanno installato l'aggiornamento [KB2640696](http://www.microsoft.com/download/details.aspx?id=28422) hanno installato anche Windows Data Access Components 6.1 sui loro sistemi e devono pertanto installare l'aggiornamento KB2698365 per risolvere la vulnerabilità.

**Software non interessato**

| **Sistema operativo**(installazione Server Core)                                    | **Componente**                     |
|-------------------------------------------------------------------------------------|------------------------------------|
| Windows Server 2008 per sistemi a 32 bit Service Pack 2 (installazione Server Core) | Windows Data Access Components 6.0 |
| Windows Server 2008 per sistemi x64 Service Pack 2 (installazione Server Core)      | Windows Data Access Components 6.0 |
| Windows Server 2008 R2 per sistemi x64 (installazione Server Core)                  | Windows Data Access Components 6.0 |
| Windows Server 2008 R2 per sistemi x64 Service Pack 1 (installazione Server Core)   | Windows Data Access Components 6.0 |
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'esecuzione di codice in modalità remota nell'overflow degli heap della CacheSize di ADO - CVE-2012-1891
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 1 in Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Critico**  
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 2 in Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Critico**  
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 2 in Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderato**  
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 2 in Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderato**  
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 2 in Windows Server 2003 con SP2 per sistemi Itanium
</td>
<td style="border:1px solid black;">
**Moderato**  
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Critico**  
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Critico**  
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows Server 2008 per sistemi a 32 bit Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderato**  
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows Server 2008 per sistemi x64 Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderato**  
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows Server 2008 per sistemi Itanium Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderato**  
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows 7 per sistemi a 32 bit e Windows 7 per sistemi a 32 bit Service Pack 1
</td>
<td style="border:1px solid black;">
**Critico**  
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows 7 per sistemi x64 e Windows 7 per sistemi x64 Service Pack 1
</td>
<td style="border:1px solid black;">
**Critico**  
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per sistemi x64 Service Pack 1
</td>
<td style="border:1px solid black;">
**Moderato**  
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 in Windows Server 2008 R2 per sistemi Itanium e Windows Server 2008 R2 per sistemi Itanium Service Pack 1
</td>
<td style="border:1px solid black;">
**Moderato**  
Esecuzione di codice in modalità remota
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Data Access Components accede a un oggetto nella memoria che è stato inizializzato in maniera errata. Sfruttando questa vulnerabilità, un utente malintenzionato può eseguire codice non autorizzato nel sistema di destinazione. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1891](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891).

#### Fattori attenuanti della vulnerabilità legata all'esecuzione di codice in modalità remota nell'overflow degli heap della CacheSize di ADO - CVE-2012-1891
...
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di codice in modalità remota nell'overflow degli heap della CacheSize di ADO - CVE-2012-1891
...
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di codice in modalità remota nell'overflow degli heap della CacheSize di ADO - CVE-2012-1891
...
La vulnerabilità si verifica quando Microsoft Data Access Components elabora un codice XML appositamente predisposto, con il conseguente accesso nella memoria di un oggetto che non è stato correttamente inizializzato.

**Che cos'è MDAC?**
[Microsoft Data Access Components](http://msdn.microsoft.com/it-it/library/aa968814(v=vs.85).aspx) (MDAC) è un insieme di componenti che semplifica l'accesso ai database e l'utilizzo dei relativi dati da parte dei programmi. I database moderni possono assumere diverse forme (ad esempio i database di SQL Server, i database di Microsoft Access e i file XML) e possono essere ubicati in una varietà di posizioni (ad esempio nel sistema locale o in un server di database remoto). MDAC offre un insieme di funzioni consolidato che consente di utilizzare in modo coerente qualsiasi tipo di origine dati. A partire da Windows Vista, MDAC è diventato Windows Data Access Components (WDAC).

Activex Data Objects (ADO), parte di MDAC, è un modello di oggetti di linguaggio neutrale che espone dei dati originati da un Provider OLE DB presente.
...
L'aggiornamento risolve la vulnerabilità modificando il modo in cui Microsoft Data Access Components gestisce gli oggetti nella memoria.
...
<td style="border:1px solid black;">Utilizzare la voce <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2698365$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2698365">articolo della Microsoft Knowledge Base 2698365</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare la voce **Installazione applicazioni** nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2698365$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2698365](http://support.microsoft.com/kb/2698365)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Un ricercatore anonimo, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/)[di TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/), per aver segnalato la vulnerabilità legata all'esecuzione di codice in modalità remota nell'overflow degli heap della CacheSize di ADO (CVE-2012-1891)
...
-   V1.1 (31 luglio 2012): Il bollettino è stato rivisto per comunicare un modifica di rilevamento nei pacchetti di Windows Vista affinché KB2698365 corregga un problema che si è ripresentato in Windows Update. Si tratta di una modifica solo al rilevamento. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.  
-   V1.2 (15 agosto 2012): È stato chiarito che questo aggiornamento si applica anche a Windows Data Access Components 6.1 su Windows 7 Service Pack 1 e Windows Server 2008 R2 Service Pack 1. La modifica è esclusivamente informativa. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.  
-   V1.3 (11 settembre 2012): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2698365 nella sottosezione Problemi noti del Riepilogo.
