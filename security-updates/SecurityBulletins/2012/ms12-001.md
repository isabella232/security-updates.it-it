---
TOCTitle: 'MS12-001'
Title: 'Bollettino Microsoft sulla sicurezza MS12-001 - Importante'
ms:assetid: 'ms12-001'
ms:contentKeyID: 61240642
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-001(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-001 - Importante
==========================================================

Una vulnerabilità nel kernel di Windows può consentire l'elusione della funzione di protezione (2644615)
--------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 10 gennaio 2012 | Aggiornamento: mercoledì 22 febbraio 2012
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                     | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                     | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                         | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                        | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                           | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                               | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                              | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                   | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                 | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit e Windows 7 per sistemi a 32 bit Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                         | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64 e Windows 7 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium e Windows Server 2008 R2 per sistemi Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | Elusione della funzione di protezione       | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'elusione di SafeSEH nel kernel di Windows - CVE-2012-0001</th>
...
Vulnerabilità legata all'elusione di SafeSEH nel kernel di Windows - CVE-2012-0001  
----------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità in Windows legata all'elusione della funzione di protezione dovuta al modo in cui il kernel carica le tabelle di gestione delle eccezioni strutturate. Sfruttando questa vulnerabilità, un utente malintenzionato può ignorare il meccanismo di difesa in profondità SafeSEH per facilitare lo sfruttamento di altre vulnerabilità.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-0001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001).
  
#### Fattori attenuanti della vulnerabilità legata all'elusione di SafeSEH nel kernel di Windows - CVE-2012-0001
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Solo le applicazioni software che sono state compilate utilizzando Microsoft Visual C++ .NET 2003 possono essere utilizzate per sfruttare questa vulnerabilità.
  
    **Nota** Per aiuto nel determinare il prodotto utilizzato per compilare un'applicazione software particolare, vedere l'[articolo della Microsoft Knowledge Base 2644615](http://support.microsoft.com/kb/2644615).
  
#### Soluzioni alternative per la vulnerabilità legata all'elusione di SafeSEH nel kernel di Windows - CVE-2012-0001
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Ricompilare** **il software** **utilizzando** **una versione più recente di** **Microsoft Visual** C++
  
    Solo le applicazioni software che sono state compilate utilizzando Microsoft Visual C++ .NET 2003 possono essere utilizzate per sfruttare questa vulnerabilità. Come soluzione alternativa per questo problema, ricompilare il modello utilizzando Microsoft Visual C++ 2005, Microsoft Visual C++ 2008 o Microsoft Visual C++ 2010.
  
-   **Attivare** **Structured Exception Handling Overwrite Protection (SEHOP)**
  
    Per i sistemi Windows Vista, Windows 7, Windows Server 2008 e Windows Server 2008 R2, vedere [Come attivare Structured Exception Handling Overwrite Protection (SEHOP) nei sistemi operativi Windows](http://support.microsoft.com/kb/956607) per istruzioni sull'attivazione di SEHOP per le applicazioni esistenti.
  
#### Domande frequenti sulla vulnerabilità legata all'elusione di SafeSEH nel kernel di Windows - CVE-2012-0001
  
**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'elusione della funzione di protezione. Sfruttando questa vulnerabilità, un utente malintenzionato può ignorare la funzione di protezione SafeSEH per facilitare lo sfruttamento di altre vulnerabilità.
  
**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità è causata quando il kernel di Windows carica una tabella di gestione delle eccezioni strutturata nell'intestazione PE "Carica configurazione" durante l'esecuzione binaria.
...
Ntdll.dll è il componente interessato dalla vulnerabilità.
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**  
Sfruttando questa vulnerabilità un utente malintenzionato può ignorare la funzione di protezione SafeSEH in un'applicazione software. Un utente malintenzionato potrebbe quindi utilizzare altre vulnerabilità per sfruttare il gestore strutturato delle eccezioni in modo che esegua codice arbitrario.
  
**In quale modo un utente malintenzionato può sfruttare questa** **vulnerabilità?**  
Per utilizzare questa vulnerabilità per eseguire il codice arbitrario, un utente malintenzionato deve ignorare dapprima la funzione di protezione SafeSEH e sfruttare quindi questa condizione di elusione della protezione per sfruttare un'altra vulnerabilità ai fini di eseguire codice arbitrario.
  
**Che cos'è** **il** **gestore delle** **eccezioni** **strutturato?**  
Il gestore delle eccezioni strutturato (SEH) è un meccanismo in un'applicazione software per la gestione di eccezioni hardware e software. SEH consente ai programmatori di avere il controllo completo sulla gestione delle eccezioni, fornisce il supporto per i debugger ed è utilizzabile con tutti i linguaggi di programmazione e i computer.
  
**Che cos'è** **SafeSEH?**  
SafeSEH è una funzione di protezione che protegge il gestore delle eccezioni strutturato da danneggiamenti o prese di controllo in caso di un sovraccarico del buffer.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**  
Le workstation e i server sono entrambi a rischio.
  
**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve la vulnerabilità modificando il modo in cui il kernel di Windows carica le tabelle di gestione delle eccezioni strutturate.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2644615$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2644615">articolo della Microsoft Knowledge Base 2644615</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2644615$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2644615](http://support.microsoft.com/kb/2644615)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Joshua J. Drake di [Accuvant LABS](http://www.accuvant.com/) per aver segnalato la vulnerabilità legata all'elusione di SafeSEH nel kernel di Windows (CVE-2012-0001)
...
-   V1.1 (22 febbraio 2012): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2644615 nella sottosezione Problemi noti del Riepilogo.
