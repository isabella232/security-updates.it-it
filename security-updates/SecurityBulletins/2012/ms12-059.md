---
TOCTitle: 'MS12-059'
Title: 'Bollettino Microsoft sulla sicurezza MS12-059 - Importante'
ms:assetid: 'ms12-059'
ms:contentKeyID: 61240700
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms12-059(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS12-059 - Importante
==========================================================

Una vulnerabilità in Microsoft Visio può consentire l'esecuzione di codice in modalità remota (2733918)
-------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per le edizioni supportate di Microsoft Visio 2010 e Microsoft Visio Viewer 2010. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità modificando il modo in cui Microsoft Office Visio convalida i dati durante l'analisi di file Visio appositamente predisposti. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=de95d8b9-51a5-43cd-8ba3-8cbb1320d099">Microsoft Visio 2010 Service Pack 1 (edizioni a 32 bit)</a>[1]<br />
(KB2687508)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">L'aggiornamento KB2553374 nel bollettino <a href="http://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a> è stato sostituito dall'aggiornamento KB2597171 o KB2687508[2]</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=af690cd8-cb2c-4743-96f0-ffaec77adf10">Microsoft Visio 2010 Service Pack 1 (edizioni a 64 bit)</a>[1]<br />
(KB2687508)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">L'aggiornamento KB2553374 nel bollettino <a href="http://go.microsoft.com/fwlink/?linkid=225739">MS11-089</a> è stato sostituito dall'aggiornamento KB2597171 o KB2687508[2]</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=62e87f7b-f48e-43a7-86d7-cbb8f0603ea3">Microsoft Visio Viewer 2010 Service Pack 1 (edizioni a 32 bit)</a><br />
(KB2598287)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB2597981 in <a href="http://go.microsoft.com/fwlink/?linkid=248385">MS12-031</a> sostituita dalla soluzione KB2598287</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3889e1b3-69b2-4a8f-a0d9-de8c7dc6f5ec">Microsoft Visio Viewer 2010 Service Pack 1 (edizione a 64-bit)</a><br />
(KB2598287)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB2597981 in <a href="http://go.microsoft.com/fwlink/?linkid=248385">MS12-031</a> sostituita dalla soluzione KB2598287</td>
...
<sup>[1]</sup>Sebbene l'aggiornamento rilasciato nuovamente (KB2687508) sostituisca l'aggiornamento originale (KB2597171) per tutte le edizioni interessate di Microsoft Visio 2010, i clienti che hanno installato correttamente l'aggiornamento KB2597171 non devono installare l'aggiornamento KB2687508. Per ulteriori informazioni, vedere le Domande frequenti sull'aggiornamento.
  
<sup>[2]</sup>Aggiornamento di Microsoft Office, MS11-089, applicato ai sistemi che utilizzano Microsoft Visio 2010 nonostante questo software sia riportato come non interessato nel bollettino MS11-089.
...
Per risolvere un problema riguardante specifici certificati digitali che sono stati generati da Microsoft senza attributi di timestamp corretti, Microsoft ha rilasciato nuovamente questo bollettino per sostituire l'aggiornamento KB2597171 con l'aggiornamento KB2687508 per tutte le edizioni interessate di Microsoft Visio 2010. Per ulteriori informazioni, vedere [l'Advisory Microsoft sulla sicurezza 2749655](http://technet.microsoft.com/security/advisory/2749655).
  
Sebbene l'aggiornamento rilasciato (KB2687508) sostituisca l'aggiornamento originale (KB2687323), i clienti che hanno già installato correttamente l'aggiornamento originale non devono installare l'aggiornamento rilasciato nuovamente.
  
**È già stato installato l'aggiornamento** **KB2597171** **originale. È necessario applicare il pacchetto di aggiornamento (KB2687508) rilasciato nuovamente l'11 dicembre 2012?**  
No. L'aggiornamento rilasciato nuovamente (KB2687508) si applica solo ai sistemi che eseguono il software interessato se il corrispondente aggiornamento originale (KB2597171) non è già installato. I clienti che hanno già installato correttamente gli aggiornamenti originali non devono intraprendere alcuna azione e gli aggiornamenti rilasciati nuovamente non verranno offerti.
  
**Nota** Nel caso in cui l'aggiornamento originale sia già installato e in seguito venga installato l'aggiornamento rilasciato nuovamente sullo stesso sistema, il programma di installazione genera un messaggio che indica che l'aggiornamento è già installato. Dopo che il messaggio è stato generato, il numero KB per l'aggiornamento rilasciato nuovamente sostituirà il numero KB dell'aggiornamento originale nell'elenco degli aggiornamenti installati. Per ulteriori informazioni in merito, vedere l'[articolo della Microsoft Knowledge Base 2720573](http://support.microsoft.com/kb/2720573).
  
**Dove si trova la sezione Informazioni sui file?**  
Fare riferimento alle tabelle contenute nella sezione **Distribuzione dell'aggiornamento per la protezione** per individuare la sezione Informazioni sui file.
  
**Dove** **si trovano gli hash degli aggiornamenti per la** **protezione?**  
Gli hash SHA1 e SHA2 degli aggiornamenti per la protezione possono essere utilizzati per verificare l'autenticità dei pacchetti di aggiornamento per la protezione scaricati. Per le informazioni sugli hash pertinenti a questo aggiornamento, vedere [l'articolo della Microsoft Knowledge Base 2733918](http://support.microsoft.com/kb/2733918).
...
<th style="border:1px solid black;" >Vulnerabilità di overflow del buffer del formato file DXF di Visio - CVE-2012-1888</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
Vulnerabilità di overflow del buffer del formato file DXF di Visio - CVE-2012-1888  
----------------------------------------------------------------------------------
  
<span></span>
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può eseguire codice non autorizzato nel contesto dell'utente corrente. Se l'utente corrente è connesso con privilegi di amministratore, un utente malintenzionato può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2012-1888](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1888).
  
#### Fattori attenuanti per la vulnerabilità di overflow del buffer del formato file DXF di Visio - CVE-2012-1888
...
#### Soluzioni alternative per la vulnerabilità di overflow del buffer del formato file DXF di Visio - CVE-2012-1888
...
#### Domande frequenti sulla vulnerabilità di overflow del buffer del formato file DXF di Visio - CVE-2012-1888
...
I sistemi più esposti sono quelli che utilizzano Microsoft Office Visio, inclusi le workstation e i server terminal. I server possono essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento corregge la vulnerabilità modificando il modo in cui Microsoft Office Visio convalida i dati quando analizza file Visio appositamente predisposti.
...
| Microsoft Visio Viewer 2010 Service Pack 1 (edizioni a 32 bit) | No   |  
| Microsoft Visio Viewer 2010 Service Pack 1 (edizione a 64-bit) | No   |
...
| Microsoft Visio Viewer 2010 Service Pack 1 (edizioni a 32 bit) | No                | No                                  |  
| Microsoft Visio Viewer 2010 Service Pack 1 (edizione a 64-bit) | No                | No                                  |
...
#### Microsoft Visio 2010 e Microsoft Visio Viewer 2010 (tutte le edizioni)
...
<td style="border:1px solid black;">Per Microsoft Visio 2010, vedere<a href="http://support.microsoft.com/kb/2597171">l'articolo della Microsoft Knowledge Base 2597171</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft Visio Viewer 2010, vedere<a href="http://support.microsoft.com/kb/2598287">l'articolo della Microsoft Knowledge Base 2598287</a></td>
</tr>
<tr class="odd">
...
-   Alexander Gavrun, che ha collaborato con [Zero Day Initiative](http://www.zerodayinitiative.com/)[di TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/), per aver segnalato la vulnerabilità di overflow del buffer del formato file DXF di Visio (CVE-2012-1888)
...
-   V2.0 (11 dicembre 2012): Il bollettino è stato rilasciato nuovamente per sostituire l'aggiornamento KB2597171 con l'aggiornamento KB2687508 per tutte le edizioni interessate di Microsoft Visio 2010.
