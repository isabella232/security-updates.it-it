---
TOCTitle: 'MS10-027'
Title: 'Bollettino Microsoft sulla sicurezza MS10-027 - Critico'
ms:assetid: 'ms10-027'
ms:contentKeyID: 61240466
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-027(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-027 - Critico
=======================================================

Una vulnerabilità di Windows Media Player può consentire l'esecuzione di codice in modalità remota (979402)
-----------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato critico per Windows Media Player 9 Series installato su tutte le edizioni supportate di Microsoft Windows 2000 e Windows XP. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui il controllo ActiveX di Windows Media Player gestisce il contenuto multimediale appositamente predisposto ospitato su un sito Web dannoso. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4 | [Windows Media Player 9 Series](http://www.microsoft.com/downloads/details.aspx?familyid=c0b8b362-a321-4ac9-be98-15c71bb7a043) | Esecuzione di codice in modalità remota     | Critico                      | [MS07-047](http://technet.microsoft.com/security/bulletin/ms07-047) |
| Windows XP Service Pack 2             | [Windows Media Player 9 Series](http://www.microsoft.com/downloads/details.aspx?familyid=5c748c6d-84d1-45a9-8a33-9372eb5504d5) | Esecuzione di codice in modalità remota     | Critico                      | [MS07-047](http://technet.microsoft.com/security/bulletin/ms07-047) |
| Windows XP Service Pack 3             | [Windows Media Player 9 Series](http://www.microsoft.com/downloads/details.aspx?familyid=9e4277b4-2dc5-4163-a6aa-7e07dd32b721) | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                                             |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'esecuzione di codice in modalità remota di Media Player - CVE-2010-0268</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 9 Series installato in Microsoft Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 9 Series per Windows XP Service Pack 2</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 9 Series per Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
...
Vulnerabilità legata all'esecuzione di codice in modalità remota di Media Player - CVE-2010-0268  
------------------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'esecuzione di codice in modalità remota nel controllo ActiveX di Windows Media Player. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-0268](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0268).
  
#### Fattori attenuanti per la vulnerabilità legata all'esecuzione di codice in modalità remota di Media Player - CVE-2010-0268
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.  
-   In uno scenario di attacco dal Web un utente malintenzionato deve pubblicare un sito Web contenente una pagina utilizzata per sfruttare la vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare un sito Web dannoso, l'utente malintenzionato dovrebbe convincere le vittime a visitare il sito Web, in genere inducendole a fare clic su un collegamento che le indirizzi al sito Web di origine dell'attacco.  
...
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di codice in modalità remota di Media Player - CVE-2010-0268
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Evitare l'esecuzione del controllo Activex di Windows Media Player in Internet Explorer**
  
    È possibile disabilitare ogni tentativo di creare un'istanza del controllo ActiveX di Windows Media Player in Internet Explorer impostando il kill bit per il controllo nel Registro di sistema.
    ...
    **Nota** Prima di apportare eventuali modifiche è consigliabile eseguire il backup del Registro di sistema.
    ...
    Per evitare l'esecuzione del controllo ActiveX in Internet Explorer, attenersi alla seguente procedura:
  
    1.  Salvare quanto segue in un file con estensione REG, ad esempio Disable\_WMP.reg:  
        ...
        `"Compatibility Flags"=dword:00000400`  
    2.  Eseguire lo script del Registro di sistema riportato sopra nel computer di destinazione utilizzando uno dei seguenti metodi:  
        Per il metodo interattivo, fare doppio clic sul file **Disable\_WMP.reg** in qualità di amministratore.  
        Per il metodo di distribuzione gestita, eseguire il comando seguente:  
        `Regedit.exe /s Disable_WMP.reg `  
        Inoltre, è possibile applicare le modifiche al registro di sistema in domini diversi utilizzando i Criteri di gruppo. Per ulteriori informazioni sui Criteri di gruppo, visitare i seguenti siti Web Microsoft:  
    ...
    **Impatto della soluzione alternativa.** Gli utenti non potranno avviare il controllo ActiveX di Windows Media Player dalle pagine Web. Di conseguenza, il contenuto di Windows Media Player non esegue il rendering in una pagina Web.
  
    **Per annullare il risultato della soluzione alternativa.**
  
    1.  Salvare quanto segue in un file con estensione REG, ad esempio Enable\_WMP.reg:  
        `Editor del Registro di sistema di Windows versione 5.00 `  
        `[-HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\ActiveX Compatibility\{6BF52A52-394A-11d3-B153-00C04F79FAA6}] `  
        `[-HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\ActiveX Compatibility\{6BF52A52-394A-11d3-B153-00C04F79FAA6}] `  
    2.  Eseguire lo script del Registro di sistema riportato sopra nel computer di destinazione utilizzando uno dei seguenti metodi:  
        Per il metodo interattivo, fare doppio clic sul file **Enable\_WMP.reg** in qualità di amministratore.  
        Per il metodo di distribuzione gestita, eseguire il comando seguente:  
...
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di codice in modalità remota di Media Player - CVE-2010-0268
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata al codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
Questa vulnerabilità esiste perché il controllo ActiveX di Windows Media Player non gestisce correttamente il contenuto multimediale appositamente predisposto ospitato su un sito Web dannoso.
...
Per le istruzioni su come determinare la versione di Windows Media Player installata nel sistema, consultare [l'articolo della Microsoft Knowledge Base](http://support.microsoft.com/kb/190990) 190990.
...
Un utente malintenzionato potrebbe ospitare un sito Web dannoso che ospita il contenuto multimediale appositamente predisposto per sfruttare questa vulnerabilità attraverso Internet Explorer. Quindi, convince un utente a visualizzare il sito Web e ad aprire il contenuto multimediale appositamente predisposto.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi che eseguono il software interessato sono maggiormente a rischio.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità modificando il modo in cui il controllo ActiveX di Windows Media Player gestisce il contenuto multimediale appositamente predisposto ospitato su un sito Web dannoso.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB979402_WM9L$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/979402">articolo della Microsoft Knowledge Base 979402</a></td>
</tr>
<tr class="even">
...
<br />
Per Windows XP Service Pack 3:<br />
...
<br />
Per Windows XP Service Pack 2:<br />
Cartella %Windir%\$NTUninstallKB979402_WM9L$\Spuninst<br />
<br />
Per Windows XP Service Pack 3:<br />
Cartella %Windir%\$NTUninstallKB979402_WM9$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/979402">articolo della Microsoft Knowledge Base 979402</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo della chiave del Registro di sistema</strong></td>
<td style="border:1px solid black;">Per Windows XP Service Pack 2, entrambe le chiavi seguenti vengono create:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Player\SP0\KB979402_WM9L\Filelist<br />
<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Player\KB979402_WM9L<br />
<br />
Per Windows XP Service Pack 3, entrambe le chiavi seguenti vengono create:<br />
...
-   Un ricercatore anonimo, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/)[di TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata all'esecuzione di codice in modalità remota di Media Player (CVE-2010-0268)
