---
TOCTitle: 'MS10-048'
Title: 'Bollettino Microsoft sulla sicurezza MS10-048 - Importante'
ms:assetid: 'ms10-048'
ms:contentKeyID: 61240487
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-048(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-048 - Importante
==========================================================

Alcune vulnerabilità nei driver in modalità kernel di Windows possono consentire l'acquisizione di privilegi più elevati (2160329)
----------------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui i driver in modalità kernel di Windows gestiscono le eccezioni, allocano la memoria e convalidano gli argomenti di chiamata di sistema, l'input in modalità utente e i nuovi parametri di callback delle finestre. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|----------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=deeac521-d3a2-4019-8176-c9228e733cf4)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d6c5455e-bc31-4842-aef4-ebff92324323)                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=59395f00-90f4-4b68-8dd3-03ff611c1bc8)                                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9ef1c600-bb93-4800-81b8-8c64b369c194)                                                       | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f96b8154-9976-41b0-b9d7-d79887fe9364)                                                      | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c9345207-7242-4b71-bf80-b52031e08f8c)                                          | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1620e7ac-3913-478d-8120-e9f46d98f453)                  | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a8b1a3f7-7147-494e-bfc0-b1979b9578e6)\* | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c1c25cb7-7e82-4c14-9666-aff52dd308b4)\*           | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=45fe5135-aa89-4f60-8cdb-ec0edc9a7e77)     | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=68bddf4b-b597-477e-80e4-9293d7160496)                                                                       | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=5ff09e03-d662-4b23-ab26-d25ca2ba58df)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=6bbc9cb1-0b59-4473-adf9-2ce2f0f94c0a)\*                                                             | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2543191a-09cb-4417-bbb2-aac4d9a2a756)                                                           | Acquisizione di privilegi più elevati       | Importante                   | [MS10-032](http://technet.microsoft.com/it-it/security/default.aspx) |
...
Sì. Oltre alle modifiche elencate nella sezione Dettagli delle vulnerabilità del presente bollettino, questo aggiornamento contiene misure di difesa che correggono potenziali overflow dei valori interi in scenari non realistici a causa di restrizioni di memoria. Queste modifiche al sistema di difesa sono valide solo per sistemi a 64 bit. Anche se non esiste uno scenario realistico in cui un utente malintenzionato possa incontrare le condizioni necessarie per sfruttare questi problemi, Microsoft ha deciso di correggere il codice per evitare che in futuro si verifichino inconvenienti in queste aree specifiche.
...
<th style="border:1px solid black;" >Vulnerabilità legata al controllo dei limiti in Win32k - CVE-2010-1887</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla gestione delle eccezioni in Win32k - CVE-2010-1894</th>
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow del pool in Win32k - CVE-2010-1895</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla convalida dell'input utente in Win32k - CVE-2010-1896</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-1897</th>
...
Vulnerabilità legata al controllo dei limiti in Win32k - CVE-2010-1887  
----------------------------------------------------------------------
  
<span></span>
È stata rilevata una vulnerabilità ad attacchi di tipo Denial of Service nei driver in modalità kernel di Windows a causa dell'errata convalida di un argomento inviato a una chiamata di sistema. Un utente malintenzionato potrebbe sfruttare la vulnerabilità eseguendo un'applicazione appositamente predisposta che causa il blocco e il riavvio automatico del sistema.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1887](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1887).
  
#### Fattori attenuanti della vulnerabilità legata al controllo dei limiti in Win32k - CVE-2010-1887
...
#### Soluzioni alternative per la vulnerabilità legata al controllo dei limiti in Win32k - CVE-2010-1887
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al controllo dei limiti in Win32k - CVE-2010-1887
...
I driver in modalità kernel di Windows non convalidano correttamente un argomento inviato a una chiamata di sistema.
...
L'aggiornamento risolve questa vulnerabilità correggendo il modo in cui i driver in modalità kernel di Windows convalidano l'argomento inviato alla chiamata di sistema.
...
Vulnerabilità legata alla gestione delle eccezioni in Win32k - CVE-2010-1894  
----------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui i driver in modalità kernel di Windows gestiscono determinate eccezioni. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1894](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1894).
  
#### Fattori attenuanti della vulnerabilità legata alla gestione delle eccezioni in Win32k - CVE-2010-1894
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alla gestione delle eccezioni in Win32k - CVE-2010-1894
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla gestione delle eccezioni in Win32k - CVE-2010-1894
...
**Quali sono le cause di questa vulnerabilità?**    
I driver in modalità kernel di Windows non gestiscono correttamente determinate eccezioni.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità assicurando che i driver in modalità kernel di Windows gestiscano correttamente l'eccezione.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-1894](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1894).
  
**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**    
No. Al momento della pubblicazione del presente bollettino, Microsoft non aveva ricevuto alcuna segnalazione in merito allo sfruttamento di questa vulnerabilità a scopo di attacco.
  
Vulnerabilità legata all'overflow del pool in Win32k - CVE-2010-1895  
--------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati poiché i driver in modalità kernel di Windows non allocano correttamente la memoria quando si crea una copia in modalità utente. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1895](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1895).
  
#### Fattori attenuanti della vulnerabilità legata all'overflow del pool in Win32k - CVE-2010-1895
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata all'overflow del pool in Win32k - CVE-2010-1895
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'overflow del pool in Win32k - CVE-2010-1895
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
I driver in modalità kernel di Windows non collocano correttamente la memoria quando si copiano i dati in modalità utente.
...
Vulnerabilità legata alla convalida dell'input utente in Win32k - CVE-2010-1896  
-------------------------------------------------------------------------------
  
<span></span>
Nei driver in modalità kernel di Windows è stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta a una errata convalida dell'input inviato in modalità utente. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1896](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1896).
  
#### Fattori attenuanti della vulnerabilità legata alla convalida dell'input utente in Win32k - CVE-2010-1896
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alla convalida dell'input utente in Win32k - CVE-2010-1896
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla convalida dell'input utente in Win32k - CVE-2010-1896
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
I driver in modalità kernel di Windows non convalidano correttamente l'input inviato in modalità utente.
...
Vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-1897  
-------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati causata dal fatto che i driver in modalità kernel di Windows non convalidano correttamente tutti i parametri durante la creazione di una nuova finestra. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1897).
  
#### Fattori attenuanti della vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-1897
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-1897
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-1897
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
I driver in modalità kernel di Windows non convalidano correttamente gli pseudo-handle nei parametri di callback durante la creazione di una nuova finestra.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve questa vulnerabilità correggendo il modo in cui i driver in modalità kernel di Windows convalidano gli pseudo-handle nei parametri di callback durante la creazione di una nuova finestra.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2160329$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2160329">articolo della Microsoft Knowledge Base 2160329</a></td>
</tr>
<tr class="even">
...
-   Tavis Ormandy di [Google, Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata al controllo dei limiti in Win32k (CVE-2010-1887)  
-   Matthieu Suiche di [MoonSols](http://moonsols.com/) per aver segnalato la vulnerabilità legata all'overflow del pool in Win32k (CVE-2010-1895)  
-   Matthieu Suiche di [MoonSols](http://moonsols.com/) per aver segnalato la vulnerabilità legata alla convalida dell'input utente in Win32k (CVE-2010-1896)  
-   Matthieu Suiche di [MoonSols](http://moonsols.com/) per aver collaborato alle modifiche al sistema di difesa descritte in questo bollettino  
-   Nicolas Economou di [Core Security Technologies](http://www.coresecurity.com/) per aver segnalato la vulnerabilità legata alla creazione di finestre in Win32k (CVE-2010-1897)
