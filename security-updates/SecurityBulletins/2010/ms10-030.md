---
TOCTitle: 'MS10-030'
Title: 'Bollettino Microsoft sulla sicurezza MS10-030 - Critico'
ms:assetid: 'ms10-030'
ms:contentKeyID: 61240469
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-030(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-030 - Critico
=======================================================

La vulnerabilità in Outlook Express e Windows Mail può consentire l'esecuzione di codice in modalità remota (978542)
--------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello critico per Microsoft Outlook Express in tutte le edizioni supportate di Microsoft Windows 2000, Windows XP e Windows Server 2003 oltre che per Windows Mail in tutte le edizioni supportate di Windows Vista e Windows Server 2008. Questo aggiornamento per la protezione è considerato di livello importante per Windows Live Mail in tutte le edizioni supportate di Windows XP, Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità convalidando correttamente le risposte del server di posta elettronica. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<span></span>
**Perché questa vulnerabilità è considerata di livello importante in Windows 7 e Windows Server 2008 R2?**    
In Windows 7 e Windows Server 2008 R2, Windows Live Mail è un componente preconfigurato che non viene installato per impostazione predefinita. Un utente dovrebbe installare l'applicazione separatamente per essere interessato da questo problema. Tuttavia, il codice vulnerabile è presente nel computer in un'installazione predefinita nel file inetcomm.dll, pertanto l'installazione di questo aggiornamento risolve la vulnerabilità indipendentemente dal fatto che il vettore di attacco esista o meno.
  
**Se si utilizza Windows 7 o Windows Server 2008 R2 senza Windows Live Mail installato, perché viene comunque offerto questo aggiornamento per la protezione?**    
Questa vulnerabilità è presente in inetcomm.dll, un componente principale del sistema operativo. Tuttavia, il solo vettore di attacco è attraverso l'uso di Windows Live Mail. Continua a essere offerto questo aggiornamento per la protezione quale aggiornamento di difesa in profondità per risolvere completamente la vulnerabilità del sistema.
...
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow dei valori integer in Outlook Express e Windows Mail - CVE-2010-0816</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 5.5 Service Pack 2 in Microsoft Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Outlook Express 6 Service Pack 1 installato in Microsoft Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 6 in Windows XP Service Pack 2 e Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows XP Service Pack 2 e Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 6 in Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 6 in Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Outlook Express 6 in Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 6 in Windows Server 2003 con SP2 per sistemi Itanium</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail in Windows Vista Service Pack 1 e Windows Vista Service Pack 2</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows Vista Service Pack 1 e Windows Vista Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail in Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail in Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2**</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2**</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail in Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2**</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2**</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail in Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2</td>
<td style="border:1px solid black;"><strong>Critico</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Critico</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows 7 per sistemi a 32 bit</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows 7 per sistemi x64</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows Server 2008 R2 per sistemi x64**</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail se installato in Windows Server 2008 R2 per sistemi Itanium</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
...
Vulnerabilità legata all'overflow dei valori integer in Outlook Express e Windows Mail - CVE-2010-0816  
------------------------------------------------------------------------------------------------------
  
<span></span>
Una vulnerabilità legata all'esecuzione di codice in modalità remota da parte di utenti non autenticati è stata riscontrata nel modo in cui il client di Windows Mail gestisce le risposte di posta appositamente predisposte. Poiché non viene richiesta l'autenticazione, un utente malintenzionato può sfruttare tale vulnerabilità inviando una risposta appositamente predisposta a un client che inizia una connessione a un server sotto il suo controllo utilizzando i protocolli di posta comune POP3 e IMAP.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-0816](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0816).
  
#### Fattori attenuanti della vulnerabilità legata all'overflow dei valori integer in Outlook Express e Windows Mail - CVE-2010-0816
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.  
-   Un utente malintenzionato non può inviare un messaggio di posta elettronica dannoso per attivare questa vulnerabilità.  
-   I clienti che utilizzano la crittografia SSL con i protocolli POP3 o IMAP non sono più vulnerabili agli attacchi di tipo "man-in-the-middle" che sfruttano questa vulnerabilità; ne sono interessati solo se il client viene indotto a collegarsi a un server di posta elettronica dannoso o compromesso.
  
#### Soluzioni alternative per la vulnerabilità legata all'overflow dei valori integer in Outlook Express e Windows Mail - CVE-2010-0816
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Quando possibile, utilizzare il servizio di posta elettronica basato su web**
  
    Se disponibile, utilizzare il servizio di posta elettronica basato su Web anziché i protocolli IMAP o POP3 per controllare la posta.
  
#### Domande frequenti sulla vulnerabilità legata all'overflow dei valori integer in Outlook Express e Windows Mail - CVE-2010-0816
...
La vulnerabilità si verifica quando una libreria comune utilizzata da Outlook Express e Windows Mail convalida in modo insufficiente i dati di rete prima di utilizzarli per calcolare la dimensione necessaria di un buffer.
...
**Che cosa sono i protocolli di posta POP3 e IMAP?**    
I server Post Office Protocol 3 (POP3) mantengono i messaggi di posta elettronica in entrata fino a quando non vengono controllati; dopodiché sono trasferiti al computer dell'utente. POP3 è il tipo di account più comune per la posta elettronica personale. Generalmente i messaggi vengono eliminati dal server non appena viene controllata la posta elettronica. Internet Message Access Protocol 4 (IMAP4) è un protocollo per la lettura della posta e per l'accesso alle cartelle pubbliche sui server remoti. I client possono accedere a un server di posta e utilizzare il protocollo IMAP4 per scaricare le intestazioni dei messaggi e successivamente leggere i singoli messaggi mentre sono online.
...
Un utente malintenzionato può sfruttare questa vulnerabilità creando un server di posta elettronica dannoso e convincendo il client a collegarsi al computer. Quindi, una volta inviata la risposta utilizzando un POP3 o IMAP predisposto, il client attiva la vulnerabilità. In alternativa, un "man-in-the-middle" può modificare risposte di server specifiche perché la vulnerabilità venga attivata.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi desktop utilizzati per archiviare e leggere la posta elettronica sono particolarmente esposti a questa vulnerabilità.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve questa vulnerabilità convalidando correttamente le risposte restituite dal server di posta elettronica prima dell'elaborazione.
...
<td style="border:1px solid black;">Per Microsoft Outlook Express 5.5 Service Pack 2 in Microsoft Windows 2000 Service Pack 4:<br />
OE5.5sp2-KB978542-Windows2000-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft Outlook Express 6 Service Pack 1 se installato in Microsoft Windows 2000 Service Pack 4:<br />
...
<td style="border:1px solid black;">Per Microsoft Outlook Express 5.5 Service Pack 2 in Microsoft Windows 2000 Service Pack 4:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB978542-OE55SP2-20100202.120000$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft Outlook Express 6 Service Pack 1 se installato in Microsoft Windows 2000 Service Pack 4:<br />
Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB978542-OE6SP1-20100202.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/978542">articolo della Microsoft Knowledge Base 978542</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB978542$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/978542">articolo della Microsoft Knowledge Base 978542</a></td>
...
-   Francis Provencher di Protek Research Lab per aver segnalato la vulnerabilità legata all'overflow dei valori integer nel client di Windows Mail (CVE-2010-0816)
...
-   V1.1 (12 maggio 2010): Sono stati corretti i requisiti di riavvio di Microsoft Windows 2000, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2. Inoltre, è stato corretto il controllo della chiave del Registro di sistema per Microsoft Outlook Express 6 Service Pack 1 quando viene installato in Microsoft Windows 2000 Service Pack 4.  
-   V1.2 (19 maggio 2010): Sono stati rimossi i riferimenti non corretti a Windows Mail in Windows 7 e Windows Server 2008 R2. Inoltre, sono state corrette le informazioni da sostituire nel bollettino per i pacchetti di aggiornamento di Windows XP, Windows Server 2003 e Windows Vista. La modifica è esclusivamente informativa. Per i clienti che hanno già installato l'aggiornamento non è necessario eseguire una nuova installazione.
