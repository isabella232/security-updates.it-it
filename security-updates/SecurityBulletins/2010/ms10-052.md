---
TOCTitle: 'MS10-052'
Title: 'Bollettino Microsoft sulla sicurezza MS10-052 - Critico'
ms:assetid: 'ms10-052'
ms:contentKeyID: 61240491
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-052(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-052 - Critico
=======================================================

Una vulnerabilità nel codec MPEG Layer-3 Microsoft può consentire l'esecuzione di codice in modalità remota (2115168)
---------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello critico per tutte le edizioni supportate di Windows XP e Windows Server 2003 (eccetto le edizioni supportate basate su Itanium). Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui i codec audio MPEG Layer-3 Microsoft decodificano il flusso audio MPEG Layer-3 in file multimediali appositamente predisposti. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=08159149-17de-4640-8818-cb7bd4811531)                          | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b7f28d7a-6b27-4059-865b-5fd55edb6299) | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9c2110ec-7e6c-4e73-9785-0a8196095ea0)                 | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fdfad4ca-37c4-4ac5-bebc-a5ad61299503)     | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow del buffer del decodificatore audio MPEG Layer-3 - CVE-2010-1882</th>
...
Vulnerabilità legata all'overflow del buffer del decodificatore audio MPEG Layer-3 - CVE-2010-1882  
--------------------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui il filtro MP3 di Microsoft DirectShow gestisce i file dei formati supportati. Tale vulnerabilità può consentire l'esecuzione di codice durante l'apertura di un file audio appositamente predisposto. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1882](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1882).
  
#### Fattori attenuanti per la vulnerabilità legata all'overflow del buffer del decodificatore audio MPEG Layer-3 - CVE-2010-1882
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow del buffer del decodificatore audio MPEG Layer-3 - CVE-2010-1882
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Annullare la registrazione di l3codecx.ax**
  
    Nei sistemi Windows XP e Windows Server 2003, eseguire i comandi indicati di seguito dal prompt dei comandi.
...
-   **Negare l'accesso a l3codecx.ax**
...
-   **Disattivare l'analisi dei file MPEG Layer-3 in DirectShow**
  
    Se si rimuove la chiave del Registro di sistema indicata di seguito, verrà disattivata l'analisi dei file MPEG Layer-3 nelle applicazioni che utilizzano DirectShow per riprodurre contenuti in formato MPEG Layer-3.
    ...
    **Utilizzo del metodo interattivo**
    ...
    4.  Nella finestra di dialogo Esporta file del Registro di sistema, digitare **MP3\_Parser\_Backup.reg** e fare clic su **Salva**.  
    ...
    3.  Scegliere **Esporta** dal menu **File**.  
    4.  Nella finestra di dialogo Esporta file del Registro di sistema, digitare **MP3\_Parser\_Backup1.reg** e fare clic su **Salva**.  
        **Nota** Questa procedura crea per impostazione predefinita un backup della chiave del Registro di sistema nella cartella Documenti.  
    5.  Premere il tasto **CANC** sulla tastiera per eliminare la chiave del Registro di sistema. Quando viene richiesto di eliminare la chiave del Registro di sistema nella finestra di dialogo **Conferma eliminazione chiave**, selezionare Sì.  
    6.  Fare clic sul pulsante **Start**, scegliere **Esegui**, digitare **Regedit** nella casella **Apri** e fare clic su **OK**.  
    7.  Individuare la sottochiave seguente:  
        HKEY\_CLASSES\_ROOT\\Wow6432Node\\CLSID\\{38BE3000-DBF4-11D0-860E-00A024CFEF6D}  
    8.  Scegliere **Esporta** dal menu **File**.  
    9.  Nella finestra di dialogo Esporta file del Registro di sistema, digitare **MP3\_Parser\_Backup2.reg** e fare clic su **Salva**.  
        **Nota** Questa procedura crea per impostazione predefinita un backup della chiave del Registro di sistema nella cartella Documenti.  
    ...
    **Utilizzo di uno script di distribuzione gestita**
    ...
    2.  Salvare, quindi, quanto segue in un file con estensione REG, ad esempio Disable\_MP3\_Parser.reg:  
        **Per i sistemi Windows a 32 bit**:  
    ...
    **Utilizzo del metodo interattivo**
    ...
    3.  Nella finestra di dialogo Importa file del Registro di sistema, selezionare **MP3\_Parser\_Backup.reg** e fare clic su **Apri**.
  
    Per i sistemi Windows a 64 bit:
  
    1.  Fare clic sul pulsante **Start**, scegliere **Esegui**, digitare **Regedit** nella casella **Apri** e fare clic su **OK**.  
    2.  Fare clic sul menu **File** e selezionare **Importa**.  
    3.  Nella finestra di dialogo Importa file del Registro di sistema, selezionare **MP3\_Parser\_Backup1.reg** e fare clic su **Apri**.  
    4.  Nella finestra di dialogo Importa file del Registro di sistema, selezionare **MP3\_Parser\_Backup2.reg** e fare clic su **Apri**.
...
#### Domande frequenti sulla vulnerabilità legata all'overflow del buffer del decodificatore audio MPEG Layer-3 - CVE-2010-1882
...
I codec audio MPEG Layer-3 Microsoft non gestiscono correttamente i file multimediali appositamente predisposti che contengono un flusso audio MPEG Layer-3.
  
**Quali sono i codec audio MPEG Layer-3 Microsoft vulnerabili?**    
Il codec audio MPEG Layer-3 vulnerabile è quello per Microsoft DirectShow (l3codecx.ax). Questo codec audio MPEG Layer-3 fa parte di Windows Media e del sistema operativo Windows.
...
In uno scenario di attacco tramite posta elettronica, l'utente malintenzionato potrebbe sfruttare la vulnerabilità inviando all'utente un file multimediale (in cui è stato incorporato un file multimediale appositamente predisposto) e convincendo l'utente ad aprire il file.
...
L'aggiornamento risolve il problema correggendo il modo in cui i codec audio MPEG Layer-3 Microsoft gestiscono il flusso audio MPEG Layer-3 in file multimediali appositamente predisposti.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2115168$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2115168">articolo della Microsoft Knowledge Base 2115168</a></td>
</tr>
<tr class="even">
...
-   Moritz Jodeit di n.runs AG, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata all'overflow del buffer del decodificatore audio MPEG Layer-3 (CVE-2010-1882).
