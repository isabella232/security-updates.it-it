---
TOCTitle: 'MS10-005'
Title: 'Bollettino Microsoft sulla sicurezza MS10-005 - Medio'
ms:assetid: 'ms10-005'
ms:contentKeyID: 61240444
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-005(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-005 - Medio
=====================================================

Una vulnerabilità in Microsoft Paint può consentire l'esecuzione di codice in modalità remota (978706)
------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello moderato per Microsoft Windows 2000, Windows XP e Windows Server 2003. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno di questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui Microsoft Paint decodifica i file di immagine JPEG. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=e5861705-8f49-45cb-8a92-cf052ccf4134)                 | Esecuzione di codice in modalità remota     | Moderato                     | Nessuno                                       |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b2e70df6-7728-4fc3-8df7-8ddb9ba5202f) | Esecuzione di codice in modalità remota     | Moderato                     | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8c4acc8-c2f4-41f7-9b32-e7bd791e0155)    | Esecuzione di codice in modalità remota     | Moderato                     | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c1efbe73-fc87-4e6a-8b36-81f125a27aec)                    | Esecuzione di codice in modalità remota     | Moderato                     | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9143e435-f0d6-464b-9273-4d1f38f8ff3a)        | Esecuzione di codice in modalità remota     | Moderato                     | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ee603435-26af-4ab9-9f22-92734346dc0a)       | Esecuzione di codice in modalità remota     | Moderato                     | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow dei valori integer in MS Paint - CVE-2010-0028</th>
...
Vulnerabilità legata all'overflow dei valori integer in MS Paint - CVE-2010-0028  
--------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Paint decodifica le immagini JPEG. Tale vulnerabilità può consentire l'esecuzione di codice in modalità remota se un utente apre in Microsoft Paint un file di immagine JPEG appositamente predisposto. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028).
  
#### Fattori attenuanti della vulnerabilità legata all'overflow dei valori integer in MS Paint - CVE-2010-0028
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per impostazione predefinita, quando un utente fa doppio clic su un file JPEG, il file viene aperto nel Visualizzatore immagini e fax per Windows. Per sfruttare la vulnerabilità, un utente malintenzionato deve convincere l'utente ad aprire il file appositamente predisposto in Microsoft Paint.  
-   Un utente malintenzionato può inviare il file appositamente predisposto come allegato in un messaggio di posta elettronica, ma l'utente malintenzionato deve convincere l'utente ad aprire l'allegato in Microsoft Paint per sfruttare la vulnerabilità.  
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
#### Soluzioni alternative per la vulnerabilità legata all'overflow dei valori integer in MS Paint- CVE-2010-0028
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Disattivazione di Microsoft Paint**
  
    Per i sistemi Windows a 32 bit, eseguire il comando seguente dal prompt dei comandi:
  
    `cacls %SystemRoot%\system32\mspaint.exe /E /P everyone:N`
  
    Per i sistemi Windows a 64 bit, eseguire il comando seguente dal prompt dei comandi:
  
    `cacls %SystemRoot%\SysWOW64\mspaint.exe /E /P everyone:N`
  
    **Impatto della soluzione alternativa.** Gli utenti non possono eseguire Microsoft Paint.
  
    **Per annullare il risultato della soluzione alternativa.**
  
    Per i sistemi Windows a 32 bit, eseguire il comando seguente dal prompt dei comandi:
  
    `il cacls %SystemRoot%\system32\mspaint.exe /E /R tutti`
  
    Per i sistemi Windows a 64 bit, eseguire il comando seguente dal prompt dei comandi:
  
    `il cacls %SystemRoot%\SysWOW64\mspaint.exe /E /R tutti`
  
-   **In Windows XP e Windows Server 2003, eliminare Microsoft Paint**
  
    1.  Nel **Pannello di controllo** aprire **Installazione applicazioni**.  
    2.  Fare clic su **Installazione componenti di Windows**.  
    3.  In **Aggiunta guidata componenti di Windows**, selezionare **Accessori e utilità** e fare clic su **Dettagli**.  
    4.  Selezionare **Accessori** e fare clic su **Dettagli**.  
    5.  Deselezionare la casella di controllo **Paint** e fare clic due volte su **OK**.  
    6.  In **Aggiunta guidata componenti di Windows**, assicurarsi che la casella di controllo **Accessori e utilità** sia deselezionata e fare clic su **Avanti**.  
    7.  Quando la rimozione dei file è stata completata, fare clic su **Fine** per uscire dalla procedura guidata.
  
    **Effetto della soluzione alternativa.** Gli utenti non possono eseguire Microsoft Paint.
  
    **Per annullare il risultato della soluzione alternativa.** Reinstallare Microsoft Paint utilizzando Aggiunta guidata componenti di Windows in Installazione applicazioni.
  
#### Domande frequenti sulla vulnerabilità legata all'overflow dei valori integer in MS Paint - CVE-2010-0028
...
Questa vulnerabilità è causata dal danneggiamento della memoria durante la decodifica di immagini JPEG elaborate da Microsoft Paint.
  
**Che cos'è Microsoft Paint?**    
Microsoft Paint è uno strumento utilizzato per creare disegni semplici o elaborati. Inoltre, Microsoft Paint può essere utilizzato per visualizzare e modificare le foto acquisite mediante scansione.
...
Questa vulnerabilità può essere sfruttata solo se un utente apre o visualizza un file di immagine appositamente predisposto. Un utente malintenzionato deve inviare un file di immagine JPEG appositamente predisposto all'utente e convincerlo ad aprirlo con Microsoft Paint.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
Questa vulnerabilità può essere sfruttata solo se un utente è connesso ed utilizza Microsoft Paint per modificare o visualizzare le immagini JPEG. Pertanto, tutti i sistemi che consentono la lettura di messaggi di posta elettronica, l'uso intensivo di Internet Explorer o l'accesso a condivisioni di rete, come le workstation o i server terminal, sono maggiormente esposti a questa vulnerabilità.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento rimuove la vulnerabilità modificando il modo in cui Microsoft Paint decodifica i file di immagine JPEG.
...
| **Distribuzione**                                  |                                                                                                                                                                   |  
| Installazione senza intervento dell'utente         | Windows2000-KB978706-x86-enu /quiet                                                                                                                               |  
| Installazione senza riavvio                        | Windows2000-KB978706-x86-enu /norestart                                                                                                                           |  
| Aggiornamento del file di registro                 | KB978706.log                                                                                                                                                      |  
...
| **Informazioni per la rimozione**                  | Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB978706$\\Spuninst |  
| **Informazioni sui file**                          | Consultare l'[articolo della Microsoft Knowledge Base 978706](http://support.microsoft.com/kb/978706)                                                             |  
| **Controllo della chiave del Registro di sistema** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB978706\\Filelist                                                                         |
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB978706$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/978706">articolo della Microsoft Knowledge Base 978706</a></td>
</tr>
<tr class="even">
...
-   Tielei Wang dell'ICST-ERCIS (Engineering Research Center of Info Security, Institute of Computer Science & Technology, Peking University/China), che collabora con [Secunia](http://secunia.com/), per aver segnalato la vulnerabilità legata all'overflow dei valori integer in MS Paint (CVE-2010-0028)
