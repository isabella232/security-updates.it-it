---
TOCTitle: 'MS10-059'
Title: 'Bollettino Microsoft sulla sicurezza MS10-059 - Importante'
ms:assetid: 'ms10-059'
ms:contentKeyID: 61240498
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-059(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-059 - Importante
==========================================================

Alcune vulnerabilità presenti nella funzionalità Traccia per Services può consentire l'acquisizione di privilegi più elevati (982799)
-------------------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui vengono ottenuti i token e viene calcolata la lunghezza di una stringa letta nel Registro di sistema. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfb31aa2-7457-4581-9e28-7984a360edf4)                                          | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=110f932f-d13c-4486-a295-e6068d5d8d7a)                  | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c9b3e60-e166-40c9-8938-3cba0a399c47)\* | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fa84e547-2190-402f-9467-2450deeff565)\*           | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=84f89dca-108c-4956-9aa2-866e17a872fc)     | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=ce6233f3-2ee5-4329-908d-ba9b28ecc553)                                                                       | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=146270fa-cd6f-440a-aa3e-e93af0bff447)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=333fb6e4-f867-4dcb-beb3-2d88e428ca2e)\*                                                             | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=62034ecb-a6bd-46c5-a03d-9642880bc2d6)                                                           | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'ACL (elenco di controllo di accesso) delle chiavi del Registro di sistema per la funzionalità di traccia - CVE-2010-2554</th>
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria per la funzionalità di traccia - CVE-2010-2555</th>
...
Vulnerabilità legata all'ACL (elenco di controllo di accesso) delle chiavi del Registro di sistema per la funzionalità di traccia - CVE-2010-2554  
-------------------------------------------------------------------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati quando Windows colloca degli elenchi di controllo di accesso (ACL) errati sulle chiavi del Registro di sistema per la funzionalità Traccia per Services. Questa vulnerabilità potrebbe consentire a un utente malintenzionato di eseguire codice con privilegi elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554).
  
#### Fattori attenuanti della vulnerabilità legata all'ACL (elenco di controllo di accesso) delle chiavi del Registro di sistema per la funzionalità di traccia - CVE-2010-2554
...
#### Soluzioni alternative per la vulnerabilità legata all'ACL (elenco di controllo di accesso) delle chiavi del Registro di sistema per la funzionalità di traccia - CVE-2010-2554
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata agli ACL delle chiavi del Registro di sistema per la funzionalità di traccia - CVE-2010-2554
...
La vulnerabilità viene riscontrata quando Windows colloca degli elenchi di controllo di accesso (ACL) errati sulle chiavi del Registro di sistema per la funzionalità Traccia per Services. Ciò consente ad un utente malintenzionato di modificare la directory della funzionalità di traccia in una named pipe e di creare un listener al suo interno. Una volta creata la named pipe, l'utente malintenzionato può impersonarla per ottenere i token del servizio che crea la named pipe. Se il creatore è in esecuzione nel contesto del sistema locale (ad esempio, il servizio IpHlpSvc), l'utente malintenzionato può ottenere ed utilizzare i token del sistema locale.
  
**Che cos'è un elenco di controllo di accesso (ACL)?**    
Un elenco di controllo di accesso (ACL) è un elenco di protezioni che si applicano a un oggetto. Tale oggetto può essere un file, un processo, un evento o qualunque elemento avente un descrittore di protezione. Una voce di ACL è una voce di controllo di accesso (ACE, Access Control Entry). Esistono due tipi di elenchi di controllo di accesso: discrezionale e di sistema. Ogni ACE di ACL identifica una serie di diritti di accesso che vengono concessi, negati o verificati per un determinato trustee. Per ulteriori informazioni, vedere l'articolo di MSDN [Elenchi di controllo di accesso](http://msdn.microsoft.com/library/aa374872(vs.85).aspx).
  
**Che cos'è una named pipe?**    
Una named pipe è una pipe denominata, unidirezionale o duplice per la comunicazione tra il server pipe ed uno o più client pipe. Tutte le istanze di una named pipe condividono lo stesso nome pipe, ma ogni istanza dispone dei propri buffer ed offre un canale separato per la comunicazione client/server. L'uso di istanze consente a più client pipe di utilizzare la stessa named pipe simultaneamente. Qualsiasi processo può accedere alle named pipe, previa verifica per la protezione, rendendole un semplice metodo di comunicazione tra processi correlati tra loro e non. Per ulteriori informazioni vedere l'articolo MSDN, [Named Pipe](http://msdn.microsoft.com/en-us/library/aa365590(vs.85).aspx).
  
**Che cos'è il componente delle utilità di routing (rtutils.dll)?**    
Il componente delle utilità di routing (rtutils.dll) è un modulo contenente le funzioni utilizzate per la funzionalità di traccia, che offre un meccanismo uniforme per la generazione dell'output diagnostico per i diversi componenti del servizio. Quando un componente utilizza il meccanismo di traccia Rtutils, impostazioni di traccia specifiche del componente memorizzate nella chiave del Registro di sistema HKLM\\Software\\Microsoft\\Tracing\\ vengono utilizzate per memorizzare i dati della funzionalità di traccia.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui i token vengono ottenuti mediante impersonificazione.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554).
  
**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**    
No. Al momento della pubblicazione del presente bollettino, Microsoft non aveva ricevuto alcuna segnalazione in merito allo sfruttamento di questa vulnerabilità a scopo di attacco.
  
Vulnerabilità legata al danneggiamento della memoria per la funzionalità di traccia - CVE-2010-2555  
---------------------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati causata dal modo in cui la funzionalità Traccia per Services alloca la memoria quando elabora stringhe lunghe appositamente predisposte lette dal registro di sistema. Sfruttando questa vulnerabilità, un utente malintenzionato può eseguire codice arbitrario con privilegi di sistema. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2555](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2555).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria per la funzionalità di traccia - CVE-2010-2555
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria per la funzionalità di traccia - CVE-2010-2555
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla Vulnerabilità legata al danneggiamento della memoria per la funzionalità di traccia - CVE-2010-2555
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità viene riscontrata quando la funzionalità Traccia per Services calcola in maniera errata la lunghezza di determinata stringhe lette dal Registro di sistema.
  
**Che cos'è il componente delle utilità di routing (rtutils.dll)?**    
Il componente delle utilità di routing (rtutils.dll) è un modulo contenente le funzioni utilizzate per la funzionalità di traccia, che offre un meccanismo uniforme per la generazione dell'output diagnostico per i diversi componenti del servizio. Quando un componente utilizza il meccanismo di traccia Rtutils, impostazioni della funzionalità di traccia specifiche del componente memorizzate nella chiave del Registro di sistema HKLM\\Software\\Microsoft\\Tracing\\ vengono utilizzate per memorizzare i dati di traccia.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui le funzionalità Traccia per Services calcolano la lunghezza di una stringa letta dal Registro di sistema.
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/982799">articolo della Microsoft Knowledge Base 982799</a></td>
</tr>
<tr class="odd">
...
-   Cesar Cerrudo di [Argeniss](http://www.argeniss.com/) per aver segnalato la vulnerabilità legata all'ACL (elenco di controllo di accesso) delle chiavi del Registro di sistema per la funzionalità di traccia (CVE-2010-2554)  
-   Cesar Cerrudo di [Argeniss](http://www.argeniss.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria per la funzionalità di traccia (CVE-2010-2555)
