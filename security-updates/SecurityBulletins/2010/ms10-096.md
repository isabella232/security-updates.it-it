---
TOCTitle: 'MS10-096'
Title: 'Bollettino Microsoft sulla sicurezza MS10-096 - Importante'
ms:assetid: 'ms10-096'
ms:contentKeyID: 61240534
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-096(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-096 - Importante
==========================================================

Una vulnerabilità nella Rubrica di Windows può consentire l'esecuzione di codice in modalità remota (2423089)
-------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui la Rubrica di Windows carica le librerie esterne. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=46baa431-126c-4fa5-9a7b-525008e2817d)                                                                          | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9ce9d62-2eaa-48d8-bb6d-ea137e63d077)                                                 | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e0b2837c-019b-419b-954d-5bdc71a3a332)                                                                 | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c5cb600-9a39-40a0-be42-1593b1e0b97d)                                                     | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=9abc8270-f3ac-474d-9ebc-410aaa6262cc)                                                    | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a1c7f1b5-e054-4cd6-857d-2ab0a2fe9f62)                                        | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73624b68-a69d-4517-b971-f0b7d2ccc9d6)                | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi 32-bit e Windows Server 2008 per sistemi 32-bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=118f528f-bd05-49c2-a4a4-78314cd00992)\*\* | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=77e288fb-b51f-4f57-baac-1443d8fbd37b)\*\*       | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82f71194-6f1f-4f43-8752-4bf5e5f94a93)   | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=4e8ad5cd-af27-4f00-9378-ad778b8ee7b3)                                                                     | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=35a3e821-b463-411c-858b-d01eb5aed42b)                                                                          | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=9e2c95f6-9381-4484-b11b-814ab9138118)\*\*                                                         | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cb4211f3-1082-4245-8f03-7cbac90e9a31)                                                         | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata al caricamento di librerie non sicure - CVE-2010-3147</th>
...
Vulnerabilità legata al caricamento di librerie non sicure - CVE-2010-3147  
--------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui la Rubrica di Windows gestisce il caricamento dei file DLL. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3147](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147).
  
#### Fattori attenuanti della vulnerabilità legata al caricamento delle librerie non sicure - CVE-2010-3147
...
#### Soluzioni alternative della vulnerabilità legata al caricamento delle librerie non sicure - CVE-2010-3147
...
#### Domande frequenti sulla vulnerabilità legata al caricamento delle librerie non sicure - CVE-2010-3147
...
Questa vulnerabilità si verifica quando la Rubrica di Windows limita in maniera errata il percorso utilizzato per il caricamento delle librerie esterne.
  
**Che cos'è la Rubrica di Windows?**    
Windows fornisce una rubrica dove archiviare le informazioni relative ai contatti. La Rubrica di Windows (WAB) è un'applicazione e un servizio che consente di tenere traccia dei contatti. WAB dispone di un database locale e di un'interfaccia utente per la ricerca e la modifica di informazioni sulle persone ed è in grado di inviare query ai server elenchi in linea di rete tramite Lightweight Directory Access Protocol (LDAP). Altre applicazioni possono utilizzare la WAB. Ad esempio, Microsoft Outlook utilizza la WAB come Rubrica per gli indirizzi di posta elettronica.
...
Un utente malintenzionato può convincere un utente ad aprire un file Windows Address Book (WAB) legittimo situato nella stessa directory di rete di un file della libreria di collegamento dinamico (DLL) appositamente predisposto. Poi, durante l'apertura del file WAB, la Rubrica di Windows può tentare di caricare il file DLL ed eseguire qualsiasi codice esso contenga.
  
In uno scenario di attacco tramite posta elettronica, un utente malintenzionato può sfruttare la vulnerabilità inviando in allegato un file WAB legittimo ad un utente, convincendolo a salvare il file WAB in una directory che contiene un file DLL appositamente predisposto e ad aprire il file WAB. Poi, durante l'apertura del file WAB, la Rubrica di Windows può tentare di caricare il file DLL ed eseguire qualsiasi codice esso contenga.
  
In uno scenario di rete, un utente malintenzionato può collocare un file WAB legittimo, accompagnato da una DLL appositamente predisposta in un percorso UNC o WebDAV, quindi convincere l'utente ad aprire il file WAB.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui la Rubrica di Windows carica le librerie esterne.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-3147](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147).
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2423089$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2423089">articolo della Microsoft Knowledge Base 2423089</a></td>
</tr>
<tr class="even">
...
#### Windows Server 2003 (tutte le edizioni a 32 bit)
...
-   Simon Raner di [ACROS Security](http://www.acrossecurity.com/) per aver segnalato la vulnerabilità legata al caricamento di librerie non sicure (CVE-2010-3147)  
-   HD Moore di [Rapid7](http://www.rapid7.com/) per aver segnalato la vulnerabilità legata al caricamento di librerie non sicure (CVE-2010-3147)  
-   Muhaimin Dzulfakar di [NGS Software](http://www.ngssoftware.com/) per aver segnalato la vulnerabilità legata al caricamento di librerie non sicure (CVE-2010-3147)
