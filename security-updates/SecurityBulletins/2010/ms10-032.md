---
TOCTitle: 'MS10-032'
Title: 'Bollettino Microsoft sulla sicurezza MS10-032 - Importante'
ms:assetid: 'ms10-032'
ms:contentKeyID: 61240471
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-032(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-032 - Importante
==========================================================

Alcune vulnerabilità nei driver in modalità kernel di Windows possono consentire l'acquisizione di privilegi più elevati (979559)
---------------------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve due vulnerabilità divulgate pubblicamente e una vulnerabilità segnalata privatamente nei driver in modalità kernel di Windows. Le vulnerabilità possono consentire l'acquisizione di privilegi più elevati se un utente visualizza un contenuto reso con un carattere TrueType appositamente predisposto.
...
L'aggiornamento per la protezione risolve le vulnerabilità correggendo la convalida dei parametri di callback e di modifica oggetti e il modo in cui Windows fornisce le strutture dei caratteri TrueType alle applicazioni in modalità utente. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=60c8579b-1540-40d8-80a0-956edadd63ce)                                                                | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=023a777a-3d83-4a4e-8029-da8b095b074b)                                                | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e3aac9d-7747-435f-9678-f621e314e070)                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79a11dcd-5d88-4d83-beae-6580ef6fc2c0)                                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f42cc5d4-1bea-4a4a-8a08-b3eb92503588)                                                       | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=50efb1cf-9d89-4522-929d-f87fd98d6fe8)                                                      | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7cb64633-d2a0-4e38-be35-ec32ea655a04)                                          | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bbfc4d80-67eb-4deb-9595-cb67942a0df2)                  | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=22d550fe-ba35-4750-a9d6-624858b67c94)\* | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=09025626-4116-4a31-8700-215382898ee2)\*           | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0035cfe2-d38d-41cd-b704-ec1feda307d8)     | Acquisizione di privilegi più elevati       | Importante                   | [MS09-065](http://technet.microsoft.com/security/bulletin/ms09-065) |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=3e0ff389-4612-4c92-bbff-bb45b5bdfc6a)                                                                       | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=2b1e4aff-605a-4e94-88f9-135ce35f0646)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=4272277f-b2dd-4406-8bbd-bc461c9923b8)\*                                                             | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7d636f82-e828-468c-ac36-808ff9d37c7f)                                                           | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
...
<th style="border:1px solid black;" >Vulnerabilità legata alla convalida errata di dati in Win32k - CVE-2010-0484</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-0485</th>
<th style="border:1px solid black;" >Vulnerabilità legata all'analisi dei caratteri TrueType in Win32k - CVE-2010-1255</th>
...
Vulnerabilità legata alla convalida errata di dati in Win32k - CVE-2010-0484  
----------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati causata dal fatto che i driver in modalità kernel di Windows non convalidano correttamente le modifiche in determinati oggetti kernel. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-0484](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0484).
  
#### Fattori attenuanti della vulnerabilità legata alla convalida errata di dati in Win32k - CVE-2010-0484
...
#### Soluzioni alternative per la vulnerabilità legata alla convalida errata di dati in Win32k - CVE-2010-0484
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla convalida errata di dati in Win32k - CVE-2010-0484
...
I driver in modalità kernel di Windows non convalidano correttamente le modifiche in determinati oggetti kernel.
...
L'aggiornamento risolve questa vulnerabilità correggendo il metodo utilizzato per la convalida di una modifica in determinati oggetti kernel.
...
Vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-0485  
-------------------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-0485](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485).
  
#### Fattori attenuanti della vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-0485
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-0485
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla creazione di finestre in Win32k - CVE-2010-0485
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
I driver in modalità kernel di Windows non convalidano correttamente tutti i parametri di callback durante la creazione di una nuova finestra.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve questa vulnerabilità correggendo il modo in cui i driver in modalità kernel di Windows convalidano i parametri di callback durante la creazione di una nuova finestra.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-0485](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485).
  
**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**    
No. Al momento della pubblicazione del presente bollettino, Microsoft non aveva ricevuto alcuna segnalazione in merito allo sfruttamento di questa vulnerabilità a scopo di attacco, né dell'esistenza di un codice di prova pubblicato.
  
Vulnerabilità legata all'analisi dei caratteri TrueType in Win32k - CVE-2010-1255  
---------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui il sistema operativo fornisce informazioni relative ai tipi di carattere alle applicazioni. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255).
  
#### Fattori attenuanti della vulnerabilità legata all'analisi dei caratteri TrueType in Win32k - CVE-2010-1255
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata all'analisi dei caratteri TrueType in Win32k - CVE-2010-1255
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'analisi dei caratteri TrueType in Win32k - CVE-2010-1255
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata dal modo in cui Windows fornisce informazioni sulla struttura dei glifi alle applicazioni.
...
Non esistono applicazioni Microsoft esposte a questa vulnerabilità attraverso un vettore remoto. Tuttavia, le applicazioni di terze parti potrebbero analizzare caratteri specifici da fonti non attendibili esponendosi così alla vulnerabilità in modalità remota. In uno scenario di questo genere, lo sfruttamento della vulnerabilità può consentire ad un utente anonimo di eseguire il codice con privilegi amministrativi completi.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi maggiormente a rischio sono workstation e server terminal. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
Questo aggiornamento risolve questa vulnerabilità correggendo il modo in cui Windows fornisce le strutture dei caratteri TrueType alle applicazioni in modalità utente.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255).
...
| **Distribuzione**                                  |                                                                                                                                                                                |  
| Installazione senza intervento dell'utente         | Windows2000-KB979559-x86-enu /quiet                                                                                                                                            |  
| Installazione senza riavvio                        | Windows2000-KB979559-x86-enu /norestart                                                                                                                                        |  
| Aggiornamento del file di registro                 | KB979559.log                                                                                                                                                                   |  
...
| **Informazioni per la rimozione**                  | Utilizzare lo strumento **Installazione applicazioni** del Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB979559$\\Spuninst |  
| **Informazioni sui file**                          | Vedere l'[articolo della Microsoft Knowledge Base 979559](http://support.microsoft.com/kb/979559)                                                                              |  
| **Controllo della chiave del Registro di sistema** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB979559\\Filelist                                                                                      |
...
<td style="border:1px solid black;">Utilizzare lo strumento <strong>Installazione applicazioni</strong> del Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB979559$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/979559">articolo della Microsoft Knowledge Base 979559</a></td>
</tr>
<tr class="even">
...
-   Sebastien Renaud del [VUPEN Vulnerability Research Team](http://www.vupen.com/) per aver segnalato la vulnerabilità legata alla convalida errata di dati in Win32k (CVE-2010-0484)  
-   [Secunia Research](http://secunia.com/) per avere collaborato con noi allo studio della vulnerabilità legata all'analisi dei caratteri TrueType in Win32k (CVE-2010-1255)
