---
TOCTitle: 'MS10-037'
Title: 'Bollettino Microsoft sulla sicurezza MS10-037 - Importante'
ms:assetid: 'ms10-037'
ms:contentKeyID: 61240476
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-037(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-037 - Importante
==========================================================

La vulnerabilità nel driver del carattere formato compatto (CFF) OpenType può consentire l'acquisizione di privilegi più elevati (980218)
-----------------------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve la vulnerabilità assicurando che il driver del carattere formato compatto (CFF) OpenType convalidi correttamente i dati. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=5d645891-31e9-42c4-b12b-eb351473fd0c)                                                                | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b42a17c5-997e-4504-ba5b-bfa62166b460)                                                | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dc835b94-3368-4c1c-8f29-40517c73540e)                                                   | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca49b5b5-db8e-4ebc-9a3c-b1ace09ac3c0)                                                                   | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b0794e7e-c925-4672-b7a5-4bb3f847f045)                                                       | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=6e76ebea-bde1-4352-a283-dd71c2cc51a1)                                                      | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=363b503a-2e1e-4284-a029-9695d2acfcb6)                                          | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f512b86-3a99-47f7-a90e-1ae9b291385c)                  | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e78ad607-d209-48c4-b0f3-ed4c70993174)\* | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=85f6fc5d-efd1-4351-b4c0-b9b7080e6173)\*           | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c6f1aae5-e8fd-4121-89b2-b97c571e8223)     | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=969af8d6-f6da-4dd1-a7d7-2de54a5a8978)                                                                       | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=b069e5b2-aa2d-452e-b687-8734b5ba0051)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=45242c7c-3752-44bf-a766-024ad7d28f53)\*                                                             | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0a271fb5-da5b-4a17-9593-e56b9a843b8f)                                                           | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria del driver del carattere CFF OpenType - CVE-2010-0819</th>
...
Vulnerabilità legata al danneggiamento della memoria del driver del carattere CFF OpenType - CVE-2010-0819  
----------------------------------------------------------------------------------------------------------
  
<span></span>
Nel driver del carattere formato compatto (CFF) OpenType di Windows esiste una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta alla convalida errata di determinati dati passati dalla modalità utente alla modalità kernel. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-0819](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0819).
  
#### Fattori attenuanti per la vulnerabilità legata al danneggiamento della memoria del driver del carattere CFF OpenType - CVE-2010-0819
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria del driver del carattere CFF OpenType - CVE-2010-0819
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti per la vulnerabilità legata al danneggiamento della memoria del driver del carattere CFF OpenType - CVE-2010-0819
...
La vulnerabilità si verifica quando il driver del carattere formato compatto (CFF) OpenType non convalida correttamente determinati dati passati dalla modalità utente alla modalità kernel.
  
**Cosa sono i caratteri formato compatto (CFF) OpenType?**    
Un carattere CFF OpenType è un carattere OpenType che contiene profili PostScript Type 1. I caratteri OpenType possono contenere sia i profili PostScript Type 1 che quelli TrueType. Tutti i caratteri Microsoft Windows contengono i profili TrueType. Le applicazioni di desktop publishing come Adobe InDesign e QuarkXpress supportano il maggior numero di funzionalità OpenType. Adobe Photoshop e Adobe Illustrator supportano molte funzionalità. Per le comuni funzionalità OpenType è stato inoltre aggiunto supporto a Microsoft Publisher e a Microsoft Word. Per ulteriori informazioni, vedere le [Domande frequenti su OpenType della Microsoft Typography](http://www.microsoft.com/typography/opentypefaq.mspx).
...
L'aggiornamento risolve la vulnerabilità assicurando che il driver del carattere formato compatto (CFF) OpenType convalidi correttamente i dati copiati dalla modalità utente alla modalità kernel.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB980218$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/980218">articolo della Microsoft Knowledge Base 980218</a></td>
</tr>
<tr class="even">
...
-   Chris Carton di Laserforce International, collaboratore di [Secunia](http://secunia.com/), per aver segnalato la vulnerabilità legata al danneggiamento della memoria del driver del carattere CFF OpenType (CVE-2010-0819)
