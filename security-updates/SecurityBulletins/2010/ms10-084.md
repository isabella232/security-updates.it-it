---
TOCTitle: 'MS10-084'
Title: 'Bollettino Microsoft sulla sicurezza MS10-084 - Importante'
ms:assetid: 'ms10-084'
ms:contentKeyID: 61240522
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-084(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-084 - Importante
==========================================================

Una vulnerabilità in Windows Local Procedure Call può consentire l'acquisizione di privilegi più elevati (2360937)
------------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 5 ottobre 2010
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando la gestione dei messaggi della porta LRPC all'interno del sottosistema RPC. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6049c879-b81a-4d10-b96b-b2837cb24834)                          | Acquisizione di privilegi più elevati       | Importante                   | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d690846c-5e0b-4216-84cd-d17e366dd16d) | Acquisizione di privilegi più elevati       | Importante                   | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b31e18b0-da9f-4b3b-82c6-603e08b3b241)                 | Acquisizione di privilegi più elevati       | Importante                   | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d73f0f1-6ec8-4304-a20e-345d8b6c225a)     | Acquisizione di privilegi più elevati       | Importante                   | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8fad4f77-7c89-4684-b957-9c00ced248d3)    | Acquisizione di privilegi più elevati       | Importante                   | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
...
<th style="border:1px solid black;" >Vulnerabilità legata al sovraccarico del buffer del messaggio LPC - CVE-2010-3222</th>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=?...?">Windows Server 2003 con SP2 per sistemi Itanium</a></td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Acquisizione di privilegi più elevati</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
...
Vulnerabilità legata al sovraccarico del buffer del messaggio LPC - CVE-2010-3222  
---------------------------------------------------------------------------------
  
<span></span>
Una vulnerabilità legata all'acquisizione di privilegi più elevati esiste nel sottosistema RPCSS (Remote Procedure Call Subsystem) eseguito nel contesto di un account NetworkService, dove un'applicazione locale può utilizzare LPC per richiedere che il server LPC si connetta di nuovo al client utilizzando LRPC. Questa richiesta può contenere dei dati appositamente predisposti per causare un sovraccarico del buffer basato su stack, consentendo a un utente autenticato di accedere a risorse eseguite nel contesto di un account NetworkService.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
  
#### Fattori attenuanti della vulnerabilità legata al sovraccarico del buffer del messaggio LPC – CVE-2010-3222
...
#### Soluzioni alternative per la vulnerabilità legata al sovraccarico del buffer del messaggio LPC – CVE-2010-3222
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al sovraccarico del buffer del messaggio LPC – CVE-2010-3222
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Sfruttando questa vulnerabilità, un utente malintenzionato con credenziali di utente può eseguire il codice nel contesto di un account NetworkService.
  
**Quali sono le cause di questa vulnerabilità?**    
Questa vulnerabilità è causata da un sovraccarico del buffer basato su stack nello scambio di messaggi di porta tra LPC e il server LRPC (mapping degli endpoint RPC) contenuti in RPCSS.
  
**Quale componente è interessato dalla vulnerabilità?**    
Il componente interessato dalla vulnerabilità è Microsoft LPC (Local Procedure Call), un componente di RPC (Remote Procedure Call).
  
**Che cos'è LPC?**  
LPC (Local Procedure Call) è un servizio per il passaggio di messaggi contenuto in Windows. Questo servizio garantisce la comunicazione tra thread e processi. Quando un processo client deve richiedere un servizio a un processo server, è necessario un metodo per la comunicazione tra i due processi. Occorre un metodo che consenta al processo client di inviare richieste al server, a quest'ultimo di inviare le risposte al client e a entrambi i sistemi di conoscere il reciproco stato. Quando il processo client e il processo server risiedono su sistemi differenti, viene utilizzato RPC (Remote Procedure Call). Quando risiedono sullo stesso sistema, può essere utilizzato LPC.
  
**Che cos'è RPC?**  
RPC (Remote Procedure Call) è un meccanismo di comunicazione interprocesso (IPC) che attiva lo scambio dati e il richiamo di funzionalità che risiedono in un altro processo. Tale processo può trovarsi nello stesso computer, nell'area locale (LAN) o in Internet. Il meccanismo RPC di Microsoft utilizza altri meccanismi IPC, come named pipe, Netbios o Winsock, per stabilire le comunicazioni tra il client e il server. Con RPC, la logica essenziale del programma e il relativo codice di procedura possono esistere su computer diversi, caratteristica importante per le applicazioni distribuite. Per ulteriori informazioni, vedere l'articolo di TechNet [Che cosa significa RPC?](http://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx)
  
**Che cos'è LRPC?**  
RPC locale (LRPC) denota la comunicazione RPC che ha luogo su un sistema locale.
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**    
Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire un codice appositamente predisposto nel contesto di un account NetworkService, consentendogli di accedere a delle risorse eseguite come NetworkService. Alcuni di questi processi potrebbero avere la capacità di acquisire privilegi più elevati in LocalSystem, consentendo a qualsiasi processo di NetworkService di acquisire privilegi più elevati anche in LocalSystem. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**In che modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
Un utente malintenzionato connesso localmente con credenziali valide può sfruttare la vulnerabilità eseguendo un codice appositamente predisposto che invia un messaggio LPC al server LRPC locale. Il messaggio può quindi consentire a un utente autenticato di eseguire il codice nel contesto di un account NetworkService.
...
L'aggiornamento risolve la vulnerabilità modificando la gestione dei messaggi della porta LPC all'interno del sottosistema RPCSS.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata descritta come una vulnerabilità comune e identificata con il codice [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2360937$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2360937">articolo della Microsoft Knowledge Base 2360937</a></td>
</tr>
<tr class="even">
