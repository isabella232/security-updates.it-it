---
TOCTitle: 'MS10-101'
Title: 'Bollettino Microsoft sulla sicurezza MS10-101 - Importante'
ms:assetid: 'ms10-101'
ms:contentKeyID: 61240539
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-101(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-101 - Importante
==========================================================

Una vulnerabilità del servizio Accesso rete di Windows può consentire un attacco di tipo Denial of Service (2207559)
--------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per tutte le edizioni supportate di Windows Server 2003, Windows Server 2008 (ad eccezione delle edizioni basate su Itanium) e Windows Server 2008 R2 (ad eccezione delle edizioni basate su Itanium). Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità correggendo la convalida dei dati forniti dall'utente nell'interfaccia del servizio RPC di accesso alla rete. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ad843b97-2f6e-4406-a17a-627b7db8a926)                                                                   | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0b0a06e7-0ae5-41f4-9ff5-d524fc0afbfa)                                                       | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7c0c2850-e81d-4347-aeb3-47036caa7c1b)                                                      | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6793f75b-cdf4-42ef-a53e-a1acb5b662d1)\* | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=85add876-ca5a-4a92-984e-188a72e349fc)\*           | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=d7307afd-84a0-434e-9658-bf9f8ae4b938)\*                                                             | Denial of Service                           | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità DOS legata alla risoluzione del riferimento NULL del servizio RPC di accesso alla rete - CVE-2010-2742</th>
...
Vulnerabilità DOS legata alla risoluzione del riferimento NULL del servizio RPC di accesso alla rete - CVE-2010-2742  
--------------------------------------------------------------------------------------------------------------------
  
<span></span>
Una vulnerabilità ad attacchi di tipo Denial of Service da parte di utenti remoti autenticati è stata riscontrata nelle implementazioni del servizio RPC di accesso alla rete nelle versioni interessate di Windows Server. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può causare il riavvio delle versioni interessate di Windows Server.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2742](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2742).
  
#### Fattori attenuanti della vulnerabilità DOS legata alla risoluzione del riferimento NULL del servizio RPC di accesso alla rete - CVE-2010-2742
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Questa vulnerabilità interessa solo i Windows Server configurati come controller di dominio.  
-   Per poter sfruttare questa vulnerabilità un utente malintenzionato necessita dei privilegi di amministratore su un computer collegato allo stesso dominio del controller di dominio interessato.
  
#### Soluzioni alternative per la vulnerabilità DOS legata alla risoluzione del riferimento NULL del servizio RPC di accesso alla rete - CVE-2010-2742
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità DOS legata alla risoluzione del riferimento NULL del servizio RPC di accesso alla rete - CVE-2010-2742
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità ad attacchi di tipo Denial of Service. Un utente malintenzionato potrebbe sfruttare la vulnerabilità causando il riavvio del sistema interessato. Si noti che la vulnerabilità ad attacchi di tipo Denial of Service non consente di eseguire codice o acquisire diritti utente più elevati, ma può causare il riavvio del sistema interessato.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è stata riscontrata quando il servizio RPC di accesso alla rete convalida in maniera errata i dati forniti dall'utente.
  
**Che cos'è l'RPC di accesso alla rete?**    
Il protocollo remoto di accesso alla rete è un'interfaccia RPC (Remote Procedure Call) utilizzata per l'autenticazione di utente e computer nelle reti basate su dominio. Per ulteriori informazioni sull'RPC di accesso alla rete, vedere l'articolo MSDN [Specifiche del protocollo remoto di accesso alla rete](http://msdn.microsoft.com/en-us/library/ms237009(v=prot.10).aspx).
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**    
Un utente malintenzionato in grado di sfruttare questa vulnerabilità può causare il riavvio dei controller di dominio.
  
**In che modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
Un utente malintenzionato può sfruttare questa vulnerabilità inviando un pacchetto RPC appositamente predisposto all'interfaccia del servizio RPC di accesso alla rete. Su tutte le piattaforme interessate, l'utente malintenzionato deve essere in possesso di credenziali di autenticazione valide con privilegi di amministratore per sfruttare la vulnerabilità.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I Windows Server che sono configurati come controller di dominio ed ospitano il servizio Accesso rete sono interessati da questa vulnerabilità. I client dei sistemi operativi Windows non sono interessati dalla vulnerabilità.
  
**Come è possibile stabilire se il proprio Windows Server è configurato come controller di dominio?**    
Se la chiave del Registro di sistema HKLM\\SYSTEM\\CurrentControlSet\\Control\\ProductOptions\\ProductType è impostata su LanmanNT, il sistema è configurato come controller di dominio.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità convalidando in maniera corretta i dati forniti dall'utente nell'interfaccia del servizio RPC di accesso alla rete.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2207559$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2207559">articolo della Microsoft Knowledge Base 2207559</a></td>
</tr>
<tr class="even">
...
-   Matthias Dieter Wallnöfer ed Andrew Bartlett del The Samba Team per aver segnalato la vulnerabilità DOS legata alla risoluzione del riferimento NULL del servizio RPC di accesso alla rete (CVE-2010-2742)
