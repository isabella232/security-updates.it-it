---
TOCTitle: 'MS10-099'
Title: 'Bollettino Microsoft sulla sicurezza MS10-099 - Importante'
ms:assetid: 'ms10-099'
ms:contentKeyID: 61240537
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-099(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-099 - Importante
==========================================================

Una vulnerabilità nel routing e nell'accesso remoto può consentire l'acquisizione di privilegi più elevati (2440591)
--------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve la vulnerabilità correggendo la convalida nel componente di routing e di accesso remoto. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=4d0ae558-a4f2-4048-b5fd-ba072ca35e48)                          | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=238bb885-eae6-464a-bb3d-679025f1cb50) | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c87af292-a068-4089-aab8-115c18b4b024)                 | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e17b8878-d065-49cc-bdba-0f24cdf35ea3)     | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ad896d80-167f-4e8f-a448-cac93516f4d0)    | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata al sovraccarico del buffer NDProxy del kernel - CVE-2010-3963</th>
...
Vulnerabilità legata al sovraccarico del buffer NDProxy del kernel - CVE-2010-3963  
----------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati nel componente NDProxy per il routing e l'accesso remoto del kernel di Windows causata da una convalida errata dell'input inviato in modalità utente al kernel. Questa vulnerabilità potrebbe consentire a un utente malintenzionato di eseguire codice con privilegi elevati. Sfruttando questa vulnerabilità, un utente malintenzionato locale può eseguire codice arbitrario e acquisire il controllo completo del sistema interessato. Inoltre, può installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3963](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963).
  
#### Fattori attenuanti della vulnerabilità legata al sovraccarico del buffer NDProxy del kernel - CVE-2010-3963
...
#### Soluzioni alternative per la vulnerabilità legata al sovraccarico del buffer NDProxy del kernel - CVE-2010-3963
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al sovraccarico del buffer NDProxy del kernel - CVE-2010-3963
...
Se i dati sono inviati al kernel in modalità utente, il componente NDProxy per il routing e l'accesso remoto non convalida correttamente l'input fornito dall'utente.
  
**Che cos'è RRAS?**    
RRAS consente ad un computer di funzionare come router di rete e offre la funzionalità server di nuova generazione per il Servizio di accesso remoto (RAS) di Windows. La funzionalità server RRAS si basa sul Servizio di accesso remoto (RAS), già incluso nei precedenti sistemi operativi.
  
Il Servizio di accesso remoto (RAS) consente agli utenti di connettersi a un computer remoto mediante le linee telefoniche e di lavorare come se il proprio sistema fosse fisicamente collegato alla rete remota. Questi servizi consentono agli utenti remoti di eseguire attività come l'invio e la ricezione di messaggi di posta elettronica e di documenti di fax, il recupero di file e la stampa dei documenti mediante una stampante.
  
Il servizio di accesso remoto è un servizio nativo in Windows XP e Windows Server 2003.
  
**Che cos'è NDProxy?**    
NDPROXY è un driver fornito dal sistema che interfaccia i driver WAN Miniport, i gestori chiamate e i gestori chiamate Miniport con i servizi TAPI (Windows Telephony Application Programming Interfaces). Per ulteriori informazioni, vedere l'articolo MSDN [Panoramica su NDPROXY](http://msdn.microsoft.com/en-us/library/ff568322(vs.85).aspx).
...
L'aggiornamento risolve la vulnerabilità convalidando correttamente l'input inviato al kernel Windows in modalità utente tramite il componente per il routing e l'accesso remoto.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2440591$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2440591">articolo della Microsoft Knowledge Base 2440591</a></td>
</tr>
<tr class="even">
...
-   Honggang Ren di [FortiGuard Labs di Fortinet](http://www.fortiguard.com/) per aver segnalato la vulnerabilità legata al sovraccarico del buffer NDProxy del kernel (CVE-2010-3963)
