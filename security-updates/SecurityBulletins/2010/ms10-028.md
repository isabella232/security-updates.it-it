---
TOCTitle: 'MS10-028'
Title: 'Bollettino Microsoft sulla sicurezza MS10-028 - Importante'
ms:assetid: 'ms10-028'
ms:contentKeyID: 61240467
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-028(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-028 - Importante
==========================================================

Alcune vulnerabilità in Microsoft Visio possono consentire l'esecuzione di codice in modalità remota (980094)
-------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per Microsoft Office Visio 2002 Service Pack 2, Microsoft Office Visio 2003 Service Pack 3, Microsoft Office Visio 2007 Service Pack 1 e Microsoft Office Visio 2007 Service Pack 2. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato**, in questa sezione.

L'aggiornamento per la protezione risolve queste vulnerabilità correggendo il modo in cui Microsoft Office Visio convalida gli attributi e calcola gli indici quando vengono aperti file Visio appositamente predisposti. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
Microsoft Office Visio 2002 e le versioni successive dispongono di una funzionalità che chiede all'utente di aprire, salvare o annullare il documento prima di aprirlo. Questo fattore attenuante riduce la vulnerabilità legata all'esecuzione di codice in modalità remota a un livello importante perché richiede più azioni dell'utente per sfruttarla.
  
**Dove è possibile trovare ulteriori informazioni sul visualizzatore di Microsoft Office?**    
Per informazioni sulle versioni attuali e precedenti del visualizzatore di Microsoft Office, consultare [l'articolo della Microsoft Knowledge Base 979860](http://support.microsoft.com/?id=979860).
...
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria di convalida attributo Visio - CVE-2010-0254</th>
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria di calcolo dell'indice Visio - CVE-2010-0256</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
Vulnerabilità legata al danneggiamento della memoria di convalida attributo Visio - CVE-2010-0254  
-------------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Office Visio convalida gli attributi durante la gestione di file Visio appositamente predisposti.
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-0254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0254).
  
#### Fattori attenuanti per la vulnerabilità legata al danneggiamento della memoria di convalida attributo Visio - CVE-2010-0254
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Agli utenti di Microsoft Office Visio 2002 e delle edizioni successive di Visio verrà richiesto di scegliere Apri, Salva o Annulla prima di aprire un documento. Questo è un fattore attenuante perché richiede più azioni dell'utente per sfruttarla.  
...
-   In uno scenario di attacco dal Web, l'utente malintenzionato dovrebbe pubblicare un sito Web contenente un file Visio appositamente predisposto utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare un sito Web appositamente predisposto, un utente malintenzionato deve dunque convincere gli utenti a visitare il sito Web, in genere inducendoli a fare clic su un collegamento che li indirizzi al sito Web dell'utente malintenzionato. Successivamente, deve convincerli ad aprire un file Visio appositamente predisposto.  
-   Sfruttando questa vulnerabilità, un utente malintenzionato può ottenere gli stessi diritti utente dell'utente locale. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di convalida attributo Visio - CVE-2010-0254
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   Non aprire file Visio provenienti da fonti non attendibili oppure ricevuti inaspettatamente da fonti attendibili. Questa vulnerabilità può essere sfruttata quando un utente apre un file appositamente predisposto. L'estensione VSD di solito è associata ai file Visio.
  
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di convalida attributo Visio - CVE-2010-0254
...
Esiste una vulnerabilità nel modo in cui Microsoft Office Visio gestisce la memoria quando vengono aperti file Visio appositamente predisposti.
...
I sistemi più esposti sono quelli che utilizzano Microsoft Office Visio, inclusi le workstation e i server terminal. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento corregge la vulnerabilità modificando il modo in cui Microsoft Office Visio convalida gli attributi quando vengono aperti file Visio appositamente predisposti.
...
Vulnerabilità legata al danneggiamento della memoria di calcolo dell'indice Visio - CVE-2010-0256  
-------------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Office Visio calcola gli indici durante la gestione di file Visio appositamente predisposti.
  
Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-0256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0256).
  
#### Fattori attenuanti per la vulnerabilità legata al danneggiamento della memoria di calcolo dell'indice Visio - CVE-2010-0256
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di calcolo dell'indice Visio - CVE-2010-0256
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di calcolo dell'indice Visio - CVE-2010-0256
...
**Quali sono gli scopi dell'aggiornamento?**    
Questo aggiornamento risolve la vulnerabilità correggendo il modo in cui Microsoft Office Visio calcola gli indici quando apre file Visio appositamente predisposti.
...
| Microsoft Office Visio 2007 Service Pack 2 | No         |
...
| Microsoft Office Visio 2007 Service Pack 2 | No      | No                | No                | No                         |
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/979364">articolo della Microsoft Knowledge Base 979364</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/979356">articolo della Microsoft Knowledge Base 979356</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo della chiave del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/979365">articolo della Microsoft Knowledge Base 979365</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo della chiave del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Bing Liu di [FortiGuard Labs](http://www.fortiguard.com/) di Fortinet per aver segnalato la vulnerabilità legata al danneggiamento della memoria di convalida attributo Visio (CVE-2010-0254)  
-   Bing Liu di [FortiGuard Labs](http://www.fortiguard.com/) di Fortinet per aver segnalato la vulnerabilità legata al danneggiamento della memoria di calcolo dell'indice Visio (CVE-2010-0256)
