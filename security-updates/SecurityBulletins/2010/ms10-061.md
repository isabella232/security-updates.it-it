---
TOCTitle: 'MS10-061'
Title: 'Bollettino Microsoft sulla sicurezza MS10-061 - Critico'
ms:assetid: 'ms10-061'
ms:contentKeyID: 61240500
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-061(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-061 - Critico
=======================================================

Una vulnerabilità nel servizio Spooler di stampa può consentire l'esecuzione di codice in modalità remota (2347290)
-------------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 14 settembre 2010 | Aggiornamento: mercoledì 29 settembre 2010
...
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui il servizio Spooler di stampa convalida le autorizzazioni utente. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=93faba6b-0a85-4acc-b527-a012bbf56b13)                                                                            | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9f7f3737-056d-44bd-b644-51093b5b501b)                                                   | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3d79680b-c071-462f-9cea-551fbd42edf0)                                                                   | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=073b3305-4a81-4ef8-b6aa-e53b31a936b4)                                                       | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ca35a520-c4da-41bb-abcc-d5bc534ff19a)                                                      | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=028977fd-0f39-42d4-9fee-0d90a2931cfd)                                          | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c68b9337-883d-4e98-ba0a-90b5cad46184)                  | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e2e788de-8400-4bf6-b96b-a915154aa20a)\* | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e08d4f49-5a13-4e1d-b0a7-27b314c2edb5)\*           | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=098537d5-bf6e-4e04-ad33-1cde697e062f)     | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=34619e9e-1f00-40e4-be6f-5bbf5e3c801b)                                                                       | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=dbb747a5-658d-44cf-bd49-425d1700157f)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=11e20088-1be2-4166-9c97-234b7e9f1c4f)\*                                                             | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d8c635f8-8978-44bf-b457-e07368f08ef4)                                                           | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
...
**Perché questa vulnerabilità è considerata di livello più alto nei sistemi Windows XP?**  
In Windows XP, l'account guest è attivato per impostazione predefinita, consentendo in tal modo ad utenti anonimi di accedere alle condivisioni di stampa. In Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 e Windows 2008 R2, un utente malintenzionato deve essere in grado di autenticarsi per sfruttare questa vulnerabilità, a meno che la condivisione basata su password non sia disattivata. Se la condivisione basata su password è disattivata, gli utenti malintenzionati potrebbero sfruttare questi sistemi senza dover effettuare l'autenticazione.
...
<th style="border:1px solid black;" >Vulnerabilità legata all'impersonificazione del servizio Spooler di stampa - CVE-2010-2729</th>
...
Vulnerabilità legata all'impersonificazione del servizio Spooler di stampa - CVE-2010-2729  
------------------------------------------------------------------------------------------
  
<span></span>
Nel servizio Spooler di stampa di Windows esiste una vulnerabilità legata all'esecuzione di codice in modalità remota che può consentire a un utente malintenzionato remoto e non autenticato di eseguire codice arbitrario su un sistema Windows XP interessato. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account. Si tratta di una vulnerabilità legata all'acquisizione di privilegi più elevati in tutti gli altri sistemi Microsoft Windows supportati.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2729](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729).
  
#### Fattori attenuanti della vulnerabilità legata all'impersonificazione del servizio Spooler di stampa - CVE-2010-2729
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per impostazione predefinita, le stampanti non sono condivise in nessun sistema operativo Windows attualmente supportato.  
-   I sistemi sono vulnerabili all'attacco remoto solo quando si condivide una stampante e l'utente malintenzionato remoto può accedere alla condivisione di stampa.  
...
#### Soluzioni alternative per la vulnerabilità legata all'impersonificazione del servizio Spooler di stampa - CVE-2010-2729
...
-   **Disattivare la condivisione stampante**
  
    Per disattivare la condivisione stampante, effettuare le operazioni seguenti:
  
    Nei sistemi Windows XP e Windows 2003
  
    1.  Fare clic su **Start** e scegliere **Stampanti e fax**.  
    2.  Fare clic con il pulsante destro del mouse sull'icona della stampante e selezionare **Condivisione**.  
    3.  Selezionare **Non condividere questa stampante**, quindi fare clic su **OK**.  
    4.  Ripetere tale procedura per ogni stampante condivisa nel sistema.
  
    Su tutti i sistemi operativi Windows successivi:
  
    1.  Fare clic su **Start** e scegliere **Dispositivi e stampanti**.  
    2.  Fare clic con il pulsante destro del mouse sull'icona della stampante e selezionare **Proprietà stampante**.  
    3.  Selezionare la scheda **Condivisione**.  
    4.  Assicurarsi che l'opzione **Condividi la stampante** non sia selezionata, quindi fare clic su **OK**.  
    5.  Ripetere tale procedura per ogni stampante condivisa nel sistema.
  
    **Impatto della soluzione alternativa.** La disattivazione di questa funzionalità impedisce agli utenti remoti di stampare dalla stampante interessata.
    ...
    **Per annullare il risultato della soluzione alternativa:**
    ...
    1.  Fare clic su **Start** e scegliere **Stampanti e fax**.  
    2.  Fare clic con il pulsante destro del mouse sull'icona della stampante e selezionare **Condivisione**.  
    3.  Selezionare **Condividi la stampante**, quindi fare clic su **OK**.  
    4.  Ripetere tale procedura per ogni stampante condivisa nel sistema.
    ...
    2.  Fare clic con il pulsante destro del mouse sull'icona della stampante e selezionare **Proprietà stampante**.  
    3.  Selezionare la scheda **Condivisione**.  
    4.  Selezionare l'opzione **Condividi la stampante**, quindi fare clic su **OK**.  
    5.  Ripetere tale procedura per ogni stampante condivisa nel sistema.
  
#### Domande frequenti sulla vulnerabilità legata all'impersonificazione del servizio Spooler di stampa - CVE-2010-2729
...
Questa vulnerabilità si verifica quando lo spooler di stampa di Windows non limita in modo sufficiente le autorizzazioni utente per l'accesso agli spooler di stampa.
...
Un utente malintenzionato può sfruttare questa vulnerabilità creando e inviando una richiesta di stampa dannosa a un sistema vulnerabile che presenta uno spooler di stampa con interfaccia esposta tramite RPC. Il sistema di destinazione non verifica correttamente se l'utente remoto dispone di autorizzazioni sufficienti e permette all'utente remoto malintenzionato di creare un file in una directory di sistema di Windows. Quando questi file vengono posizionati in percorsi particolari possono essere eseguiti automaticamente dal sistema.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi maggiormente a rischio sono le workstation e i server terminal che condividono una stampante o i server di stampa. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui il servizio Spooler di stampa convalida le autorizzazioni utente per l'accesso agli spooler di stampa.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-2729](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729).
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2347290$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2347290">articolo della Microsoft Knowledge Base 2347290</a></td>
</tr>
<tr class="even">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin e Alexey Monastyrsky di [Kaspersky Lab](http://www.kaspersky.com) e Vitaly Kiktenko e Alexander Saprykin di [Design and Test Lab](http://www.dnt-lab.com) per aver segnalato la vulnerabilità legata all'impersonificazione del servizio Spooler di stampa (CVE-2010-2729)  
-   Liam O Morchu di [Symantec](http://www.symantec.com/index.jsp) per aver segnalato la vulnerabilità legata all'impersonificazione del servizio Spooler di stampa (CVE-2010-2729)
...
-   V1.1 (29 settembre 2010): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2347290 nella sottosezione Problemi noti del Riepilogo.
