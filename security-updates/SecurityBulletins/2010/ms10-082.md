---
TOCTitle: 'MS10-082'
Title: 'Bollettino Microsoft sulla sicurezza MS10-082 - Importante'
ms:assetid: 'ms10-082'
ms:contentKeyID: 61240520
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-082(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-082 - Importante
==========================================================

Una vulnerabilità di Windows Media Player può consentire l'esecuzione di codice in modalità remota (2378111)
------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per Windows Media Player 9 Series, Windows Media Player 10, Windows Media Player 11 e Windows Media Player 12 quando installati sulle versioni supportate di Microsoft Windows, eccetto per Windows Server 2008 e Windows Server 2008 R2. Per Windows Media Player 11 e Windows Media Player 12 quando installati sulle versioni supportate di Windows Server 2008 e Windows Server 2008 R2, questo aggiornamento per la protezione è considerato Moderato. Tutte le edizioni supportate basate su Itanium di Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2 non sono interessate dalla vulnerabilità. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui Windows Media Player disalloca gli oggetti durante un'operazione di ricarica. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<th style="border:1px solid black;" >
Vulnerabilità legata al danneggiamento della memoria di Windows Media Player - CVE-2010-2745  
</th>
<th style="border:1px solid black;" >
...
Windows Media Player 9 in Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
...
<td style="border:1px solid black;">
Windows Media Player 10 in Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 10 in Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 10 in Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 10 in Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 11 in Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 11 in Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 11 in Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 11 in Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 11 in Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Moderato**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 11 in Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Moderato**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 12 in Windows 7 per sistemi a 32 bit
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Windows Media Player 12 in Windows 7 per sistemi x64
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 12 in Windows Server 2008 R2 per sistemi x64\*\*
</td>
<td style="border:1px solid black;">
**Moderato**   
Esecuzione di codice in modalità remota
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Windows Media Player disalloca gli oggetti durante un'operazione di ricarica tramite un browser Web. Questa vulnerabilità può consentire l'esecuzione di codice in modalità remota se un utente visita una pagina Web appositamente predisposta. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2745](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2745).

#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria di Windows Media Player - CVE-2010-2745
...
-   Le edizioni supportate di Windows Server 2008 e Windows Server 2008 R2 non sono interessate da questo problema a meno che non sia installata la funzionalità Desktop Experience. Per impostazione predefinita, queste piattaforme non caricano il componente di Windows Media Player interessato. Per ulteriori informazioni sulla funzionalità Desktop Experience, vedere l'articolo TechNet [Desktop Experience Overview](http://technet.microsoft.com/en-us/library/cc772567.aspx).

#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria di Windows Media Player - CVE-2010-2745

Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:

-   **Annullare la registrazione di wmp.dll**

    Per annullare la registrazione di questa DLL, eseguire i comandi seguenti da un prompt dei comandi di livello elevato.
    ...
    **Impatto della soluzione alternativa.** Windows Media Player non sarà in grado di riprodurre i formati file supportati.
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria di riproduzione in Windows Media Player - CVE-2010-2745
...
Windows Media Player disalloca erroneamente gli oggetti durante un'operazione di ricarica tramite un browser Web.
...
**Come si fa a sapere quale versione di Windows Media Player è installata nel sistema?**  
Per le istruzioni su come determinare la versione di Windows Media Player installata nel sistema, consultare [l'articolo della Microsoft Knowledge Base 190990](http://support.microsoft.com/kb/190990).

**È necessaria l'interazione dell'utente affinché venga sfruttata questa vulnerabilità?**  
Sì. Affinché un attacco abbia esito positivo, l'utente deve fare clic attraverso una o più finestre popup durante l'esplorazione di una pagina Web. Questa vulnerabilità non può essere sfruttata automaticamente durante la visita di una pagina Web appositamente predisposta.
...
L'aggiornamento risolve il problema correggendo il modo in cui Windows Media Player disalloca gli oggetti durante un'operazione di ricarica.
...
<td style="border:1px solid black;">Per Windows Media Player 9, Windows Media Player 10 e Windows Media Player 11 in Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Windows Media Player 10 in Windows XP Professional x64 Edition Service Pack 2:<br />
windowsserver2003.windowsxp-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Windows Media Player 11 in Windows XP Professional x64 Edition Service Pack 2:<br />
windowsmedia11-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installazione senza riavvio</td>
<td style="border:1px solid black;">Per Windows Media Player 9 in Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Windows Media Player 10 e Windows Media Player 11 in Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nelle seguenti posizioni:<br />
<br />
Per Windows Media Player 9, Windows Media Player 10 e Windows Media Player 11 in Windows XP Service Pack 3:<br />
cartella %Windir%\$NTUninstallKB2378111_WM9$\Spuninst<br />
<br />
Per Windows Media Player 10 in Windows XP Professional x64 Edition Service Pack 2:<br />
cartella %Windir%\$NTUninstallKB2378111$\Spuninst<br />
<br />
Per Windows Media Player 11 in Windows XP Professional x64 Edition Service Pack 2:<br />
cartella %Windir%\$NTUninstallKB2378111_WM11x64$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2378111">articolo della Microsoft Knowledge Base 2378111</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Per Windows Media Player 9, Windows Media Player 10 e Windows Media Player 11 nelle edizioni supportate a 32 bit di Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Windows Media Player 10 in tutte le edizioni supportate x64 di Windows XP:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP Version 2003\SP3\KB2378111\Filelist<br />
<br />
Per Windows Media Player 11 in tutte le edizioni supportate x64 di Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni per la rimozione</strong></td>
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2378111$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2378111">articolo della Microsoft Knowledge Base 2378111</a></td>
...
-   SkyLined di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria di Windows Media Player (CVE-2010-2745)
...
-   V1.1 (13 ottobre 2010): È stato corretto il collegamento per il download nella tabella **Software interessato** per Windows Media Player 11 in Windows XP Professional x64 Edition Service Pack 2. I clienti che hanno già installato questo pacchetto specifico tramite gli Aggiornamenti automatici non devono eseguire ulteriori operazioni. I clienti che hanno eseguito l'installazione manualmente dall'Area download Microsoft devono installare il nuovo pacchetto manualmente.
