...
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7eeac1bb-9f86-4ea5-b30f-980d52be5044)                                                           | Acquisizione di privilegi più elevati       | Importante                   | [MS10-073](http://go.microsoft.com/fwlink/?linkid=201093) |
...
<th style="border:1px solid black;" >Vulnerabilità legata al sovraccarico del buffer Win32k - CVE-2010-3939</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla condizione double free del puntatore PFE in Win32k - CVE-2010-3940</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla condizione double free in Win32k - CVE-2010-3941</th>
<th style="border:1px solid black;" >Vulnerabilità WriteAV in Win32k - CVE-2010-3942</th>
<th style="border:1px solid black;" >Vulnerabilità del collegamento cursore in Win32k - CVE-2010-3943</th>
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria Win32k - CVE-2010-3944</th>
...
#### Fattori attenuanti della vulnerabilità legata alla condizione double free del puntatore PFE in Win32k - CVE-2010-3940
...
#### Soluzioni alternative per la vulnerabilità WriteAV in Win32k - CVE-2010-3942
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria Win32k - CVE-2010-3944
...
-   Tarjei Mandt di [Norman](http://www.norman.com) per aver segnalato la vulnerabilità legata alla condizione double free del kernel di Windows (CVE-2010-3941)  
-   Tarjei Mandt di [Norman](http://www.norman.com) per aver segnalato la vulnerabilità di WriteAV del kernel di Windows (CVE-2010-3942)  
-   Tarjei Mandt di [Norman](http://www.norman.com) per aver segnalato la vulnerabilità del collegamento cursore del kernel di Windows (CVE-2010-3943)  
-   Tarjei Mandt di [Norman](http://www.norman.com) per aver segnalato la vulnerabilità legata al danneggiamento della memoria di Kernel di Windows (CVE-2010-3944)  
-   Stéfan Le Berre di [Sysdream](http://www.sysdream.com) per aver segnalato la vulnerabilità legata al danneggiamento della memoria di Kernel di Windows (CVE-2010-3944)
