---
TOCTitle: 'MS10-076'
Title: 'Bollettino Microsoft sulla sicurezza MS10-076 - Critico'
ms:assetid: 'ms10-076'
ms:contentKeyID: 61240514
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-076(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-076 - Critico
=======================================================

Una vulnerabilità nel motore per caratteri Embedded OpenType può consentire l'esecuzione di codice in modalità remota (982132)
------------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento della protezione risolve la vulnerabilità correggendo la modalità con cui il motore per caratteri Embedded OpenType analizza il contenuto e i file che includono caratteri incorporati. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c3799399-ca72-4dec-a2a2-3571ad0b2f63)                                                                          | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=860ff738-205d-430e-b223-b333813fc590)                                                 | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7b240b65-f3ca-465c-a606-b561999c1977)                                                                 | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=70c9e826-b80b-4a20-82d2-8e52e5cca839)                                                     | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=bd5878bb-f565-4303-afed-4e17b44a02f2)                                                    | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=29c4afb1-227d-4572-b136-a78ef7e1df77)                                        | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=880ad9a0-6ddd-41f4-a608-171d59a31b6a)                | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2008 per sistemi 32-bit e Windows Server 2008 per sistemi 32-bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=50386655-982e-4126-8261-2c972d695bbd)\*\* | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6b2ae1d-9225-4495-8560-97860f87d7b4)\*\*       | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a4e38a77-3835-47b3-bd86-6c039169abf5)   | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=f6cae091-e9f1-48e9-a035-4346b9c6fec6)                                                                     | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=35882477-4e0a-4783-a4b4-0f1ea3398360)                                                                          | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=b060c516-233a-4e1e-9237-698420e97b2f)\*\*                                                         | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0ead2ed9-8b2f-496e-b7d1-3ad2b04be5cc)                                                         | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2010-1883</th>
...
Vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2010-1883  
---------------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui la tecnologia dei caratteri Embedded OpenType (EOT) di Microsoft Windows analizza alcune tabelle nei caratteri incorporati appositamente predisposti. Se un utente è connesso con privilegi di amministrazione, un utente malintenzionato che sfrutti questa vulnerabilità può assumere il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1883](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1883).
  
#### Fattori attenuanti della vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2010-1883
...
#### Soluzioni alternative per la vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2010-1883
...
-   **Disattivare il supporto per l'analisi dei caratteri incorporati in Internet Explorer**
    ...
    **Utilizzo del metodo interattivo:**
    ...
    1.  In Internet Explorer, fare clic sul menu **Strumenti**, quindi scegliere **Opzioni Internet**.  
    2.  Nelle **Opzioni Internet**, fare clic sulla scheda **Protezione**, selezionare **Internet Zone,** quindi fare clic su **Livello personalizzato.**  
    3.  Nelle **Impostazioni protezione - Area Internet**, scorrere verso il basso fino a **Download** nel riquadro **Impostazioni** e selezionare un'impostazione di **Chiedi conferma** o **Disattiva** del **download del carattere**.  
    4.  Fare clic su **OK** per salvare la selezione, quindi selezionare di nuovo **OK** per tornare a Internet Explorer.
  
    **Utilizzo dei criteri di gruppo:**
  
    **Nota** Lo snap-in di MMC Criteri di gruppo può essere utilizzato per impostare i criteri per un sistema, un'unità organizzativa o un intero dominio. Per ulteriori informazioni sui Criteri di gruppo, visitare i seguenti siti Web Microsoft:
  
    -   Insieme di [Criteri di gruppo](http://technet.microsoft.com/it-it/library/cc779838(ws.10).aspx)  
    -   [Che cos'è](http://technet.microsoft.com/it-it/library/cc737816(ws.10).aspx) un Editor oggetti Criteri di gruppo?  
    -   Strumenti e impostazioni [principali di Criteri di gruppo](http://technet.microsoft.com/it-it/library/cc784165(ws.10).aspx)
  
    Per utilizzare i Criteri di gruppo, eseguire i seguenti passaggi:
    ...
    2.  Selezionare **Configurazione utente**, fare clic su **Impostazioni di Windows**, selezionare **Manutenzione di Internet Explorer**, quindi fare clic su **Protezione**.  
    3.  Fare doppio clic su **Aree di protezione e classificazioni del contenuto**, selezionare **Importa le impostazioni per le aree di protezione correnti e di privacy**, quindi fare clic su **Modifica impostazioni**.
  
    **Note** Questa azione crea criteri di gruppo per Internet Explorer basati sulle impostazioni dell'utente connesso e apre Proprietà Internet.
  
    1.  In Proprietà Internet, fare clic sulla scheda **Protezione**, assicurarsi che l'area **Internet** sia selezionata, quindi fare clic su **Livello personalizzato**.  
    2.  Nelle **Impostazioni protezione - Area Internet**, scorrere verso il basso fino a **Download** nel riquadro **Impostazioni** e selezionare un'impostazione di **Chiedi conferma** o **Disattiva** del **download del carattere**.  
    3.  Fare clic su **OK** per tornare a **Proprietà Internet**.  
    4.  Ripetere i passaggi da 4 a 6 per l'area **Intranet locale**.  
    5.  Premere **OK** tre volte per ritornare al sistema di gestione dei criteri di gruppo.  
    ...
    **Avvertenza** L'utilizzo non corretto dell'Editor del Registro di sistema potrebbe causare problemi tali da rendere necessaria la reinstallazione del sistema operativo. Microsoft non garantisce la risoluzione di problemi dovuti a un utilizzo non corretto dell'Editor del Registro di sistema. È quindi necessario utilizzare questo strumento con grande attenzione.
    ...
    Per salvare questa impostazione su "Chiedi conferma" per le aree Internet e intranet locale incollare il testo seguente in un file .REG, quindi importarlo nei computer gestiti come parte del processo di distribuzione gestito dalla propria organizzazione:
    ...
    Per salvare questa impostazione su "Disattiva" per le aree Internet e intranet locale incollare il testo seguente in un file .REG, quindi importarlo nei computer gestiti come parte del processo di distribuzione gestito dalla propria organizzazione:
...
#### Domande frequenti sulla vulnerabilità legata all'overflow dei valori interi dei caratteri Embedded OpenType - CVE-2010-1883
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato potrebbe assumere il pieno controllo in remoto del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata da un overflow dei valori interi quando un componente di Microsoft Windows, il motore per caratteri Embedded OpenType, analizza alcune tabelle all'interno di file e contenuto appositamente predisposti che contengono caratteri incorporati.
...
Questa vulnerabilità può essere sfruttata solo se un utente apre un contenuto che incorpora un carattere EOT appositamente predisposto.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB982132$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/http://support.microsoft.com/?ln=it">articolo della Microsoft Knowledge Base 982132</a></td>
</tr>
<tr class="even">
...
-   Sebastian Apelt, che collabora con [Tipping Point](http://www.tippingpoint.com) e [Zero Day Initiative](http://www.zerodayinitiative.com/) per aver segnalato la vulnerabilità legata all'overflow di valori interi dei caratteri Embedded OpenType (CVE-2010-1883)  
-   Ivan Fratric, attraverso [iSIGHT Partners Global Vulnerability Partnership](https://gvp.isightpartners.com), per aver segnalato la vulnerabilità legata all'overflow di valori interi dei caratteri Embedded OpenType (CVE-2010-1883)
