---
TOCTitle: 'MS10-067'
Title: 'Bollettino Microsoft sulla sicurezza MS10-067 - Importante'
ms:assetid: 'ms10-067'
ms:contentKeyID: 61240506
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-067(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-067 - Importante
==========================================================

Una vulnerabilità nei convertitori di testo di WordPad può consentire l'esecuzione di codice in modalità remota (2259922)
-------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve la vulnerabilità modificando il modo in cui i convertitori di testo di WordPad gestiscono i file appositamente predisposti. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=fc4369ec-864a-42ae-a850-b006872241fe)                          | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7567986a-261d-4def-9fa5-c667994c7844) | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3290e7ee-1e4a-464c-abfd-17fc4108601e)                 | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b21570cc-4f90-4ed8-b901-a34584d44a63)     | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c9c4427d-54c8-4f3c-9a94-818196cd5180)    | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria nel convertitore di testo di WordPad per Word 97 - CVE-2010-2563</th>
...
Vulnerabilità legata al danneggiamento della memoria nel convertitore di testo di WordPad per Word 97 - CVE-2010-2563  
---------------------------------------------------------------------------------------------------------------------
  
<span></span>
Una vulnerabilità legata all'esecuzione di codice in modalità remota è stata riscontrata nel modo in cui Microsoft WordPad elabora la memoria durante l'analisi di un documento di Word 97 appositamente predisposto. Tale vulnerabilità può consentire l'esecuzione di codice in modalità remota durante l'apertura di un file di Word appositamente predisposto contenente una struttura non valida.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2563).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria nel convertitore di testo di WordPad per Word 97 - CVE-2010-2563
...
-   Non è possibile sfruttare la vulnerabilità automaticamente per posta elettronica. L'attacco è possibile solo se l'utente apre un allegato a un messaggio di posta elettronica. che chiede all'utente se desidera aprire o meno il file, a meno che non sia stata precedentemente disattivata l'opzione "Avvisa sempre prima di aprire questo tipo di file".  
-   Nei sistemi in cui è installato Microsoft Word generalmente i documenti Word vengono aperti con Microsoft Office anziché con WordPad per impostazione predefinita.
  
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria nel convertitore di testo di WordPad per Word 97 - CVE-2010-2563
...
-   Disattivare il convertitore di testo di WordPad per Word 97 limitando l'accesso al file del convertitore.
    ...
    Un amministratore può applicare un elenco di controllo di accesso ai convertitori interessati al fine di impedire che essi vengano caricati da WordPad. Questa procedura previene efficacemente lo sfruttamento del problema mediante questo vettore di attacco.
    ...
    **Avviso** Annullare il risultato della soluzione alternativa prima di installare il presente aggiornamento per la protezione.
    ...
    Per applicare l'elenco di accesso, effettuare l'accesso come amministratore ed eseguire i comandi seguenti dal prompt dei comandi.
  
    **Nota** Alcuni di questi comandi possono generare un messaggio di errore; tale messaggio di errore è prevedibile se il file per cui si tenta di modificare le autorizzazioni non esiste.
    ...
    **Impatto della soluzione alternativa.** Dopo aver implementato la soluzione alternativa, quando si apre un documento Word in WordPad vengono visualizzati i dati binari anziché il testo formattato.
  
    **Per annullare il risultato della soluzione alternativa.** Effettuare l'accesso come amministratore ed eseguire i comandi seguenti dal prompt dei comandi.
  
    **Nota** A seconda della versione del sistema operativo e della cronologia degli aggiornamenti del sistema operativo e dei service pack, alcuni dei file indicati sotto potrebbero non esistere. Questo è prevedibile.
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria nel convertitore di testo di WordPad per Word 97 - CVE-2010-2563
...
La vulnerabilità si presenta quando il convertitore di testo di WordPad analizza in modo errato dei campi specifici in un documento Word 97.
  
**Che cosa sono i convertitori di testo di WordPad?**    
WordPad è un componente predefinito dei sistemi operativi di Microsoft Windows. I convertitori di testo in WordPad consentono agli utenti che non hanno installato Microsoft Word di aprire documenti nei formati Microsoft Windows Write (.wri) e Microsoft Word (.doc).
...
In uno scenario di attacco dal Web, l'utente malintenzionato deve pubblicare un sito Web contenente un documento di Word 97 utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare un sito Web appositamente predisposto, l'utente malintenzionato deve convincere le vittime a visitare il sito, in genere inducendole a fare clic su un collegamento che le indirizzi al sito Web di origine dell'attacco. L'utente riceve anche una richiesta e deve accettare manualmente di aprire il documento.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi più esposti sono quelli che utilizzano WordPad per aprire documenti Word provenienti da fonti non attendibili, come le workstation o i server terminal. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi. Nei sistemi in cui è installato Microsoft Word generalmente i documenti Word vengono aperti con Microsoft Office anziché con WordPad per impostazione predefinita.
  
**Quali sono gli scopi dell'aggiornamento?**    
Il presente aggiornamento risolve la vulnerabilità modificando il modo in cui i convertitori di testo di WordPad gestiscono i file appositamente predisposti.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
No. Microsoft ha ricevuto informazioni sulla vulnerabilità grazie ad un'indagine coordinata. Secondo le informazioni in possesso di Microsoft, al momento della pubblicazione del presente bollettino l'esistenza di questa vulnerabilità non era stata ancora divulgata pubblicamente.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2259922$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2259922">articolo della Microsoft Knowledge Base 2259922</a></td>
</tr>
<tr class="even">
...
-   S0lute di [iDefense Labs](http://labs.idefense.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria del convertitore di testo di WordPad per Word 97 (CVE-2010-2563)
