---
TOCTitle: 'MS10-073'
Title: 'Bollettino Microsoft sulla sicurezza MS10-073 - Importante'
ms:assetid: 'ms10-073'
ms:contentKeyID: 61240511
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-073(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-073 - Importante
==========================================================

Alcune vulnerabilità nei driver in modalità kernel di Windows possono consentire l'acquisizione di privilegi più elevati (981957)
---------------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui i driver in modalità kernel di Windows mantengono il conteggio dei riferimenti di un oggetto, indicizzano una tabella di puntatori di funzione durante il caricamento di un layout di tastiera dal disco e convalidano i dati di classe di finestra. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7fd7c675-0675-4a87-a709-edc47a30f1e2)                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1)                                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745)                                                       | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=21637cd8-c75c-43b4-9948-be7be54af6bf)                                                      | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f)                                          | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db)                  | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763)\* | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e)\*           | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9096046-8c7a-450c-b8c5-6e9fb001e6cd)     | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602)                                                                       | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5)\*                                                             | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=44080c75-036e-4bd0-914a-74ab72189ee3)                                                           | Acquisizione di privilegi più elevati       | Importante                   | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
...
<th style="border:1px solid black;" >Vulnerabilità legata al conteggio dei riferimenti Win32k - CVE-2010-2549</th>
<th style="border:1px solid black;" >Vulnerabilità legata al layout di tastiera Win32k - CVE-2010-2743</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla creazione di classi di finestre Win32K - CVE-2010-2744</th>
...
Vulnerabilità legata al conteggio dei riferimenti Win32k - CVE-2010-2549  
------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui i driver in modalità kernel di Windows mantengono il conteggio dei riferimenti di un oggetto. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549).
  
#### Fattori attenuanti della vulnerabilità legata al conteggio dei riferimenti Win32k - CVE-2010-2549
...
#### Soluzioni alternative per la vulnerabilità legata al conteggio dei riferimenti Win32k - CVE-2010-2549
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al conteggio dei riferimenti Win32k - CVE-2010-2549
...
La vulnerabilità è causata quando i driver in modalità kernel di Windows non mantengono correttamente il conteggio dei riferimenti di un oggetto.
...
**Che cos'è un conteggio dei riferimenti?**    
Un conteggio dei riferimenti è la registrazione del gestore degli oggetti del numero di puntatori di oggetto che ha dispensato ai processi del sistema operativo. Il gestore degli oggetti incrementa il conteggio dei riferimenti di un oggetto ogni volta che fornisce un puntatore all'oggetto; quando i componenti di modalità kernel terminano l'utilizzo del puntatore, richiamano il gestore degli oggetti per diminuire il conteggio dei riferimenti dell'oggetto.
...
L'aggiornamento risolve questa vulnerabilità correggendo il modo in cui i driver in modalità kernel di Windows mantengono il conteggio dei riferimenti di un oggetto.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549).
  
**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**    
No. Al momento della pubblicazione del presente bollettino, Microsoft non aveva ricevuto alcuna segnalazione in merito allo sfruttamento di questa vulnerabilità a scopo di attacco, né dell'esistenza di un codice di prova pubblicato.
  
Vulnerabilità legata al layout di tastiera Win32k - CVE-2010-2743  
-----------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui i driver in modalità kernel di Windows caricano layout di tastiera specifici. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2743](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743).
  
#### Fattori attenuanti della vulnerabilità legata al layout di tastiera Win32k - CVE-2010-2743
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata al layout di tastiera Win32k - CVE-2010-2743
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al layout di tastiera Win32k - CVE-2010-2743
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata quando i driver in modalità kernel di Windows non indicizzano correttamente una tabella di puntatori di funzione durante il caricamento di un layout di tastiera dal disco.
  
**Perché questa vulnerabilità ha una classificazione di gravità bassa per tutte le edizioni supportate di Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2?**    
Su queste versioni di Windows, il codice che riguarda questa vulnerabilità esiste, ma non vi è attualmente alcun modo conosciuto per il quale un utente malintenzionato possa raggiungere tale codice. Tuttavia, questo aggiornamento risolve il problema come misura di difesa in profondità, qualora venga individuato in futuro un modo per sfruttare questo codice per acquisire privilegi elevati.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve questa vulnerabilità correggendo il modo in cui i driver in modalità kernel di Windows indicizzano una tabella di puntatori di funzione durante il caricamento di un layout di tastiera da disco.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-2743](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743).
  
**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**    
Sì. Al momento del rilascio del presente bollettino, questa vulnerabilità veniva sfruttata su scala ridotta da malware.
  
Vulnerabilità legata alla creazione di classi di finestre Win32K - CVE-2010-2744  
--------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati quando i driver in modalità kernel di Windows non convalidano correttamente i dati di classe di finestra. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-2744](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744).
  
#### Fattori attenuanti della vulnerabilità legata alla creazione di classi di finestre Win32k - CVE-2010-2744
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alla creazione di classi di finestre Win32k - CVE-2010-2744
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla creazione di classi di finestre Win32k - CVE-2010-2744
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
Questa vulnerabilità è causata dai driver in modalità kernel di Windows che non gestiscono correttamente una classe di finestra.
...
**Che cos'è una classe di finestra?**    
Una classe di finestra è una serie di attributi che il sistema utilizza come modello per creare una finestra. Ogni finestra è membro di una classe di finestre. Tutte le classi di finestra sono specifiche di processo. Vi sono tre tipi di classi di finestra. Una classe di sistema è una classe di finestra registrata dal sistema. Sono disponibili per l'utilizzo molte classi di sistema per tutti i processi, mentre altre vengono utilizzate dal sistema solo internamente. Poiché il sistema registra tali classi, un processo non è in grado di distruggerle. Una classe di applicazione globale è una classe di finestra registrata da un eseguibile o DLL disponibile a tutti gli altri moduli del processo. Una classe locale di applicazione è qualsiasi classe di finestra registrata da un eseguibile o .dll per il proprio utilizzo esclusivo. Sebbene sia possibile registrare qualsiasi numero di classi locali, generalmente se ne registra soltanto una. Questa classe di finestra supporta la procedura di finestra della finestra principale dell'applicazione. Per ulteriori informazioni sulle classi di finestra, vedere l'articolo MSDN, [Classi di Finestra](http://msdn.microsoft.com/en-us/library/ms632596(v=vs.85).aspx).
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve questa vulnerabilità correggendo il modo in cui i driver in modalità kernel di Windows convalidano i dati di classe di finestra.
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-2744](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744).
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB981957$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/981957">articolo della Microsoft Knowledge Base 981957</a></td>
</tr>
<tr class="even">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin e Alexey Monastyrsky di [Kaspersky Lab](http://www.kaspersky.com) e Vitaly Kiktenko e Alexander Saprykin di [Design and Test Lab](http://www.dnt-lab.com) per aver segnalato la vulnerabilità legata al layout di tastiera Win32K (CVE-2010-2743)  
-   Joji Hamada di [Symantec](http://www.symantec.com/index.jsp) per aver segnalato la vulnerabilità legata al layout di tastiera Win32k (CVE-2010-2743)  
-   Tarjei Mandt di [Norman](http://www.norman.com) per aver collaborato con noi sulla vulnerabilità legata alla creazione di classi di finestra Win32K (CVE-2010-2744)
