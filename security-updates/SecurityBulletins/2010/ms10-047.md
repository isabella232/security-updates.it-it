---
TOCTitle: 'MS10-047'
Title: 'Bollettino Microsoft sulla sicurezza MS10-047 - Importante'
ms:assetid: 'ms10-047'
ms:contentKeyID: 61240486
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms10-047(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS10-047 - Importante
==========================================================

Alcune vulnerabilità del kernel di Windows possono consentire l'acquisizione di privilegi più elevati (981852)
--------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per Windows XP, Windows Vista e Windows Server 2008 e moderato per Windows 7 e Windows Server 2008 R2. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità correggendo l'inizializzazione degli oggetti del kernel di Windows e la convalida degli elenchi di controllo di accesso e aggiungendo una convalida aggiuntiva in fase di esecuzione al meccanismo di creazione dei thread. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1)                                          | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc)                  | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27)\* | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=131f3512-1585-462e-a4f1-3f359aac44bd)\*           | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=972efd3a-ec1e-49b2-835e-76f4b21b5b79)     | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14)                                                                       | Denial of Service                           | Moderato                     | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8)                                                                            | Denial of Service                           | Moderato                     | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4)\*                                                             | Denial of Service                           | Moderato                     | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f23dec0f-a33b-4d8c-a86d-0e9368ae7ff5)                                                           | Denial of Service                           | Moderato                     | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'inizializzazione dei dati del kernel di Windows - CVE-2010-1888</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla condizione double free del kernel di Windows - CVE-2010-1889</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla convalida errata del kernel di Windows - CVE-2010-1890</th>
...
Vulnerabilità legata all'inizializzazione dei dati del kernel di Windows - CVE-2010-1888  
----------------------------------------------------------------------------------------
  
<span></span>
Nel kernel di Windows è stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui il kernel gestisce i tentativi di creazione di thread specifici. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1888](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888).
  
#### Fattori attenuanti della vulnerabilità legata all'inizializzazione dei dati del kernel di Windows - CVE-2010-1888
...
#### Soluzioni alternative per la vulnerabilità legata all'inizializzazione dei dati del kernel di Windows - CVE-2010-1888
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'inizializzazione dei dati del kernel di Windows - CVE-2010-1888
...
Vulnerabilità legata alla condizione double free del kernel di Windows - CVE-2010-1889  
--------------------------------------------------------------------------------------
  
<span></span>
Nel kernel di Windows è stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui il kernel inizializza gli oggetti durante la gestione di determinati errori. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1889](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889).
  
#### Fattori attenuanti della vulnerabilità legata alla condizione double free del kernel di Windows - CVE-2010-1889
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alla condizione double free del kernel di Windows - CVE-2010-1889
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla condizione double free del kernel di Windows - CVE-2010-1889
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
Il kernel di Windows non inizializza correttamente gli oggetti durante la gestione di determinati errori.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità facendo in modo che il kernel di Windows inizializzi correttamente gli oggetti durante la gestione di determinati errori.
...
Vulnerabilità legata alla convalida errata del kernel di Windows - CVE-2010-1890  
--------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità ad attacchi di tipo Denial of Service nel modo in cui il kernel di Windows convalida gli elenchi di controllo di accesso sugli oggetti kernel. Un utente malintenzionato potrebbe sfruttare la vulnerabilità eseguendo un'applicazione appositamente predisposta che causa il blocco e il riavvio automatico del sistema.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890).
  
#### Fattori attenuanti della vulnerabilità legata alla convalida errata del kernel di Windows - CVE-2010-1890
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale. La vulnerabilità non può essere sfruttata in remoto o da utenti anonimi.
  
#### Soluzioni alternative per la vulnerabilità legata alla convalida errata del kernel di Windows - CVE-2010-1890
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla convalida errata del kernel di Windows - CVE-2010-1890
...
**Quali sono le cause di questa vulnerabilità?**    
Il kernel di Windows non convalida correttamente gli elenchi di controllo di accesso sugli oggetti kernel.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve questa vulnerabilità correggendo il modo in cui il kernel di Windows convalida gli elenchi di controllo di accesso applicati agli oggetti kernel.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB981852$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/981852">articolo della Microsoft Knowledge Base 981852</a></td>
</tr>
<tr class="even">
...
-   Tavis Ormandy di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata all'inizializzazione dei dati del kernel di Windows (CVE-2010-1888)  
-   Tavis Ormandy di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata alla condizione double free del kernel di Windows (CVE-2010-1889)  
-   Tavis Ormandy di [Google Inc.](http://www.google.com/) per aver segnalato la vulnerabilità legata alla convalida errata del kernel di Windows (CVE-2010-1890)
