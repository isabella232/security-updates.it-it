---
TOCTitle: 'MS11-011'
Title: 'Bollettino Microsoft sulla sicurezza MS11-011 - Importante'
ms:assetid: 'ms11-011'
ms:contentKeyID: 61240554
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-011(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-011 - Importante
==========================================================

Alcune vulnerabilità del kernel di Windows possono consentire l'acquisizione di privilegi più elevati (2393802)
---------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve le vulnerabilità assicurando che il kernel di Windows convalidi correttamente i dati forniti dall'utente prima di assegnare la memoria. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=a511d33a-9ae0-46ee-a225-9d97390de7d1)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e7273a85-ce96-464b-8c4f-2710701213e3)                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6bf2eeec-8225-477f-a606-263d3ee434d6)                                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ec544894-ee98-4a2b-ac4d-33b0c3754213)                                                       | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=fcd48499-1bb4-4304-b9cc-27d9d92e11cd)                                                      | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://technet.microsoft.com/security/bulletin/ms10-021) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=66978514-bb7f-42cc-9360-2fd1c686f4e6)                                          | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8fdb8c37-1b22-457b-bdc0-21f6a5061dd3)                  | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4b37418a-e044-415e-b566-4507f157934a)\* | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=163d3aca-3703-452e-b1cb-73932e2bcf8c)\*           | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=55b07bc0-dff5-4cd7-87c9-c08e5a49197d)     | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=e1224c90-b0bc-4e4b-999a-efae327213b4)                                                                       | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=ddcf352e-742c-485e-9ed5-19cdba673562)                                                                            | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=70f5056a-72ad-46ff-a43f-ee151639b9a7)\*                                                             | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1646b3a5-714f-4ea5-b109-566fa9b933b6)                                                           | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)           |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'interazione errata del driver con il kernel di Windows - CVE-2010-4398</th>
<th style="border:1px solid black;" >Vulnerabilità legata al troncamento dei valori integer del kernel di Windows - CVE-2011-0045</th>
...
Vulnerabilità legata all'interazione errata del driver con il kernel di Windows - CVE-2010-4398  
-----------------------------------------------------------------------------------------------
  
<span></span>
È stata riscontrata una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta all'interazione errata dei driver con il kernel di Windows. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario nella modalità kernel ed assumere il controllo completo di un sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-4398](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398).
  
#### Fattori attenuanti della vulnerabilità legata all'interazione errata del driver con il kernel di Windows - CVE-2010-4398
...
#### Soluzioni alternative per la vulnerabilità legata all'interazione errata del driver con il kernel di Windows - CVE-2010-4398
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'interazione errata del driver con il kernel di Windows - CVE-2010-4398
...
La vulnerabilità è causata dall'interazione errata dei driver con il kernel di Windows.
...
L'aggiornamento risolve la vulnerabilità proteggendo l'interazione dei driver interessati con il kernel di Windows.
  
**L'aggiornamento include modifiche di funzionalità relative alla sicurezza?**    
L'aggiornamento contiene modifiche alle funzionalità relative alla sicurezza. Per ulteriori informazioni, vedere l'articolo MSDN [Routine RtlQueryRegistryValues](http://msdn.microsoft.com/en-us/library/ff562046(v=vs.85).aspx).
  
**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**    
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-4398](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398).
  
**Al momento del rilascio di questo bollettino erano già stati segnalati attacchi basati sullo sfruttamento di questa vulnerabilità?**    
No. Al momento della pubblicazione del presente bollettino, Microsoft non aveva ricevuto alcuna segnalazione in merito allo sfruttamento di questa vulnerabilità a scopo di attacco.
  
Vulnerabilità legata al troncamento dei valori integer del kernel di Windows - CVE-2011-0045  
--------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui il kernel di Windows assegna la memoria quando legge i dati forniti dall'utente. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario nella modalità kernel ed assumere il controllo completo di un sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0045](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0045).
  
#### Fattori attenuanti della vulnerabilità legata al troncamento dei valori integer del kernel di Windows - CVE-2011-0045
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per sfruttare la vulnerabilità, è necessario disporre di credenziali di accesso valide ed essere in grado di accedere al sistema in locale.
  
#### Soluzioni alternative per la vulnerabilità legata al troncamento dei valori integer del kernel di Windows - CVE-2011-0045
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al troncamento dei valori integer del kernel di Windows - CVE-2011-0045
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario nella modalità kernel ed assumere il controllo completo di un sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.
  
**Quali sono le cause di questa vulnerabilità?**    
Il kernel di Windows non convalida correttamente i dati forniti dall'utente prima di assegnare la memoria.
...
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità assicurando che il kernel di Windows convalidi correttamente i dati forniti dall'utente prima di assegnare la memoria.
...
<td style="border:1px solid black;">Utilizzare lo strumento <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2393802$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2393802">articolo della Microsoft Knowledge Base 2393802</a></td>
</tr>
<tr class="even">
...
-   Zhengwenbin di [360safe](http://www.360.cn) per aver segnalato la vulnerabilità legata all'interazione errata del driver con il kernel di Windows (CVE-2010-4398)  
-   Guo Bojun per aver segnalato la vulnerabilità legata all'interazione errata del driver con il kernel di Windows (CVE-2010-4398)  
-   Wei Zhang per aver segnalato la vulnerabilità legata all'interazione errata del driver con il kernel di Windows (CVE-2010-4398)  
-   Marco Giuliani di [Prevx](http://www.prevx.com/) per aver collaborato con noi allo studio della vulnerabilità legata all'interazione errata del driver con il kernel di Windows (CVE-2010-4398)  
-   std\_logic, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata al troncamento dei valori integer del kernel di Windows (CVE-2011-0045)
...
-   V1.1 (2 marzo 2011): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2393802 nella sottosezione Problemi noti del Riepilogo.  
-   V1.2 (18 marzo 2011): Microsoft ha incluso Windows 7 per sistemi a 32 bit Service Pack 1, Windows 7 per sistemi x64 Service Pack 1, Windows Server 2008 R2 per sistemi x64 Service Pack 1 e Windows Server 2008 R2 per sistemi Itanium Service Pack 1 ai **software non interessati**. La modifica è esclusivamente informativa. Non sono previste modifiche ai file di aggiornamento per la protezione o per la logica di rilevamento.
