---
TOCTitle: 'MS11-008'
Title: 'Bollettino Microsoft sulla sicurezza MS11-008 - Importante'
ms:assetid: 'ms11-008'
ms:contentKeyID: 61240551
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-008(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-008 - Importante
==========================================================

Alcune vulnerabilità in Microsoft Visio possono consentire l'esecuzione di codice in modalità remota (2451879)
--------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione è considerato di livello importante per Microsoft Visio 2002 Service Pack 2, Microsoft Visio 2003 Service Pack 3 e Microsoft Visio 2007 Service Pack 2. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato**, in questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui Microsoft Visio gestisce strutture e oggetti corrotti nella memoria durante l'analisi di file Visio appositamente predisposti. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
<thead>
<tr class="header">
<th style="border:1px solid black;" >Microsoft Office e altro software di produttività</th>
...
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria degli oggetti Visio - CVE-2011-0092</th>
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria per determinati tipi di dati Visio - CVE-2011-0093</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
Vulnerabilità legata al danneggiamento della memoria degli oggetti Visio - CVE-2011-0092  
----------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Visio convalida gli oggetti nella memoria durante l'analisi di file Visio appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0092](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0092).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria degli oggetti Visio - CVE-2011-0092
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria degli oggetti Visio - CVE-2011-0092
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Limitare l'accesso a ORMELEMS.dll**
    ...
    **Nota** Per &lt;office version&gt; inserire la versione appropriata del componente Microsoft Office installato nel proprio sistema, ad esempio "Office10" per Microsoft Visio 2002," Office11" per Microsoft Visio 2003 e "Office12" per Microsoft Visio 2007. Per controllare la versione, aprire il componente Microsoft Office e fare clic su **?**.
    ...
    **Per le edizioni a 64 bit di Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2:**
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<office version>\ormelems.dll" /E /P everyone:N`
  
    **Nota** Per &lt;office version&gt; inserire la versione appropriata del componente Microsoft Office installato nel proprio sistema, ad esempio "Office10" per Microsoft Visio 2002," Office11" per Microsoft Visio 2003 e "Office12" per Microsoft Visio 2007. Per controllare la versione, aprire il componente Microsoft Office e fare clic su **?**.
  
    **Impatto della soluzione alternativa.** Gli utenti non possono utilizzare la funzione Modello Database in Visio.
...
-   **Disattivare i componenti aggiuntivi in Microsoft Visio 2007**
  
    Aprire Visio 2007 e seguire i passaggi riportati di seguito:
  
    1.  Fare clic su **Strumenti**.  
    2.  Fare clic su **Centro protezione**.  
    3.  Fare clic su **Componenti aggiuntivi**.  
    4.  Accertarsi che la casella di controllo **Disattiva tutti i componenti aggiuntivi applicazioni** sia selezionata.  
    5.  Fare clic su **OK** per applicare le impostazioni.
  
    **Impatto della soluzione alternativa.** Le funzioni basate sui componenti aggiuntivi di Visio non funzionano.
    ...
    **Per annullare il risultato della soluzione alternativa.**
    ...
    2.  Fare clic su **Centro protezione**.  
    3.  Fare clic su **Componenti aggiuntivi**.  
    4.  Accertarsi che la casella di controllo **Disattiva tutti i componenti aggiuntivi applicazioni** non sia selezionata.  
    5.  Fare clic su **OK** per applicare le impostazioni.
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria degli oggetti Visio - CVE-2011-0092
...
Microsoft Visio non convalida correttamente gli oggetti nella memoria quando analizza i file Visio appositamente predisposti.
...
I sistemi più esposti sono quelli che utilizzano Microsoft Visio, inclusi le workstation e i server terminal. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento corregge la vulnerabilità modificando il modo in cui Microsoft Visio convalida gli oggetti nella memoria quando analizza file Visio appositamente predisposti.
...
Vulnerabilità legata al danneggiamento della memoria per determinati tipi di dati Visio - CVE-2011-0093  
-------------------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Visio analizza determinate strutture durante la gestione di file Visio appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0093](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0093).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria per determinati tipi di dati Visio - CVE-2011-0093
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria per determinati tipi di dati Visio - CVE-2011-0093
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Limitare l'accesso a ELEMENTS.dll**
...
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria per determinati tipi di dati Visio - CVE-2011-0093
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
**Quali sono le cause di questa vulnerabilità?**    
Microsoft Visio non gestisce correttamente le strutture corrotte quando apre file Visio appositamente predisposti.
...
In uno scenario di attacco dal Web, l'utente malintenzionato dovrebbe pubblicare un sito Web contenente un file Visio appositamente predisposto utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare questi siti Web, un utente malintenzionato deve dunque convincere gli utenti a visitare il sito Web, in genere inducendoli a fare clic su un collegamento che li indirizzi al sito dell'utente malintenzionato. Successivamente, deve convincerli ad aprire un file Visio appositamente predisposto.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi più esposti sono quelli che utilizzano Microsoft Visio, inclusi le workstation e i server terminal. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi.
  
**Quali sono gli scopi dell'aggiornamento?**    
Questo aggiornamento risolve la vulnerabilità correggendo il modo in cui Microsoft Visio analizza le strutture corrotte quando apre file Visio appositamente predisposti.
...
| Microsoft Visio 2007 Service Pack 2 | No   |
...
| Microsoft Visio 2007 Service Pack 2 | No      | No                | No                | No                         |
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2434711">articolo della Microsoft Knowledge Base 2434711</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2434733">articolo della Microsoft Knowledge Base 2434733</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
#### Microsoft Visio 2007 (tutte le edizioni)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2434737">articolo della Microsoft Knowledge Base 2434737</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Procyun, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata al danneggiamento della memoria degli oggetti Visio (CVE-2011-0092)  
-   Xin Ouyang di [Palo Alto Networks](http://www.paloaltonetworks.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria degli oggetti Visio (CVE-2011-0092)  
-   Xin Ouyang di [Palo Alto Networks](http://www.paloaltonetworks.com/) per aver segnalato la vulnerabilità legata al danneggiamento della memoria per determinati tipi di dati Visio (CVE-2011-0093)
