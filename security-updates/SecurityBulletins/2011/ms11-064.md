---
TOCTitle: 'MS11-064'
Title: 'Bollettino Microsoft sulla sicurezza MS11-064 - Importante'
ms:assetid: 'ms11-064'
ms:contentKeyID: 61240605
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-064(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-064 - Importante
==========================================================

Alcune vulnerabilità nello stack TCP/IP possono consentire un attacco di tipo Denial of Service (2563894)
---------------------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=114c2835-921a-4d3e-be91-dfd217fd26a9)                                                                           | Denial of Service                           | Moderato                     | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0fcee476-8d7e-49a7-b6ea-89043304a653)                                                               | Denial of Service                           | Moderato                     | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c01d9132-af5f-4039-8195-95f6761f2d0e)\*                                              | Denial of Service                           | Importante                   | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=70797adb-d693-4102-9e7c-ba1ea8fb07d0)\*                                                   | Denial of Service                           | Importante                   | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9babf81a-8b21-42ae-a65c-f414793516ab)                                                 | Denial of Service                           | Importante                   | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows 7 per sistemi a 32 bit e Windows 7 per sistemi a 32 bit Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=814bbdfa-7cbc-40e5-8ca3-8fed9d13ff00)                         | Denial of Service                           | Moderato                     | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows 7 per sistemi x64 e Windows 7 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=085ee785-b6ad-4c68-835a-e17bc8f12a53)                                   | Denial of Service                           | Moderato                     | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9fd2b4ba-d98e-4ad6-99f2-c471335042d3)\*       | Denial of Service                           | Importante                   | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows Server 2008 R2 per sistemi Itanium e Windows Server 2008 R2 per sistemi Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=93752c8f-5461-4e6f-9cab-6401b985ef17) | Denial of Service                           | Importante                   | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
...
<th style="border:1px solid black;" >Vulnerabilità ad attacchi di tipo Denial of Service in ICMP - CVE-2011-1871</th>
<th style="border:1px solid black;" >Vulnerabilità ad attacchi di tipo Denial of Service dovuta al meccanismo di convalida di QoS in TCP/IP - CVE-2011- 1965</th>
...
Vulnerabilità ad attacchi di tipo Denial of Service in ICMP - CVE-2011-1871  
---------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità ad attacchi di tipo Denial of Service nello stack TCP/IP di Windows, causato quando lo stack TCP/IP gestisce erroneamente una sequenza di messaggi ICMP appositamente predisposti. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può impedire al sistema di rispondere alle richieste e forzarne eventualmente il riavvio automatico.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1871](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1871).
  
#### Fattori attenuanti della vulnerabilità ad attacchi di tipo Denial of Service in ICMP - CVE-2011-1871
  
Microsoft non ha individuato alcun fattore attenuante per questa vulnerabilità.
  
#### Soluzioni alternative per la vulnerabilità ad attacchi di tipo Denial of Service in ICMP - CVE-2011-1871
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   **Bloccare ICMP al firewall**
  
    Bloccando tutti i messaggi ICMP a livello di firewall dei limiti di rete o a livello di router è quindi possibile evitare che i sistemi dietro al firewall o al router subiscano attacchi volti a sfruttare la vulnerabilità. Si consiglia di bloccare tutte le comunicazioni in ingresso non richieste provenienti da Internet.
  
    **Impatto della soluzione alternativa.** Questa soluzione può avere conseguenze negative sulle prestazioni del sistema, in quanto impedisce al TCP di ottimizzare le comunicazioni di rete. I pacchetti di rete ICMP possono eliminare la frammentazione dei router che connettono le reti con MTU diverse. La frammentazione riduce la velocità effettiva del protocollo TCP e aumenta la congestione di rete.
  
#### Domande frequenti sulla vulnerabilità ad attacchi di tipo Denial of Service in ICMP - CVE-2011-1871
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità ad attacchi di tipo Denial of Service.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata quando lo stack TCP/IP di Windows elabora erroneamente una sequenza di messaggi ICMP appositamente predisposti.
  
**Quale componente è interessato dalla vulnerabilità?**    
Tcpip.sys è il componente interessato dalla vulnerabilità.
...
Un utente malintenzionato remoto non autenticato in grado di sfruttare questa vulnerabilità può creare un programma per inviare una sequenza di messaggi ICMP appositamente predisposti a un sistema di destinazione.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I server e le workstation sono interessati da questa vulnerabilità.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità modificando il modo in cui lo stack TCP/IP di Windows elabora i messaggi ICMP.
...
Vulnerabilità ad attacchi di tipo Denial of Service dovuta al meccanismo di convalida di QoS in TCP/IP - CVE-2011- 1965  
-----------------------------------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità ad attacchi di tipo Denial of Service nello stack TCP/IP di Windows dovuta alla gestione errata da parte dello stack TCP/IP di URL nella memoria quando è attivata la Qualità del servizio (QoS) basata su URL. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può impedire al sistema di rispondere alle richieste e forzarne eventualmente il riavvio automatico.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1965](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1965).
  
#### Fattori attenuanti della vulnerabilità ad attacchi di tipo Denial of Service dovuta al meccanismo di convalida di QoS in TCP/IP - CVE-2011- 1965
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   Per impostazione predefinita, la funzionalità Qualità del servizio basata su URL non è attivata in nessun sistema operativo Windows. Gli utenti devono installare manualmente questa funzionalità per essere interessati da questa vulnerabilità.
  
#### Soluzioni alternative per la vulnerabilità ad attacchi di tipo Denial of Service dovuta al meccanismo di convalida di QoS in TCP/IP - CVE-2011- 1965
  
Per soluzione alternativa si intende un'impostazione o una modifica nella configurazione che non elimina la vulnerabilità sottostante, ma consente di bloccare gli attacchi noti prima di applicare l'aggiornamento. Microsoft ha verificato le seguenti soluzioni alternative e segnala nel corso della discussione se tali soluzioni riducono la funzionalità:
  
-   Disattivare la Qualità del servizio basata sui criteri. Per ulteriori informazioni, vedere l'articolo di Microsoft TechNet [Quality of Service (QoS) basata sui criteri](http://technet.microsoft.com/it-it/library/dd919203(ws.10).aspx).
  
#### Domande frequenti sulla vulnerabilità ad attacchi di tipo Denial of Service dovuta al meccanismo di convalida di QoS in TCP/IP - CVE-2011- 1965
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità ad attacchi di tipo Denial of Service.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata quando lo stack TCP/IP gestisce erroneamente URL appositamente predisposti nella memoria. Questa vulnerabilità si verifica solo quando il sistema di destinazione ospita contenuto Web con un servizio come IIS e ha la funzionalità QoS basata su URL attivata.
  
**Quale componente è interessato dalla vulnerabilità?**    
Tcpip.sys è il componente interessato dalla vulnerabilità.
  
**Che cos'è la Qualità del servizio (QoS) basata su URL?**    
La Qualità del servizio (QoS) per le reti è una serie di standard e di meccanismi riguardanti tutto il settore per assicurare prestazione di qualità superiore per le applicazioni critiche. Gli amministratori di rete possono utilizzare i meccanismi QoS per dare la priorità a e gestire il tasso di invio per il traffico di rete in uscita. L'utilizzo di questi meccanismi assicura che le risorse siano utilizzate in modo efficiente per fornire il livello di servizio richiesto.
  
Windows Server 2008 R2 consente ai professionisti IT di dare la priorità al traffico Web basato sull'URL. Con QoS basata su URL, i professionisti IT possono assicurare che il traffico Web più importante venga elaborato prima di quello meno importante, migliorando le prestazioni sulle reti sovraccariche. Ad esempio, i professionisti IT possono assegnare al traffico Web per i siti Web critici interni una più alta priorità rispetto ai siti Web esterni, ottimizzando le prestazioni quando la rete è sovraccarica. Per ulteriori informazioni, vedere l'articolo di Microsoft TechNet, [QoS basata su URL](http://technet.microsoft.com/en-us/library/dd637810(ws.10).aspx).
...
**In che modo un utente malintenzionato può sfruttare questa vulnerabilità?**    
In uno scenario di attacco remoto, un utente malintenzionato non autenticato può sfruttare questa vulnerabilità inviando una richiesta URL appositamente predisposta a un server che elabora contenuto Web e ha QoS basata su URL attivata.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I server che ospitano contenuto Web con QoS basata su URL attivata sono principalmente a rischio. I server che non hanno QoS basata su URL attivata o che non elaborano il contenuto Web non sono interessati. Le workstation come i sistemi Windows 7, che possono eseguire Internet Information Services (IIS), sono esposte ad un rischio maggiore se hanno entrambi IIS e QoS basata su URL attivati.
  
**I sistemi Windows 7 sono esposti ad un rischio maggiore se configurati come server con servizi IIS?**    
Sì. Un software dei server come IIS può essere installato e configurato sui sistemi Windows 7. Sebbene i sistemi Windows 7 siano considerati delle workstation, in questa configurazione agiscono come server e sono quindi più esposti a questa vulnerabilità.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento risolve la vulnerabilità modificando il modo in cui lo stack TCP/IP gestisce gli URL nella memoria quando è attivata QoS basata su URL.
...
<td style="border:1px solid black;">Vedere l'articolo della <a href="http://support.microsoft.com/kb/2563894">Microsoft Knowledge Base 2563894</a></td>
</tr>
<tr class="odd">
