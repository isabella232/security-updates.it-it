---
TOCTitle: 'MS11-017'
Title: 'Bollettino Microsoft sulla sicurezza MS11-017 - Importante'
ms:assetid: 'ms11-017'
ms:contentKeyID: 61240560
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-017(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-017 - Importante
==========================================================

Una vulnerabilità del client desktop remoto può consentire l'esecuzione di codice in modalità remota (2508062)
--------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 8 marzo 2011 | Aggiornamento: mercoledì 4 maggio 2011
...
<tr>
<th colspan="5">
Client Remote Desktop Connection 5.2
</th>
</tr>
<tr>
...
<tr>
<th colspan="5">
Client Remote Desktop Connection 6.0 e Remote Desktop Connection 6.1
</th>
</tr>
...
<tr>
<th colspan="5">
Client Remote Desktop Connection 7.0
</th>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
|-----------------------------------------------------------|--------------------------------------|
| Windows XP Professional x64 Edition Service Pack 2        | Client Remote Desktop Connection 5.2 |
| Windows Server 2003 Service Pack 2                        | Client Remote Desktop Connection 5.2 |
| Windows Server 2003 x64 Edition Service Pack 2            | Client Remote Desktop Connection 5.2 |
| Windows Server 2003 con SP2 per sistemi Itanium           | Client Remote Desktop Connection 5.2 |
| Windows 7 per sistemi a 32 bit Service Pack 1             | Remote Desktop Connection 7.1 Client |
| Windows 7 per sistemi x64 Service Pack 1                  | Remote Desktop Connection 7.1 Client |
| Windows Server 2008 R2 per sistemi x64 Service Pack 1     | Remote Desktop Connection 7.1 Client |
| Windows Server 2008 R2 per sistemi Itanium Service Pack 1 | Remote Desktop Connection 7.1 Client |
...
<th style="border:1px solid black;" >
Vulnerabilità legata al caricamento di librerie non sicure nel desktop remoto - CVE-2011-0029
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 5.2 in Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 su Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.0 in Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.0 in Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Interfaccia utente multilingue (MUI) del client Remote Desktop Connection 6.0 in Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.0 in Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 in Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 in Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 in Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 in Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 6.1 in Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 in Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 in Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 in Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 in Windows 7 per sistemi a 32 bit
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 in Windows 7 per sistemi x64
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr>
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 in Windows Server 2008 R2 per sistemi x64\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Remote Desktop Connection 7.0 in Windows Server 2008 R2 per sistemi Itanium
</td>
<td style="border:1px solid black;">
**Importante**   
Esecuzione di codice in modalità remota
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui il client desktop remoto gestisce il caricamento dei file DLL. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029).

#### Fattori attenuanti della vulnerabilità legata al caricamento delle librerie non sicure nel desktop remoto - CVE-2011-0029

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   L'attacco è possibile solo se l'utente visita un file system remoto o una condivisione WebDAV di dubbia provenienza e apre un file .rdp.
...
#### Soluzioni alternative per la vulnerabilità legata al caricamento delle librerie non sicure nel desktop remoto - CVE-2011-0029
...
#### Domande frequenti sulla vulnerabilità legata al caricamento delle librerie non sicure nel desktop remoto - CVE-2011-0029
...
La vulnerabilità si verifica quando il client desktop remoto di Windows limita in maniera errata il percorso utilizzato per il caricamento delle librerie esterne.

**Che cos'è il client desktop remoto di Windows?**  
La funzione Desktop remoto in Windows consente di accedere a tutti i programmi, le risorse e gli accessori presenti sul computer di un utente da un secondo computer Windows. Una volta collegato, il desktop remoto consente di controllare il primo computer mediante il mouse e la tastiera, visualizzando contemporaneamente sulla schermata tutte le operazioni in corso.
...
Un utente malintenzionato può convincere un utente ad aprire un file legittimo .rdp per la configurazione del desktop remoto situato nella stessa directory di rete di un file della libreria di collegamento dinamico (DLL) appositamente predisposto. Poi, durante l'apertura del file .rdp, il client desktop remoto di Windows può tentare di caricare il file DLL ed eseguire qualsiasi codice esso contenga.

In uno scenario di attacco tramite posta elettronica, un utente malintenzionato può sfruttare la vulnerabilità inviando un allegato .rdp legittimo ad un utente, convincendolo a salvare l'allegato in una directory che contiene un file DLL appositamente predisposto e ad aprire il file .rdp. Poi, durante l'apertura del file .rdp, il client desktop remoto di Windows può tentare di caricare il file DLL ed eseguire qualsiasi codice esso contenga.

In uno scenario di rete, un utente malintenzionato può collocare un file .rdp legittimo, accompagnato da una DLL appositamente predisposta in un percorso UNC o WebDAV, quindi convincere l'utente ad aprire il file .rdp.
...
L'aggiornamento risolve questa vulnerabilità correggendo il modo in cui il client desktop remoto carica le librerie esterne.

**Questa vulnerabilità è correlata all'Advisory Microsoft sulla sicurezza 2269637?**  
Sì, la vulnerabilità risolta dal presente aggiornamento è correlata alle vulnerabilità descritte nell'[Advisory Microsoft sulla sicurezza 2269637](http://technet.microsoft.com/security/advisory/2269637) che interessano le modalità con cui le applicazioni caricano le librerie esterne. Questo aggiornamento per la protezione risolve un'istanza particolare di questo tipo di vulnerabilità.

**Al momento del rilascio di questo bollettino le informazioni sulla vulnerabilità erano disponibili pubblicamente?**  
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029).
...
| Windows 7 per sistemi a 32 bit Pack 1                                                              | No      | No                | No                | No                         |
...
<td style="border:1px solid black;">Per Remote Desktop Connection 5.2 in Windows XP Service Pack 3:<br />
WindowsXP-KB2483618-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.1 in Windows XP Service Pack 3:<br />
WindowsXP-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0 in Windows XP Service Pack 3:<br />
WindowsXP-KB2483614-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0 in Windows XP Professional x64 Edition Service Pack 2<br />
...
<td style="border:1px solid black;">Per Remote Desktop Connection 5.2:<br />
KB2483618.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0 e Remote Desktop Connection 6.1:<br />
KB2481109.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0:<br />
KB2483614.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Per Remote Desktop Connection 5.2:<br />
Utilizzare lo strumento <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2483618$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0 e Remote Desktop Connection 6.1:<br />
Utilizzare lo strumento <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2481109$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0:<br />
Utilizzare lo strumento <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2483614$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 5.2:<br />
Vedere l'<a href="http://support.microsoft.com/kb/2483618">articolo della Microsoft Knowledge Base 2483618</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0 e Remote Desktop Connection 6.1:<br />
Vedere l'<a href="http://support.microsoft.com/kb/2481109">articolo della Microsoft Knowledge Base 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0:<br />
Vedere l'<a href="http://support.microsoft.com/kb/2483614">articolo della Microsoft Knowledge Base 2483614</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0 in Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per l'interfaccia utente multilingue (MUI) del client Remote Desktop Connection 6.0 in Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB2483619-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0 in Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2481109-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Installazione senza riavvio</td>
...
<tr class="odd">
<td style="border:1px solid black;">Aggiornamento del file di registro</td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0:<br />
KB2481109.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per l'interfaccia utente multilingue (MUI) del client Remote Desktop Connection 6.0:<br />
KB2483619.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Ulteriori informazioni</td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per l'interfaccia utente multilingue (MUI) del client Remote Desktop Connection 6.0:<br />
Utilizzare lo strumento <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2483619$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per l'interfaccia utente multilingue (MUI) del client Remote Desktop Connection 6.0:<br />
Vedere l'<a href="http://support.microsoft.com/kb/2483619">articolo della Microsoft Knowledge Base 2483619</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.1 in Windows Vista Service Pack 1 e Windows Vista Service Pack 2:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0 in Windows Vista Service Pack 1 e Windows Vista Service Pack 2:<br />
Windows6.0-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.1 in Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.1:<br />
Vedere l'<a href="http://support.microsoft.com/kb/2481109">articolo della Microsoft Knowledge Base 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.1 in tutte le edizioni a 32 bit supportate di Windows Server 2008:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.1 in tutte le edizioni basate su x64 supportate di Windows Server 2008:<br />
Windows6.0-KB2481109-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 6.1 in tutte le edizioni Itanium supportate di Windows Server 2008:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2481109">articolo della Microsoft Knowledge Base 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> Non esiste alcuna chiave del Registro di sistema per verificare la presenza di questo aggiornamento.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0 su tutte le versioni a 32 bit supportate della versione originale di Windows 7:<br />
Windows6.1-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0 su tutte le versioni x64 supportate della versione originale di Windows 7:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2483614">articolo della Microsoft Knowledge Base 2483614</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> Non esiste alcuna chiave del Registro di sistema per verificare la presenza di questo aggiornamento.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0 su tutte le versioni x64 supportate della versione originale di Windows Server 2008 R2:<br />
Windows6.1-KB2483614-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Remote Desktop Connection 7.0 su tutte le versioni basate su Itanium supportate della versione originale di Windows Server 2008 R2:<br />
...
-   Eyal Gruner di [Versafe Anti Fraud](http://www.versafe-login.com/) per aver segnalato la vulnerabilità legata al caricamento delle librerie non sicure nel desktop remoto (CVE-2011-0029)
...
-   V1.1 (8 marzo 2011): Sono state corrette le voci della tabella di Systems Management Server per SMS 2.0 e SMS 2003 con SUIT per Windows XP Service Pack 3 e Windows Server 2003 Service Pack 2. Le modifiche sono esclusivamente informative. Non sono previste modifiche ai file di aggiornamento per la protezione o per la logica di rilevamento.  
-   V1.2 (9 marzo 2011): Sono state corrette le voci del componente **software non interessato** per le versioni Service Pack 1 di Windows 7 e Windows Server 2008 R2 da Remote Desktop Connection 7.0 Client a Remote Desktop Connection 7.1 Client. Le modifiche sono esclusivamente informative. Non sono previste modifiche ai file di aggiornamento per la protezione o per la logica di rilevamento.  
-   V1.3 (13 aprile 2011): Sono state corrette le informazioni sul bollettino sostitutivo per il client Remote Desktop Connection 6.0 sulle edizioni supportate di Windows Server 2003 e il client Remote Desktop Connection 6.1 sulle edizioni supportate di Windows Vista. Questa modifica riguarda solo il bollettino. Non sono state apportate modifiche al rilevamento o ai file di aggiornamento della protezione.  
-   V1.4 (15 aprile 2011): Sono state corrette le informazioni sul bollettino sostitutivo per il client di Connessione desktop remoto 6.0 nelle edizioni supportate di Windows Server 2003 e il client di Connessione desktop remoto 6.1 nelle edizioni supportate di Windows Server 2008. Questa modifica riguarda solo il bollettino. Non sono state apportate modifiche al rilevamento o ai file di aggiornamento della protezione.  
-   V1.5 (04 maggio 2011): Sono state corrette le informazioni sul bollettino sostitutivo per il client di Connessione desktop remoto 5.2 nelle edizioni supportate di Windows XP Service Pack 3. Questa modifica riguarda solo il bollettino. Non sono state apportate modifiche al rilevamento o ai file di aggiornamento della protezione.
