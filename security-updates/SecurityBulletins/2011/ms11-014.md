---
TOCTitle: 'MS11-014'
Title: 'Bollettino Microsoft sulla sicurezza MS11-014 - Importante'
ms:assetid: 'ms11-014'
ms:contentKeyID: 61240557
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-014(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-014 - Importante
==========================================================

Una vulnerabilità in Local Security Authority Subsystem Service può consentire l'acquisizione locale di privilegi più elevati (2478960)
---------------------------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve una vulnerabilità di Local Security Authority Subsystem Service (LSASS) in Windows XP e Windows Server 2003, che è stata segnalata privatamente. Questo aggiornamento per la protezione è considerato di livello importante per tutte le edizioni supportate di questi sistemi operativi. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** in questa sezione.
...
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui LSASS gestisce determinati valori usati nel processo di autenticazione. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                          | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e) | Acquisizione di privilegi più elevati       | Importante                   | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                 | Acquisizione di privilegi più elevati       | Importante                   | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)     | Acquisizione di privilegi più elevati       | Importante                   | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41)    | Acquisizione di privilegi più elevati       | Importante                   | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
...
<th style="border:1px solid black;" >Vulnerabilità legata alla convalida lunghezza LSASS - CVE-2011-0039</th>
...
Vulnerabilità legata alla convalida lunghezza LSASS - CVE-2011-0039  
-------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati nel modo in cui Local Security Authority Subsystem Service (LSASS) di Microsoft Windows elabora richieste di autenticazione appositamente predisposte. Questa vulnerabilità potrebbe consentire a un utente malintenzionato di eseguire codice con privilegi elevati. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti amministrativi completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0039](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039).
  
#### Fattori attenuanti della vulnerabilità legata alla convalida della lunghezza LSASS - CVE-2011-0039
...
#### Soluzioni alternative per la vulnerabilità legata alla convalida lunghezza LSASS - CVE-2011-0039
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla convalida lunghezza LSASS - CVE-2011-0039
...
La vulnerabilità si presenta quando Windows LSASS elabora una richiesta di autenticazione appositamente predisposta.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui LSASS gestisce valori specifici utilizzati nel processo di autenticazione.
...
<td style="border:1px solid black;">Utilizzare lo strumento <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2478960$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2478960">articolo della Microsoft Knowledge Base 2478960</a></td>
</tr>
<tr class="even">
...
-   Il security tester Jorge Moura di Primavera BSS per aver segnalato la vulnerabilità legata alla convalida lunghezza LSASS (CVE-2011-0039)
