---
TOCTitle: 'MS11-098'
Title: 'Bollettino Microsoft sulla sicurezza MS11-098 - Importante'
ms:assetid: 'ms11-098'
ms:contentKeyID: 61240639
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-098(v=Security.10)'
author: SharonSears
...
Data di pubblicazione: martedì 13 dicembre 2011 | Aggiornamento: mercoledì 1 febbraio 2012
...
Questo aggiornamento per la protezione è considerato di livello importante per tutte le edizioni a 32 bit supportate di Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 e Windows 7. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno della presente sezione.

L'aggiornamento per la protezione risolve la vulnerabilità assicurando che il kernel di Windows inizializzi gli oggetti in memoria. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.

**Raccomandazione.** Per gli amministratori e le installazioni delle organizzazioni o gli utenti finali che desiderano installare manualmente questo aggiornamento per la protezione, Microsoft consiglia di applicare l'aggiornamento quanto prima utilizzando il software di gestione degli aggiornamenti o verificando la disponibilità degli aggiornamenti tramite il servizio [Microsoft Update](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=it-it).

Vedere anche la sezione, **Strumenti e informazioni sul rilevamento e sulla distribuzione**, riportata di seguito nel presente bollettino.

**Problemi noti.** L'[articolo della Microsoft Knowledge Base 2633171](http://support.microsoft.com/kb/2633171) descrive i problemi attualmente conosciuti che gli utenti potrebbero riscontrare durante l'installazione di questo aggiornamento per la protezione. L'articolo illustra inoltre le soluzioni consigliate in grado di risolvere questi problemi.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|------------------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7a6fcf8d-8c7b-4882-90d3-02db79a75238)                                                      | Acquisizione di privilegi più elevati       | Importante                   | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812)                          |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=281e5bd4-4582-4aa9-af88-518ad3152132)                                             | Acquisizione di privilegi più elevati       | Importante                   | [MS10-021](http://www.microsoft.com/italy/technet/security/bulletin/ms10-021.mspx) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6c7c960-768d-40d4-8fe5-7d59f48ead1d)                                                   | Acquisizione di privilegi più elevati       | Importante                   | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578)                          |
| [Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*                      | Acquisizione di privilegi più elevati       | Importante                   | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578)                          |
| [Windows 7 per sistemi a 32 bit e Windows 7 per sistemi a 32 bit Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a) | Acquisizione di privilegi più elevati       | Importante                   | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578)                          |
...
<th style="border:1px solid black;" >Vulnerabilità legata al gestore delle eccezioni del kernel di Windows - CVE-2011-2018</th>
...
Vulnerabilità legata al gestore delle eccezioni del kernel di Windows - CVE-2011-2018  
-------------------------------------------------------------------------------------
  
<span></span>
Nel kernel di Windows è presente una vulnerabilità legata all'acquisizione di privilegi più elevati dovuta al modo in cui il kernel accede a un oggetto non inizializzato correttamente. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario in modalità kernel. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-2018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2018).
  
#### Fattori attenuanti della vulnerabilità legata al gestore delle eccezioni del kernel di Windows - CVE-2011-2018
...
#### Soluzioni alternative per la vulnerabilità legata al gestore delle eccezioni del kernel di Windows - CVE-2011-2018
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al gestore delle eccezioni del kernel di Windows - CVE-2011-2018
...
Tale vulnerabilità è dovuta al modo in cui il kernel di Windows accede a un oggetto non inizializzato correttamente.
...
L'aggiornamento risolve la vulnerabilità assicurando che il kernel di Windows inizializzi gli oggetti in memoria.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2633171$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/kb/2633171">articolo della Microsoft Knowledge Base 2633171</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2633171$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consultare l'[articolo della Microsoft Knowledge Base 2633171](http://support.microsoft.com/kb/2633171)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Matthew Jurczyk, di [VeriSign iDefense Labs](http://labs.idefense.com/), per aver segnalato la vulnerabilità legata al gestore delle eccezioni del kernel di Windows (CVE-2011-2018)
...
-   V1.1 (1 febbraio 2012): È stato aggiunto un collegamento all'articolo della Microsoft Knowledge Base 2633171 nella sottosezione Problemi noti del Riepilogo.
