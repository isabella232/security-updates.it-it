---
TOCTitle: 'MS11-023'
Title: 'Bollettino Microsoft sulla sicurezza MS11-023 - Importante'
ms:assetid: 'ms11-023'
ms:contentKeyID: 61240566
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-023(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-023 - Importante
==========================================================

Alcune vulnerabilità in Microsoft Office possono consentire l'esecuzione di codice in modalità remota (2489293)
---------------------------------------------------------------------------------------------------------------
...
Sì, la vulnerabilità legata al caricamento non sicuro delle librerie nel componente Office ([CVE-2011-0107)](http://technet.microsoft.com/security/advisory/2269637), risolta dal presente aggiornamento è correlata alle vulnerabilità descritte nell'Advisory Microsoft sulla sicurezza 2269637 che interessano le modalità con cui le applicazioni caricano le librerie esterne. Questo aggiornamento per la protezione risolve un'istanza particolare di questo tipo di vulnerabilità.

**L'aggiornamento include modifiche di funzionalità relative alla sicurezza?**  
Sì. Gli aggiornamenti per Microsoft Office 2003 Service Pack 3 (KB2509503) e Microsoft Office 2007 Service Pack 2 (KB2509488), insieme agli aggiornamenti per Microsoft Word, Microsoft Excel e Microsoft PowerPoint forniscono il supporto per la funzionalità Convalida file di Office. Per ulteriori informazioni sulla funzionalità Convalida file di Office, consultare l'[Advisory Microsoft sulla sicurezza 2501584](http://technet.microsoft.com/security/advisory/2501584).

**Quale relazione esiste tra il presente aggiornamento per la protezione e il bollettino MS11-029?**  
Il pacchetto di aggiornamento per la protezione per Microsoft Office XP (KB2509461) offerto in questo bollettino risolve anche la vulnerabilità descritta nel bollettino sulla sicurezza [MS11-029](http://go.microsoft.com/fwlink/?linkid=208524). Gli utenti che utilizzano Microsoft Office XP devono installare solo uno dei pacchetti di aggiornamento per la protezione.
...
**Anche gli articoli MS11-022 e MS11-021 descrivono alcune vulnerabilità di Microsoft Office 2004 per Mac, Microsoft Office 2008 per Mac e del convertitore file in formato XML aperto per Mac. Qual è la relazione tra MS11-022 e MS11-021 e questo bollettino, MS11-023?**  
I pacchetti di aggiornamento per la protezione di Microsoft Office 2004 per Mac (KB2505924), Microsoft Office 2008 per Mac (KB2505927), e del convertitore file in formato XML aperto per Mac (KB2505935) offerti in questo bollettino risolvono anche le vulnerabilità descritte nei bollettini sulla sicurezza [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) e [MS11-021](http://go.microsoft.com/fwlink/?linkid=210121). Gli utenti che utilizzano Microsoft Office 2004 per Mac, Microsoft Office 2008 per Mac o il convertitore file in formato XML aperto per Mac dovranno installare questi pacchetti di aggiornamento per la protezione una sola volta.
...
Il livello di gravità per un programma autonomo di Microsoft Office è lo stesso del componente corrispondente in applicazioni Microsoft Office. Ad esempio, un'installazione autonoma di Microsoft Excel è interessata con lo stesso livello di gravità di un'installazione delle applicazioni Microsoft Office.
...
<th style="border:1px solid black;" >
Vulnerabilità legata al caricamento non sicuro delle librerie nel componente Office - CVE-2011-0107
</th>
<th style="border:1px solid black;" >
Vulnerabilità legata alla risoluzione del riferimento dell'oggetto grafico in Microsoft Office - CVE-2011-0977
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).

#### Fattori attenuanti della vulnerabilità legata al caricamento non sicuro delle librerie nel componente Office - CVE-2011-0107

Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:

-   L'attacco è possibile solo se l'utente visita un file system remoto o una condivisione WebDAV di dubbia provenienza e apre un file relativo a Office (ad esempio un file .docx).
...
#### Soluzioni alternative per la vulnerabilità legata al caricamento non sicuro delle librerie nel componente Office - CVE-2011-0107
...
#### Domande frequenti sulla vulnerabilità legata al caricamento non sicuro delle librerie nel componente Office - CVE-2011-0107
...
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).
...
Sì. Questo aggiornamento per la protezione risolve la vulnerabilità che può essere sfruttata utilizzando il codice di prova esistente pubblicato. Questa vulnerabilità è stata identificata con il codice [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).

Vulnerabilità legata alla risoluzione del riferimento dell'oggetto grafico in Microsoft Office - CVE-2011-0977
--------------------------------------------------------------------------------------------------------------

<span></span>
Una vulnerabilità legata all'esecuzione di codice in modalità remota è stata riscontrata nel modo in cui Microsoft Office gestisce gli oggetti grafici quando analizza un file Office appositamente predisposto. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0977](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977).

#### Fattori attenuanti per la vulnerabilità legata alla risoluzione del riferimento dell'oggetto grafico in Microsoft Office - CVE-2011-0977
...
#### Domande frequenti sulla vulnerabilità legata alla risoluzione del riferimento dell'oggetto grafico in Microsoft Office - CVE-2011-0977

**Qual è la portata o l'impatto di questa vulnerabilità?**  
Si tratta di una vulnerabilità legata all'esecuzione di codice in modalità remota. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.

**Quali sono le cause di questa vulnerabilità?**  
La vulnerabilità si presenta quando Microsoft Office non gestisce correttamente strutture di dati della risoluzione del riferimento quando analizza un file di Office appositamente predisposto che contiene oggetti grafici.
...
**In che modo un utente malintenzionato può sfruttare questa vulnerabilità?**  
Sebbene il codice vulnerabile esista in un componente condiviso di Microsoft Office, il vettore di attacco conosciuto è attraverso Microsoft Excel. Questa vulnerabilità può essere sfruttata solo se un utente apre un file Excel appositamente predisposto con una versione interessata di Microsoft Excel.
...
**Il vettore di attacco per la vulnerabilità è attraverso Microsoft Excel. Perché questo bollettino è relativo a Microsoft Office?**  
Sebbene il vettore di attacco conosciuto per lo sfruttamento della vulnerabilità sia attraverso Microsoft Excel, il codice vulnerabile esiste in un componente condiviso di Microsoft Office. La logica di rilevamento utilizzata per eseguire la scansione per i sistemi interessati è progettata per controllare quali sono i componenti condivisi di Microsoft Office interessati e offrire gli aggiornamenti a un sistema a prescindere che Microsoft Excel sia installato o meno.
...
**Quali sono gli scopi dell'aggiornamento?**  
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui Microsoft Office gestisce gli oggetti grafici nei file di Office appositamente predisposti.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it">articolo della Microsoft Knowledge Base 2509503</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it">articolo della Microsoft Knowledge Base 2509488</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Haifei Li di [FortiGuard Labs di Fortinet](http://www.fortiguard.com/) per aver segnalato la vulnerabilità legata al caricamento non sicuro delle librerie nel componente Office (CVE-2011-0107)  
-   Un ricercatore anonimo, che collabora con [Zero Day Initiative](http://www.zerodayinitiative.com/) di [TippingPoint](http://www.tippingpoint.com/), per aver segnalato la vulnerabilità legata alla risoluzione del riferimento dell'oggetto grafico in Microsoft Office (CVE-2011-0977)
