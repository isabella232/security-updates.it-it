---
TOCTitle: 'MS11-033'
Title: 'Bollettino Microsoft sulla sicurezza MS11-033 - Importante'
ms:assetid: 'ms11-033'
ms:contentKeyID: 61240576
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-033(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-033 - Importante
==========================================================

Una vulnerabilità nei convertitori di testo di WordPad può consentire l'esecuzione di codice in modalità remota (2485663)
-------------------------------------------------------------------------------------------------------------------------
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6753ca98-feb4-4c7f-9969-9294038a2bbb)                          | Esecuzione di codice in modalità remota     | Importante                   | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3c94bc96-99ea-44a1-9052-e69de5e21f81) | Esecuzione di codice in modalità remota     | Importante                   | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9fbfc742-6c74-49a2-b3cc-e1d5d8c84b77)                 | Esecuzione di codice in modalità remota     | Importante                   | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=897b97b0-1bab-4b1b-b417-950fab0d4a65)     | Esecuzione di codice in modalità remota     | Importante                   | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ede38974-4e57-4ea1-8731-b91e96534693)    | Esecuzione di codice in modalità remota     | Importante                   | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'analisi del convertitore di WordPad - CVE-2011-0028</th>
...
Vulnerabilità legata all'analisi del convertitore di WordPad - CVE-2011-0028  
----------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Word gestisce dei documenti Word appositamente predisposti. Tale vulnerabilità può consentire l'esecuzione di codice in modalità remota durante l'apertura di un file di Word appositamente predisposto contenente una struttura non valida. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0028).
  
#### Fattori attenuanti della vulnerabilità legata all'analisi del convertitore di WordPad - CVE-2011-0028
...
#### Soluzioni alternative per la vulnerabilità legata all'analisi del convertitore di WordPad - CVE-2011-0028
...
#### Domande frequenti sulla vulnerabilità legata all'analisi del convertitore di WordPad - CVE-2011-0028
...
La vulnerabilità si presenta quando il convertitore di testo di WordPad analizza in modo errato dei campi specifici in un documento Word.
...
In uno scenario di attacco dal Web, l'utente malintenzionato dovrebbe pubblicare un sito Web contenente un documento di Word utilizzato per tentare di sfruttare questa vulnerabilità. Inoltre, i siti Web manomessi e quelli che accettano o ospitano contenuti forniti dagli utenti potrebbero presentare contenuti appositamente predisposti per sfruttare questa vulnerabilità. Poiché non è in alcun modo possibile obbligare gli utenti a visitare un sito Web appositamente predisposto, l'utente malintenzionato deve convincere le vittime a visitare il sito, in genere inducendole a fare clic su un collegamento che le indirizzi al sito Web di origine dell'attacco. Dopo aver fatto clic sul collegamento, gli utenti dovrebbero accettare manualmente un'istruzione di aprire il documento.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
I sistemi interessati come le workstation o i terminal server, dove WordPad è utilizzato per aprire dei documenti Word da fonti non attendibili, sono principalmente al rischio. I server potrebbero essere maggiormente a rischio se gli amministratori consentono agli utenti di accedere ai server ed eseguire programmi. Tuttavia, le procedure consigliate scoraggiano fortemente questa attribuzione di privilegi. Nei sistemi in cui è installato Microsoft Word generalmente i documenti Word vengono aperti con Microsoft Office anziché con WordPad per impostazione predefinita.
...
No. Microsoft ha ricevuto informazioni sulla vulnerabilità grazie a un'indagine coordinata. Secondo le informazioni in possesso di Microsoft, al momento della pubblicazione del presente bollettino l'esistenza di questa vulnerabilità non era stata ancora divulgata pubblicamente.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2485663$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it">articolo della Microsoft Knowledge Base 2485663</a></td>
</tr>
<tr class="even">
...
-   Carsten Eiram di [Secunia](http://secunia.com/) per aver segnalato la vulnerabilità legata all'analisi del convertitore di WordPad (CVE-2011-0028)
