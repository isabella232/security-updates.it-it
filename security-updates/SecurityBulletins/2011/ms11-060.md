---
TOCTitle: 'MS11-060'
Title: 'Bollettino Microsoft sulla sicurezza MS11-060 - Importante'
ms:assetid: 'ms11-060'
ms:contentKeyID: 61240601
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-060(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-060 - Importante
==========================================================

Alcune vulnerabilità in Microsoft Visio possono consentire l'esecuzione di codice in modalità remota (2560978)
--------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui Microsoft Visio convalida gli oggetti nella memoria durante l'analisi di file Visio appositamente predisposti. Per ulteriori informazioni sulla vulnerabilità, vedere la voce specifica nella sottosezione Domande frequenti all'interno della sezione **Informazioni sulle vulnerabilità**.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6da236c2-0ef5-4c13-8393-673b70298a77">Microsoft Visio 2010 e Microsoft Visio 2010 Service Pack 1 (edizioni a 32 bit)</a><br />
(KB2553008)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b7f5f2a9-116a-41ef-a19e-a7dd0947d2cb">Microsoft Visio 2010 e Microsoft Visio 2010 Service Pack 1 (edizioni a 64 bit)</a><br />
(KB2553008)</td>
<td style="border:1px solid black;">Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nessuno</td>
...
|------------------------------------------------------------------------------------------------|  
| Visualizzatore di Microsoft Visio 2010 e Visualizzatore di Microsoft Visio 2010 Service Pack 1 |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'esecuzione di codice in modalità remota di pStream Release - CVE-2011-1972</th>
<th style="border:1px solid black;" >Vulnerabilità legata all'esecuzione di codice in modalità remota di Move Around the Block - CVE-2011-1979</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio 2010 (edizioni a 32 bit) e Microsoft Visio 2010 (edizioni a 32 bit) Service Pack 1</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Esecuzione di codice in modalità remota</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Visio 2010 (edizioni a 64 bit) e Microsoft Visio 2010 (edizioni a 64 bit) Service Pack 1</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Esecuzione di codice in modalità remota</td>
<td style="border:1px solid black;">Non applicabile</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
...
Vulnerabilità legata all'esecuzione di codice in modalità remota di pStream Release - CVE-2011-1972  
---------------------------------------------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1972](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1972).
  
#### Fattori attenuanti della vulnerabilità legata all'esecuzione di codice in modalità remota di pStream Release - CVE-2011-1972
...
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di codice in modalità remota di pStream Release - CVE-2011-1972
...
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di codice in modalità remota di pStream Release - CVE-2011-1972
...
Vulnerabilità legata all'esecuzione di codice in modalità remota di Move Around the Block - CVE-2011-1979  
---------------------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Visio convalida gli oggetti nella memoria durante l'analisi di file Visio appositamente predisposti. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1979).
  
#### Fattori attenuanti della vulnerabilità legata all'esecuzione di codice in modalità remota di Move Around the Block - CVE-2011-1979
...
#### Soluzioni alternative per la vulnerabilità legata all'esecuzione di codice in modalità remota di Move Around the Block - CVE-2011-1979
...
#### Domande frequenti sulla vulnerabilità legata all'esecuzione di codice in modalità remota di Move Around the Block - CVE-2011-1979
...
| Microsoft Visio 2010 (edizioni a 32 bit) e Microsoft Visio 2010 (edizioni a 32 bit) Service Pack 1 | No   |  
| Microsoft Visio 2010 (edizioni a 64 bit) e Microsoft Visio 2010 (edizioni a 64 bit) Service Pack 1 | No   |
...
|----------------------------------------------------------------------------------------------------|-------------------|----------------------------|  
| Microsoft Visio 2003 Service Pack 3                                                                | No                | No                         |  
| Microsoft Visio 2007 Service Pack 2                                                                | No                | No                         |  
| Microsoft Visio 2010 (edizioni a 32 bit) e Microsoft Visio 2010 (edizioni a 32 bit) Service Pack 1 | No                | No                         |  
| Microsoft Visio 2010 (edizioni a 64 bit) e Microsoft Visio 2010 (edizioni a 64 bit) Service Pack 1 | No                | No                         |
...
#### Microsoft Visio 2003 (tutte le edizioni)
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2553009">articolo della Microsoft Knowledge Base 2553009</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2553010">articolo della Microsoft Knowledge Base 2553010</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
#### Microsoft Visio 2010 (tutte le edizioni)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2553008">articolo della Microsoft Knowledge Base 2553008</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Controllo delle chiavi del Registro di sistema</strong></td>
<td style="border:1px solid black;">Non applicabile</td>
...
-   Linlin Zhao di [Baidu Security Team](http://www.baidu.com) per aver segnalato la vulnerabilità legata all'esecuzione di codice in modalità remota di pStream Release (CVE-2011-1972)  
-   Linlin Zhao di [Squadra di Protezione di Baidu](http://www.baidu.com) per aver segnalato Vulnerabilità legata all'esecuzione di codice in modalità remota di Move Around the Block (CVE-2011-1979)
