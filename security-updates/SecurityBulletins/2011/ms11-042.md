---
TOCTitle: 'MS11-042'
Title: 'Bollettino Microsoft sulla sicurezza MS11-042 - Critico'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61240585
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-042(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-042 - Critico
=======================================================

Le vulnerabilità nel Distributed File System potrebbero consentire l'esecuzione di codice in modalità remota (2535512)
----------------------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 14 giugno 2011 | Aggiornamento: martedì 14 giugno 2011
...
Questo aggiornamento per la protezione è considerato Critico per tutte le edizioni supportate di Windows XP e Windows Server 2003; Importante per tutte le edizioni supportate di Windows Vista e Windows Server 2008; ed Importante per Windows 7 per sistemi a 32 bit, Windows 7 per sistemi x64, Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per i sistemi Itanium. Per ulteriori informazioni, vedere la sottosezione **Software interessato e Software non interessato** all'interno di questa sezione.

L'aggiornamento per la protezione risolve le vulnerabilità correggendo il modo in cui il client DFS convalida i campi nelle risposte di riferimento DFS appositamente predisposte e correggendo il modo in cui il servizio DFS gestisce le risposte di riferimento DFS appositamente predisposte. Per ulteriori informazioni sulle vulnerabilità, cercare la voce specifica nella sottosezione Domande frequenti della sezione **Informazioni sulle vulnerabilità**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                            | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                   | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                   | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                       | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                      | Esecuzione di codice in modalità remota     | Critico                      | Nessuno                                       |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                          | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                  | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi a 32 bit e Windows Server 2008 per sistemi a 32 bit Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\* | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi x64 e Windows Server 2008 per sistemi x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*           | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 per sistemi Itanium e Windows Server 2008 per sistemi Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4)     | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi a 32 bit](http://www.microsoft.com/downloads/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                       | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                            | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64](http://www.microsoft.com/downloads/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                             | Denial of Service                           | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                           | Denial of Service                           | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata al danneggiamento della memoria DFS - CVE-2011-1868</th>
<th style="border:1px solid black;" >Vulnerabilità legata alla risposta di riferimento DFS - CVE-2011-1869</th>
...
Vulnerabilità legata al danneggiamento della memoria DFS - CVE-2011-1868  
------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota non autenticata nel modo in cui il client DFS analizza risposte DFS appositamente predisposte. Poiché non viene richiesta l'autenticazione, un utente malintenzionato può sfruttare tale vulnerabilità inviando una risposta DFS appositamente predisposta a una richiesta DFS avviata dal client. Un utente malintenzionato che sfrutti questa vulnerabilità potrebbe eseguire codice non autorizzato e acquisire il controllo completo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868).
  
#### Fattori attenuanti della vulnerabilità legata al danneggiamento della memoria DFS - CVE-2011-1868
...
#### Soluzioni alternative per la vulnerabilità legata al danneggiamento della memoria DFS - CVE-2011-1868
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata al danneggiamento della memoria DFS - CVE-2011-1868
...
La vulnerabilità si verifica quando l'implementazione DFS Microsoft convalida erroneamente tutti i campi all'interno delle risposte DFS appositamente predisposte.
  
**Che cos'è il DFS (Distributed File System)?**    
Il DFS consente agli amministratori di raggruppare le cartelle condivise situate su server diversi connettendole in modo trasparente a uno o più spazi nome DFS. Uno spazio nome DFS è una visualizzazione virtuale delle cartelle condivise in un'organizzazione. Tramite gli strumenti DFS, un amministratore seleziona le cartelle condivise da presentare nello spazio nome, progetta la gerarchia in cui tali cartelle vengono visualizzate e stabilisce i nomi visualizzai dalle cartelle condivise nello spazio nome. Quando un utente visualizza lo spazio nome, vengono visualizzate le cartelle da posizionare in un solo disco fisso a elevata capacità. Gli utenti sono in grado di esplorare le cartelle nello spazio nome senza conoscere i nomi server o le cartelle condivise contenenti i dati. Per ulteriori informazioni, consultare [DFS Technical Reference](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx).
...
Un utente malintenzionato può ospitare un server appositamente predisposto, progettato per sfruttare la vulnerabilità e convincere un utente ad avviare una connessione DFS con esso. L'utente malintenzionato può inoltre eseguire nella rete locale un attacco di tipo "man-in-the-middle" per rispondere a una richiesta DFS legittima con una risposta DFS non valida.
  
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
La vulnerabilità sono a rischio tutte le edizioni supportate di Windows XP e Windows Server 2003.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui il client DFS convalida i campi all'interno delle riposte DFS appositamente predisposte.
...
Vulnerabilità legata alla risposta di riferimento DFS - CVE-2011-1869  
---------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità ad attacchi di tipo Denial of Service nel modo in cui DFS Microsoft gestisce le risposte di riferimento DFS appositamente predisposte. Poiché non viene richiesta l'autenticazione, un utente malintenzionato può sfruttare tale vulnerabilità inviando un messaggio di rete appositamente predisposto a un computer che esegue il servizio Server.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869).
  
#### Fattori attenuanti per la vulnerabilità legata alla risposta di riferimento DFS - CVE-2011-1869
...
#### Soluzioni alternative per la vulnerabilità legata alla risposta di riferimento DFS - CVE-2011-1869
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata alla risposta di riferimento DFS - CVE-2011-1869
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità ad attacchi di tipo Denial of Service. Un utente malintenzionato può sfruttare la vulnerabilità impedendo al sistema di rispondere alle richieste e richiedendone il riavvio manuale. Tenere presente che la vulnerabilità ad attacchi di tipo Denial of Service non consente di eseguire il codice o acquisire diritti utente più elevati, ma può impedire al servizio interessato di accettare richieste.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità si verifica l'implementazione del DFS gestisce in modo errato le risposte di riferimento DFS appositamente predisposte.
...
**Quali sono i sistemi principalmente interessati da questa vulnerabilità?**    
Tutte le versioni di Windows sono a rischio a causa di questa vulnerabilità.
  
**Quali sono gli scopi dell'aggiornamento?**    
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui il servizio DFS gestisce le risposte DFS appositamente predisposte.
...
| Windows 7 per sistemi 32-bit                                                                       | No                | No                         |  
| Windows 7 per sistemi x64                                                                          | No                | No                         |  
| Windows Server 2008 R2 per sistemi x64                                                             | No                | No                         |  
| Windows Server 2008 R2 per sistemi Itanium                                                         | No                | No                         |
...
<td style="border:1px solid black;">Utilizzare lo strumento <strong>Installazione applicazioni</strong> nel Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2535512$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it/kb/2535512">articolo della Microsoft Knowledge Base 2535512</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Windows 7 per sistemi a 32 bit:<br />
Windows6.1-KB2535512-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Windows 7 per sistemi x64:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per tutte le versioni di Windows 7 per sistemi x64:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Installazione senza intervento dell'utente</td>
<td style="border:1px solid black;">Per Windows 2008 R2 per sistemi x64:<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Windows 2008 R2 per sistemi Itanium:<br />
...
-   Laurent Gaffié di [Software di NGS](http://www.ngssoftware.com/) per aver segnalato la vulnerabilità legata alla risposta di riferimento DFS (CVE-2011-1869)
...
-   V1.1 (14 giugno 2011): Windows 7 per sistemi a 32 bit Service Pack 1, Windows 7 per sistemi x64 Service Pack 1, Windows Server 2008 R2 per sistemi x64 Service Pack 1 e Windows Server 2008 R2 per sistemi Itanium Service Pack 1 sono stati spostati dalla tabella Software interessato alla tabella Software non interessato. La modifica è esclusivamente informativa. Non sono previste modifiche ai file di aggiornamento per la protezione o per la logica di rilevamento.
