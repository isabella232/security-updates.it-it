---
TOCTitle: 'MS11-080'
Title: 'Bollettino Microsoft sulla sicurezza MS11-080 - Importante'
ms:assetid: 'ms11-080'
ms:contentKeyID: 61240621
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-080(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-080 - Importante
==========================================================

Una vulnerabilità nel driver di funzioni ausiliario può consentire l'acquisizione di privilegi più elevati (2592799)
--------------------------------------------------------------------------------------------------------------------
...
Questo aggiornamento per la protezione risolve una vulnerabilità segnalata privatamente nel driver di funzioni ausiliario di Microsoft (AFD). La vulnerabilità può consentire l'acquisizione di privilegi più elevati se un utente malintenzionato accede ad un sistema ed esegue un'applicazione appositamente predisposta. Per sfruttare la vulnerabilità, un utente malintenzionato deve disporre di credenziali di accesso valide ed essere in grado di sfruttare tale vulnerabilità.
...
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui il driver di funzioni ausiliario (AFD) convalida l'input prima di inviarlo dalla modalità utente al kernel di Windows. Per ulteriori informazioni sulla vulnerabilità, vedere la voce specifica nella sottosezione Domande frequenti all'interno della sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f1b2dceb-5bef-4522-9001-8dff0545d805)                          | Acquisizione di privilegi più elevati       | Importante                   | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9a37864e-8543-4c52-aa73-e3c190860d76) | Acquisizione di privilegi più elevati       | Importante                   | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=29228167-b811-43d7-b4a0-91e385b598a5)                 | Acquisizione di privilegi più elevati       | Importante                   | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0816d729-6769-4ca6-a14e-71750eca8d29)     | Acquisizione di privilegi più elevati       | Importante                   | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=42465652-2664-4fd5-9a22-ae847b08e7c8)    | Acquisizione di privilegi più elevati       | Importante                   | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'acquisizione di privilegi più elevati nel driver di funzioni ausiliario - CVE-2011-2005</th>
...
Vulnerabilità legata all'acquisizione di privilegi più elevati nel driver di funzioni ausiliario - CVE-2011-2005  
----------------------------------------------------------------------------------------------------------------
...
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-2005](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2005).
  
#### Fattori attenuanti della vulnerabilità legata all'acquisizione di privilegi più elevati nel driver di funzioni ausiliario - CVE-2011-2005
...
#### Soluzioni alternative per la vulnerabilità legata all'acquisizione di privilegi più elevati nel driver di funzioni ausiliario - CVE-2011-2005
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'acquisizione di privilegi più elevati nel driver di funzioni ausiliario - CVE-2011-2005
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2592799$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2592799">articolo della Microsoft Knowledge Base 2592799</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilizzare **Installazione applicazioni** dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\\$NTUninstallKB2592799$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Vedere l'[articolo della Microsoft Knowledge Base 2592799](http://support.microsoft.com/kb/2592799)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Bo Zhou di [National University of Defense Technology](http://www.nudt.edu.cn/) per aver segnalato la vulnerabilità legata all'acquisizione di privilegi più elevati nel driver di funzioni ausiliario (CVE-2011-2005)
