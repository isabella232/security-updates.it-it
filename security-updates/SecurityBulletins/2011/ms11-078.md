---
TOCTitle: 'MS11-078'
Title: 'Bollettino Microsoft sulla sicurezza MS11-078 - Critico'
ms:assetid: 'ms11-078'
ms:contentKeyID: 61240619
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-078(v=Security.10)'
author: SharonSears
...
Data di pubblicazione: martedì 11 ottobre 2011 | Aggiornamento: martedì 10 luglio 2012
...
**Problemi noti.** L'[articolo della Microsoft Knowledge Base 2604930](http://support.microsoft.com/kb/2604930) descrive i problemi attualmente conosciuti che gli utenti potrebbero riscontrare installando questo aggiornamento per la protezione. L'articolo illustra inoltre le soluzioni consigliate in grado di risolvere questi problemi.
...
<td style="border:1px solid black;">
KB953295 in [MS09-061](http://go.microsoft.com/fwlink/?linkid=160527) sostituito da KB2572066  
KB2416447 in [MS10-070](http://go.microsoft.com/fwlink/?linkid=202409) sostituito da KB2572067  
KB983583 in [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830) sostituito da KB2572073  
...
<td style="border:1px solid black;">
KB953298 in [MS09-061](http://go.microsoft.com/fwlink/?linkid=?????) sostituito da KB2572069  
KB983583 in [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830) sostituito da KB2572073  
Nessun bollettino sostituito da KB2572078
</td>
</tr>
...
<td style="border:1px solid black;">
KB2416447 in [MS10-070](http://go.microsoft.com/fwlink/?linkid=202409) sostituito da KB2572067  
KB983589 in [MS10-060](http://go.microsoft.com/fwlink/?linkid=179830) sostituito da KB2572075  
Nessun bollettino sostituito da KB2572078
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
Nessun bollettino sostituito da KB2572076  
Nessun bollettino sostituito da KB2572078
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
Nessun bollettino sostituito da KB2572077  
Nessun bollettino sostituito da KB2572078
</td>
</tr>
<tr>
...
La build 4.0.60831 di Microsoft Silverlight, che è l'attuale build di Silverlight come nella prima versione di questo bollettino, risolve la vulnerabilità e non è interessata. Le build di Microsoft Silverlight precedenti a 4.0.60831 sono interessate.
...
La versione installata con questo aggiornamento per la protezione è 4.0.60831. Se il numero della propria versione è uguale o superiore a tale numero, il sistema non è vulnerabile.
...
**Le versioni Silverlight 5 Beta o Release Candidate (RC) sono interessate da questa vulnerabilità?**
No, nessuna versione di Silverlight 5 è interessata da questo problema.
...
Questo bollettino descrive una vulnerabilità in .NET Framework 1.1 e in .NET Framework 2.0 e nei livelli di funzionalità di .NET Framework 4. Il programma di installazione di .NET Framework 3.0 Service Pack 2 è collegato alla configurazione di .NET Framework 2.0 Service Pack 2, quindi l'installazione della prima applicazione comporta anche l'installazione della seconda. Quindi, i clienti che hanno installato .NET Framework 3.0 Service Pack 2 devono installare gli aggiornamenti per la protezione per .NET Framework 2.0 Service Pack 2.

**È stato installato .NET Framework 3.5 Service Pack 1. È necessario installare un aggiornamento?**
Questo bollettino descrive una vulnerabilità in .NET Framework 1.1 e in .NET Framework 2.0 e nel livello di funzionalità di .NET Framework 4. Il programma di installazione di .NET Framework 3.5 Service Pack 1 è collegato sia alla configurazione di .NET Framework 2.0 Service Pack 2 sia a quella di .NET Framework 3.0 Service Pack 2. Quindi, i clienti che hanno installato .NET Framework 3.5 Service Pack 1 devono installare anche gli aggiornamenti per la protezione per .NET Framework 2.0 Service Pack 2.
...
<span></span>
I seguenti livelli di gravità presuppongono il livello massimo di impatto potenziale della vulnerabilità. Per informazioni relative al rischio, entro 30 giorni dalla pubblicazione del presente bollettino sulla sicurezza, di sfruttamento della vulnerabilità in relazione al livello di gravità e all'impatto sulla protezione, vedere l'Exploitability Index nel [riepilogo dei bollettini di ottobre](http://technet.microsoft.com/security/bulletin/ms11-oct.mspx). Per ulteriori informazioni, vedere [Microsoft Exploitability Index](http://technet.microsoft.com/it-it/security/cc998259.aspx).
...
<span></span>
Una vulnerabilità legata all'esecuzione di codice in modalità remota è stata riscontrata nel modo in cui il framework di Microsoft .NET Framework e Silverlight limita l'ereditarietà all'interno delle classi. Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario nel contesto di protezione dell'utente connesso. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1253).

#### Fattori attenuanti della vulnerabilità legata all'ereditarietà delle classi in .NET Framework - CVE-2011-1253
...
#### Soluzioni alternative per la vulnerabilità legata all'ereditarietà delle classi in .NET Framework - CVE-2011-1253
...
#### Domande frequenti sulla vulnerabilità legata all'ereditarietà delle classi in .NET Framework - CVE-2011-1253
...
La vulnerabilità è causata dal fatto che .NET Framework limita in maniera errata l'ereditarietà all'interno delle classi.
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2604930">articolo della Microsoft Knowledge Base 2604930</a></td>
</tr>
<tr class="odd">
...
**Installazione dell'aggiornamento per Microsoft .NET Framework 1.0 Service Pack 3 (KB2572066)**
...
**Installazione dell'aggiornamento per Microsoft .NET Framework 1.1 Service Pack 1 (KB2572067)**
...
**Installazione dell'aggiornamento per** **Microsoft .NET Framework 2.0 Service Pack 2(KB2572073)e** **Microsoft .NET Framework 4(KB2572078)**
...
**Rimozione dell'aggiornamento per Microsoft .NET Framework 1.0 Service Pack 3** (**KB2572066)**
...
**Rimozione dell'aggiornamento per Microsoft .NET Framework 1.1 Service Pack 1 (KB2572067)**
...
**Rimozione dell'aggiornamento per Microsoft .NET Framework 2.0 Service Pack 2 (KB2572073** **e Microsoft .NET Framework 4.0 (KB2572078)**
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft .NET Framework 2.0 Service Pack 2 installato in Microsoft Windows 2003 Service Pack 2:<br />
NDP20SP2-KB2572073-x86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft .NET Framework 1.1 Service Pack 1 installato in Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft .NET Framework 2.0 Service Pack 2 installato in Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP20SP2-KB2572073-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft .NET Framework 1.1 Service Pack 1 installato in Windows Server 2003 Service Pack 2 per sistemi Itanium:<br />
NDP1.1sp1-KB2572067-X86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Per Microsoft .NET Framework 2.0 Service Pack 2 installato in Windows Server 2003 con SP2 per sistemi Itanium:<br />
...
**Installazione dell'aggiornamento per Microsoft .NET Framework 1.1 Service Pack 1** **su** **Windows Server 2003 Service Pack 2** **(KB2572069)**

Questo aggiornamento per la protezione supporta le opzioni di installazione seguenti per Microsoft .NET Framework 1.1 Service Pack 1 su Windows Server 2003 Service Pack 2 (KB2572069).
...
**Installazione dell'aggiornamento per Microsoft .NET Framework 1.1 Service Pack 1** **su Windows Server 2003 x64 Edition Service Pack 2** **e** **Windows Server 2003 Itanium-based Edition Service Pack 2** **(KB2572067)**
...
**Rimozione dell'aggiornamento per** **Microsoft .NET Framework 1.1 Service Pack 1 su Windows Server 2003 Service Pack 2 (KB2572069)**
...
**Rimozione dell'aggiornamento** **per** **Microsoft .NET Framework 1.1 Service Pack 1 su Windows Server 2003 x64 Edition Service Pack 2 e Windows Server 2003 Itanium-based Edition Service Pack 2 (KB2572067)**
...
**Installazione dell'aggiornamento per Microsoft .NET Framework 2.0 Service Pack 2 (KB2572075)**
...
**Installazione dell'aggiornamento per Microsoft .NET Framework 4 (KB2572078)**
...
-   Un collaboratore anonimo che collabora con il programma [SecuriTeam Secure Disclosure di Beyond Security](http://www.beyondsecurity.com/ssd.html) per aver segnalato la vulnerabilità legata all'ereditarietà delle classi in .NET Framework (CVE-2011-1253)
