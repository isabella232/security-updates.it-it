---
TOCTitle: 'MS11-044'
Title: 'Bollettino Microsoft sulla sicurezza MS11-044 - Critico'
ms:assetid: 'ms11-044'
ms:contentKeyID: 61240587
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-044(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-044 - Critico
=======================================================

Una vulnerabilità in .NET Framework può consentire l'esecuzione di codice in modalità remota (2538814)
------------------------------------------------------------------------------------------------------

Data di pubblicazione: martedì 14 giugno 2011 | Aggiornamento: martedì 10 luglio 2012
...
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui il compilatore JIT all'interno di .NET Framework convalida alcun valori in un oggetto. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
Microsoft ha rivisto questo bollettino sulla sicurezza per comunicare una modifica di rilevamento ai pacchetti per KB2518870 e KB2518864 per rettificare un problema di installazione. Si tratta di una modifica solo al rilevamento. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.

**Dove si trova la sezione Informazioni sui file?**
Fare riferimento alle tabelle contenute nella sezione **Distribuzione dell'aggiornamento per la protezione** per individuare la sezione Informazioni sui file.

**L'aggiornamento per la protezione si riferisce a MS11-039: la vulnerabilità di .NET Framework e Microsoft Silverlight potrebbe consentire l'esecuzione di codici in modalità remota?**
...
Inoltre alle modifiche elencate nella sezione informazioni sulle vulnerabilità di questo bollettino, quest'aggiornamento per la protezione disattiva anche il supporto di ClickOnce per l'ash di MD2 e MD4 l'hash. Dopo aver applicato l'aggiornamento per l'ash, le registrate con MD2 o MD4 non verrà più eseguiti. Per dettagli completi, consultare l'[articolo della Microsoft Knowledge Base 2562394](http://support.microsoft.com/?ln=it/kb/2562394).
...
<th style="border:1px solid black;" >
Vulnerabilità legata all'ottimizzazione JIT .NET Framework - CVE-2011-1271
</th>
<th style="border:1px solid black;" >
Livello di gravità aggregato
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 installato in Windows 7 per sistemi x64 e Windows 7 per sistemi x64 Service Pack 1<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Critico**  
Esecuzione di codice in modalità remota
...
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui .NET Framework di Microsoft convalida alcuni valori all'interno di un oggetto. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.

Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1271](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1271).

#### Fattori attenuanti per la vulnerabilità legata all'ottimizzazione JIT .NET Framework - CVE-2011-1271
...
#### Soluzioni alternative per la vulnerabilità legata all'ottimizzazione JIT .NET Framework - CVE-2011-1271
...
#### Domande frequenti sulla vulnerabilità legata all'ottimizzazione JIT .NET Framework - CVE-2011-1271
...
La vulnerabilità si verifica quando il compilatore JIT all'interno di .NET Framework convalida in modo errato alcuni valori in un oggetto.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui il compilatore JIT all'interno di .NET Framework convalida alcuni valori in un oggetto.

**Al momento del rilascio di questo bollettino, le informazioni sulla vulnerabilità erano disponibili pubblicamente?**
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2011-1271](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1271).
...
<td style="border:1px solid black;">Consultare l'<a href="http://support.microsoft.com/?ln=it/kb/2538814">articolo della Microsoft Knowledge Base 2538814</a></td>
</tr>
<tr class="even">
...
-   Dan Kaminsky per aver collaborato con noi sulle modifiche obsolete MD2 risolte in questo bollettino
...
-   V1.1 (11 ottobre 2011): È stata aggiunta una Domanda frequente sull'aggiornamento per comunicare una modifica relativa al rilevamento per KB2518870 e KB2518864 che rettifica un problema di installazione. Si tratta di una modifica solo al rilevamento. Non sono previsti aggiornamenti ai file sull'aggiornamento per la protezione. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.
...
-   V1.3 (10 luglio 2012): Microsoft ha rivisto questo bollettino per comunicare un modifica minore relativa al rilevamento per KB2518864 per consentire a Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 di correggere un problema di offerta. Non sono previsti aggiornamenti ai file sull'aggiornamento per la protezione. I clienti che hanno già aggiornato i propri sistemi non devono eseguire ulteriori operazioni.
