---
TOCTitle: 'MS11-059'
Title: 'Bollettino Microsoft sulla sicurezza MS11-059 - Importante'
ms:assetid: 'ms11-059'
ms:contentKeyID: 61240600
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-059(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-059 - Importante
==========================================================

Una vulnerabilità in Data Access Components può consentire l'esecuzione di codice in modalità remota (2560656)
--------------------------------------------------------------------------------------------------------------
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows 7 per sistemi a 32 bit e Windows 7 per sistemi a 32 bit Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6bc168d9-6664-41fb-914f-dbd7514a4b0e)                         | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows 7 per sistemi x64 e Windows 7 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=aafeff2d-db9a-4b3b-b620-be4ec5f5bdcc)                                   | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi x64 e Windows Server 2008 R2 per sistemi x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c29deec3-4672-4658-a550-dce244434cd4)\*       | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
| [Windows Server 2008 R2 per sistemi Itanium e Windows Server 2008 R2 per sistemi Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1d6b8036-d38f-408a-a36c-027553faefc1) | Esecuzione di codice in modalità remota     | Importante                   | Nessuno                                       |
...
Sì, la vulnerabilità legata al caricamento non sicuro delle librerie in Windows Data Access Components (CVE-2011-1975) risolta dal presente aggiornamento è correlata alle vulnerabilità descritte nell'[Advisory Microsoft sulla sicurezza 2269637](http://technet.microsoft.com/security/advisory/2269637) che interessano le modalità con cui le applicazioni caricano le librerie esterne. Questo aggiornamento per la protezione risolve un'istanza particolare di questo tipo di vulnerabilità.
...
<th style="border:1px solid black;" >Vulnerabilità legata al caricamento non sicuro delle librerie in Data Access Components - CVE-2011-1975</th>
...
Vulnerabilità legata al caricamento non sicuro delle librerie in Data Access Components - CVE-2011-1975  
-------------------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui il componente di traccia Windows Data Access gestisce il caricamento dei file DLL. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1975](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1975).
  
#### Fattori attenuanti della vulnerabilità legata al caricamento non sicuro delle librerie in Data Access Components - CVE-2011-1975
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   L'attacco è possibile solo se l'utente visita una posizione di file system o condivisione WebDAV non attendibile remota e apre un file Excel (ad esempio un file .xlsx).  
...
#### Soluzioni alternative per la vulnerabilità legata al caricamento non sicuro delle librerie in Data Access Components - CVE-2011-1975
...
#### Domande frequenti sulla vulnerabilità legata al caricamento non sicuro delle librerie in Data Access Components - CVE-2011-1975
...
La vulnerabilità si verifica quando il componente di traccia Windows Data Access limita in maniera errata il percorso utilizzato per il caricamento delle librerie esterne.
  
**Che cos'è Windows Data Access Components (Windows DAC)?**    
Windows Data Access Components (Windows DAC) 6.0 è un insieme di tecnologie contenute in Windows Vista, Windows 7, Windows Server 2008 e Windows Server 2008 R2 per fornire accesso alle informazioni in tutta l'azienda. Queste tecnologie includono Microsoft ActiveX Data Objects (ADO), OLE DB e Microsoft Open Database Connectivity (ODBC). Le applicazioni client/server basate su dati distribuite tramite Web o tramite una LAN possono utilizzare questi componenti per integrare facilmente delle informazioni da una varietà di fonti, sia relazionali (SQL) sia non-relazionali. Per ulteriori informazioni, vedere l'articolo MSDN, [Windows Data Access Components SDK](http://msdn.microsoft.com/it-it/library/aa968814(v=vs.85).aspx).
...
Sebbene i vettori di attacco conosciuti possano sfruttare il software Microsoft Office, ad esempio Microsoft Excel, il codice vulnerabile esiste in un componente condiviso di Microsoft Windows.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui il componente di traccia Windows Data Access carica le librerie esterne.
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2560656">articolo della Microsoft Knowledge Base 2560656</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (10 agosto 2011): Sono stati corretti i requisiti di riavvio per l'aggiornamento su tutti i sistemi operativi interessati.
