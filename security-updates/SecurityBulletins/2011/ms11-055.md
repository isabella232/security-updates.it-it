---
TOCTitle: 'MS11-055'
Title: 'Bollettino Microsoft sulla sicurezza MS11-055 - Importante'
ms:assetid: 'ms11-055'
ms:contentKeyID: 61240596
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-055(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-055 - Importante
==========================================================

Una vulnerabilità in Microsoft Visio può consentire l'esecuzione di codice in modalità remota (2560847)
-------------------------------------------------------------------------------------------------------
...
La vulnerabilità descritta in questo bollettino ha un livello di gravità importante per Microsoft Visio 2003 Service Pack 3. Per ulteriori informazioni, vedere la sottosezione **Software interessato e software non interessato** all'interno della presente sezione.

L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui Microsoft Visio carica le librerie esterne. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
| Microsoft Visio 2010 (edizioni a 32 bit) e Microsoft Visio 2010 (edizioni a 32 bit) Service Pack 1 |  
| Microsoft Visio 2010 (edizioni a 64 bit) e Microsoft Visio 2010 (edizioni a 64 bit) Service Pack 1 |  
...
**Ho installato una versione del software Microsoft Office 2003 non esposta a vulnerabilità. Perché mi viene offerto questo aggiornamento?**    
Sebbene il vettore di attacco per sfruttare la vulnerabilità descritta in CVE-2010-3148 agisce tramite Microsoft Visio 2003, il codice vulnerabile è presente in un componente condiviso di Microsoft Office. Alcuni software non interessati, come i programmi autonomi Microsoft Office 2003 Suite e Microsoft Office 2003, contengono il componente vulnerabile condiviso di Microsoft Office, ma poiché non accedono al codice vulnerabile, non sono interessati da questa vulnerabilità. L'aggiornamento viene offerto perché il codice vulnerabile è comunque presente.
...
Sì, la vulnerabilità legata al caricamento non sicuro delle librerie in Microsoft Visio (CVE-2010-3148), risolta dal presente aggiornamento è correlata alle vulnerabilità descritte nell'[Advisory Microsoft sulla sicurezza 2269637](http://technet.microsoft.com/security/advisory/2269637) che interessano le modalità con cui le applicazioni caricano le librerie esterne. Questo aggiornamento per la protezione risolve un'istanza particolare di questo tipo di vulnerabilità.
...
<th style="border:1px solid black;" >Vulnerabilità legata al caricamento di librerie non sicure in Microsoft Visio - CVE-2010-3148</th>
<th style="border:1px solid black;" >Livello di gravità aggregato</th>
</tr>
</thead>
<tbody>
...
Vulnerabilità legata al caricamento di librerie non sicure in Microsoft Visio - CVE-2010-3148  
---------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'esecuzione di codice in modalità remota nel modo in cui Microsoft Visio gestisce il caricamento dei file DLL. Sfruttando questa vulnerabilità, un utente malintenzionato può assumere il pieno controllo del sistema interessato. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi. Pertanto, gli utenti con account configurati in modo da disporre solo di diritti limitati sono esposti all'attacco in misura inferiore rispetto a quelli che operano con privilegi di amministrazione.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2010-3148](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3148).
  
#### Fattori attenuanti della vulnerabilità legata al caricamento delle librerie non sicure in Microsoft Visio - CVE-2010-3148
  
Per fattore attenuante si intende un'impostazione, una configurazione comune o una procedura consigliata generica esistente in uno stato predefinito in grado di ridurre la gravità nello sfruttamento di una vulnerabilità. I seguenti fattori attenuanti possono essere utili per l'utente:
  
-   L'attacco è possibile solo se l'utente visita un file system remoto o una condivisione WebDAV di dubbia provenienza e apre un file relativo a Office (ad esempio un file .vsd, .vdx o .vst).  
...
#### Soluzioni alternative della vulnerabilità legata al caricamento delle librerie non sicure in Microsoft Visio - CVE-2010-3148
...
#### Domande frequenti sulla vulnerabilità legata al caricamento delle librerie non sicure in Microsoft Visio - CVE-2010-3148
...
La vulnerabilità si verifica quando il componente Microsoft Visio limita in maniera errata il percorso utilizzato per il caricamento delle librerie esterne.
...
Un utente malintenzionato può convincere un utente ad aprire un file legittimo collegato a Visio (ad esempio .vsd, .vdx, .vst o .vtx) situato nella stessa directory di rete di un file appositamente predisposto della libreria di collegamento dinamico (DLL). Quindi, durante l'apertura del file legittimo, Microsoft Visio può tentare di caricare il file DLL ed eseguire qualsiasi codice esso contenga.
  
In uno scenario di attacco tramite posta elettronica, un utente malintenzionato può sfruttare la vulnerabilità inviando ad un utente un allegato legittimo del file collegato a Visio (ad esempio .vsd, .vdx, .vst o .vtx), convincendolo a salvare l'allegato in una directory che contiene un file DLL appositamente predisposto e ad aprire il file legittimo. Quindi, durante l'apertura del file legittimo, Microsoft Visio può tentare di caricare il file DLL ed eseguire qualsiasi codice esso contenga.
  
In uno scenario di attacco di rete, un utente malintenzionato può collocare un file collegato a Visio e un file DLL appositamente predisposto su una condivisione di rete, una posizione di UNC o WebDAV e convincere quindi l'utente ad aprire il file.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui Microsoft Visio carica le librerie esterne.
...
Sì. Le informazioni sulla vulnerabilità sono state divulgate pubblicamente. Questa vulnerabilità è stata identificata con il codice [CVE-2010-3148](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3148).
...
Sì. Questo aggiornamento per la protezione risolve la vulnerabilità che può essere sfruttata utilizzando il codice di prova esistente pubblicato. Questa vulnerabilità è stata identificata con il codice [CVE-2010-3148](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3148).
...
<td style="border:1px solid black;">Vedere l'<a href="http://support.microsoft.com/kb/2493523">articolo della Microsoft Knowledge Base 2493523</a></td>
</tr>
<tr class="even">
