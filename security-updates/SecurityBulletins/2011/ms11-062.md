---
TOCTitle: 'MS11-062'
Title: 'Bollettino Microsoft sulla sicurezza MS11-062 - Importante'
ms:assetid: 'ms11-062'
ms:contentKeyID: 61240603
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms11-062(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS11-062 - Importante
==========================================================

Una vulnerabilità nel driver NDISTAPI del Servizio di accesso remoto può consentire l'acquisizione di privilegi più elevati (2566454)
-------------------------------------------------------------------------------------------------------------------------------------
...
L'aggiornamento per la protezione risolve la vulnerabilità correggendo il modo in cui il driver NDISTAPI convalida l'input in modalità utente prima di inviarlo al kernel di Windows. Per ulteriori informazioni sulla vulnerabilità, vedere la sottosezione Domande frequenti per la specifica voce della vulnerabilità nella sezione **Informazioni sulle vulnerabilità**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4)                          | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b) | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc)                 | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667)     | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
| [Windows Server 2003 con SP2 per sistemi Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d)    | Acquisizione di privilegi più elevati       | Importante                   | Nessuno                                       |
...
<th style="border:1px solid black;" >Vulnerabilità legata all'acquisizione di privilegi più elevati in NDISTAPI - CVE-2011-1974</th>
...
Vulnerabilità legata all'acquisizione di privilegi più elevati in NDISTAPI - CVE-2011-1974  
------------------------------------------------------------------------------------------
  
<span></span>
Esiste una vulnerabilità legata all'acquisizione di privilegi più elevati nel driver NDISTAPI del Servizio di accesso remoto. La vulnerabilità è causata quando il driver NDISTAPI non convalida correttamente l'input fornito dall'utente quando invia i dati in modalità utente al kernel di Windows. Sfruttando questa vulnerabilità, un utente malintenzionato locale può eseguire codice arbitrario e acquisire il controllo completo del sistema interessato. Inoltre, può installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
  
Per visualizzare questa vulnerabilità come voce standard nell'elenco CVE, vedere il codice [CVE-2011-1974](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974).
  
#### Fattori attenuanti della vulnerabilità legata all'acquisizione di privilegi più elevati in NDISTAPI - CVE-2011-1974
...
#### Soluzioni alternative per la vulnerabilità legata all'acquisizione di privilegi più elevati in NDISTAPI - CVE-2011-1974
  
Microsoft non ha individuato alcuna soluzione alternativa per questa vulnerabilità.
  
#### Domande frequenti sulla vulnerabilità legata all'acquisizione di privilegi più elevati in NDISTAPI - CVE-2011-1974
  
**Qual è la portata o l'impatto di questa vulnerabilità?**    
Si tratta di una vulnerabilità associata all'acquisizione di privilegi più elevati.
  
**Quali sono le cause di questa vulnerabilità?**    
La vulnerabilità è causata quando il driver NDISTAPI non convalida correttamente l'input fornito dall'utente quando invia i dati in modalità utente al kernel di Windows.
  
**Quale componente è interessato dalla vulnerabilità?**    
NDISTAPI.sys è il componente interessato dalla vulnerabilità.
  
**Che cos'è il Servizio di accesso remoto (RAS)?**    
Il Servizio di accesso remoto (RAS) consente agli utenti di collegarsi a un computer remoto tramite linee telefoniche, Internet o un 'altra connessione di rete in modo da poter lavorare come se il proprio sistema fosse fisicamente collegato alla rete remota. RAS permette agli utenti di eseguire in modalità remota attività come l'invio e la ricezione di messaggi di posta elettronica, l'invio di fax, il recupero di file e la stampa di documenti su una stampante dell'ufficio. Per ulteriori informazioni, vedere l'articolo MSDN, [RAS](http://msdn.microsoft.com/en-us/library/ff563285(v=vs.85).aspx) Architecture Overview (NDIS 5.1).
  
RAS è un servizio nativo in Windows XP e Windows Server 2003, che è stato sostituito dal Servizio routing e Accesso remoto (RRAS) nei sistemi operativi più recenti. RRAS consente ad un computer di funzionare come router di rete RRAS fornisce anche la funzionalità server di nuova generazione per RAS per Windows. La funzionalità server RRAS si basa sulla funzionalità RAS, già inclusa nei precedenti sistemi operativi.
  
**Che cos'è il driver NDISTAPI?**    
Il driver NDISTAPI è parte dell'architettura di RAS ed interfaccia l'NDISWAN ai servizi TAPI. Le applicazioni di telefonia implementano i servizi TAPI e possono inviare richieste TAPI per impostare, monitorare e chiudere linee e chiamate. Il driver NDISTAPI passa queste richieste TAPI al driver NDISWAN. Per ulteriori informazioni, vedere l'articolo MSDN, [NDISTAPI Overview (NDIS 5.1)](http://msdn.microsoft.com/en-us/library/ff554813(v=vs.85).aspx).
  
**Che cos'è NDISWAN?**    
Il driver NDISWAN (Network Driver Interface Standard Wide Area Network) è un driver NDIS intermedio fornito dal sistema che fornisce funzionalità come la compressione di dati, la crittografia, il loopback e il framing PPP semplice utilizzato dai driver WAN Miniport. I driver WAN Miniport sono quindi richiesti per implementare solo quelle funzionalità che sono specifiche del mezzo (ad esempio, è richiesto un segnale Q931 per ISDN). Per ulteriori informazioni, vedere l'articolo MSDN [NDISWAN Overview](http://msdn.microsoft.com/en-us/library/ff564653(v=vs.85).aspx).
  
**Che cos'è il servizio TAPI?**    
Il servizio TAPI (Telephony Application Programming Interface) è un'interfaccia di programmazione che fornisce i servizi di telefonia alle applicazioni che supportano la comunicazione telefonica.
  
**Che cos'è NDIS?**    
NDIS (Network Driver Interface Standard) è parte di Windows Driver Kit, che è un sistema di sviluppo di driver completamente integrato che contiene Windows Driver Device Kit ed i test per la stabilità e l'affidabilità dei driver di Windows. La libreria di NDIS estrae l'hardware di rete dai driver di rete. NDIS specifica anche un'interfaccia standard tra i driver di rete stratificati, estraendo perciò i driver di livello inferiore che gestiscono l'hardware dai driver di livello superiore, ad esempio i trasporti di rete. NDIS mantiene anche le informazioni di stato ed i parametri per i driver di rete, compresi i puntatori alle funzioni, le gestioni ed i blocchi di parametro per il collegamento e altri valori di sistema.
  
**A quali attacchi viene esposto il sistema a causa di questa vulnerabilità?**    
Un utente malintenzionato in grado di sfruttare questa vulnerabilità può eseguire codice arbitrario nel contesto del sistema locale. Potrebbe quindi installare programmi e visualizzare, modificare o eliminare dati oppure creare nuovi account con diritti utente completi.
...
L'aggiornamento risolve la vulnerabilità correggendo il modo in cui il driver NDISTAPI convalida l'input in modalità utente prima di inviarlo al kernel di Windows.
...
<td style="border:1px solid black;">Utilizzare <strong>Installazione applicazioni</strong> dal Pannello di controllo o l'utilità Spuninst.exe disponibile nella cartella %Windir%\$NTUninstallKB2566454$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informazioni sui file</strong></td>
<td style="border:1px solid black;">Consultare l<a href="http://support.microsoft.com/kb/2566454">'articolo della Microsoft Knowledge Base 2566454</a></td>
</tr>
<tr class="even">
...
-   Lufeng Li di per aver segnalato la vulnerabilità legata all'acquisizione di privilegi più elevati in NDISTAPI (CVE-2011-1974)
