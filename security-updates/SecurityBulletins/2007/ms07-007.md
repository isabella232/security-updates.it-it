---
TOCTitle: 'MS07-007'
Title: 'Bollettino Microsoft sulla sicurezza MS07-007 - Importante'
ms:assetid: 'ms07-007'
ms:contentKeyID: 61240226
ms:mtpsurl: 'https://technet.microsoft.com/it-IT/library/ms07-007(v=Security.10)'
author: SharonSears
...
Bollettino Microsoft sulla sicurezza MS07-007 - Importante
==========================================================

Alcune vulnerabilità nel servizio di acquisizione di immagini di Windows potrebbero consentire l'acquisizione di privilegi più elevati (927802)
-----------------------------------------------------------------------------------------------------------------------------------------------
...
-   Microsoft Windows XP Service Pack 2 - [Download dell'aggiornamento](http://www.microsoft.com/downloads/details.aspx?displaylang=it&familyid=ce695e0e-938c-4fc6-a9a2-0eb9fc3e5512)
...
| Identificatori della vulnerabilità                                                                                                                   | Effetti della vulnerabilità           | Windows XP Service Pack 2 |
|------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|---------------------------|
| Vulnerabilità del servizio di acquisizione di immagini di Windows - [CVE-2007-0210](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0210) | Acquisizione di privilegi più elevati | Importante                |
...
<span></span>
#### Vulnerabilità del servizio di acquisizione di immagini di Windows - CVE-2007-0210:

Windows XP Service Pack 2 presenta una vulnerabilità [di acquisizione di privilegi più elevati](http://go.microsoft.com/fwlink/?linkid=21142) legata all'avvio dell'applicazione di Acquisizione di immagini di Windows. La vulnerabilità può consentire a un utente, che riesce ad accedere al sistema, di assumere il controllo completo del sistema in questione.

#### Fattori attenuanti della vulnerabilità del servizio di acquisizione di immagini di Windows - CVE-2007-0210:
...
#### Soluzioni alternative per la vulnerabilità del servizio di acquisizione di immagini di Windows - CVE-2007-0210:

Microsoft ha verificato le soluzioni alternative seguenti. Sebbene queste soluzioni alternative non eliminino la vulnerabilità sottostante, consentono di bloccare gli attacchi noti. Se una soluzione alternativa riduce la funzionalità, viene identificata nella sezione seguente.

-   **Disattivare il servizio di acquisizione di immagini di Window**s

    La disabilitazione del servizio di acquisizione di immagini di Windows consente di proteggere il sistema interessato dai tentativi di sfruttare questa vulnerabilità. Per disattivare il servizio, procedere come segue:
    ...
    È anche possibile arrestare e disattivare il servizio Acquisizione di immagini di Windows (WIA) digitando la riga seguente al prompt dei comandi:

    `sc stop stisvc & sc config stisvc start= disabled`

    **Effetto della soluzione alternativa:** Disattivando Acquisizione di immagini di Windows (WIA), potrebbe non essere possibile connettersi o comunicare con svariate periferiche di gestione di immagini compresi fotocamere digitali e scanner. Questa soluzione alternativa è pertanto consigliata soltanto sui sistemi che non richiedono la comunicazione con le periferiche di gestione di immagini digitali.

#### Domande frequenti sulla vulnerabilità del servizio di acquisizione di immagini di Windows - CVE-2007-0210:
...
Un buffer non controllato nel servizio di acquisizione di immagini di Windows.

**Cosa si intende per Acquisizione immagini di Windows (WIA)?**
Acquisizione immagini di Windows (WIA) abilita la comunicazione tra programmi di gestione delle immagini, quali Microsoft Picture It! 2000, Kodak Imaging o Adobe Photoshop, e periferiche di creazione delle immagini come fotocamere digitali e scanner. WIA supporta fotocamere digitali e scanner sia low-end sia high-end; attiva inoltre il recupero di fermi immagine da videocamere digitali (DV) basate su standard [IEEE 1394](http://www.1394ta.org/technology/) e videocamere Web USB.
...
I sistemi Windows XP Service Pack 2 sono a rischio di vulnerabilità.

**È possibile sfruttare questa vulnerabilità tramite Internet?**
No. L'utente malintenzionato deve accedere localmente al sistema specifico a cui è destinato l'attacco.

**Quali sono gli scopi dell'aggiornamento?**
L'aggiornamento elimina la vulnerabilità modificando il modo in cui Acquisizione di immagini di Windows (WIA) convalida la lunghezza di un messaggio prima di passarlo al buffer allocato.
...
Gli amministratori di sistema possono rimuovere l'aggiornamento per la protezione anche mediante l'utilità Spuninst.exe, disponibile nella cartella %Windir%\\$NTUninstallKB927802$\\Spuninst.
